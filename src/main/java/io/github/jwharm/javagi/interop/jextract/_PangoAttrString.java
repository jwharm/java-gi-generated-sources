...
public class _PangoAttrString {
    ...
    public static MemoryAddress value$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_PangoAttrString.value$VH.get(seg);
    }
    ...
    public static MemoryAddress value$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_PangoAttrString.value$VH.get(seg.asSlice(index*sizeof()));
    }
