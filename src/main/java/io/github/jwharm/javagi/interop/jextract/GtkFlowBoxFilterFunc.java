...
public interface GtkFlowBoxFilterFunc {
    ...
    static MemorySegment allocate(GtkFlowBoxFilterFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkFlowBoxFilterFunc.class, fi, constants$2098.GtkFlowBoxFilterFunc$FUNC, session);
    }
    static GtkFlowBoxFilterFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _child, java.lang.foreign.MemoryAddress _user_data) -> {
            try {
                return (int)constants$2098.GtkFlowBoxFilterFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_child, (java.lang.foreign.Addressable)_user_data);
            } catch (Throwable ex$) {
