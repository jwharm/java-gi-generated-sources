...
class constants$2105 {
    ...
    static final MethodHandle gtk_font_chooser_dialog_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2105.gtk_font_chooser_dialog_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_font_chooser_dialog_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2105.gtk_font_chooser_dialog_new$FUNC
    );
    ...
    static final MethodHandle gtk_font_chooser_widget_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2105.gtk_font_chooser_widget_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_font_chooser_widget_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2105.gtk_font_chooser_widget_new$FUNC
    );
    ...
    static final MethodHandle gtk_frame_get_type$MH = RuntimeHelper.downcallHandle(
        "gtk_frame_get_type",
        constants$2105.gtk_frame_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_frame_new$MH = RuntimeHelper.downcallHandle(
        "gtk_frame_new",
        constants$2105.gtk_frame_new$FUNC
    );
}
