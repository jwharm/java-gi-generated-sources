...
class constants$1166 {
    ...
    static final MethodHandle hb_font_get_variation_glyph_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1166.hb_font_get_variation_glyph_func_t$FUNC
    );
    ...
    static final MethodHandle hb_font_get_nominal_glyphs_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1166.hb_font_get_nominal_glyphs_func_t$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_advance_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1166.hb_font_get_glyph_advance_func_t$FUNC
    );
}
