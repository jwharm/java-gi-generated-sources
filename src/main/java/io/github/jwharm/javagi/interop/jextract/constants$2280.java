...
class constants$2280 {
    ...
    static final MethodHandle gtk_print_settings_new_from_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2280.gtk_print_settings_new_from_file$FUNC
    );
    ...
    static final MethodHandle gtk_print_settings_load_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2280.gtk_print_settings_load_file$FUNC
    );
    ...
    static final MethodHandle gtk_print_settings_to_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2280.gtk_print_settings_to_file$FUNC
    );
    ...
    static final MethodHandle gtk_print_settings_new_from_key_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2280.gtk_print_settings_new_from_key_file$FUNC
    );
    ...
    static final MethodHandle gtk_print_settings_load_key_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2280.gtk_print_settings_load_key_file$FUNC
    );
    ...
    static final MethodHandle gtk_print_settings_to_key_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2280.gtk_print_settings_to_key_file$FUNC
    );
}
