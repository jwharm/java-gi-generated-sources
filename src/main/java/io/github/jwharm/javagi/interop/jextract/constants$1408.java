...
class constants$1408 {
    ...
    static final MethodHandle gdk_gl_context_set_required_version$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1408.gdk_gl_context_set_required_version$FUNC
    );
    ...
    static final MethodHandle gdk_gl_context_get_required_version$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1408.gdk_gl_context_get_required_version$FUNC
    );
    ...
    static final MethodHandle gdk_gl_context_set_debug_enabled$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1408.gdk_gl_context_set_debug_enabled$FUNC
    );
    ...
    static final MethodHandle gdk_gl_context_get_debug_enabled$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1408.gdk_gl_context_get_debug_enabled$FUNC
    );
    ...
    static final MethodHandle gdk_gl_context_set_forward_compatible$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1408.gdk_gl_context_set_forward_compatible$FUNC
    );
    ...
    static final MethodHandle gdk_gl_context_get_forward_compatible$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1408.gdk_gl_context_get_forward_compatible$FUNC
    );
}
