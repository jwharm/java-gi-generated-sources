...
public interface hb_unicode_script_func_t {
    ...
    static MemorySegment allocate(hb_unicode_script_func_t fi, MemorySession session) {
        return RuntimeHelper.upcallStub(hb_unicode_script_func_t.class, fi, constants$1146.hb_unicode_script_func_t$FUNC, session);
    }
    static hb_unicode_script_func_t ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _ufuncs, int _unicode, java.lang.foreign.MemoryAddress _user_data) -> {
            try {
                return (int)constants$1147.hb_unicode_script_func_t$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_ufuncs, _unicode, (java.lang.foreign.Addressable)_user_data);
            } catch (Throwable ex$) {
