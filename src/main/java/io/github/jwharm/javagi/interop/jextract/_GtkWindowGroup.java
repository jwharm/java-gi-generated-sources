...
public class _GtkWindowGroup {
    ...
    public static MemoryLayout $LAYOUT() {
        return _GtkWindowGroup.$struct$LAYOUT;
    }
    ...
    public static VarHandle priv$VH() {
        return _GtkWindowGroup.priv$VH;
    }
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkWindowGroup.priv$VH.get(seg);
    }
    public static void priv$set( MemorySegment seg, MemoryAddress x) {
        _GtkWindowGroup.priv$VH.set(seg, x);
    }
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkWindowGroup.priv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void priv$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkWindowGroup.priv$VH.set(seg.asSlice(index*sizeof()), x);
    }
