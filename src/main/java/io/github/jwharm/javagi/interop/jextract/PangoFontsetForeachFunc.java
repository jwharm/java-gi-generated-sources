...
public interface PangoFontsetForeachFunc {
    ...
    static MemorySegment allocate(PangoFontsetForeachFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PangoFontsetForeachFunc.class, fi, constants$1248.PangoFontsetForeachFunc$FUNC, session);
    }
    static PangoFontsetForeachFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _fontset, java.lang.foreign.MemoryAddress _font, java.lang.foreign.MemoryAddress _user_data) -> {
            try {
                return (int)constants$1248.PangoFontsetForeachFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_fontset, (java.lang.foreign.Addressable)_font, (java.lang.foreign.Addressable)_user_data);
            } catch (Throwable ex$) {
