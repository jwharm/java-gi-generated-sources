...
class constants$2147 {
    ...
    static final MethodHandle gtk_icon_view_selected_foreach$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2147.gtk_icon_view_selected_foreach$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_set_selection_mode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2147.gtk_icon_view_set_selection_mode$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_get_selection_mode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2147.gtk_icon_view_get_selection_mode$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_select_path$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2147.gtk_icon_view_select_path$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_unselect_path$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2147.gtk_icon_view_unselect_path$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_path_is_selected$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2147.gtk_icon_view_path_is_selected$FUNC
    );
}
