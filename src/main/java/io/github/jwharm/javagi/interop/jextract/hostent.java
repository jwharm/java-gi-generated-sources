...
public class hostent {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_INT$LAYOUT.withName("h_addrtype"),
        Constants$root.C_INT$LAYOUT.withName("h_length"),
    ...
    public static int h_addrtype$get(MemorySegment seg) {
        return (int)hostent.h_addrtype$VH.get(seg);
    }
    public static void h_addrtype$set( MemorySegment seg, int x) {
        hostent.h_addrtype$VH.set(seg, x);
    }
    public static int h_addrtype$get(MemorySegment seg, long index) {
        return (int)hostent.h_addrtype$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void h_addrtype$set(MemorySegment seg, long index, int x) {
    ...
    public static int h_length$get(MemorySegment seg) {
        return (int)hostent.h_length$VH.get(seg);
    }
    public static void h_length$set( MemorySegment seg, int x) {
        hostent.h_length$VH.set(seg, x);
    }
    public static int h_length$get(MemorySegment seg, long index) {
        return (int)hostent.h_length$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void h_length$set(MemorySegment seg, long index, int x) {
