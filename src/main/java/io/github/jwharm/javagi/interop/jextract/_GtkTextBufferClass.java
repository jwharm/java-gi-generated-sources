...
public class _GtkTextBufferClass {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_POINTER$LAYOUT.withName("insert_paintable"),
        ...
        Constants$root.C_POINTER$LAYOUT.withName("undo"),
        Constants$root.C_POINTER$LAYOUT.withName("redo"),
    ...
    static final FunctionDescriptor insert_paintable$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle insert_paintable$MH = RuntimeHelper.downcallHandle(
        _GtkTextBufferClass.insert_paintable$FUNC
    );
    public interface insert_paintable {

        void apply(java.lang.foreign.MemoryAddress _x0, java.lang.foreign.MemoryAddress _x1, java.lang.foreign.MemoryAddress _x2);
        static MemorySegment allocate(insert_paintable fi, MemorySession session) {
            return RuntimeHelper.upcallStub(insert_paintable.class, fi, _GtkTextBufferClass.insert_paintable$FUNC, session);
        }
        static insert_paintable ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2) -> {
                try {
                    _GtkTextBufferClass.insert_paintable$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle insert_paintable$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("insert_paintable"));
    public static VarHandle insert_paintable$VH() {
        return _GtkTextBufferClass.insert_paintable$VH;
    }
    public static MemoryAddress insert_paintable$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkTextBufferClass.insert_paintable$VH.get(seg);
    }
    public static void insert_paintable$set( MemorySegment seg, MemoryAddress x) {
        _GtkTextBufferClass.insert_paintable$VH.set(seg, x);
    }
    public static MemoryAddress insert_paintable$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkTextBufferClass.insert_paintable$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void insert_paintable$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkTextBufferClass.insert_paintable$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static insert_paintable insert_paintable (MemorySegment segment, MemorySession session) {
        return insert_paintable.ofAddress(insert_paintable$get(segment), session);
    }
    ...
    static final FunctionDescriptor undo$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle undo$MH = RuntimeHelper.downcallHandle(
        _GtkTextBufferClass.undo$FUNC
    );
    public interface undo {

        void apply(java.lang.foreign.MemoryAddress _x0);
        static MemorySegment allocate(undo fi, MemorySession session) {
            return RuntimeHelper.upcallStub(undo.class, fi, _GtkTextBufferClass.undo$FUNC, session);
        }
        static undo ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0) -> {
                try {
                    _GtkTextBufferClass.undo$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle undo$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("undo"));
    public static VarHandle undo$VH() {
        return _GtkTextBufferClass.undo$VH;
    }
    public static MemoryAddress undo$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkTextBufferClass.undo$VH.get(seg);
    }
    public static void undo$set( MemorySegment seg, MemoryAddress x) {
        _GtkTextBufferClass.undo$VH.set(seg, x);
    }
    public static MemoryAddress undo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkTextBufferClass.undo$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void undo$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkTextBufferClass.undo$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static undo undo (MemorySegment segment, MemorySession session) {
        return undo.ofAddress(undo$get(segment), session);
    }
    static final FunctionDescriptor redo$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle redo$MH = RuntimeHelper.downcallHandle(
        _GtkTextBufferClass.redo$FUNC
    );
    public interface redo {

        void apply(java.lang.foreign.MemoryAddress _x0);
        static MemorySegment allocate(redo fi, MemorySession session) {
            return RuntimeHelper.upcallStub(redo.class, fi, _GtkTextBufferClass.redo$FUNC, session);
        }
        static redo ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0) -> {
                try {
                    _GtkTextBufferClass.redo$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle redo$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("redo"));
    public static VarHandle redo$VH() {
        return _GtkTextBufferClass.redo$VH;
    }
    public static MemoryAddress redo$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkTextBufferClass.redo$VH.get(seg);
    }
    public static void redo$set( MemorySegment seg, MemoryAddress x) {
        _GtkTextBufferClass.redo$VH.set(seg, x);
    }
    public static MemoryAddress redo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkTextBufferClass.redo$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void redo$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkTextBufferClass.redo$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static redo redo (MemorySegment segment, MemorySession session) {
        return redo.ofAddress(redo$get(segment), session);
    }
