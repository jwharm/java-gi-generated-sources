...
class constants$2150 {
    ...
    static final MethodHandle gtk_icon_view_unset_model_drag_dest$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2150.gtk_icon_view_unset_model_drag_dest$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_set_reorderable$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2150.gtk_icon_view_set_reorderable$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_get_reorderable$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2150.gtk_icon_view_get_reorderable$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_set_drag_dest_item$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2150.gtk_icon_view_set_drag_dest_item$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_get_drag_dest_item$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2150.gtk_icon_view_get_drag_dest_item$FUNC
    );
    ...
    static final MethodHandle gtk_icon_view_get_dest_item_at_pos$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2150.gtk_icon_view_get_dest_item_at_pos$FUNC
    );
}
