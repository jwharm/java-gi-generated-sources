...
public interface GtkFontFilterFunc {
    ...
    static MemorySegment allocate(GtkFontFilterFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkFontFilterFunc.class, fi, constants$2101.GtkFontFilterFunc$FUNC, session);
    }
    static GtkFontFilterFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _family, java.lang.foreign.MemoryAddress _face, java.lang.foreign.MemoryAddress _data) -> {
            try {
                return (int)constants$2101.GtkFontFilterFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_family, (java.lang.foreign.Addressable)_face, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
