...
public class servent {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_INT$LAYOUT.withName("s_port"),
    ...
    public static int s_port$get(MemorySegment seg) {
        return (int)servent.s_port$VH.get(seg);
    }
    public static void s_port$set( MemorySegment seg, int x) {
        servent.s_port$VH.set(seg, x);
    }
    public static int s_port$get(MemorySegment seg, long index) {
        return (int)servent.s_port$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void s_port$set(MemorySegment seg, long index, int x) {
