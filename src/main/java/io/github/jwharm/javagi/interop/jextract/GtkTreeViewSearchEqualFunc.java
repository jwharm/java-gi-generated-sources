...
public interface GtkTreeViewSearchEqualFunc {
    ...
    static MemorySegment allocate(GtkTreeViewSearchEqualFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkTreeViewSearchEqualFunc.class, fi, constants$1966.GtkTreeViewSearchEqualFunc$FUNC, session);
    }
    static GtkTreeViewSearchEqualFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _model, int _column, java.lang.foreign.MemoryAddress _key, java.lang.foreign.MemoryAddress _iter, java.lang.foreign.MemoryAddress _search_data) -> {
            try {
                return (int)constants$1966.GtkTreeViewSearchEqualFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_model, _column, (java.lang.foreign.Addressable)_key, (java.lang.foreign.Addressable)_iter, (java.lang.foreign.Addressable)_search_data);
            } catch (Throwable ex$) {
