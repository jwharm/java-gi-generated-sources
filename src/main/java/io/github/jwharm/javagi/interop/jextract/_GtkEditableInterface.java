...
public class _GtkEditableInterface {
    ...
    static final MethodHandle get_text$MH = RuntimeHelper.downcallHandle(
        _GtkEditableInterface.get_text$FUNC
    );
    public interface get_text {

        java.lang.foreign.Addressable apply(java.lang.foreign.MemoryAddress _x0);
        static MemorySegment allocate(get_text fi, MemorySession session) {
            return RuntimeHelper.upcallStub(get_text.class, fi, _GtkEditableInterface.get_text$FUNC, session);
        }
        static get_text ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0) -> {
                try {
                    return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)_GtkEditableInterface.get_text$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress get_text$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkEditableInterface.get_text$VH.get(seg);
    }
    ...
    public static MemoryAddress get_text$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkEditableInterface.get_text$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle get_delegate$MH = RuntimeHelper.downcallHandle(
        _GtkEditableInterface.get_delegate$FUNC
    );
    public interface get_delegate {

        java.lang.foreign.Addressable apply(java.lang.foreign.MemoryAddress _x0);
        static MemorySegment allocate(get_delegate fi, MemorySession session) {
            return RuntimeHelper.upcallStub(get_delegate.class, fi, _GtkEditableInterface.get_delegate$FUNC, session);
        }
        static get_delegate ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0) -> {
                try {
                    return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)_GtkEditableInterface.get_delegate$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress get_delegate$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkEditableInterface.get_delegate$VH.get(seg);
    }
    public static void get_delegate$set( MemorySegment seg, MemoryAddress x) {
        _GtkEditableInterface.get_delegate$VH.set(seg, x);
    }
    public static MemoryAddress get_delegate$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkEditableInterface.get_delegate$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void get_delegate$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkEditableInterface.get_delegate$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static get_delegate get_delegate (MemorySegment segment, MemorySession session) {
        return get_delegate.ofAddress(get_delegate$get(segment), session);
    }
