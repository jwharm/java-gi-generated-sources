...
class constants$2338 {
    ...
    static final MethodHandle gtk_shortcut_label_get_accelerator$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2338.gtk_shortcut_label_get_accelerator$FUNC
    );
    ...
    static final MethodHandle gtk_shortcut_label_set_accelerator$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2338.gtk_shortcut_label_set_accelerator$FUNC
    );
    ...
    static final MethodHandle gtk_shortcut_label_get_disabled_text$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2338.gtk_shortcut_label_get_disabled_text$FUNC
    );
    ...
    static final MethodHandle gtk_shortcut_label_set_disabled_text$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2338.gtk_shortcut_label_set_disabled_text$FUNC
    );
    static final FunctionDescriptor gtk_shortcut_manager_get_type$FUNC = FunctionDescriptor.of(Constants$root.C_LONG_LONG$LAYOUT);
    static final MethodHandle gtk_shortcut_manager_get_type$MH = RuntimeHelper.downcallHandle(
        "gtk_shortcut_manager_get_type",
        constants$2338.gtk_shortcut_manager_get_type$FUNC
    );
    static final FunctionDescriptor glib_autoptr_clear_GtkShortcutManager$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle glib_autoptr_clear_GtkShortcutManager$MH = RuntimeHelper.downcallHandle(
        "glib_autoptr_clear_GtkShortcutManager",
        constants$2338.glib_autoptr_clear_GtkShortcutManager$FUNC
    );
}
