...
class constants$1257 {
    ...
    static final MethodHandle pango_glyph_string_x_to_index$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1257.pango_glyph_string_x_to_index$FUNC
    );
    ...
    static final MethodHandle pango_glyph_string_index_to_x_full$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1257.pango_glyph_string_index_to_x_full$FUNC
    );
    ...
    static final MethodHandle pango_shape$MH = RuntimeHelper.downcallHandle(
        "pango_shape",
        constants$1257.pango_shape$FUNC
    );
    ...
    static final MethodHandle pango_shape_full$MH = RuntimeHelper.downcallHandle(
        "pango_shape_full",
        constants$1257.pango_shape_full$FUNC
    );
    ...
    static final MethodHandle pango_shape_with_flags$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1257.pango_shape_with_flags$FUNC
    );
    ...
    static final MethodHandle pango_shape_item$MH = RuntimeHelper.downcallHandle(
        "pango_shape_item",
        constants$1257.pango_shape_item$FUNC
    );
}
