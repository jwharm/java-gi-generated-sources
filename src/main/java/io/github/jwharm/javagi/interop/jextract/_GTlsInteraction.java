...
public class _GTlsInteraction {
    ...
    public static MemoryLayout $LAYOUT() {
        return _GTlsInteraction.$struct$LAYOUT;
    }
    ...
    public static VarHandle priv$VH() {
        return _GTlsInteraction.priv$VH;
    }
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GTlsInteraction.priv$VH.get(seg);
    }
    public static void priv$set( MemorySegment seg, MemoryAddress x) {
        _GTlsInteraction.priv$VH.set(seg, x);
    }
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GTlsInteraction.priv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void priv$set(MemorySegment seg, long index, MemoryAddress x) {
        _GTlsInteraction.priv$VH.set(seg.asSlice(index*sizeof()), x);
    }
