...
class constants$2377 {
    ...
    static final MethodHandle gtk_stack_remove$MH = RuntimeHelper.downcallHandle(
        "gtk_stack_remove",
        constants$2377.gtk_stack_remove$FUNC
    );
    ...
    static final MethodHandle gtk_stack_get_page$MH = RuntimeHelper.downcallHandle(
        "gtk_stack_get_page",
        constants$2377.gtk_stack_get_page$FUNC
    );
    ...
    static final MethodHandle gtk_stack_get_child_by_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2377.gtk_stack_get_child_by_name$FUNC
    );
    ...
    static final MethodHandle gtk_stack_set_visible_child$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2377.gtk_stack_set_visible_child$FUNC
    );
    ...
    static final MethodHandle gtk_stack_get_visible_child$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2377.gtk_stack_get_visible_child$FUNC
    );
    ...
    static final MethodHandle gtk_stack_set_visible_child_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2377.gtk_stack_set_visible_child_name$FUNC
    );
}
