...
class constants$1167 {
    ...
    static final MethodHandle hb_font_get_glyph_h_advance_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1167.hb_font_get_glyph_h_advance_func_t$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_v_advance_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1167.hb_font_get_glyph_v_advance_func_t$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_advances_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1167.hb_font_get_glyph_advances_func_t$FUNC
    );
}
