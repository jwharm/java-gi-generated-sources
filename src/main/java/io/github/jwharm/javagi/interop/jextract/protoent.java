...
public class protoent {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_INT$LAYOUT.withName("p_proto"),
    ...
    public static int p_proto$get(MemorySegment seg) {
        return (int)protoent.p_proto$VH.get(seg);
    }
    public static void p_proto$set( MemorySegment seg, int x) {
        protoent.p_proto$VH.set(seg, x);
    }
    public static int p_proto$get(MemorySegment seg, long index) {
        return (int)protoent.p_proto$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void p_proto$set(MemorySegment seg, long index, int x) {
