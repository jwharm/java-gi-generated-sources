...
class constants$1194 {
    ...
    static final MethodHandle hb_buffer_serialize_glyphs$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1194.hb_buffer_serialize_glyphs$FUNC
    );
    ...
    static final MethodHandle hb_buffer_serialize_unicode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1194.hb_buffer_serialize_unicode$FUNC
    );
    ...
    static final MethodHandle hb_buffer_serialize$MH = RuntimeHelper.downcallHandle(
        "hb_buffer_serialize",
        constants$1194.hb_buffer_serialize$FUNC
    );
    ...
    static final MethodHandle hb_buffer_deserialize_glyphs$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1194.hb_buffer_deserialize_glyphs$FUNC
    );
    ...
    static final MethodHandle hb_buffer_deserialize_unicode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1194.hb_buffer_deserialize_unicode$FUNC
    );
    ...
    static final MethodHandle hb_buffer_diff$MH = RuntimeHelper.downcallHandle(
        "hb_buffer_diff",
        constants$1194.hb_buffer_diff$FUNC
    );
}
