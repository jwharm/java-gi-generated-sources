...
public interface GtkTreeModelFilterVisibleFunc {
    ...
    static MemorySegment allocate(GtkTreeModelFilterVisibleFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkTreeModelFilterVisibleFunc.class, fi, constants$1944.GtkTreeModelFilterVisibleFunc$FUNC, session);
    }
    static GtkTreeModelFilterVisibleFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _model, java.lang.foreign.MemoryAddress _iter, java.lang.foreign.MemoryAddress _data) -> {
            try {
                return (int)constants$1944.GtkTreeModelFilterVisibleFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_model, (java.lang.foreign.Addressable)_iter, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
