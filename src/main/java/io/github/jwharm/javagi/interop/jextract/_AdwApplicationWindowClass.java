...
public class _AdwApplicationWindowClass {
    ...
    ).withName("_AdwApplicationWindowClass");
    public static MemoryLayout $LAYOUT() {
        return _AdwApplicationWindowClass.$struct$LAYOUT;
    }
    public static MemorySegment parent_class$slice(MemorySegment seg) {
        return seg.asSlice(0, 576);
    }
    public static MemorySegment padding$slice(MemorySegment seg) {
        return seg.asSlice(576, 32);
    }
