...
public interface GtkAssistantPageFunc {
    ...
    static MemorySegment allocate(GtkAssistantPageFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkAssistantPageFunc.class, fi, constants$1790.GtkAssistantPageFunc$FUNC, session);
    }
    static GtkAssistantPageFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _current_page, java.lang.foreign.MemoryAddress _data) -> {
            try {
                return (int)constants$1791.GtkAssistantPageFunc$MH.invokeExact((Addressable)symbol, _current_page, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
