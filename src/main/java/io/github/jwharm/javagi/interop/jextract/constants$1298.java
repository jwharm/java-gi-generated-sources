...
class constants$1298 {
    ...
    static final MethodHandle gdk_rgba_hash$MH = RuntimeHelper.downcallHandle(
        "gdk_rgba_hash",
        constants$1298.gdk_rgba_hash$FUNC
    );
    ...
    static final MethodHandle gdk_rgba_equal$MH = RuntimeHelper.downcallHandle(
        "gdk_rgba_equal",
        constants$1298.gdk_rgba_equal$FUNC
    );
    ...
    static final MethodHandle gdk_rgba_parse$MH = RuntimeHelper.downcallHandle(
        "gdk_rgba_parse",
        constants$1298.gdk_rgba_parse$FUNC
    );
    ...
    static final MethodHandle gdk_rgba_to_string$MH = RuntimeHelper.downcallHandle(
        "gdk_rgba_to_string",
        constants$1298.gdk_rgba_to_string$FUNC
    );
    static final  OfInt gdk_pixbuf_major_version$LAYOUT = Constants$root.C_INT$LAYOUT;
    static final VarHandle gdk_pixbuf_major_version$VH = constants$1298.gdk_pixbuf_major_version$LAYOUT.varHandle();
    static final MemorySegment gdk_pixbuf_major_version$SEGMENT = RuntimeHelper.lookupGlobalVariable("gdk_pixbuf_major_version", constants$1298.gdk_pixbuf_major_version$LAYOUT);
    static final  OfInt gdk_pixbuf_minor_version$LAYOUT = Constants$root.C_INT$LAYOUT;
    static final VarHandle gdk_pixbuf_minor_version$VH = constants$1298.gdk_pixbuf_minor_version$LAYOUT.varHandle();
    static final MemorySegment gdk_pixbuf_minor_version$SEGMENT = RuntimeHelper.lookupGlobalVariable("gdk_pixbuf_minor_version", constants$1298.gdk_pixbuf_minor_version$LAYOUT);
}
