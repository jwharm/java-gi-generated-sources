...
class constants$2173 {
    ...
    static final MethodHandle gtk_list_box_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2173.gtk_list_box_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_list_box_prepend$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2173.gtk_list_box_prepend$FUNC
    );
    ...
    static final MethodHandle gtk_list_box_append$MH = RuntimeHelper.downcallHandle(
        "gtk_list_box_append",
        constants$2173.gtk_list_box_append$FUNC
    );
    ...
    static final MethodHandle gtk_list_box_insert$MH = RuntimeHelper.downcallHandle(
        "gtk_list_box_insert",
        constants$2173.gtk_list_box_insert$FUNC
    );
    ...
    static final MethodHandle gtk_list_box_remove$MH = RuntimeHelper.downcallHandle(
        "gtk_list_box_remove",
        constants$2173.gtk_list_box_remove$FUNC
    );
    ...
    static final MethodHandle gtk_list_box_get_selected_row$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2173.gtk_list_box_get_selected_row$FUNC
    );
}
