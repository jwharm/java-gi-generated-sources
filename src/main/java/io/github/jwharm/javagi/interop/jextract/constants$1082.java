...
class constants$1082 {
    ...
    static final MethodHandle cairo_set_tolerance$MH = RuntimeHelper.downcallHandle(
        "cairo_set_tolerance",
        constants$1082.cairo_set_tolerance$FUNC
    );
    ...
    static final MethodHandle cairo_set_antialias$MH = RuntimeHelper.downcallHandle(
        "cairo_set_antialias",
        constants$1082.cairo_set_antialias$FUNC
    );
    ...
    static final MethodHandle cairo_set_fill_rule$MH = RuntimeHelper.downcallHandle(
        "cairo_set_fill_rule",
        constants$1082.cairo_set_fill_rule$FUNC
    );
    ...
    static final MethodHandle cairo_set_line_width$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1082.cairo_set_line_width$FUNC
    );
    static final FunctionDescriptor cairo_set_hairline$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_INT$LAYOUT
    );
    static final MethodHandle cairo_set_hairline$MH = RuntimeHelper.downcallHandle(
        "cairo_set_hairline",
        constants$1082.cairo_set_hairline$FUNC
    );
    ...
    static final MethodHandle cairo_set_line_cap$MH = RuntimeHelper.downcallHandle(
        "cairo_set_line_cap",
        constants$1082.cairo_set_line_cap$FUNC
    );
}
