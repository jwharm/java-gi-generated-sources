...
public class _GtkIMContextClass {
    ...
    static final FunctionDescriptor set_client_widget$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle set_client_widget$MH = RuntimeHelper.downcallHandle(
        _GtkIMContextClass.set_client_widget$FUNC
    );
    public interface set_client_widget {

        void apply(java.lang.foreign.MemoryAddress _x0, java.lang.foreign.MemoryAddress _x1);
        static MemorySegment allocate(set_client_widget fi, MemorySession session) {
            return RuntimeHelper.upcallStub(set_client_widget.class, fi, _GtkIMContextClass.set_client_widget$FUNC, session);
        }
        static set_client_widget ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1) -> {
                try {
                    _GtkIMContextClass.set_client_widget$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle set_client_widget$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("set_client_widget"));
    public static VarHandle set_client_widget$VH() {
        return _GtkIMContextClass.set_client_widget$VH;
    }
    public static MemoryAddress set_client_widget$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkIMContextClass.set_client_widget$VH.get(seg);
    }
    public static void set_client_widget$set( MemorySegment seg, MemoryAddress x) {
        _GtkIMContextClass.set_client_widget$VH.set(seg, x);
    }
    public static MemoryAddress set_client_widget$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkIMContextClass.set_client_widget$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void set_client_widget$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkIMContextClass.set_client_widget$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static set_client_widget set_client_widget (MemorySegment segment, MemorySession session) {
        return set_client_widget.ofAddress(set_client_widget$get(segment), session);
    }
    ...
    static final FunctionDescriptor set_surrounding_with_selection$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_INT$LAYOUT,
        Constants$root.C_INT$LAYOUT,
    ...
    static final MethodHandle set_surrounding_with_selection$MH = RuntimeHelper.downcallHandle(
        _GtkIMContextClass.set_surrounding_with_selection$FUNC
    );
    public interface set_surrounding_with_selection {

        void apply(java.lang.foreign.MemoryAddress _x0, java.lang.foreign.MemoryAddress _x1, int _x2, int _x3, int _x4);
        static MemorySegment allocate(set_surrounding_with_selection fi, MemorySession session) {
            return RuntimeHelper.upcallStub(set_surrounding_with_selection.class, fi, _GtkIMContextClass.set_surrounding_with_selection$FUNC, session);
        }
        static set_surrounding_with_selection ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, int __x2, int __x3, int __x4) -> {
                try {
                    _GtkIMContextClass.set_surrounding_with_selection$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, __x2, __x3, __x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle set_surrounding_with_selection$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("set_surrounding_with_selection"));
    public static VarHandle set_surrounding_with_selection$VH() {
        return _GtkIMContextClass.set_surrounding_with_selection$VH;
    }
    public static MemoryAddress set_surrounding_with_selection$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkIMContextClass.set_surrounding_with_selection$VH.get(seg);
    }
    public static void set_surrounding_with_selection$set( MemorySegment seg, MemoryAddress x) {
        _GtkIMContextClass.set_surrounding_with_selection$VH.set(seg, x);
    }
    public static MemoryAddress set_surrounding_with_selection$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkIMContextClass.set_surrounding_with_selection$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void set_surrounding_with_selection$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkIMContextClass.set_surrounding_with_selection$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static set_surrounding_with_selection set_surrounding_with_selection (MemorySegment segment, MemorySession session) {
        return set_surrounding_with_selection.ofAddress(set_surrounding_with_selection$get(segment), session);
    }
    static final FunctionDescriptor get_surrounding_with_selection$FUNC = FunctionDescriptor.of(Constants$root.C_INT$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle get_surrounding_with_selection$MH = RuntimeHelper.downcallHandle(
        _GtkIMContextClass.get_surrounding_with_selection$FUNC
    );
    public interface get_surrounding_with_selection {
        ...
        static MemorySegment allocate(get_surrounding_with_selection fi, MemorySession session) {
            return RuntimeHelper.upcallStub(get_surrounding_with_selection.class, fi, _GtkIMContextClass.get_surrounding_with_selection$FUNC, session);
        }
        static get_surrounding_with_selection ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3) -> {
                try {
                    return (int)_GtkIMContextClass.get_surrounding_with_selection$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle get_surrounding_with_selection$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("get_surrounding_with_selection"));
    public static VarHandle get_surrounding_with_selection$VH() {
        return _GtkIMContextClass.get_surrounding_with_selection$VH;
    }
    public static MemoryAddress get_surrounding_with_selection$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkIMContextClass.get_surrounding_with_selection$VH.get(seg);
    }
    public static void get_surrounding_with_selection$set( MemorySegment seg, MemoryAddress x) {
        _GtkIMContextClass.get_surrounding_with_selection$VH.set(seg, x);
    }
    public static MemoryAddress get_surrounding_with_selection$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkIMContextClass.get_surrounding_with_selection$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void get_surrounding_with_selection$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkIMContextClass.get_surrounding_with_selection$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static get_surrounding_with_selection get_surrounding_with_selection (MemorySegment segment, MemorySession session) {
        return get_surrounding_with_selection.ofAddress(get_surrounding_with_selection$get(segment), session);
    }
