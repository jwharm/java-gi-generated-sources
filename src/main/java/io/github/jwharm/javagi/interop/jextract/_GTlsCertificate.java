...
public class _GTlsCertificate {
    ...
    public static MemoryLayout $LAYOUT() {
        return _GTlsCertificate.$struct$LAYOUT;
    }
    ...
    public static VarHandle priv$VH() {
        return _GTlsCertificate.priv$VH;
    }
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GTlsCertificate.priv$VH.get(seg);
    }
    public static void priv$set( MemorySegment seg, MemoryAddress x) {
        _GTlsCertificate.priv$VH.set(seg, x);
    }
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GTlsCertificate.priv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void priv$set(MemorySegment seg, long index, MemoryAddress x) {
        _GTlsCertificate.priv$VH.set(seg.asSlice(index*sizeof()), x);
    }
