...
class constants$1193 {
    ...
    static final MethodHandle hb_buffer_get_glyph_positions$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1193.hb_buffer_get_glyph_positions$FUNC
    );
    ...
    static final MethodHandle hb_buffer_has_positions$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1193.hb_buffer_has_positions$FUNC
    );
    ...
    static final MethodHandle hb_buffer_normalize_glyphs$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1193.hb_buffer_normalize_glyphs$FUNC
    );
    ...
    static final MethodHandle hb_buffer_serialize_format_from_string$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1193.hb_buffer_serialize_format_from_string$FUNC
    );
    ...
    static final MethodHandle hb_buffer_serialize_format_to_string$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1193.hb_buffer_serialize_format_to_string$FUNC
    );
    ...
    static final MethodHandle hb_buffer_serialize_list_formats$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1193.hb_buffer_serialize_list_formats$FUNC
    );
}
