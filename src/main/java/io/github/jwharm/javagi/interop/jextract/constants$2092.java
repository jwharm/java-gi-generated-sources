...
class constants$2092 {
    ...
    static final FunctionDescriptor gtk_flow_box_child_get_child$FUNC = FunctionDescriptor.of(Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle gtk_flow_box_child_get_child$MH = RuntimeHelper.downcallHandle(
        "gtk_flow_box_child_get_child",
        constants$2092.gtk_flow_box_child_get_child$FUNC
    );
    ...
    static final MethodHandle gtk_flow_box_child_get_index$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2092.gtk_flow_box_child_get_index$FUNC
    );
    ...
    static final MethodHandle gtk_flow_box_child_is_selected$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2092.gtk_flow_box_child_is_selected$FUNC
    );
    ...
    static final MethodHandle gtk_flow_box_child_changed$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2092.gtk_flow_box_child_changed$FUNC
    );
    ...
    static final MethodHandle gtk_flow_box_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2092.gtk_flow_box_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_flow_box_new$MH = RuntimeHelper.downcallHandle(
        "gtk_flow_box_new",
        constants$2092.gtk_flow_box_new$FUNC
    );
}
