...
public interface GtkTreeIterCompareFunc {
    ...
    static MemorySegment allocate(GtkTreeIterCompareFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkTreeIterCompareFunc.class, fi, constants$1920.GtkTreeIterCompareFunc$FUNC, session);
    }
    static GtkTreeIterCompareFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _model, java.lang.foreign.MemoryAddress _a, java.lang.foreign.MemoryAddress _b, java.lang.foreign.MemoryAddress _user_data) -> {
            try {
                return (int)constants$1920.GtkTreeIterCompareFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_model, (java.lang.foreign.Addressable)_a, (java.lang.foreign.Addressable)_b, (java.lang.foreign.Addressable)_user_data);
            } catch (Throwable ex$) {
