...
class constants$1157 {
    ...
    static final MethodHandle hb_face_reference_blob$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1157.hb_face_reference_blob$FUNC
    );
    ...
    static final MethodHandle hb_face_set_index$MH = RuntimeHelper.downcallHandle(
        "hb_face_set_index",
        constants$1157.hb_face_set_index$FUNC
    );
    ...
    static final MethodHandle hb_face_get_index$MH = RuntimeHelper.downcallHandle(
        "hb_face_get_index",
        constants$1157.hb_face_get_index$FUNC
    );
    ...
    static final MethodHandle hb_face_set_upem$MH = RuntimeHelper.downcallHandle(
        "hb_face_set_upem",
        constants$1157.hb_face_set_upem$FUNC
    );
    ...
    static final MethodHandle hb_face_get_upem$MH = RuntimeHelper.downcallHandle(
        "hb_face_get_upem",
        constants$1157.hb_face_get_upem$FUNC
    );
    ...
    static final MethodHandle hb_face_set_glyph_count$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1157.hb_face_set_glyph_count$FUNC
    );
}
