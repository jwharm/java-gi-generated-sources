...
public interface GtkListBoxSortFunc {
    ...
    static MemorySegment allocate(GtkListBoxSortFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkListBoxSortFunc.class, fi, constants$2169.GtkListBoxSortFunc$FUNC, session);
    }
    static GtkListBoxSortFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _row1, java.lang.foreign.MemoryAddress _row2, java.lang.foreign.MemoryAddress _user_data) -> {
            try {
                return (int)constants$2170.GtkListBoxSortFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_row1, (java.lang.foreign.Addressable)_row2, (java.lang.foreign.Addressable)_user_data);
            } catch (Throwable ex$) {
