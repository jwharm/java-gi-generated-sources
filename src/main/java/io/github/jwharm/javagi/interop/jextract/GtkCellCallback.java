...
public interface GtkCellCallback {
    ...
    static MemorySegment allocate(GtkCellCallback fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkCellCallback.class, fi, constants$1869.GtkCellCallback$FUNC, session);
    }
    static GtkCellCallback ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _renderer, java.lang.foreign.MemoryAddress _data) -> {
            try {
                return (int)constants$1869.GtkCellCallback$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_renderer, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
