...
class constants$1955 {
    ...
    static final MethodHandle gtk_image_get_pixel_size$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1955.gtk_image_get_pixel_size$FUNC
    );
    static final FunctionDescriptor gtk_image_get_icon_size$FUNC = FunctionDescriptor.of(Constants$root.C_INT$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle gtk_image_get_icon_size$MH = RuntimeHelper.downcallHandle(
        "gtk_image_get_icon_size",
        constants$1955.gtk_image_get_icon_size$FUNC
    );
    ...
    static final MethodHandle gtk_entry_get_type$MH = RuntimeHelper.downcallHandle(
        "gtk_entry_get_type",
        constants$1955.gtk_entry_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_entry_new$MH = RuntimeHelper.downcallHandle(
        "gtk_entry_new",
        constants$1955.gtk_entry_new$FUNC
    );
    ...
    static final MethodHandle gtk_entry_new_with_buffer$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1955.gtk_entry_new_with_buffer$FUNC
    );
    ...
    static final MethodHandle gtk_entry_get_buffer$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1955.gtk_entry_get_buffer$FUNC
    );
}
