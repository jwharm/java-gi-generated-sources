...
class constants$1265 {
    ...
    static final MethodHandle pango_glyph_item_apply_attrs$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1265.pango_glyph_item_apply_attrs$FUNC
    );
    ...
    static final MethodHandle pango_glyph_item_letter_space$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1265.pango_glyph_item_letter_space$FUNC
    );
    ...
    static final MethodHandle pango_glyph_item_get_logical_widths$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1265.pango_glyph_item_get_logical_widths$FUNC
    );
    ...
    static final MethodHandle pango_glyph_item_iter_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1265.pango_glyph_item_iter_get_type$FUNC
    );
    ...
    static final MethodHandle pango_glyph_item_iter_copy$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1265.pango_glyph_item_iter_copy$FUNC
    );
    ...
    static final MethodHandle pango_glyph_item_iter_free$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1265.pango_glyph_item_iter_free$FUNC
    );
}
