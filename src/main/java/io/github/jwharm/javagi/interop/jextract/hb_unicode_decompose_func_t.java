...
public interface hb_unicode_decompose_func_t {
    ...
    static MemorySegment allocate(hb_unicode_decompose_func_t fi, MemorySession session) {
        return RuntimeHelper.upcallStub(hb_unicode_decompose_func_t.class, fi, constants$1147.hb_unicode_decompose_func_t$FUNC, session);
    }
    static hb_unicode_decompose_func_t ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _ufuncs, int _ab, java.lang.foreign.MemoryAddress _a, java.lang.foreign.MemoryAddress _b, java.lang.foreign.MemoryAddress _user_data) -> {
            try {
                return (int)constants$1147.hb_unicode_decompose_func_t$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_ufuncs, _ab, (java.lang.foreign.Addressable)_a, (java.lang.foreign.Addressable)_b, (java.lang.foreign.Addressable)_user_data);
            } catch (Throwable ex$) {
