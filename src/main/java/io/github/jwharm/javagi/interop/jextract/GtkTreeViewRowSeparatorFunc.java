...
public interface GtkTreeViewRowSeparatorFunc {
    ...
    static MemorySegment allocate(GtkTreeViewRowSeparatorFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkTreeViewRowSeparatorFunc.class, fi, constants$1966.GtkTreeViewRowSeparatorFunc$FUNC, session);
    }
    static GtkTreeViewRowSeparatorFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _model, java.lang.foreign.MemoryAddress _iter, java.lang.foreign.MemoryAddress _data) -> {
            try {
                return (int)constants$1966.GtkTreeViewRowSeparatorFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_model, (java.lang.foreign.Addressable)_iter, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
