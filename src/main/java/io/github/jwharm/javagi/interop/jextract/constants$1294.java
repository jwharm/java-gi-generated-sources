...
class constants$1294 {
    ...
    static final MethodHandle pango_scan_int$MH = RuntimeHelper.downcallHandle(
        "pango_scan_int",
        constants$1294.pango_scan_int$FUNC
    );
    ...
    static final MethodHandle pango_parse_enum$MH = RuntimeHelper.downcallHandle(
        "pango_parse_enum",
        constants$1294.pango_parse_enum$FUNC
    );
    ...
    static final MethodHandle pango_parse_style$MH = RuntimeHelper.downcallHandle(
        "pango_parse_style",
        constants$1294.pango_parse_style$FUNC
    );
    ...
    static final MethodHandle pango_parse_variant$MH = RuntimeHelper.downcallHandle(
        "pango_parse_variant",
        constants$1294.pango_parse_variant$FUNC
    );
    ...
    static final MethodHandle pango_parse_weight$MH = RuntimeHelper.downcallHandle(
        "pango_parse_weight",
        constants$1294.pango_parse_weight$FUNC
    );
    ...
    static final MethodHandle pango_parse_stretch$MH = RuntimeHelper.downcallHandle(
        "pango_parse_stretch",
        constants$1294.pango_parse_stretch$FUNC
    );
}
