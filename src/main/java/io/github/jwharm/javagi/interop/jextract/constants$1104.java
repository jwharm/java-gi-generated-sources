...
class constants$1104 {
    ...
    static final MethodHandle cairo_user_font_face_set_render_glyph_func$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1104.cairo_user_font_face_set_render_glyph_func$FUNC
    );
    static final FunctionDescriptor cairo_user_font_face_set_render_color_glyph_func$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle cairo_user_font_face_set_render_color_glyph_func$MH = RuntimeHelper.downcallHandle(
        "cairo_user_font_face_set_render_color_glyph_func",
        constants$1104.cairo_user_font_face_set_render_color_glyph_func$FUNC
    );
    ...
    static final MethodHandle cairo_user_font_face_set_text_to_glyphs_func$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1104.cairo_user_font_face_set_text_to_glyphs_func$FUNC
    );
    ...
    static final MethodHandle cairo_user_font_face_set_unicode_to_glyph_func$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1104.cairo_user_font_face_set_unicode_to_glyph_func$FUNC
    );
    ...
    static final MethodHandle cairo_user_font_face_get_init_func$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1104.cairo_user_font_face_get_init_func$FUNC
    );
    ...
    static final MethodHandle cairo_user_font_face_get_render_glyph_func$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1104.cairo_user_font_face_get_render_glyph_func$FUNC
    );
}
