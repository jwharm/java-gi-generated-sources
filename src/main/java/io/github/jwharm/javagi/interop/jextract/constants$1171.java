...
class constants$1171 {
    ...
    static final MethodHandle hb_font_get_glyph_name_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1171.hb_font_get_glyph_name_func_t$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_from_name_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1171.hb_font_get_glyph_from_name_func_t$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_shape_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1171.hb_font_get_glyph_shape_func_t$FUNC
    );
}
