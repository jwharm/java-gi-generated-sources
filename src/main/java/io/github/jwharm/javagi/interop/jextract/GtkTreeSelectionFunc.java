...
public interface GtkTreeSelectionFunc {
    ...
    static MemorySegment allocate(GtkTreeSelectionFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GtkTreeSelectionFunc.class, fi, constants$2477.GtkTreeSelectionFunc$FUNC, session);
    }
    static GtkTreeSelectionFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _selection, java.lang.foreign.MemoryAddress _model, java.lang.foreign.MemoryAddress _path, int _path_currently_selected, java.lang.foreign.MemoryAddress _data) -> {
            try {
                return (int)constants$2478.GtkTreeSelectionFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_selection, (java.lang.foreign.Addressable)_model, (java.lang.foreign.Addressable)_path, _path_currently_selected, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
