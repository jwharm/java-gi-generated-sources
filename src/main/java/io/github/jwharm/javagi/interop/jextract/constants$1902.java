...
class constants$1902 {
    ...
    static final MethodHandle gtk_color_chooser_widget_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1902.gtk_color_chooser_widget_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_color_chooser_widget_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1902.gtk_color_chooser_widget_new$FUNC
    );
    ...
    static final MethodHandle gtk_hsv_to_rgb$MH = RuntimeHelper.downcallHandle(
        "gtk_hsv_to_rgb",
        constants$1902.gtk_hsv_to_rgb$FUNC
    );
    ...
    static final MethodHandle gtk_rgb_to_hsv$MH = RuntimeHelper.downcallHandle(
        "gtk_rgb_to_hsv",
        constants$1902.gtk_rgb_to_hsv$FUNC
    );
    ...
    static final MethodHandle gtk_sorter_get_type$MH = RuntimeHelper.downcallHandle(
        "gtk_sorter_get_type",
        constants$1902.gtk_sorter_get_type$FUNC
    );
    static final FunctionDescriptor glib_autoptr_clear_GtkSorter$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle glib_autoptr_clear_GtkSorter$MH = RuntimeHelper.downcallHandle(
        "glib_autoptr_clear_GtkSorter",
        constants$1902.glib_autoptr_clear_GtkSorter$FUNC
    );
}
