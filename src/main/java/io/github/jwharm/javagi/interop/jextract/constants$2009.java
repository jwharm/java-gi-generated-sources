...
class constants$2009 {
    ...
    static final MethodHandle gtk_print_status_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2009.gtk_print_status_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_print_operation_result_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2009.gtk_print_operation_result_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_print_operation_action_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2009.gtk_print_operation_action_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_print_error_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2009.gtk_print_error_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_recent_manager_error_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2009.gtk_recent_manager_error_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_revealer_transition_type_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2009.gtk_revealer_transition_type_get_type$FUNC
    );
}
