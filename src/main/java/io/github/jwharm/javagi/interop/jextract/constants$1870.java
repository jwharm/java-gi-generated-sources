...
class constants$1870 {
    ...
    static final MethodHandle GtkCellAllocCallback$MH = RuntimeHelper.downcallHandle(
        constants$1870.GtkCellAllocCallback$FUNC
    );
    ...
    static final MethodHandle gtk_cell_area_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1870.gtk_cell_area_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_cell_area_add$MH = RuntimeHelper.downcallHandle(
        "gtk_cell_area_add",
        constants$1870.gtk_cell_area_add$FUNC
    );
    ...
    static final MethodHandle gtk_cell_area_remove$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1870.gtk_cell_area_remove$FUNC
    );
    ...
    static final MethodHandle gtk_cell_area_has_renderer$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1870.gtk_cell_area_has_renderer$FUNC
    );
}
