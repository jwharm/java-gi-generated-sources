...
public class _AdwPreferencesWindowClass {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(4, Constants$root.C_POINTER$LAYOUT).withName("padding")
    ).withName("_AdwPreferencesWindowClass");
    public static MemoryLayout $LAYOUT() {
        return _AdwPreferencesWindowClass.$struct$LAYOUT;
    }
    public static MemorySegment parent_class$slice(MemorySegment seg) {
        return seg.asSlice(0, 544);
    }
    public static MemorySegment padding$slice(MemorySegment seg) {
        return seg.asSlice(544, 32);
    }
