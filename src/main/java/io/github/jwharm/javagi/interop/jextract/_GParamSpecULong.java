...
public class _GParamSpecULong {
    ...
    public static MemoryLayout $LAYOUT() {
        return _GParamSpecULong.$struct$LAYOUT;
    }
    ...
    public static long minimum$get(MemorySegment seg, long index) {
        return (long)_GParamSpecULong.minimum$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void minimum$set(MemorySegment seg, long index, long x) {
        _GParamSpecULong.minimum$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static long maximum$get(MemorySegment seg, long index) {
        return (long)_GParamSpecULong.maximum$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void maximum$set(MemorySegment seg, long index, long x) {
        _GParamSpecULong.maximum$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static long default_value$get(MemorySegment seg, long index) {
        return (long)_GParamSpecULong.default_value$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void default_value$set(MemorySegment seg, long index, long x) {
        _GParamSpecULong.default_value$VH.set(seg.asSlice(index*sizeof()), x);
    }
