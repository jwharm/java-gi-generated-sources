...
class constants$1170 {
    ...
    static final MethodHandle hb_font_get_glyph_h_kerning_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1170.hb_font_get_glyph_h_kerning_func_t$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_extents_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1170.hb_font_get_glyph_extents_func_t$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_contour_point_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1170.hb_font_get_glyph_contour_point_func_t$FUNC
    );
}
