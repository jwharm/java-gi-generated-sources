...
public class _GtkBuildableParser {
    ...
    static final MethodHandle start_element$MH = RuntimeHelper.downcallHandle(
        _GtkBuildableParser.start_element$FUNC
    );
    public interface start_element {
        ...
        static MemorySegment allocate(start_element fi, MemorySession session) {
            return RuntimeHelper.upcallStub(start_element.class, fi, _GtkBuildableParser.start_element$FUNC, session);
        }
        static start_element ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3, java.lang.foreign.MemoryAddress __x4, java.lang.foreign.MemoryAddress __x5) -> {
                try {
                    _GtkBuildableParser.start_element$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3, (java.lang.foreign.Addressable)__x4, (java.lang.foreign.Addressable)__x5);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress start_element$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableParser.start_element$VH.get(seg);
    }
    ...
    public static MemoryAddress start_element$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableParser.start_element$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle end_element$MH = RuntimeHelper.downcallHandle(
        _GtkBuildableParser.end_element$FUNC
    );
    public interface end_element {
        ...
        static MemorySegment allocate(end_element fi, MemorySession session) {
            return RuntimeHelper.upcallStub(end_element.class, fi, _GtkBuildableParser.end_element$FUNC, session);
        }
        static end_element ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3) -> {
                try {
                    _GtkBuildableParser.end_element$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress end_element$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableParser.end_element$VH.get(seg);
    }
    ...
    public static MemoryAddress end_element$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableParser.end_element$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface text {
        ...
        static MemorySegment allocate(text fi, MemorySession session) {
            return RuntimeHelper.upcallStub(text.class, fi, _GtkBuildableParser.text$FUNC, session);
        }
        static text ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, long __x2, java.lang.foreign.MemoryAddress __x3, java.lang.foreign.MemoryAddress __x4) -> {
                try {
                    _GtkBuildableParser.text$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, __x2, (java.lang.foreign.Addressable)__x3, (java.lang.foreign.Addressable)__x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress text$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableParser.text$VH.get(seg);
    }
    ...
    public static MemoryAddress text$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableParser.text$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle error$MH = RuntimeHelper.downcallHandle(
        _GtkBuildableParser.error$FUNC
    );
    public interface error {
        ...
        static MemorySegment allocate(error fi, MemorySession session) {
            return RuntimeHelper.upcallStub(error.class, fi, _GtkBuildableParser.error$FUNC, session);
        }
        static error ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2) -> {
                try {
                    _GtkBuildableParser.error$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress error$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableParser.error$VH.get(seg);
    }
    ...
    public static MemoryAddress error$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableParser.error$VH.get(seg.asSlice(index*sizeof()));
    }
