...
class constants$1253 {
    ...
    static final MethodHandle pango_context_get_font_description$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1253.pango_context_get_font_description$FUNC
    );
    ...
    static final MethodHandle pango_context_get_language$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1253.pango_context_get_language$FUNC
    );
    ...
    static final MethodHandle pango_context_set_language$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1253.pango_context_set_language$FUNC
    );
    ...
    static final MethodHandle pango_context_set_base_dir$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1253.pango_context_set_base_dir$FUNC
    );
    ...
    static final MethodHandle pango_context_get_base_dir$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1253.pango_context_get_base_dir$FUNC
    );
    ...
    static final MethodHandle pango_context_set_base_gravity$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1253.pango_context_set_base_gravity$FUNC
    );
}
