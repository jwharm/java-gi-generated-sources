...
class constants$1155 {
    ...
    static final MethodHandle hb_face_create$MH = RuntimeHelper.downcallHandle(
        "hb_face_create",
        constants$1155.hb_face_create$FUNC
    );
    ...
    static final MethodHandle hb_reference_table_func_t$MH = RuntimeHelper.downcallHandle(
        constants$1155.hb_reference_table_func_t$FUNC
    );
    ...
    static final MethodHandle hb_face_create_for_tables$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1155.hb_face_create_for_tables$FUNC
    );
    ...
    static final MethodHandle hb_face_get_empty$MH = RuntimeHelper.downcallHandle(
        "hb_face_get_empty",
        constants$1155.hb_face_get_empty$FUNC
    );
    ...
    static final MethodHandle hb_face_reference$MH = RuntimeHelper.downcallHandle(
        "hb_face_reference",
        constants$1155.hb_face_reference$FUNC
    );
}
