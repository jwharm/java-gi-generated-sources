...
public class _GtkTextChildAnchor {
    ...
    public static MemoryLayout $LAYOUT() {
        return _GtkTextChildAnchor.$struct$LAYOUT;
    }
    ...
    public static VarHandle segment$VH() {
        return _GtkTextChildAnchor.segment$VH;
    }
    public static MemoryAddress segment$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkTextChildAnchor.segment$VH.get(seg);
    }
    public static void segment$set( MemorySegment seg, MemoryAddress x) {
        _GtkTextChildAnchor.segment$VH.set(seg, x);
    }
    public static MemoryAddress segment$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkTextChildAnchor.segment$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void segment$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkTextChildAnchor.segment$VH.set(seg.asSlice(index*sizeof()), x);
    }
