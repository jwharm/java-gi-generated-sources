...
class constants$1842 {
    ...
    static final MethodHandle gtk_builder_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1842.gtk_builder_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_builder_new$MH = RuntimeHelper.downcallHandle(
        "gtk_builder_new",
        constants$1842.gtk_builder_new$FUNC
    );
    ...
    static final MethodHandle gtk_builder_add_from_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1842.gtk_builder_add_from_file$FUNC
    );
    ...
    static final MethodHandle gtk_builder_add_from_resource$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1842.gtk_builder_add_from_resource$FUNC
    );
    ...
    static final MethodHandle gtk_builder_add_from_string$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1842.gtk_builder_add_from_string$FUNC
    );
    ...
    static final MethodHandle gtk_builder_add_objects_from_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1842.gtk_builder_add_objects_from_file$FUNC
    );
}
