...
public interface hb_font_get_glyph_extents_func_t {
    ...
    static MemorySegment allocate(hb_font_get_glyph_extents_func_t fi, MemorySession session) {
        return RuntimeHelper.upcallStub(hb_font_get_glyph_extents_func_t.class, fi, constants$1170.hb_font_get_glyph_extents_func_t$FUNC, session);
    }
    static hb_font_get_glyph_extents_func_t ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _font, java.lang.foreign.MemoryAddress _font_data, int _glyph, java.lang.foreign.MemoryAddress _extents, java.lang.foreign.MemoryAddress _user_data) -> {
            try {
                return (int)constants$1170.hb_font_get_glyph_extents_func_t$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_font, (java.lang.foreign.Addressable)_font_data, _glyph, (java.lang.foreign.Addressable)_extents, (java.lang.foreign.Addressable)_user_data);
            } catch (Throwable ex$) {
