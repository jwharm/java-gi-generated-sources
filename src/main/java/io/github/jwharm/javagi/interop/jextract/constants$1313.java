...
class constants$1313 {
    ...
    static final MethodHandle gdk_pixbuf_animation_iter_on_currently_loading_frame$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1313.gdk_pixbuf_animation_iter_on_currently_loading_frame$FUNC
    );
    ...
    static final MethodHandle gdk_pixbuf_animation_iter_advance$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1313.gdk_pixbuf_animation_iter_advance$FUNC
    );
    static final FunctionDescriptor gdk_pixbuf_non_anim_get_type$FUNC = FunctionDescriptor.of(Constants$root.C_LONG_LONG$LAYOUT);
    static final MethodHandle gdk_pixbuf_non_anim_get_type$MH = RuntimeHelper.downcallHandle(
        "gdk_pixbuf_non_anim_get_type",
        constants$1313.gdk_pixbuf_non_anim_get_type$FUNC
    );
    static final FunctionDescriptor gdk_pixbuf_non_anim_new$FUNC = FunctionDescriptor.of(Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle gdk_pixbuf_non_anim_new$MH = RuntimeHelper.downcallHandle(
        "gdk_pixbuf_non_anim_new",
        constants$1313.gdk_pixbuf_non_anim_new$FUNC
    );
    ...
    static final MethodHandle gdk_pixbuf_simple_anim_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1313.gdk_pixbuf_simple_anim_get_type$FUNC
    );
    ...
    static final MethodHandle gdk_pixbuf_simple_anim_iter_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1313.gdk_pixbuf_simple_anim_iter_get_type$FUNC
    );
}
