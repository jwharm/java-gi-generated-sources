...
public class _GtkTextView {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_POINTER$LAYOUT.withName("priv")
    ).withName("_GtkTextView");
    public static MemoryLayout $LAYOUT() {
        return _GtkTextView.$struct$LAYOUT;
    }
    ...
    public static VarHandle priv$VH() {
        return _GtkTextView.priv$VH;
    }
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkTextView.priv$VH.get(seg);
    }
    public static void priv$set( MemorySegment seg, MemoryAddress x) {
        _GtkTextView.priv$VH.set(seg, x);
    }
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkTextView.priv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void priv$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkTextView.priv$VH.set(seg.asSlice(index*sizeof()), x);
    }
