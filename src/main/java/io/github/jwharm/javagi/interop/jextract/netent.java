...
public class netent {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_INT$LAYOUT.withName("n_addrtype"),
        Constants$root.C_INT$LAYOUT.withName("n_net")
    ).withName("netent");
    ...
    public static int n_addrtype$get(MemorySegment seg) {
        return (int)netent.n_addrtype$VH.get(seg);
    }
    public static void n_addrtype$set( MemorySegment seg, int x) {
        netent.n_addrtype$VH.set(seg, x);
    }
    public static int n_addrtype$get(MemorySegment seg, long index) {
        return (int)netent.n_addrtype$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void n_addrtype$set(MemorySegment seg, long index, int x) {
