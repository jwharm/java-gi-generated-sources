...
class constants$2253 {
    ...
    static final MethodHandle gtk_overlay_layout_child_set_measure$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2253.gtk_overlay_layout_child_set_measure$FUNC
    );
    ...
    static final MethodHandle gtk_overlay_layout_child_get_measure$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2253.gtk_overlay_layout_child_get_measure$FUNC
    );
    ...
    static final MethodHandle gtk_overlay_layout_child_set_clip_overlay$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2253.gtk_overlay_layout_child_set_clip_overlay$FUNC
    );
    ...
    static final MethodHandle gtk_overlay_layout_child_get_clip_overlay$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2253.gtk_overlay_layout_child_get_clip_overlay$FUNC
    );
    ...
    static final MethodHandle gtk_pad_controller_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2253.gtk_pad_controller_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_pad_controller_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$2253.gtk_pad_controller_new$FUNC
    );
}
