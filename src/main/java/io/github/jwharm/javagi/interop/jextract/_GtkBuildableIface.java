...
public class _GtkBuildableIface {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_POINTER$LAYOUT.withName("set_id"),
    ...
    static final FunctionDescriptor set_id$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle set_id$MH = RuntimeHelper.downcallHandle(
        _GtkBuildableIface.set_id$FUNC
    );
    public interface set_id {

        void apply(java.lang.foreign.MemoryAddress _x0, java.lang.foreign.MemoryAddress _x1);
        static MemorySegment allocate(set_id fi, MemorySession session) {
            return RuntimeHelper.upcallStub(set_id.class, fi, _GtkBuildableIface.set_id$FUNC, session);
        }
        static set_id ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1) -> {
                try {
                    _GtkBuildableIface.set_id$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1);
                } catch (Throwable ex$) {
    ...
    static final VarHandle set_id$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("set_id"));
    public static VarHandle set_id$VH() {
        return _GtkBuildableIface.set_id$VH;
    }
    public static MemoryAddress set_id$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableIface.set_id$VH.get(seg);
    }
    public static void set_id$set( MemorySegment seg, MemoryAddress x) {
        _GtkBuildableIface.set_id$VH.set(seg, x);
    }
    public static MemoryAddress set_id$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableIface.set_id$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void set_id$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkBuildableIface.set_id$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static set_id set_id (MemorySegment segment, MemorySession session) {
        return set_id.ofAddress(set_id$get(segment), session);
    }
    ...
    static final MethodHandle get_id$MH = RuntimeHelper.downcallHandle(
        _GtkBuildableIface.get_id$FUNC
    );
    public interface get_id {

        java.lang.foreign.Addressable apply(java.lang.foreign.MemoryAddress _x0);
        static MemorySegment allocate(get_id fi, MemorySession session) {
            return RuntimeHelper.upcallStub(get_id.class, fi, _GtkBuildableIface.get_id$FUNC, session);
        }
        static get_id ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0) -> {
                try {
                    return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)_GtkBuildableIface.get_id$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle get_id$VH() {
        return _GtkBuildableIface.get_id$VH;
    }
    public static MemoryAddress get_id$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableIface.get_id$VH.get(seg);
    }
    public static void get_id$set( MemorySegment seg, MemoryAddress x) {
        _GtkBuildableIface.get_id$VH.set(seg, x);
    }
    public static MemoryAddress get_id$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkBuildableIface.get_id$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void get_id$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkBuildableIface.get_id$VH.set(seg.asSlice(index*sizeof()), x);
    }
