...
public interface hb_buffer_message_func_t {
    ...
    static MemorySegment allocate(hb_buffer_message_func_t fi, MemorySession session) {
        return RuntimeHelper.upcallStub(hb_buffer_message_func_t.class, fi, constants$1195.hb_buffer_message_func_t$FUNC, session);
    }
    static hb_buffer_message_func_t ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _buffer, java.lang.foreign.MemoryAddress _font, java.lang.foreign.MemoryAddress _message, java.lang.foreign.MemoryAddress _user_data) -> {
            try {
                return (int)constants$1195.hb_buffer_message_func_t$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_buffer, (java.lang.foreign.Addressable)_font, (java.lang.foreign.Addressable)_message, (java.lang.foreign.Addressable)_user_data);
            } catch (Throwable ex$) {
