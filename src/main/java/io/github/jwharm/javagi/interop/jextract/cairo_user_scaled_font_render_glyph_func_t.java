...
public interface cairo_user_scaled_font_render_glyph_func_t {
    ...
    static MemorySegment allocate(cairo_user_scaled_font_render_glyph_func_t fi, MemorySession session) {
        return RuntimeHelper.upcallStub(cairo_user_scaled_font_render_glyph_func_t.class, fi, constants$1102.cairo_user_scaled_font_render_glyph_func_t$FUNC, session);
    }
    static cairo_user_scaled_font_render_glyph_func_t ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _scaled_font, long _glyph, java.lang.foreign.MemoryAddress _cr, java.lang.foreign.MemoryAddress _extents) -> {
            try {
                return (int)constants$1103.cairo_user_scaled_font_render_glyph_func_t$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_scaled_font, _glyph, (java.lang.foreign.Addressable)_cr, (java.lang.foreign.Addressable)_extents);
            } catch (Throwable ex$) {
