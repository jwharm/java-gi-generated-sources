...
public class DisplayPlaneAlphaFlagsKHR extends Struct {
    ...
    public static DisplayPlaneAlphaFlagsKHR allocate() {
        ...
        DisplayPlaneAlphaFlagsKHR newInstance = new DisplayPlaneAlphaFlagsKHR(segment.address());
     ...
     */
    protected DisplayPlaneAlphaFlagsKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DisplayPlaneAlphaFlagsKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DisplayPlaneAlphaFlagsKHR(input);
}
