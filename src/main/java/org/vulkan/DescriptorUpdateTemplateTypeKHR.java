...
public class DescriptorUpdateTemplateTypeKHR extends Struct {
     ...
     */
    protected DescriptorUpdateTemplateTypeKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorUpdateTemplateTypeKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorUpdateTemplateTypeKHR(input, ownership);
}
