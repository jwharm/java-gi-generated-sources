...
public class ComponentTypeNV extends Struct {
    ...
    public static ComponentTypeNV allocate() {
        ...
        ComponentTypeNV newInstance = new ComponentTypeNV(segment.address());
     ...
     */
    protected ComponentTypeNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ComponentTypeNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ComponentTypeNV(input);
}
