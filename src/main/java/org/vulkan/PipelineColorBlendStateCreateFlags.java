...
public class PipelineColorBlendStateCreateFlags extends Struct {
     ...
     */
    protected PipelineColorBlendStateCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineColorBlendStateCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineColorBlendStateCreateFlags(input, ownership);
}
