...
public class PipelineRasterizationDepthClipStateCreateFlagsEXT extends Struct {
    ...
    public static PipelineRasterizationDepthClipStateCreateFlagsEXT allocate() {
        ...
        PipelineRasterizationDepthClipStateCreateFlagsEXT newInstance = new PipelineRasterizationDepthClipStateCreateFlagsEXT(segment.address(), Ownership.NONE);
     ...
     */
    protected PipelineRasterizationDepthClipStateCreateFlagsEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineRasterizationDepthClipStateCreateFlagsEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineRasterizationDepthClipStateCreateFlagsEXT(input, ownership);
}
