...
public class PhysicalDeviceComputeShaderDerivativesFeaturesNV extends Struct {
     ...
     */
    protected PhysicalDeviceComputeShaderDerivativesFeaturesNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceComputeShaderDerivativesFeaturesNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceComputeShaderDerivativesFeaturesNV(input, ownership);
}
