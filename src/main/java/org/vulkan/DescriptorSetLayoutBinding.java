...
public class DescriptorSetLayoutBinding extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkDescriptorSetLayoutBinding";
    ...
    /**
     * Allocate a new {@link DescriptorSetLayoutBinding}
     ...
     */
    @ApiStatus.Internal
    public DescriptorSetLayoutBinding(Addressable address, Ownership ownership) {
