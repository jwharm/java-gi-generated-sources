...
public class ExportMemoryAllocateInfoKHR extends Struct {
    ...
    public static ExportMemoryAllocateInfoKHR allocate() {
        ...
        ExportMemoryAllocateInfoKHR newInstance = new ExportMemoryAllocateInfoKHR(segment.address());
     ...
     */
    protected ExportMemoryAllocateInfoKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExportMemoryAllocateInfoKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ExportMemoryAllocateInfoKHR(input);
}
