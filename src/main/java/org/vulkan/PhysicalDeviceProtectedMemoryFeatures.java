...
public class PhysicalDeviceProtectedMemoryFeatures extends Struct {
    ...
    public static PhysicalDeviceProtectedMemoryFeatures allocate() {
        ...
        PhysicalDeviceProtectedMemoryFeatures newInstance = new PhysicalDeviceProtectedMemoryFeatures(segment.address(), Ownership.NONE);
     ...
     */
    protected PhysicalDeviceProtectedMemoryFeatures(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceProtectedMemoryFeatures> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceProtectedMemoryFeatures(input, ownership);
}
