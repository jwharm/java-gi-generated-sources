...
public class PipelineInputAssemblyStateCreateInfo extends Struct {
     ...
     */
    protected PipelineInputAssemblyStateCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineInputAssemblyStateCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineInputAssemblyStateCreateInfo(input, ownership);
}
