...
public class DisplayPresentInfoKHR extends Struct {
     ...
     */
    protected DisplayPresentInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DisplayPresentInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DisplayPresentInfoKHR(input, ownership);
}
