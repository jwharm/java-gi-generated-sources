...
public class PipelineShaderStageCreateFlags extends Struct {
     ...
     */
    protected PipelineShaderStageCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineShaderStageCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineShaderStageCreateFlags(input, ownership);
}
