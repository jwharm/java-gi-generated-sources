...
public class PipelineTessellationStateCreateFlags extends Struct {
    ...
    public static PipelineTessellationStateCreateFlags allocate() {
        ...
        PipelineTessellationStateCreateFlags newInstance = new PipelineTessellationStateCreateFlags(segment.address());
     ...
     */
    protected PipelineTessellationStateCreateFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineTessellationStateCreateFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineTessellationStateCreateFlags(input);
}
