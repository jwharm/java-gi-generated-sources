...
public class ShaderModuleValidationCacheCreateInfoEXT extends Struct {
    ...
    public static ShaderModuleValidationCacheCreateInfoEXT allocate() {
        ...
        ShaderModuleValidationCacheCreateInfoEXT newInstance = new ShaderModuleValidationCacheCreateInfoEXT(segment.address());
     ...
     */
    protected ShaderModuleValidationCacheCreateInfoEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShaderModuleValidationCacheCreateInfoEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ShaderModuleValidationCacheCreateInfoEXT(input);
}
