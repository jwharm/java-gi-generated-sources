...
public class SparseImageFormatFlags extends Struct {
    ...
    public static SparseImageFormatFlags allocate() {
        ...
        SparseImageFormatFlags newInstance = new SparseImageFormatFlags(segment.address());
     ...
     */
    protected SparseImageFormatFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SparseImageFormatFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SparseImageFormatFlags(input);
}
