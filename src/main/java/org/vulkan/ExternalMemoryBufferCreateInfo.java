...
public class ExternalMemoryBufferCreateInfo extends Struct {
    ...
    public static ExternalMemoryBufferCreateInfo allocate() {
        ...
        ExternalMemoryBufferCreateInfo newInstance = new ExternalMemoryBufferCreateInfo(segment.address(), Ownership.NONE);
     ...
     */
    protected ExternalMemoryBufferCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryBufferCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryBufferCreateInfo(input, ownership);
}
