...
public class DrmFormatModifierPropertiesEXT extends Struct {
    ...
    public static DrmFormatModifierPropertiesEXT allocate() {
        ...
        DrmFormatModifierPropertiesEXT newInstance = new DrmFormatModifierPropertiesEXT(segment.address());
     ...
     */
    protected DrmFormatModifierPropertiesEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DrmFormatModifierPropertiesEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DrmFormatModifierPropertiesEXT(input);
}
