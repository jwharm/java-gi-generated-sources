...
public class QueryControlFlags extends Struct {
    ...
    public static QueryControlFlags allocate() {
        ...
        QueryControlFlags newInstance = new QueryControlFlags(segment.address());
     ...
     */
    protected QueryControlFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, QueryControlFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new QueryControlFlags(input);
}
