...
public class AccelerationStructureTypeNV extends Struct {
    ...
    public static AccelerationStructureTypeNV allocate() {
        ...
        AccelerationStructureTypeNV newInstance = new AccelerationStructureTypeNV(segment.address(), Ownership.NONE);
     ...
     */
    protected AccelerationStructureTypeNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AccelerationStructureTypeNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AccelerationStructureTypeNV(input, ownership);
}
