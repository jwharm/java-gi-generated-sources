...
public class PipelineLayoutCreateInfo extends Struct {
    ...
    public static PipelineLayoutCreateInfo allocate() {
        ...
        PipelineLayoutCreateInfo newInstance = new PipelineLayoutCreateInfo(segment.address(), Ownership.NONE);
     ...
     */
    protected PipelineLayoutCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineLayoutCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineLayoutCreateInfo(input, ownership);
}
