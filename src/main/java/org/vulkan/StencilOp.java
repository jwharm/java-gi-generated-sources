...
public class StencilOp extends Struct {
     ...
     */
    protected StencilOp(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, StencilOp> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new StencilOp(input, ownership);
}
