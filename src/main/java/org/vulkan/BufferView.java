...
public class BufferView extends Struct {
     ...
     */
    protected BufferView(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferView> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BufferView(input, ownership);
}
