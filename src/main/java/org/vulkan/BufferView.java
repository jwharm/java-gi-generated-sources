...
public class BufferView extends Struct {
    ...
    public static BufferView allocate() {
        ...
        BufferView newInstance = new BufferView(segment.address());
     ...
     */
    protected BufferView(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferView> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BufferView(input);
}
