...
public class SparseMemoryBind extends Struct {
    ...
    public static SparseMemoryBind allocate() {
        ...
        SparseMemoryBind newInstance = new SparseMemoryBind(segment.address());
     ...
     */
    protected SparseMemoryBind(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SparseMemoryBind> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SparseMemoryBind(input);
}
