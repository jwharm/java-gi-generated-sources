...
public class Flags extends Struct {
    ...
    public static Flags allocate() {
        ...
        Flags newInstance = new Flags(segment.address());
     ...
     */
    protected Flags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, Flags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new Flags(input);
}
