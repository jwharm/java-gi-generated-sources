...
public class SubpassSampleLocationsEXT extends Struct {
    ...
    public static SubpassSampleLocationsEXT allocate() {
        ...
        SubpassSampleLocationsEXT newInstance = new SubpassSampleLocationsEXT(segment.address());
     ...
     */
    protected SubpassSampleLocationsEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SubpassSampleLocationsEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SubpassSampleLocationsEXT(input);
}
