...
public class ExternalMemoryHandleTypeFlagBitsNV extends Struct {
    ...
    public static ExternalMemoryHandleTypeFlagBitsNV allocate() {
        ...
        ExternalMemoryHandleTypeFlagBitsNV newInstance = new ExternalMemoryHandleTypeFlagBitsNV(segment.address(), Ownership.NONE);
     ...
     */
    protected ExternalMemoryHandleTypeFlagBitsNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryHandleTypeFlagBitsNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryHandleTypeFlagBitsNV(input, ownership);
}
