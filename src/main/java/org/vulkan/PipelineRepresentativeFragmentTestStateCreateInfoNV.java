...
public class PipelineRepresentativeFragmentTestStateCreateInfoNV extends Struct {
    ...
    public static PipelineRepresentativeFragmentTestStateCreateInfoNV allocate() {
        ...
        PipelineRepresentativeFragmentTestStateCreateInfoNV newInstance = new PipelineRepresentativeFragmentTestStateCreateInfoNV(segment.address());
     ...
     */
    protected PipelineRepresentativeFragmentTestStateCreateInfoNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineRepresentativeFragmentTestStateCreateInfoNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineRepresentativeFragmentTestStateCreateInfoNV(input);
}
