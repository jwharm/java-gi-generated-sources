...
public class ImageFormatProperties2KHR extends Struct {
    ...
    public static ImageFormatProperties2KHR allocate() {
        ...
        ImageFormatProperties2KHR newInstance = new ImageFormatProperties2KHR(segment.address());
     ...
     */
    protected ImageFormatProperties2KHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageFormatProperties2KHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ImageFormatProperties2KHR(input);
}
