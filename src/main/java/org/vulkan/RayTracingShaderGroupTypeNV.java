...
public class RayTracingShaderGroupTypeNV extends Struct {
    ...
    public static RayTracingShaderGroupTypeNV allocate() {
        ...
        RayTracingShaderGroupTypeNV newInstance = new RayTracingShaderGroupTypeNV(segment.address(), Ownership.NONE);
     ...
     */
    protected RayTracingShaderGroupTypeNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RayTracingShaderGroupTypeNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RayTracingShaderGroupTypeNV(input, ownership);
}
