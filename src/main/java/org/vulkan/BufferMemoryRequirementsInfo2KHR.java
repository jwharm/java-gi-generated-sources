...
public class BufferMemoryRequirementsInfo2KHR extends Struct {
    ...
    public static BufferMemoryRequirementsInfo2KHR allocate() {
        ...
        BufferMemoryRequirementsInfo2KHR newInstance = new BufferMemoryRequirementsInfo2KHR(segment.address());
     ...
     */
    protected BufferMemoryRequirementsInfo2KHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferMemoryRequirementsInfo2KHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BufferMemoryRequirementsInfo2KHR(input);
}
