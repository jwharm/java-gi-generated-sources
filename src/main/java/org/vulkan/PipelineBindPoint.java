...
public class PipelineBindPoint extends Struct {
    ...
    public static PipelineBindPoint allocate() {
        ...
        PipelineBindPoint newInstance = new PipelineBindPoint(segment.address());
     ...
     */
    protected PipelineBindPoint(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineBindPoint> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineBindPoint(input);
}
