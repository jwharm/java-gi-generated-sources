...
public class PipelineBindPoint extends Struct {
     ...
     */
    protected PipelineBindPoint(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineBindPoint> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineBindPoint(input, ownership);
}
