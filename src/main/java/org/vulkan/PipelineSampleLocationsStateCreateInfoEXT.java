...
public class PipelineSampleLocationsStateCreateInfoEXT extends Struct {
     ...
     */
    protected PipelineSampleLocationsStateCreateInfoEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineSampleLocationsStateCreateInfoEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineSampleLocationsStateCreateInfoEXT(input, ownership);
}
