...
public class AcquireNextImageInfoKHR extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkAcquireNextImageInfoKHR";
    ...
    /**
     * Allocate a new {@link AcquireNextImageInfoKHR}
     ...
     */
    @ApiStatus.Internal
    public AcquireNextImageInfoKHR(Addressable address, Ownership ownership) {
