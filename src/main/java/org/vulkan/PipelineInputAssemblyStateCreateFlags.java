...
public class PipelineInputAssemblyStateCreateFlags extends Struct {
     ...
     */
    protected PipelineInputAssemblyStateCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineInputAssemblyStateCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineInputAssemblyStateCreateFlags(input, ownership);
}
