...
public class SemaphoreImportFlagBitsKHR extends Struct {
    ...
    public static SemaphoreImportFlagBitsKHR allocate() {
        ...
        SemaphoreImportFlagBitsKHR newInstance = new SemaphoreImportFlagBitsKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected SemaphoreImportFlagBitsKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SemaphoreImportFlagBitsKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SemaphoreImportFlagBitsKHR(input, ownership);
}
