...
public class RayTracingShaderGroupCreateInfoNV extends Struct {
     ...
     */
    protected RayTracingShaderGroupCreateInfoNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RayTracingShaderGroupCreateInfoNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RayTracingShaderGroupCreateInfoNV(input, ownership);
}
