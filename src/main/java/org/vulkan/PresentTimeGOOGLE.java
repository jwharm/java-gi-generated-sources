...
public class PresentTimeGOOGLE extends Struct {
    ...
    public static PresentTimeGOOGLE allocate() {
        ...
        PresentTimeGOOGLE newInstance = new PresentTimeGOOGLE(segment.address());
     ...
     */
    protected PresentTimeGOOGLE(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PresentTimeGOOGLE> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PresentTimeGOOGLE(input);
}
