...
public class DescriptorUpdateTemplateCreateFlagsKHR extends Struct {
    ...
    public static DescriptorUpdateTemplateCreateFlagsKHR allocate() {
        ...
        DescriptorUpdateTemplateCreateFlagsKHR newInstance = new DescriptorUpdateTemplateCreateFlagsKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected DescriptorUpdateTemplateCreateFlagsKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorUpdateTemplateCreateFlagsKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorUpdateTemplateCreateFlagsKHR(input, ownership);
}
