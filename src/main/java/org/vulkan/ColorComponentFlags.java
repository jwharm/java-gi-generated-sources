...
public class ColorComponentFlags extends Struct {
    ...
    public static ColorComponentFlags allocate() {
        ...
        ColorComponentFlags newInstance = new ColorComponentFlags(segment.address());
     ...
     */
    protected ColorComponentFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ColorComponentFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ColorComponentFlags(input);
}
