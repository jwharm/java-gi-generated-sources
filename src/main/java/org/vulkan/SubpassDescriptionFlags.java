...
public class SubpassDescriptionFlags extends Struct {
    ...
    public static SubpassDescriptionFlags allocate() {
        ...
        SubpassDescriptionFlags newInstance = new SubpassDescriptionFlags(segment.address());
     ...
     */
    protected SubpassDescriptionFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SubpassDescriptionFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SubpassDescriptionFlags(input);
}
