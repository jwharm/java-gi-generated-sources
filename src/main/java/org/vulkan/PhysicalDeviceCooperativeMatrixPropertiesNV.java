...
public class PhysicalDeviceCooperativeMatrixPropertiesNV extends Struct {
    ...
    public static PhysicalDeviceCooperativeMatrixPropertiesNV allocate() {
        ...
        PhysicalDeviceCooperativeMatrixPropertiesNV newInstance = new PhysicalDeviceCooperativeMatrixPropertiesNV(segment.address(), Ownership.NONE);
     ...
     */
    protected PhysicalDeviceCooperativeMatrixPropertiesNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceCooperativeMatrixPropertiesNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceCooperativeMatrixPropertiesNV(input, ownership);
}
