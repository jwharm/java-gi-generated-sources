...
public class PhysicalDeviceGroupPropertiesKHR extends Struct {
    ...
    public static PhysicalDeviceGroupPropertiesKHR allocate() {
        ...
        PhysicalDeviceGroupPropertiesKHR newInstance = new PhysicalDeviceGroupPropertiesKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected PhysicalDeviceGroupPropertiesKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceGroupPropertiesKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceGroupPropertiesKHR(input, ownership);
}
