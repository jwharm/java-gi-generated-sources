...
public class ComponentMapping extends Struct {
    ...
    public static ComponentMapping allocate() {
        ...
        ComponentMapping newInstance = new ComponentMapping(segment.address(), Ownership.NONE);
     ...
     */
    protected ComponentMapping(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ComponentMapping> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ComponentMapping(input, ownership);
}
