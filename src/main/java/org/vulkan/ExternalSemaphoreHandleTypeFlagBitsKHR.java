...
public class ExternalSemaphoreHandleTypeFlagBitsKHR extends Struct {
    ...
    public static ExternalSemaphoreHandleTypeFlagBitsKHR allocate() {
        ...
        ExternalSemaphoreHandleTypeFlagBitsKHR newInstance = new ExternalSemaphoreHandleTypeFlagBitsKHR(segment.address());
     ...
     */
    protected ExternalSemaphoreHandleTypeFlagBitsKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalSemaphoreHandleTypeFlagBitsKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ExternalSemaphoreHandleTypeFlagBitsKHR(input);
}
