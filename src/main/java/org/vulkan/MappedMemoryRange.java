...
public class MappedMemoryRange extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkMappedMemoryRange";
    ...
    /**
     * Allocate a new {@link MappedMemoryRange}
     ...
     */
    @ApiStatus.Internal
    public MappedMemoryRange(Addressable address, Ownership ownership) {
