...
public class SurfaceKHR extends Struct {
    ...
    public static SurfaceKHR allocate() {
        ...
        SurfaceKHR newInstance = new SurfaceKHR(segment.address());
     ...
     */
    protected SurfaceKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SurfaceKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SurfaceKHR(input);
}
