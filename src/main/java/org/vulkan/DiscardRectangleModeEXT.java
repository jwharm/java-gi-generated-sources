...
public class DiscardRectangleModeEXT extends Struct {
     ...
     */
    protected DiscardRectangleModeEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DiscardRectangleModeEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DiscardRectangleModeEXT(input, ownership);
}
