...
public class DiscardRectangleModeEXT extends Struct {
    ...
    public static DiscardRectangleModeEXT allocate() {
        ...
        DiscardRectangleModeEXT newInstance = new DiscardRectangleModeEXT(segment.address());
     ...
     */
    protected DiscardRectangleModeEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DiscardRectangleModeEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DiscardRectangleModeEXT(input);
}
