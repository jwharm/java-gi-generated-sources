...
public class DescriptorPool extends Struct {
     ...
     */
    protected DescriptorPool(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorPool> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorPool(input, ownership);
}
