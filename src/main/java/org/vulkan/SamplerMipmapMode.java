...
public class SamplerMipmapMode extends Struct {
     ...
     */
    protected SamplerMipmapMode(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SamplerMipmapMode> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SamplerMipmapMode(input, ownership);
}
