...
public class CompositeAlphaFlagsKHR extends Struct {
     ...
     */
    protected CompositeAlphaFlagsKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CompositeAlphaFlagsKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CompositeAlphaFlagsKHR(input, ownership);
}
