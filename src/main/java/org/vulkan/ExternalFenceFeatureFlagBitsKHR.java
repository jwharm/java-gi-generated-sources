...
public class ExternalFenceFeatureFlagBitsKHR extends Struct {
    ...
    public static ExternalFenceFeatureFlagBitsKHR allocate() {
        ...
        ExternalFenceFeatureFlagBitsKHR newInstance = new ExternalFenceFeatureFlagBitsKHR(segment.address());
     ...
     */
    protected ExternalFenceFeatureFlagBitsKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalFenceFeatureFlagBitsKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ExternalFenceFeatureFlagBitsKHR(input);
}
