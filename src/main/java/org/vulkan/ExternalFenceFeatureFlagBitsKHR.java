...
public class ExternalFenceFeatureFlagBitsKHR extends Struct {
     ...
     */
    protected ExternalFenceFeatureFlagBitsKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalFenceFeatureFlagBitsKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalFenceFeatureFlagBitsKHR(input, ownership);
}
