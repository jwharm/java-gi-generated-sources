...
public class SubmitInfo extends Struct {
    ...
    public static SubmitInfo allocate() {
        ...
        SubmitInfo newInstance = new SubmitInfo(segment.address());
     ...
     */
    protected SubmitInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SubmitInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SubmitInfo(input);
}
