...
public class ExternalSemaphoreHandleTypeFlags extends Struct {
     ...
     */
    protected ExternalSemaphoreHandleTypeFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalSemaphoreHandleTypeFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalSemaphoreHandleTypeFlags(input, ownership);
}
