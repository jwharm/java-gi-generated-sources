...
public class ExternalMemoryImageCreateInfoNV extends Struct {
    ...
    public static ExternalMemoryImageCreateInfoNV allocate() {
        ...
        ExternalMemoryImageCreateInfoNV newInstance = new ExternalMemoryImageCreateInfoNV(segment.address(), Ownership.NONE);
     ...
     */
    protected ExternalMemoryImageCreateInfoNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryImageCreateInfoNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryImageCreateInfoNV(input, ownership);
}
