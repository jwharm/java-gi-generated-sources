...
public class PhysicalDeviceExternalMemoryHostPropertiesEXT extends Struct {
    ...
    public static PhysicalDeviceExternalMemoryHostPropertiesEXT allocate() {
        ...
        PhysicalDeviceExternalMemoryHostPropertiesEXT newInstance = new PhysicalDeviceExternalMemoryHostPropertiesEXT(segment.address());
     ...
     */
    protected PhysicalDeviceExternalMemoryHostPropertiesEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceExternalMemoryHostPropertiesEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceExternalMemoryHostPropertiesEXT(input);
}
