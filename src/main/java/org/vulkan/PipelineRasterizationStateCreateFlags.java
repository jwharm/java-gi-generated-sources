...
public class PipelineRasterizationStateCreateFlags extends Struct {
     ...
     */
    protected PipelineRasterizationStateCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineRasterizationStateCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineRasterizationStateCreateFlags(input, ownership);
}
