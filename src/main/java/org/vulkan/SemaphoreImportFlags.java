...
public class SemaphoreImportFlags extends Struct {
    ...
    public static SemaphoreImportFlags allocate() {
        ...
        SemaphoreImportFlags newInstance = new SemaphoreImportFlags(segment.address(), Ownership.NONE);
     ...
     */
    protected SemaphoreImportFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SemaphoreImportFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SemaphoreImportFlags(input, ownership);
}
