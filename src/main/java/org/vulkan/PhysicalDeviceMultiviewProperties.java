...
public class PhysicalDeviceMultiviewProperties extends Struct {
    ...
    public static PhysicalDeviceMultiviewProperties allocate() {
        ...
        PhysicalDeviceMultiviewProperties newInstance = new PhysicalDeviceMultiviewProperties(segment.address(), Ownership.NONE);
     ...
     */
    protected PhysicalDeviceMultiviewProperties(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceMultiviewProperties> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceMultiviewProperties(input, ownership);
}
