...
public class GeometryDataNV extends Struct {
     ...
     */
    protected GeometryDataNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GeometryDataNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GeometryDataNV(input, ownership);
}
