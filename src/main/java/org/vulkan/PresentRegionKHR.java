...
public class PresentRegionKHR extends Struct {
     ...
     */
    protected PresentRegionKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PresentRegionKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PresentRegionKHR(input, ownership);
}
