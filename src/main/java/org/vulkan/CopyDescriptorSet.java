...
public class CopyDescriptorSet extends Struct {
    ...
    public static CopyDescriptorSet allocate() {
        ...
        CopyDescriptorSet newInstance = new CopyDescriptorSet(segment.address(), Ownership.NONE);
     ...
     */
    protected CopyDescriptorSet(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CopyDescriptorSet> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CopyDescriptorSet(input, ownership);
}
