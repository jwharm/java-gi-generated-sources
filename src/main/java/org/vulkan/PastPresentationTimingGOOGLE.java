...
public class PastPresentationTimingGOOGLE extends Struct {
     ...
     */
    protected PastPresentationTimingGOOGLE(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PastPresentationTimingGOOGLE> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PastPresentationTimingGOOGLE(input, ownership);
}
