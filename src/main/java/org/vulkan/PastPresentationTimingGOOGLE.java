...
public class PastPresentationTimingGOOGLE extends Struct {
    ...
    public static PastPresentationTimingGOOGLE allocate() {
        ...
        PastPresentationTimingGOOGLE newInstance = new PastPresentationTimingGOOGLE(segment.address());
     ...
     */
    protected PastPresentationTimingGOOGLE(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PastPresentationTimingGOOGLE> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PastPresentationTimingGOOGLE(input);
}
