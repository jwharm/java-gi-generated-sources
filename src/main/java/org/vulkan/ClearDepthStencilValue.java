...
public class ClearDepthStencilValue extends Struct {
    ...
    public static ClearDepthStencilValue allocate() {
        ...
        ClearDepthStencilValue newInstance = new ClearDepthStencilValue(segment.address(), Ownership.NONE);
     ...
     */
    protected ClearDepthStencilValue(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ClearDepthStencilValue> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ClearDepthStencilValue(input, ownership);
}
