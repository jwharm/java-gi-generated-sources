...
public class ValidationFlagsEXT extends Struct {
    ...
    public static ValidationFlagsEXT allocate() {
        ...
        ValidationFlagsEXT newInstance = new ValidationFlagsEXT(segment.address());
     ...
     */
    protected ValidationFlagsEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ValidationFlagsEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ValidationFlagsEXT(input);
}
