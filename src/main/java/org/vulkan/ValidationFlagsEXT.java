...
public class ValidationFlagsEXT extends Struct {
     ...
     */
    protected ValidationFlagsEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ValidationFlagsEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ValidationFlagsEXT(input, ownership);
}
