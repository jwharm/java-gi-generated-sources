...
public class SparseImageMemoryBindInfo extends Struct {
     ...
     */
    protected SparseImageMemoryBindInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SparseImageMemoryBindInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SparseImageMemoryBindInfo(input, ownership);
}
