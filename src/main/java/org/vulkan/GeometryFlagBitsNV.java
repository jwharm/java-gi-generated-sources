...
public class GeometryFlagBitsNV extends Struct {
     ...
     */
    protected GeometryFlagBitsNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GeometryFlagBitsNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GeometryFlagBitsNV(input, ownership);
}
