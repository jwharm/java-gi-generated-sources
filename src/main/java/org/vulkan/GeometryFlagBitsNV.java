...
public class GeometryFlagBitsNV extends Struct {
    ...
    public static GeometryFlagBitsNV allocate() {
        ...
        GeometryFlagBitsNV newInstance = new GeometryFlagBitsNV(segment.address());
     ...
     */
    protected GeometryFlagBitsNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, GeometryFlagBitsNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new GeometryFlagBitsNV(input);
}
