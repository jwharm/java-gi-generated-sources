...
public class CooperativeMatrixPropertiesNV extends Struct {
    ...
    public static CooperativeMatrixPropertiesNV allocate() {
        ...
        CooperativeMatrixPropertiesNV newInstance = new CooperativeMatrixPropertiesNV(segment.address(), Ownership.NONE);
     ...
     */
    protected CooperativeMatrixPropertiesNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CooperativeMatrixPropertiesNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CooperativeMatrixPropertiesNV(input, ownership);
}
