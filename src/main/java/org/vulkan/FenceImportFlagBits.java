...
public class FenceImportFlagBits extends Struct {
    ...
    public static FenceImportFlagBits allocate() {
        ...
        FenceImportFlagBits newInstance = new FenceImportFlagBits(segment.address());
     ...
     */
    protected FenceImportFlagBits(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FenceImportFlagBits> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FenceImportFlagBits(input);
}
