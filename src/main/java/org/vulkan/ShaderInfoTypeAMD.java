...
public class ShaderInfoTypeAMD extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkShaderInfoTypeAMD";
    ...
    /**
     * Allocate a new {@link ShaderInfoTypeAMD}
     ...
     */
    @ApiStatus.Internal
    public ShaderInfoTypeAMD(Addressable address, Ownership ownership) {
