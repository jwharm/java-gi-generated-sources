...
public class ImageSubresourceLayers extends Struct {
     ...
     */
    protected ImageSubresourceLayers(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageSubresourceLayers> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageSubresourceLayers(input, ownership);
}
