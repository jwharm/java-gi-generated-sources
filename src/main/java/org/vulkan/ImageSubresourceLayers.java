...
public class ImageSubresourceLayers extends Struct {
    ...
    public static ImageSubresourceLayers allocate() {
        ...
        ImageSubresourceLayers newInstance = new ImageSubresourceLayers(segment.address());
     ...
     */
    protected ImageSubresourceLayers(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageSubresourceLayers> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ImageSubresourceLayers(input);
}
