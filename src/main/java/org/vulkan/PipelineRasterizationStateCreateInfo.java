...
public class PipelineRasterizationStateCreateInfo extends Struct {
    ...
    public static PipelineRasterizationStateCreateInfo allocate() {
        ...
        PipelineRasterizationStateCreateInfo newInstance = new PipelineRasterizationStateCreateInfo(segment.address(), Ownership.NONE);
     ...
     */
    protected PipelineRasterizationStateCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineRasterizationStateCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineRasterizationStateCreateInfo(input, ownership);
}
