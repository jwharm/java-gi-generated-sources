...
public class DeviceEventTypeEXT extends Struct {
    ...
    public static DeviceEventTypeEXT allocate() {
        ...
        DeviceEventTypeEXT newInstance = new DeviceEventTypeEXT(segment.address());
     ...
     */
    protected DeviceEventTypeEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceEventTypeEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DeviceEventTypeEXT(input);
}
