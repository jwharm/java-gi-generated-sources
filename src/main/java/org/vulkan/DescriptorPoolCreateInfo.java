...
public class DescriptorPoolCreateInfo extends Struct {
    ...
    public static DescriptorPoolCreateInfo allocate() {
        ...
        DescriptorPoolCreateInfo newInstance = new DescriptorPoolCreateInfo(segment.address(), Ownership.NONE);
     ...
     */
    protected DescriptorPoolCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorPoolCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorPoolCreateInfo(input, ownership);
}
