...
public class PipelineVertexInputStateCreateFlags extends Struct {
     ...
     */
    protected PipelineVertexInputStateCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineVertexInputStateCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineVertexInputStateCreateFlags(input, ownership);
}
