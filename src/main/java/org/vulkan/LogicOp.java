...
public class LogicOp extends Struct {
    ...
    public static LogicOp allocate() {
        ...
        LogicOp newInstance = new LogicOp(segment.address());
     ...
     */
    protected LogicOp(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, LogicOp> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new LogicOp(input);
}
