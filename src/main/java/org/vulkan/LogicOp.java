...
public class LogicOp extends Struct {
     ...
     */
    protected LogicOp(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, LogicOp> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new LogicOp(input, ownership);
}
