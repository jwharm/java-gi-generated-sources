...
public class ImagePlaneMemoryRequirementsInfo extends Struct {
    ...
    public static ImagePlaneMemoryRequirementsInfo allocate() {
        ...
        ImagePlaneMemoryRequirementsInfo newInstance = new ImagePlaneMemoryRequirementsInfo(segment.address());
     ...
     */
    protected ImagePlaneMemoryRequirementsInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImagePlaneMemoryRequirementsInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ImagePlaneMemoryRequirementsInfo(input);
}
