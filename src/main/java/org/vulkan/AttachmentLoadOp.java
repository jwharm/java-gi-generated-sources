...
public class AttachmentLoadOp extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkAttachmentLoadOp";
    ...
    /**
     * Allocate a new {@link AttachmentLoadOp}
     ...
     */
    @ApiStatus.Internal
    public AttachmentLoadOp(Addressable address, Ownership ownership) {
