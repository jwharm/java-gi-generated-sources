...
public class DeviceGroupPresentInfoKHR extends Struct {
     ...
     */
    protected DeviceGroupPresentInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceGroupPresentInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DeviceGroupPresentInfoKHR(input, ownership);
}
