...
public class DeviceGroupPresentInfoKHR extends Struct {
    ...
    public static DeviceGroupPresentInfoKHR allocate() {
        ...
        DeviceGroupPresentInfoKHR newInstance = new DeviceGroupPresentInfoKHR(segment.address());
     ...
     */
    protected DeviceGroupPresentInfoKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceGroupPresentInfoKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DeviceGroupPresentInfoKHR(input);
}
