...
public class SamplerYcbcrConversionCreateInfo extends Struct {
    ...
    public static SamplerYcbcrConversionCreateInfo allocate() {
        ...
        SamplerYcbcrConversionCreateInfo newInstance = new SamplerYcbcrConversionCreateInfo(segment.address());
     ...
     */
    protected SamplerYcbcrConversionCreateInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SamplerYcbcrConversionCreateInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SamplerYcbcrConversionCreateInfo(input);
}
