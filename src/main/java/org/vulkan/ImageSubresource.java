...
public class ImageSubresource extends Struct {
    ...
    public static ImageSubresource allocate() {
        ...
        ImageSubresource newInstance = new ImageSubresource(segment.address(), Ownership.NONE);
     ...
     */
    protected ImageSubresource(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageSubresource> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageSubresource(input, ownership);
}
