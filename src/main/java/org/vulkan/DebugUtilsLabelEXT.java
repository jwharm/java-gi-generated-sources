...
public class DebugUtilsLabelEXT extends Struct {
     ...
     */
    protected DebugUtilsLabelEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DebugUtilsLabelEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DebugUtilsLabelEXT(input, ownership);
}
