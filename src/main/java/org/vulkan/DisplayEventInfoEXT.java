...
public class DisplayEventInfoEXT extends Struct {
    ...
    public static DisplayEventInfoEXT allocate() {
        ...
        DisplayEventInfoEXT newInstance = new DisplayEventInfoEXT(segment.address(), Ownership.NONE);
     ...
     */
    protected DisplayEventInfoEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DisplayEventInfoEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DisplayEventInfoEXT(input, ownership);
}
