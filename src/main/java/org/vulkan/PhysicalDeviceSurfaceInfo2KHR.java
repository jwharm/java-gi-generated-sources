...
public class PhysicalDeviceSurfaceInfo2KHR extends Struct {
     ...
     */
    protected PhysicalDeviceSurfaceInfo2KHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceSurfaceInfo2KHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceSurfaceInfo2KHR(input, ownership);
}
