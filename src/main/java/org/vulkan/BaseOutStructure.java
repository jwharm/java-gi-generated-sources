...
public class BaseOutStructure extends Struct {
    ...
    public static BaseOutStructure allocate() {
        ...
        BaseOutStructure newInstance = new BaseOutStructure(segment.address());
     ...
     */
    protected BaseOutStructure(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BaseOutStructure> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BaseOutStructure(input);
}
