...
public class InstanceCreateFlags extends Struct {
     ...
     */
    protected InstanceCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, InstanceCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new InstanceCreateFlags(input, ownership);
}
