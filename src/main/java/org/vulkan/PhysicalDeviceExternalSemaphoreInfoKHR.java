...
public class PhysicalDeviceExternalSemaphoreInfoKHR extends Struct {
    ...
    public static PhysicalDeviceExternalSemaphoreInfoKHR allocate() {
        ...
        PhysicalDeviceExternalSemaphoreInfoKHR newInstance = new PhysicalDeviceExternalSemaphoreInfoKHR(segment.address());
     ...
     */
    protected PhysicalDeviceExternalSemaphoreInfoKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceExternalSemaphoreInfoKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceExternalSemaphoreInfoKHR(input);
}
