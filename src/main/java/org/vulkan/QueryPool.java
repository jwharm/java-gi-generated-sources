...
public class QueryPool extends Struct {
    ...
    public static QueryPool allocate() {
        ...
        QueryPool newInstance = new QueryPool(segment.address());
     ...
     */
    protected QueryPool(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, QueryPool> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new QueryPool(input);
}
