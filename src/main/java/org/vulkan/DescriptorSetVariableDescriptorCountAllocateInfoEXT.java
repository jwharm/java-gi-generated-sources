...
public class DescriptorSetVariableDescriptorCountAllocateInfoEXT extends Struct {
    ...
    public static DescriptorSetVariableDescriptorCountAllocateInfoEXT allocate() {
        ...
        DescriptorSetVariableDescriptorCountAllocateInfoEXT newInstance = new DescriptorSetVariableDescriptorCountAllocateInfoEXT(segment.address());
     ...
     */
    protected DescriptorSetVariableDescriptorCountAllocateInfoEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorSetVariableDescriptorCountAllocateInfoEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorSetVariableDescriptorCountAllocateInfoEXT(input);
}
