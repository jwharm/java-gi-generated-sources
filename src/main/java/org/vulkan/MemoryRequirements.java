...
public class MemoryRequirements extends Struct {
     ...
     */
    protected MemoryRequirements(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryRequirements> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MemoryRequirements(input, ownership);
}
