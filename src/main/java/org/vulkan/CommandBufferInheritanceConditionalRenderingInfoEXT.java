...
public class CommandBufferInheritanceConditionalRenderingInfoEXT extends Struct {
    ...
    public static CommandBufferInheritanceConditionalRenderingInfoEXT allocate() {
        ...
        CommandBufferInheritanceConditionalRenderingInfoEXT newInstance = new CommandBufferInheritanceConditionalRenderingInfoEXT(segment.address());
     ...
     */
    protected CommandBufferInheritanceConditionalRenderingInfoEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CommandBufferInheritanceConditionalRenderingInfoEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CommandBufferInheritanceConditionalRenderingInfoEXT(input);
}
