...
public class CommandBufferInheritanceConditionalRenderingInfoEXT extends Struct {
     ...
     */
    protected CommandBufferInheritanceConditionalRenderingInfoEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CommandBufferInheritanceConditionalRenderingInfoEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CommandBufferInheritanceConditionalRenderingInfoEXT(input, ownership);
}
