...
public class DescriptorPoolResetFlags extends Struct {
    ...
    public static DescriptorPoolResetFlags allocate() {
        ...
        DescriptorPoolResetFlags newInstance = new DescriptorPoolResetFlags(segment.address());
     ...
     */
    protected DescriptorPoolResetFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorPoolResetFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorPoolResetFlags(input);
}
