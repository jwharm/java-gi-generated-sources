...
public class MemoryOverallocationBehaviorAMD extends Struct {
     ...
     */
    protected MemoryOverallocationBehaviorAMD(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryOverallocationBehaviorAMD> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MemoryOverallocationBehaviorAMD(input, ownership);
}
