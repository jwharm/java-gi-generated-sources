...
public class DedicatedAllocationImageCreateInfoNV extends Struct {
     ...
     */
    protected DedicatedAllocationImageCreateInfoNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DedicatedAllocationImageCreateInfoNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DedicatedAllocationImageCreateInfoNV(input, ownership);
}
