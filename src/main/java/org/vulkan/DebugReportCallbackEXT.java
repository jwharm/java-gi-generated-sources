...
public class DebugReportCallbackEXT extends Struct {
     ...
     */
    protected DebugReportCallbackEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DebugReportCallbackEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DebugReportCallbackEXT(input, ownership);
}
