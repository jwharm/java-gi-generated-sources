...
public class QueryPoolCreateFlags extends Struct {
    ...
    public static QueryPoolCreateFlags allocate() {
        ...
        QueryPoolCreateFlags newInstance = new QueryPoolCreateFlags(segment.address(), Ownership.NONE);
     ...
     */
    protected QueryPoolCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, QueryPoolCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new QueryPoolCreateFlags(input, ownership);
}
