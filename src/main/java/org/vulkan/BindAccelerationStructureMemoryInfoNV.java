...
public class BindAccelerationStructureMemoryInfoNV extends Struct {
    ...
    public static BindAccelerationStructureMemoryInfoNV allocate() {
        ...
        BindAccelerationStructureMemoryInfoNV newInstance = new BindAccelerationStructureMemoryInfoNV(segment.address(), Ownership.NONE);
     ...
     */
    protected BindAccelerationStructureMemoryInfoNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BindAccelerationStructureMemoryInfoNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BindAccelerationStructureMemoryInfoNV(input, ownership);
}
