...
public class IndirectCommandsLayoutUsageFlagsNVX extends Struct {
     ...
     */
    protected IndirectCommandsLayoutUsageFlagsNVX(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, IndirectCommandsLayoutUsageFlagsNVX> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new IndirectCommandsLayoutUsageFlagsNVX(input, ownership);
}
