...
public class ExternalImageFormatPropertiesNV extends Struct {
     ...
     */
    protected ExternalImageFormatPropertiesNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalImageFormatPropertiesNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalImageFormatPropertiesNV(input, ownership);
}
