...
public class DisplayModeCreateFlagsKHR extends Struct {
     ...
     */
    protected DisplayModeCreateFlagsKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DisplayModeCreateFlagsKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DisplayModeCreateFlagsKHR(input, ownership);
}
