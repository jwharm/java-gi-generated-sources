...
public class ExtensionProperties extends Struct {
    ...
    public static ExtensionProperties allocate() {
        ...
        ExtensionProperties newInstance = new ExtensionProperties(segment.address(), Ownership.NONE);
     ...
     */
    protected ExtensionProperties(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExtensionProperties> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExtensionProperties(input, ownership);
}
