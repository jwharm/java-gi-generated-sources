...
public class MemoryAllocateFlagsKHR extends Struct {
    ...
    public static MemoryAllocateFlagsKHR allocate() {
        ...
        MemoryAllocateFlagsKHR newInstance = new MemoryAllocateFlagsKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected MemoryAllocateFlagsKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryAllocateFlagsKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MemoryAllocateFlagsKHR(input, ownership);
}
