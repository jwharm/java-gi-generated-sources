...
public class PipelineViewportWScalingStateCreateInfoNV extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkPipelineViewportWScalingStateCreateInfoNV";
    ...
    /**
     * Allocate a new {@link PipelineViewportWScalingStateCreateInfoNV}
     ...
     */
    @ApiStatus.Internal
    public PipelineViewportWScalingStateCreateInfoNV(Addressable address, Ownership ownership) {
