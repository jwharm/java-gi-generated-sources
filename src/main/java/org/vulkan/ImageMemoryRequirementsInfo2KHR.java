...
public class ImageMemoryRequirementsInfo2KHR extends Struct {
     ...
     */
    protected ImageMemoryRequirementsInfo2KHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageMemoryRequirementsInfo2KHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageMemoryRequirementsInfo2KHR(input, ownership);
}
