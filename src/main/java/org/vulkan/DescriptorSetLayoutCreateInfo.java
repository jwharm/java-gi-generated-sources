...
public class DescriptorSetLayoutCreateInfo extends Struct {
    ...
    public static DescriptorSetLayoutCreateInfo allocate() {
        ...
        DescriptorSetLayoutCreateInfo newInstance = new DescriptorSetLayoutCreateInfo(segment.address(), Ownership.NONE);
     ...
     */
    protected DescriptorSetLayoutCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorSetLayoutCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorSetLayoutCreateInfo(input, ownership);
}
