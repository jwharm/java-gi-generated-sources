...
public class GeometryFlagsNV extends Struct {
    ...
    public static GeometryFlagsNV allocate() {
        ...
        GeometryFlagsNV newInstance = new GeometryFlagsNV(segment.address());
     ...
     */
    protected GeometryFlagsNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, GeometryFlagsNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new GeometryFlagsNV(input);
}
