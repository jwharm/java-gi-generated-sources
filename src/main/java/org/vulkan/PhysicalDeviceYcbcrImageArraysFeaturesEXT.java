...
public class PhysicalDeviceYcbcrImageArraysFeaturesEXT extends Struct {
    ...
    public static PhysicalDeviceYcbcrImageArraysFeaturesEXT allocate() {
        ...
        PhysicalDeviceYcbcrImageArraysFeaturesEXT newInstance = new PhysicalDeviceYcbcrImageArraysFeaturesEXT(segment.address(), Ownership.NONE);
     ...
     */
    protected PhysicalDeviceYcbcrImageArraysFeaturesEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceYcbcrImageArraysFeaturesEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceYcbcrImageArraysFeaturesEXT(input, ownership);
}
