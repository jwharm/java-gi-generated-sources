...
public class PipelineDiscardRectangleStateCreateInfoEXT extends Struct {
    ...
    public static PipelineDiscardRectangleStateCreateInfoEXT allocate() {
        ...
        PipelineDiscardRectangleStateCreateInfoEXT newInstance = new PipelineDiscardRectangleStateCreateInfoEXT(segment.address(), Ownership.NONE);
     ...
     */
    protected PipelineDiscardRectangleStateCreateInfoEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineDiscardRectangleStateCreateInfoEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineDiscardRectangleStateCreateInfoEXT(input, ownership);
}
