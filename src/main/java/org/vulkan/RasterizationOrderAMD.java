...
public class RasterizationOrderAMD extends Struct {
    ...
    public static RasterizationOrderAMD allocate() {
        ...
        RasterizationOrderAMD newInstance = new RasterizationOrderAMD(segment.address(), Ownership.NONE);
     ...
     */
    protected RasterizationOrderAMD(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RasterizationOrderAMD> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RasterizationOrderAMD(input, ownership);
}
