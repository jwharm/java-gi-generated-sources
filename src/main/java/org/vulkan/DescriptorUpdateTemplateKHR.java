...
public class DescriptorUpdateTemplateKHR extends Struct {
    ...
    public static DescriptorUpdateTemplateKHR allocate() {
        ...
        DescriptorUpdateTemplateKHR newInstance = new DescriptorUpdateTemplateKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected DescriptorUpdateTemplateKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorUpdateTemplateKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorUpdateTemplateKHR(input, ownership);
}
