...
public class AccelerationStructureNV extends Struct {
    ...
    public static AccelerationStructureNV allocate() {
        ...
        AccelerationStructureNV newInstance = new AccelerationStructureNV(segment.address(), Ownership.NONE);
     ...
     */
    protected AccelerationStructureNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AccelerationStructureNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AccelerationStructureNV(input, ownership);
}
