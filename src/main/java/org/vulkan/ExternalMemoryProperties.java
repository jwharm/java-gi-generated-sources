...
public class ExternalMemoryProperties extends Struct {
    ...
    public static ExternalMemoryProperties allocate() {
        ...
        ExternalMemoryProperties newInstance = new ExternalMemoryProperties(segment.address());
     ...
     */
    protected ExternalMemoryProperties(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryProperties> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryProperties(input);
}
