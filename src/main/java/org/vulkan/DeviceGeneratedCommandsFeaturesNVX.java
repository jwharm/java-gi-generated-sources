...
public class DeviceGeneratedCommandsFeaturesNVX extends Struct {
    ...
    public static DeviceGeneratedCommandsFeaturesNVX allocate() {
        ...
        DeviceGeneratedCommandsFeaturesNVX newInstance = new DeviceGeneratedCommandsFeaturesNVX(segment.address(), Ownership.NONE);
     ...
     */
    protected DeviceGeneratedCommandsFeaturesNVX(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceGeneratedCommandsFeaturesNVX> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DeviceGeneratedCommandsFeaturesNVX(input, ownership);
}
