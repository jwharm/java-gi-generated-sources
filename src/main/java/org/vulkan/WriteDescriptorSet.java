...
public class WriteDescriptorSet extends Struct {
    ...
    public static WriteDescriptorSet allocate() {
        ...
        WriteDescriptorSet newInstance = new WriteDescriptorSet(segment.address());
     ...
     */
    protected WriteDescriptorSet(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, WriteDescriptorSet> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new WriteDescriptorSet(input);
}
