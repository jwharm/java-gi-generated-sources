...
public class DisplaySurfaceCreateInfoKHR extends Struct {
     ...
     */
    protected DisplaySurfaceCreateInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DisplaySurfaceCreateInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DisplaySurfaceCreateInfoKHR(input, ownership);
}
