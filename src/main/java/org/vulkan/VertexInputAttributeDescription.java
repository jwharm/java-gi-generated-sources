...
public class VertexInputAttributeDescription extends Struct {
    ...
    public static VertexInputAttributeDescription allocate() {
        ...
        VertexInputAttributeDescription newInstance = new VertexInputAttributeDescription(segment.address());
     ...
     */
    protected VertexInputAttributeDescription(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VertexInputAttributeDescription> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VertexInputAttributeDescription(input);
}
