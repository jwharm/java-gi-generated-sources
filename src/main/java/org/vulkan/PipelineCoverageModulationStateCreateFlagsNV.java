...
public class PipelineCoverageModulationStateCreateFlagsNV extends Struct {
    ...
    public static PipelineCoverageModulationStateCreateFlagsNV allocate() {
        ...
        PipelineCoverageModulationStateCreateFlagsNV newInstance = new PipelineCoverageModulationStateCreateFlagsNV(segment.address(), Ownership.NONE);
     ...
     */
    protected PipelineCoverageModulationStateCreateFlagsNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineCoverageModulationStateCreateFlagsNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineCoverageModulationStateCreateFlagsNV(input, ownership);
}
