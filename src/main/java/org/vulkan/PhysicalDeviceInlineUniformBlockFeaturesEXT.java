...
public class PhysicalDeviceInlineUniformBlockFeaturesEXT extends Struct {
     ...
     */
    protected PhysicalDeviceInlineUniformBlockFeaturesEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceInlineUniformBlockFeaturesEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceInlineUniformBlockFeaturesEXT(input, ownership);
}
