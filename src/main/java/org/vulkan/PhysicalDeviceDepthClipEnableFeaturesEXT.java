...
public class PhysicalDeviceDepthClipEnableFeaturesEXT extends Struct {
    ...
    public static PhysicalDeviceDepthClipEnableFeaturesEXT allocate() {
        ...
        PhysicalDeviceDepthClipEnableFeaturesEXT newInstance = new PhysicalDeviceDepthClipEnableFeaturesEXT(segment.address());
     ...
     */
    protected PhysicalDeviceDepthClipEnableFeaturesEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceDepthClipEnableFeaturesEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceDepthClipEnableFeaturesEXT(input);
}
