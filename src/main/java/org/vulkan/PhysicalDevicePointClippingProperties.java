...
public class PhysicalDevicePointClippingProperties extends Struct {
    ...
    public static PhysicalDevicePointClippingProperties allocate() {
        ...
        PhysicalDevicePointClippingProperties newInstance = new PhysicalDevicePointClippingProperties(segment.address());
     ...
     */
    protected PhysicalDevicePointClippingProperties(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDevicePointClippingProperties> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDevicePointClippingProperties(input);
}
