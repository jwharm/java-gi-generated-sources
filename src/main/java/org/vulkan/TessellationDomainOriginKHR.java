...
public class TessellationDomainOriginKHR extends Struct {
     ...
     */
    protected TessellationDomainOriginKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TessellationDomainOriginKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TessellationDomainOriginKHR(input, ownership);
}
