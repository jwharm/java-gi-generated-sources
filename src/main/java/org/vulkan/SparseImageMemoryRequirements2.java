...
public class SparseImageMemoryRequirements2 extends Struct {
     ...
     */
    protected SparseImageMemoryRequirements2(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SparseImageMemoryRequirements2> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SparseImageMemoryRequirements2(input, ownership);
}
