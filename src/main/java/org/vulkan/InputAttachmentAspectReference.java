...
public class InputAttachmentAspectReference extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkInputAttachmentAspectReference";
    ...
    /**
     * Allocate a new {@link InputAttachmentAspectReference}
     ...
     */
    @ApiStatus.Internal
    public InputAttachmentAspectReference(Addressable address, Ownership ownership) {
