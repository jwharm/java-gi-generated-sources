...
public class ExternalSemaphoreFeatureFlagsKHR extends Struct {
    ...
    public static ExternalSemaphoreFeatureFlagsKHR allocate() {
        ...
        ExternalSemaphoreFeatureFlagsKHR newInstance = new ExternalSemaphoreFeatureFlagsKHR(segment.address());
     ...
     */
    protected ExternalSemaphoreFeatureFlagsKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalSemaphoreFeatureFlagsKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ExternalSemaphoreFeatureFlagsKHR(input);
}
