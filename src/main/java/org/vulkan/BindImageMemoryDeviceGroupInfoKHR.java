...
public class BindImageMemoryDeviceGroupInfoKHR extends Struct {
    ...
    public static BindImageMemoryDeviceGroupInfoKHR allocate() {
        ...
        BindImageMemoryDeviceGroupInfoKHR newInstance = new BindImageMemoryDeviceGroupInfoKHR(segment.address());
     ...
     */
    protected BindImageMemoryDeviceGroupInfoKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BindImageMemoryDeviceGroupInfoKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BindImageMemoryDeviceGroupInfoKHR(input);
}
