...
public class BindImageMemoryDeviceGroupInfoKHR extends Struct {
     ...
     */
    protected BindImageMemoryDeviceGroupInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BindImageMemoryDeviceGroupInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BindImageMemoryDeviceGroupInfoKHR(input, ownership);
}
