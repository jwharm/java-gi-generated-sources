...
public class DisplayProperties2KHR extends Struct {
     ...
     */
    protected DisplayProperties2KHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DisplayProperties2KHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DisplayProperties2KHR(input, ownership);
}
