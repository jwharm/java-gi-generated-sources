...
public class BorderColor extends Struct {
     ...
     */
    protected BorderColor(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BorderColor> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BorderColor(input, ownership);
}
