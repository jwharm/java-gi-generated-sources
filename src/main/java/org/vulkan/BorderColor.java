...
public class BorderColor extends Struct {
    ...
    public static BorderColor allocate() {
        ...
        BorderColor newInstance = new BorderColor(segment.address());
     ...
     */
    protected BorderColor(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BorderColor> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BorderColor(input);
}
