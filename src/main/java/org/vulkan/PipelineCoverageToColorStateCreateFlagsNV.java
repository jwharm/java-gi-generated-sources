...
public class PipelineCoverageToColorStateCreateFlagsNV extends Struct {
    ...
    public static PipelineCoverageToColorStateCreateFlagsNV allocate() {
        ...
        PipelineCoverageToColorStateCreateFlagsNV newInstance = new PipelineCoverageToColorStateCreateFlagsNV(segment.address());
     ...
     */
    protected PipelineCoverageToColorStateCreateFlagsNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineCoverageToColorStateCreateFlagsNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineCoverageToColorStateCreateFlagsNV(input);
}
