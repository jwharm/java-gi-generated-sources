...
public class PhysicalDeviceMemoryProperties2 extends Struct {
    ...
    public static PhysicalDeviceMemoryProperties2 allocate() {
        ...
        PhysicalDeviceMemoryProperties2 newInstance = new PhysicalDeviceMemoryProperties2(segment.address());
     ...
     */
    protected PhysicalDeviceMemoryProperties2(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceMemoryProperties2> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceMemoryProperties2(input);
}
