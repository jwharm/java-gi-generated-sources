...
public class FramebufferCreateFlags extends Struct {
    ...
    public static FramebufferCreateFlags allocate() {
        ...
        FramebufferCreateFlags newInstance = new FramebufferCreateFlags(segment.address());
     ...
     */
    protected FramebufferCreateFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FramebufferCreateFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FramebufferCreateFlags(input);
}
