...
public class AllocationCallbacks extends Struct {
     ...
     */
    protected AllocationCallbacks(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AllocationCallbacks> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AllocationCallbacks(input, ownership);
}
