...
public class PresentModeKHR extends Struct {
     ...
     */
    protected PresentModeKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PresentModeKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PresentModeKHR(input, ownership);
}
