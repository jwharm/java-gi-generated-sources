...
public class PresentModeKHR extends Struct {
    ...
    public static PresentModeKHR allocate() {
        ...
        PresentModeKHR newInstance = new PresentModeKHR(segment.address());
     ...
     */
    protected PresentModeKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PresentModeKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PresentModeKHR(input);
}
