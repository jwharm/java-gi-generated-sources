...
public class SemaphoreGetFdInfoKHR extends Struct {
    ...
    public static SemaphoreGetFdInfoKHR allocate() {
        ...
        SemaphoreGetFdInfoKHR newInstance = new SemaphoreGetFdInfoKHR(segment.address());
     ...
     */
    protected SemaphoreGetFdInfoKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SemaphoreGetFdInfoKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SemaphoreGetFdInfoKHR(input);
}
