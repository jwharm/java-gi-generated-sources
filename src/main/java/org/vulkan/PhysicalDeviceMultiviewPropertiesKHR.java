...
public class PhysicalDeviceMultiviewPropertiesKHR extends Struct {
     ...
     */
    protected PhysicalDeviceMultiviewPropertiesKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceMultiviewPropertiesKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceMultiviewPropertiesKHR(input, ownership);
}
