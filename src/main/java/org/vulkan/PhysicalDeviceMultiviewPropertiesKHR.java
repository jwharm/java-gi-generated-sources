...
public class PhysicalDeviceMultiviewPropertiesKHR extends Struct {
    ...
    public static PhysicalDeviceMultiviewPropertiesKHR allocate() {
        ...
        PhysicalDeviceMultiviewPropertiesKHR newInstance = new PhysicalDeviceMultiviewPropertiesKHR(segment.address());
     ...
     */
    protected PhysicalDeviceMultiviewPropertiesKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceMultiviewPropertiesKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceMultiviewPropertiesKHR(input);
}
