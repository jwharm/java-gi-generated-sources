...
public class PipelineCoverageReductionStateCreateFlagsNV extends Struct {
    ...
    public static PipelineCoverageReductionStateCreateFlagsNV allocate() {
        ...
        PipelineCoverageReductionStateCreateFlagsNV newInstance = new PipelineCoverageReductionStateCreateFlagsNV(segment.address(), Ownership.NONE);
     ...
     */
    protected PipelineCoverageReductionStateCreateFlagsNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineCoverageReductionStateCreateFlagsNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineCoverageReductionStateCreateFlagsNV(input, ownership);
}
