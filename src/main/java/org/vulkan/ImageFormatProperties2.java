...
public class ImageFormatProperties2 extends Struct {
    ...
    public static ImageFormatProperties2 allocate() {
        ...
        ImageFormatProperties2 newInstance = new ImageFormatProperties2(segment.address());
     ...
     */
    protected ImageFormatProperties2(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageFormatProperties2> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ImageFormatProperties2(input);
}
