...
public class BindImagePlaneMemoryInfo extends Struct {
     ...
     */
    protected BindImagePlaneMemoryInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BindImagePlaneMemoryInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BindImagePlaneMemoryInfo(input, ownership);
}
