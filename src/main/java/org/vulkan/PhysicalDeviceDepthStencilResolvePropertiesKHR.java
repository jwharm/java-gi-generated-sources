...
public class PhysicalDeviceDepthStencilResolvePropertiesKHR extends Struct {
    ...
    public static PhysicalDeviceDepthStencilResolvePropertiesKHR allocate() {
        ...
        PhysicalDeviceDepthStencilResolvePropertiesKHR newInstance = new PhysicalDeviceDepthStencilResolvePropertiesKHR(segment.address());
     ...
     */
    protected PhysicalDeviceDepthStencilResolvePropertiesKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceDepthStencilResolvePropertiesKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceDepthStencilResolvePropertiesKHR(input);
}
