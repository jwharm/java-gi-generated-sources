...
public class ConditionalRenderingBeginInfoEXT extends Struct {
    ...
    public static ConditionalRenderingBeginInfoEXT allocate() {
        ...
        ConditionalRenderingBeginInfoEXT newInstance = new ConditionalRenderingBeginInfoEXT(segment.address(), Ownership.NONE);
     ...
     */
    protected ConditionalRenderingBeginInfoEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ConditionalRenderingBeginInfoEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ConditionalRenderingBeginInfoEXT(input, ownership);
}
