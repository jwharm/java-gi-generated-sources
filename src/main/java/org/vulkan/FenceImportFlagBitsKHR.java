...
public class FenceImportFlagBitsKHR extends Struct {
    ...
    public static FenceImportFlagBitsKHR allocate() {
        ...
        FenceImportFlagBitsKHR newInstance = new FenceImportFlagBitsKHR(segment.address());
     ...
     */
    protected FenceImportFlagBitsKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FenceImportFlagBitsKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FenceImportFlagBitsKHR(input);
}
