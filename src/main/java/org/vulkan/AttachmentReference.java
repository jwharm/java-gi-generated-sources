...
public class AttachmentReference extends Struct {
    ...
    public static AttachmentReference allocate() {
        ...
        AttachmentReference newInstance = new AttachmentReference(segment.address());
     ...
     */
    protected AttachmentReference(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, AttachmentReference> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new AttachmentReference(input);
}
