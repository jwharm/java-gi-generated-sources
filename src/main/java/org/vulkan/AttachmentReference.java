...
public class AttachmentReference extends Struct {
     ...
     */
    protected AttachmentReference(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AttachmentReference> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AttachmentReference(input, ownership);
}
