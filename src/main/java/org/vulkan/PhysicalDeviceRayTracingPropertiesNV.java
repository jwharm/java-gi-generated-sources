...
public class PhysicalDeviceRayTracingPropertiesNV extends Struct {
    ...
    public static PhysicalDeviceRayTracingPropertiesNV allocate() {
        ...
        PhysicalDeviceRayTracingPropertiesNV newInstance = new PhysicalDeviceRayTracingPropertiesNV(segment.address(), Ownership.NONE);
     ...
     */
    protected PhysicalDeviceRayTracingPropertiesNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceRayTracingPropertiesNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceRayTracingPropertiesNV(input, ownership);
}
