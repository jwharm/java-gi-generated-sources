...
public class WriteDescriptorSetAccelerationStructureNV extends Struct {
    ...
    public static WriteDescriptorSetAccelerationStructureNV allocate() {
        ...
        WriteDescriptorSetAccelerationStructureNV newInstance = new WriteDescriptorSetAccelerationStructureNV(segment.address());
     ...
     */
    protected WriteDescriptorSetAccelerationStructureNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, WriteDescriptorSetAccelerationStructureNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new WriteDescriptorSetAccelerationStructureNV(input);
}
