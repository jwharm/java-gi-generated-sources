...
public class PipelineViewportStateCreateFlags extends Struct {
     ...
     */
    protected PipelineViewportStateCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineViewportStateCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineViewportStateCreateFlags(input, ownership);
}
