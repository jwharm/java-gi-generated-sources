...
public class GraphicsPipelineCreateInfo extends Struct {
    ...
    public static GraphicsPipelineCreateInfo allocate() {
        ...
        GraphicsPipelineCreateInfo newInstance = new GraphicsPipelineCreateInfo(segment.address());
     ...
     */
    protected GraphicsPipelineCreateInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, GraphicsPipelineCreateInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new GraphicsPipelineCreateInfo(input);
}
