...
public class GraphicsPipelineCreateInfo extends Struct {
     ...
     */
    protected GraphicsPipelineCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GraphicsPipelineCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GraphicsPipelineCreateInfo(input, ownership);
}
