...
public class SurfaceCapabilities2EXT extends Struct {
     ...
     */
    protected SurfaceCapabilities2EXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SurfaceCapabilities2EXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SurfaceCapabilities2EXT(input, ownership);
}
