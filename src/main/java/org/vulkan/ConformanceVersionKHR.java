...
public class ConformanceVersionKHR extends Struct {
    ...
    public static ConformanceVersionKHR allocate() {
        ...
        ConformanceVersionKHR newInstance = new ConformanceVersionKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected ConformanceVersionKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ConformanceVersionKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ConformanceVersionKHR(input, ownership);
}
