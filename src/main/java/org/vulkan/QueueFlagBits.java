...
public class QueueFlagBits extends Struct {
    ...
    public static QueueFlagBits allocate() {
        ...
        QueueFlagBits newInstance = new QueueFlagBits(segment.address(), Ownership.NONE);
     ...
     */
    protected QueueFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, QueueFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new QueueFlagBits(input, ownership);
}
