...
public class ImageViewUsageCreateInfo extends Struct {
     ...
     */
    protected ImageViewUsageCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageViewUsageCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageViewUsageCreateInfo(input, ownership);
}
