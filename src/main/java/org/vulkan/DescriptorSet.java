...
public class DescriptorSet extends Struct {
    ...
    public static DescriptorSet allocate() {
        ...
        DescriptorSet newInstance = new DescriptorSet(segment.address(), Ownership.NONE);
     ...
     */
    protected DescriptorSet(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorSet> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorSet(input, ownership);
}
