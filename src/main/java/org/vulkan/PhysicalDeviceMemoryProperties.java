...
public class PhysicalDeviceMemoryProperties extends Struct {
     ...
     */
    protected PhysicalDeviceMemoryProperties(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceMemoryProperties> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceMemoryProperties(input, ownership);
}
