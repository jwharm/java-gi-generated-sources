...
public class PhysicalDeviceMultiviewFeatures extends Struct {
    ...
    public static PhysicalDeviceMultiviewFeatures allocate() {
        ...
        PhysicalDeviceMultiviewFeatures newInstance = new PhysicalDeviceMultiviewFeatures(segment.address());
     ...
     */
    protected PhysicalDeviceMultiviewFeatures(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceMultiviewFeatures> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceMultiviewFeatures(input);
}
