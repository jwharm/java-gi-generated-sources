...
public class SparseMemoryBindFlagBits extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkSparseMemoryBindFlagBits";
    ...
    /**
     * Allocate a new {@link SparseMemoryBindFlagBits}
     ...
     */
    @ApiStatus.Internal
    public SparseMemoryBindFlagBits(Addressable address, Ownership ownership) {
