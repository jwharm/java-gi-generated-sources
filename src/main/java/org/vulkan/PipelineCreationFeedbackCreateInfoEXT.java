...
public class PipelineCreationFeedbackCreateInfoEXT extends Struct {
     ...
     */
    protected PipelineCreationFeedbackCreateInfoEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineCreationFeedbackCreateInfoEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineCreationFeedbackCreateInfoEXT(input, ownership);
}
