...
public class DependencyFlagBits extends Struct {
     ...
     */
    protected DependencyFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DependencyFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DependencyFlagBits(input, ownership);
}
