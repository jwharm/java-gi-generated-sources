...
public class DependencyFlagBits extends Struct {
    ...
    public static DependencyFlagBits allocate() {
        ...
        DependencyFlagBits newInstance = new DependencyFlagBits(segment.address());
     ...
     */
    protected DependencyFlagBits(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DependencyFlagBits> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DependencyFlagBits(input);
}
