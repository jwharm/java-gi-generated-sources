...
public class PeerMemoryFeatureFlagBitsKHR extends Struct {
    ...
    public static PeerMemoryFeatureFlagBitsKHR allocate() {
        ...
        PeerMemoryFeatureFlagBitsKHR newInstance = new PeerMemoryFeatureFlagBitsKHR(segment.address());
     ...
     */
    protected PeerMemoryFeatureFlagBitsKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PeerMemoryFeatureFlagBitsKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PeerMemoryFeatureFlagBitsKHR(input);
}
