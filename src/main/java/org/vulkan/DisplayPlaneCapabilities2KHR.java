...
public class DisplayPlaneCapabilities2KHR extends Struct {
    ...
    public static DisplayPlaneCapabilities2KHR allocate() {
        ...
        DisplayPlaneCapabilities2KHR newInstance = new DisplayPlaneCapabilities2KHR(segment.address());
     ...
     */
    protected DisplayPlaneCapabilities2KHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DisplayPlaneCapabilities2KHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DisplayPlaneCapabilities2KHR(input);
}
