...
public class ObjectEntryUsageFlagsNVX extends Struct {
     ...
     */
    protected ObjectEntryUsageFlagsNVX(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ObjectEntryUsageFlagsNVX> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ObjectEntryUsageFlagsNVX(input, ownership);
}
