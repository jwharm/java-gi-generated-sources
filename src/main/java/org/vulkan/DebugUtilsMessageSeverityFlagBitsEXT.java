...
public class DebugUtilsMessageSeverityFlagBitsEXT extends Struct {
    ...
    public static DebugUtilsMessageSeverityFlagBitsEXT allocate() {
        ...
        DebugUtilsMessageSeverityFlagBitsEXT newInstance = new DebugUtilsMessageSeverityFlagBitsEXT(segment.address(), Ownership.NONE);
     ...
     */
    protected DebugUtilsMessageSeverityFlagBitsEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DebugUtilsMessageSeverityFlagBitsEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DebugUtilsMessageSeverityFlagBitsEXT(input, ownership);
}
