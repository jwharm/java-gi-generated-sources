...
public class DescriptorPoolInlineUniformBlockCreateInfoEXT extends Struct {
    ...
    public static DescriptorPoolInlineUniformBlockCreateInfoEXT allocate() {
        ...
        DescriptorPoolInlineUniformBlockCreateInfoEXT newInstance = new DescriptorPoolInlineUniformBlockCreateInfoEXT(segment.address());
     ...
     */
    protected DescriptorPoolInlineUniformBlockCreateInfoEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorPoolInlineUniformBlockCreateInfoEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorPoolInlineUniformBlockCreateInfoEXT(input);
}
