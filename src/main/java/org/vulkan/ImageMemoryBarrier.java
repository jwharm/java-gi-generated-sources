...
public class ImageMemoryBarrier extends Struct {
     ...
     */
    protected ImageMemoryBarrier(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageMemoryBarrier> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageMemoryBarrier(input, ownership);
}
