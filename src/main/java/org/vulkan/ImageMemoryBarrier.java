...
public class ImageMemoryBarrier extends Struct {
    ...
    public static ImageMemoryBarrier allocate() {
        ...
        ImageMemoryBarrier newInstance = new ImageMemoryBarrier(segment.address());
     ...
     */
    protected ImageMemoryBarrier(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageMemoryBarrier> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ImageMemoryBarrier(input);
}
