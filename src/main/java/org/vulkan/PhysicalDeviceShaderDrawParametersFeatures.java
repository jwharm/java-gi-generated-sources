...
public class PhysicalDeviceShaderDrawParametersFeatures extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkPhysicalDeviceShaderDrawParametersFeatures";
    ...
    /**
     * Allocate a new {@link PhysicalDeviceShaderDrawParametersFeatures}
     ...
     */
    @ApiStatus.Internal
    public PhysicalDeviceShaderDrawParametersFeatures(Addressable address, Ownership ownership) {
