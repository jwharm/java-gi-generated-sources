...
public class PhysicalDeviceInlineUniformBlockPropertiesEXT extends Struct {
    ...
    public static PhysicalDeviceInlineUniformBlockPropertiesEXT allocate() {
        ...
        PhysicalDeviceInlineUniformBlockPropertiesEXT newInstance = new PhysicalDeviceInlineUniformBlockPropertiesEXT(segment.address());
     ...
     */
    protected PhysicalDeviceInlineUniformBlockPropertiesEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceInlineUniformBlockPropertiesEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceInlineUniformBlockPropertiesEXT(input);
}
