...
public class ClearColorValue extends Struct {
    ...
    public static ClearColorValue allocate() {
        ...
        ClearColorValue newInstance = new ClearColorValue(segment.address(), Ownership.NONE);
     ...
     */
    protected ClearColorValue(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ClearColorValue> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ClearColorValue(input, ownership);
}
