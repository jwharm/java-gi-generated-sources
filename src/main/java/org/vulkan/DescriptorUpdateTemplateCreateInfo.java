...
public class DescriptorUpdateTemplateCreateInfo extends Struct {
     ...
     */
    protected DescriptorUpdateTemplateCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorUpdateTemplateCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorUpdateTemplateCreateInfo(input, ownership);
}
