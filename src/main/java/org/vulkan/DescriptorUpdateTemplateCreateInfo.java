...
public class DescriptorUpdateTemplateCreateInfo extends Struct {
    ...
    public static DescriptorUpdateTemplateCreateInfo allocate() {
        ...
        DescriptorUpdateTemplateCreateInfo newInstance = new DescriptorUpdateTemplateCreateInfo(segment.address());
     ...
     */
    protected DescriptorUpdateTemplateCreateInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorUpdateTemplateCreateInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorUpdateTemplateCreateInfo(input);
}
