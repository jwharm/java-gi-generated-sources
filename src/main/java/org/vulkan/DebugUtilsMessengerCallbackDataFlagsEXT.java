...
public class DebugUtilsMessengerCallbackDataFlagsEXT extends Struct {
     ...
     */
    protected DebugUtilsMessengerCallbackDataFlagsEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DebugUtilsMessengerCallbackDataFlagsEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DebugUtilsMessengerCallbackDataFlagsEXT(input, ownership);
}
