...
public class PhysicalDevicePCIBusInfoPropertiesEXT extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkPhysicalDevicePCIBusInfoPropertiesEXT";
    ...
    /**
     * Allocate a new {@link PhysicalDevicePCIBusInfoPropertiesEXT}
     ...
     */
    @ApiStatus.Internal
    public PhysicalDevicePCIBusInfoPropertiesEXT(Addressable address, Ownership ownership) {
