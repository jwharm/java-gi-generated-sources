...
public class PointClippingBehaviorKHR extends Struct {
    ...
    public static PointClippingBehaviorKHR allocate() {
        ...
        PointClippingBehaviorKHR newInstance = new PointClippingBehaviorKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected PointClippingBehaviorKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PointClippingBehaviorKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PointClippingBehaviorKHR(input, ownership);
}
