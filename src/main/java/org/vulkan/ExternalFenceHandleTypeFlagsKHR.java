...
public class ExternalFenceHandleTypeFlagsKHR extends Struct {
     ...
     */
    protected ExternalFenceHandleTypeFlagsKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalFenceHandleTypeFlagsKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalFenceHandleTypeFlagsKHR(input, ownership);
}
