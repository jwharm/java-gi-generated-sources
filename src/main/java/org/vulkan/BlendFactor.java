...
public class BlendFactor extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkBlendFactor";
    ...
    /**
     * Allocate a new {@link BlendFactor}
     ...
     */
    @ApiStatus.Internal
    public BlendFactor(Addressable address, Ownership ownership) {
