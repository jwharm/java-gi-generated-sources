...
public class ImageFormatProperties extends Struct {
     ...
     */
    protected ImageFormatProperties(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageFormatProperties> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageFormatProperties(input, ownership);
}
