...
public class ImageFormatProperties extends Struct {
    ...
    public static ImageFormatProperties allocate() {
        ...
        ImageFormatProperties newInstance = new ImageFormatProperties(segment.address());
     ...
     */
    protected ImageFormatProperties(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageFormatProperties> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ImageFormatProperties(input);
}
