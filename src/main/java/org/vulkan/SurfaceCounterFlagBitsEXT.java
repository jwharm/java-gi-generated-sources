...
public class SurfaceCounterFlagBitsEXT extends Struct {
     ...
     */
    protected SurfaceCounterFlagBitsEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SurfaceCounterFlagBitsEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SurfaceCounterFlagBitsEXT(input, ownership);
}
