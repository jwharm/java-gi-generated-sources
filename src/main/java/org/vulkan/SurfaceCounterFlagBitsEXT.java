...
public class SurfaceCounterFlagBitsEXT extends Struct {
    ...
    public static SurfaceCounterFlagBitsEXT allocate() {
        ...
        SurfaceCounterFlagBitsEXT newInstance = new SurfaceCounterFlagBitsEXT(segment.address());
     ...
     */
    protected SurfaceCounterFlagBitsEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SurfaceCounterFlagBitsEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SurfaceCounterFlagBitsEXT(input);
}
