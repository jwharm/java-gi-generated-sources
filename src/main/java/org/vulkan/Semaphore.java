...
public class Semaphore extends Struct {
     ...
     */
    protected Semaphore(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, Semaphore> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new Semaphore(input, ownership);
}
