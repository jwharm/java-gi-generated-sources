...
public class ImportMemoryFdInfoKHR extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkImportMemoryFdInfoKHR";
    ...
    /**
     * Allocate a new {@link ImportMemoryFdInfoKHR}
     ...
     */
    @ApiStatus.Internal
    public ImportMemoryFdInfoKHR(Addressable address, Ownership ownership) {
