...
public class ExternalMemoryPropertiesKHR extends Struct {
     ...
     */
    protected ExternalMemoryPropertiesKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryPropertiesKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryPropertiesKHR(input, ownership);
}
