...
public class ExternalMemoryPropertiesKHR extends Struct {
    ...
    public static ExternalMemoryPropertiesKHR allocate() {
        ...
        ExternalMemoryPropertiesKHR newInstance = new ExternalMemoryPropertiesKHR(segment.address());
     ...
     */
    protected ExternalMemoryPropertiesKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryPropertiesKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryPropertiesKHR(input);
}
