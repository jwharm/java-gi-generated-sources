...
public class ValidationCacheEXT extends Struct {
    ...
    public static ValidationCacheEXT allocate() {
        ...
        ValidationCacheEXT newInstance = new ValidationCacheEXT(segment.address());
     ...
     */
    protected ValidationCacheEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ValidationCacheEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ValidationCacheEXT(input);
}
