...
public class RenderPassInputAttachmentAspectCreateInfoKHR extends Struct {
    ...
    public static RenderPassInputAttachmentAspectCreateInfoKHR allocate() {
        ...
        RenderPassInputAttachmentAspectCreateInfoKHR newInstance = new RenderPassInputAttachmentAspectCreateInfoKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected RenderPassInputAttachmentAspectCreateInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RenderPassInputAttachmentAspectCreateInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RenderPassInputAttachmentAspectCreateInfoKHR(input, ownership);
}
