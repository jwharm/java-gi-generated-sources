...
public class SparseBufferMemoryBindInfo extends Struct {
    ...
    public static SparseBufferMemoryBindInfo allocate() {
        ...
        SparseBufferMemoryBindInfo newInstance = new SparseBufferMemoryBindInfo(segment.address());
     ...
     */
    protected SparseBufferMemoryBindInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SparseBufferMemoryBindInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SparseBufferMemoryBindInfo(input);
}
