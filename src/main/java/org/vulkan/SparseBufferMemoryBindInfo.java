...
public class SparseBufferMemoryBindInfo extends Struct {
     ...
     */
    protected SparseBufferMemoryBindInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SparseBufferMemoryBindInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SparseBufferMemoryBindInfo(input, ownership);
}
