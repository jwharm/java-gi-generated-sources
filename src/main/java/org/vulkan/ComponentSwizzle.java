...
public class ComponentSwizzle extends Struct {
    ...
    public static ComponentSwizzle allocate() {
        ...
        ComponentSwizzle newInstance = new ComponentSwizzle(segment.address(), Ownership.NONE);
     ...
     */
    protected ComponentSwizzle(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ComponentSwizzle> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ComponentSwizzle(input, ownership);
}
