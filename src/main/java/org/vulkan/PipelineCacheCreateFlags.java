...
public class PipelineCacheCreateFlags extends Struct {
    ...
    public static PipelineCacheCreateFlags allocate() {
        ...
        PipelineCacheCreateFlags newInstance = new PipelineCacheCreateFlags(segment.address());
     ...
     */
    protected PipelineCacheCreateFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineCacheCreateFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineCacheCreateFlags(input);
}
