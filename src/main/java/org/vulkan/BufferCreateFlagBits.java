...
public class BufferCreateFlagBits extends Struct {
     ...
     */
    protected BufferCreateFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferCreateFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BufferCreateFlagBits(input, ownership);
}
