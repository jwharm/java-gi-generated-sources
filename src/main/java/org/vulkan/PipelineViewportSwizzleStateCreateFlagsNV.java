...
public class PipelineViewportSwizzleStateCreateFlagsNV extends Struct {
    ...
    public static PipelineViewportSwizzleStateCreateFlagsNV allocate() {
        ...
        PipelineViewportSwizzleStateCreateFlagsNV newInstance = new PipelineViewportSwizzleStateCreateFlagsNV(segment.address());
     ...
     */
    protected PipelineViewportSwizzleStateCreateFlagsNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineViewportSwizzleStateCreateFlagsNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineViewportSwizzleStateCreateFlagsNV(input);
}
