...
public class QueryResultFlagBits extends Struct {
    ...
    public static QueryResultFlagBits allocate() {
        ...
        QueryResultFlagBits newInstance = new QueryResultFlagBits(segment.address(), Ownership.NONE);
     ...
     */
    protected QueryResultFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, QueryResultFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new QueryResultFlagBits(input, ownership);
}
