...
public class AccessFlagBits extends Struct {
     ...
     */
    protected AccessFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AccessFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AccessFlagBits(input, ownership);
}
