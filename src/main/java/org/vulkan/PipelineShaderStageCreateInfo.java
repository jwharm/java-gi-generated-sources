...
public class PipelineShaderStageCreateInfo extends Struct {
    ...
    public static PipelineShaderStageCreateInfo allocate() {
        ...
        PipelineShaderStageCreateInfo newInstance = new PipelineShaderStageCreateInfo(segment.address());
     ...
     */
    protected PipelineShaderStageCreateInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineShaderStageCreateInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineShaderStageCreateInfo(input);
}
