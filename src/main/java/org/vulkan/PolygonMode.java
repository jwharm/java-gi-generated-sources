...
public class PolygonMode extends Struct {
    ...
    public static PolygonMode allocate() {
        ...
        PolygonMode newInstance = new PolygonMode(segment.address());
     ...
     */
    protected PolygonMode(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PolygonMode> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PolygonMode(input);
}
