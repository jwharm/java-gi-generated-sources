...
public class SubpassDescription2KHR extends Struct {
     ...
     */
    protected SubpassDescription2KHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SubpassDescription2KHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SubpassDescription2KHR(input, ownership);
}
