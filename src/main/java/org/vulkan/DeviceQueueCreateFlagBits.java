...
public class DeviceQueueCreateFlagBits extends Struct {
    ...
    public static DeviceQueueCreateFlagBits allocate() {
        ...
        DeviceQueueCreateFlagBits newInstance = new DeviceQueueCreateFlagBits(segment.address());
     ...
     */
    protected DeviceQueueCreateFlagBits(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceQueueCreateFlagBits> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DeviceQueueCreateFlagBits(input);
}
