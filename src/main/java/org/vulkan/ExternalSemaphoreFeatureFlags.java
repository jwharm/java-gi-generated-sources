...
public class ExternalSemaphoreFeatureFlags extends Struct {
     ...
     */
    protected ExternalSemaphoreFeatureFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalSemaphoreFeatureFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalSemaphoreFeatureFlags(input, ownership);
}
