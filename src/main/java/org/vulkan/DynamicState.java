...
public class DynamicState extends Struct {
     ...
     */
    protected DynamicState(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DynamicState> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DynamicState(input, ownership);
}
