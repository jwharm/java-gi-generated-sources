...
public class SubpassBeginInfoKHR extends Struct {
    ...
    public static SubpassBeginInfoKHR allocate() {
        ...
        SubpassBeginInfoKHR newInstance = new SubpassBeginInfoKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected SubpassBeginInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SubpassBeginInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SubpassBeginInfoKHR(input, ownership);
}
