...
public class ValidationCheckEXT extends Struct {
     ...
     */
    protected ValidationCheckEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ValidationCheckEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ValidationCheckEXT(input, ownership);
}
