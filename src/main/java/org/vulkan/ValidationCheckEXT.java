...
public class ValidationCheckEXT extends Struct {
    ...
    public static ValidationCheckEXT allocate() {
        ...
        ValidationCheckEXT newInstance = new ValidationCheckEXT(segment.address());
     ...
     */
    protected ValidationCheckEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ValidationCheckEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ValidationCheckEXT(input);
}
