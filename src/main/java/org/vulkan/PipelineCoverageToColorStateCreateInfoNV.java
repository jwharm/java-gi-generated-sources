...
public class PipelineCoverageToColorStateCreateInfoNV extends Struct {
     ...
     */
    protected PipelineCoverageToColorStateCreateInfoNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineCoverageToColorStateCreateInfoNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineCoverageToColorStateCreateInfoNV(input, ownership);
}
