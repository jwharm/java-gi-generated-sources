...
public class PhysicalDeviceExternalFenceInfo extends Struct {
    ...
    public static PhysicalDeviceExternalFenceInfo allocate() {
        ...
        PhysicalDeviceExternalFenceInfo newInstance = new PhysicalDeviceExternalFenceInfo(segment.address());
     ...
     */
    protected PhysicalDeviceExternalFenceInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceExternalFenceInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceExternalFenceInfo(input);
}
