...
public class SampleLocationEXT extends Struct {
     ...
     */
    protected SampleLocationEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SampleLocationEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SampleLocationEXT(input, ownership);
}
