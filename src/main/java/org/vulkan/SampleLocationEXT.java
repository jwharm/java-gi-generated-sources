...
public class SampleLocationEXT extends Struct {
    ...
    public static SampleLocationEXT allocate() {
        ...
        SampleLocationEXT newInstance = new SampleLocationEXT(segment.address());
     ...
     */
    protected SampleLocationEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SampleLocationEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SampleLocationEXT(input);
}
