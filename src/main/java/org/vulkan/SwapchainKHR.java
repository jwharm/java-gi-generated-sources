...
public class SwapchainKHR extends Struct {
     ...
     */
    protected SwapchainKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SwapchainKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SwapchainKHR(input, ownership);
}
