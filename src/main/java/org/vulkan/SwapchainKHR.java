...
public class SwapchainKHR extends Struct {
    ...
    public static SwapchainKHR allocate() {
        ...
        SwapchainKHR newInstance = new SwapchainKHR(segment.address());
     ...
     */
    protected SwapchainKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SwapchainKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SwapchainKHR(input);
}
