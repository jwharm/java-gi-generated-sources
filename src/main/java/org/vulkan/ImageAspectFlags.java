...
public class ImageAspectFlags extends Struct {
    ...
    public static ImageAspectFlags allocate() {
        ...
        ImageAspectFlags newInstance = new ImageAspectFlags(segment.address());
     ...
     */
    protected ImageAspectFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageAspectFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ImageAspectFlags(input);
}
