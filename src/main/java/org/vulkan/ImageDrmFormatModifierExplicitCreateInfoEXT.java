...
public class ImageDrmFormatModifierExplicitCreateInfoEXT extends Struct {
     ...
     */
    protected ImageDrmFormatModifierExplicitCreateInfoEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageDrmFormatModifierExplicitCreateInfoEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageDrmFormatModifierExplicitCreateInfoEXT(input, ownership);
}
