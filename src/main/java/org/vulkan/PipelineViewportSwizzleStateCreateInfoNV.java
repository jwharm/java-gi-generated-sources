...
public class PipelineViewportSwizzleStateCreateInfoNV extends Struct {
    ...
    public static PipelineViewportSwizzleStateCreateInfoNV allocate() {
        ...
        PipelineViewportSwizzleStateCreateInfoNV newInstance = new PipelineViewportSwizzleStateCreateInfoNV(segment.address(), Ownership.NONE);
     ...
     */
    protected PipelineViewportSwizzleStateCreateInfoNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineViewportSwizzleStateCreateInfoNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineViewportSwizzleStateCreateInfoNV(input, ownership);
}
