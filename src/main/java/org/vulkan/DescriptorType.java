...
public class DescriptorType extends Struct {
     ...
     */
    protected DescriptorType(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorType> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorType(input, ownership);
}
