...
public class DrawMeshTasksIndirectCommandNV extends Struct {
    ...
    public static DrawMeshTasksIndirectCommandNV allocate() {
        ...
        DrawMeshTasksIndirectCommandNV newInstance = new DrawMeshTasksIndirectCommandNV(segment.address(), Ownership.NONE);
     ...
     */
    protected DrawMeshTasksIndirectCommandNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DrawMeshTasksIndirectCommandNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DrawMeshTasksIndirectCommandNV(input, ownership);
}
