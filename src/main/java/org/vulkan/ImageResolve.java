...
public class ImageResolve extends Struct {
    ...
    public static ImageResolve allocate() {
        ...
        ImageResolve newInstance = new ImageResolve(segment.address());
     ...
     */
    protected ImageResolve(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageResolve> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ImageResolve(input);
}
