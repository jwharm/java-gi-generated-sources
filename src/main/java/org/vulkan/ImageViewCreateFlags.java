...
public class ImageViewCreateFlags extends Struct {
    ...
    public static ImageViewCreateFlags allocate() {
        ...
        ImageViewCreateFlags newInstance = new ImageViewCreateFlags(segment.address(), Ownership.NONE);
     ...
     */
    protected ImageViewCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageViewCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageViewCreateFlags(input, ownership);
}
