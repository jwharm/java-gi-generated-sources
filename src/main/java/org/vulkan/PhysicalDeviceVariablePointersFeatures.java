...
public class PhysicalDeviceVariablePointersFeatures extends Struct {
    ...
    public static PhysicalDeviceVariablePointersFeatures allocate() {
        ...
        PhysicalDeviceVariablePointersFeatures newInstance = new PhysicalDeviceVariablePointersFeatures(segment.address(), Ownership.NONE);
     ...
     */
    protected PhysicalDeviceVariablePointersFeatures(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceVariablePointersFeatures> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceVariablePointersFeatures(input, ownership);
}
