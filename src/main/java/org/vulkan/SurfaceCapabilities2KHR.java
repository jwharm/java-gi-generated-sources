...
public class SurfaceCapabilities2KHR extends Struct {
     ...
     */
    protected SurfaceCapabilities2KHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SurfaceCapabilities2KHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SurfaceCapabilities2KHR(input, ownership);
}
