...
public class PipelineRasterizationStateRasterizationOrderAMD extends Struct {
     ...
     */
    protected PipelineRasterizationStateRasterizationOrderAMD(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineRasterizationStateRasterizationOrderAMD> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineRasterizationStateRasterizationOrderAMD(input, ownership);
}
