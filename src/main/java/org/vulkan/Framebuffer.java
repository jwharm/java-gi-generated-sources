...
public class Framebuffer extends Struct {
    ...
    public static Framebuffer allocate() {
        ...
        Framebuffer newInstance = new Framebuffer(segment.address());
     ...
     */
    protected Framebuffer(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, Framebuffer> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new Framebuffer(input);
}
