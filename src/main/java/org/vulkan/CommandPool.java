...
public class CommandPool extends Struct {
    ...
    public static CommandPool allocate() {
        ...
        CommandPool newInstance = new CommandPool(segment.address());
     ...
     */
    protected CommandPool(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CommandPool> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CommandPool(input);
}
