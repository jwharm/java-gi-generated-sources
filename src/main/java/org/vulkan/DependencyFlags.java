...
public class DependencyFlags extends Struct {
     ...
     */
    protected DependencyFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DependencyFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DependencyFlags(input, ownership);
}
