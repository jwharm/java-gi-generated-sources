...
public class PhysicalDeviceLimits extends Struct {
    ...
    public static PhysicalDeviceLimits allocate() {
        ...
        PhysicalDeviceLimits newInstance = new PhysicalDeviceLimits(segment.address());
     ...
     */
    protected PhysicalDeviceLimits(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceLimits> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceLimits(input);
}
