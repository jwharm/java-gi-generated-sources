...
public class PhysicalDeviceFragmentDensityMapFeaturesEXT extends Struct {
    ...
    public static PhysicalDeviceFragmentDensityMapFeaturesEXT allocate() {
        ...
        PhysicalDeviceFragmentDensityMapFeaturesEXT newInstance = new PhysicalDeviceFragmentDensityMapFeaturesEXT(segment.address());
     ...
     */
    protected PhysicalDeviceFragmentDensityMapFeaturesEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceFragmentDensityMapFeaturesEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceFragmentDensityMapFeaturesEXT(input);
}
