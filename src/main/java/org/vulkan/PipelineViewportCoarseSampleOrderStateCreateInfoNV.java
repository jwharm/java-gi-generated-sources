...
public class PipelineViewportCoarseSampleOrderStateCreateInfoNV extends Struct {
    ...
    public static PipelineViewportCoarseSampleOrderStateCreateInfoNV allocate() {
        ...
        PipelineViewportCoarseSampleOrderStateCreateInfoNV newInstance = new PipelineViewportCoarseSampleOrderStateCreateInfoNV(segment.address());
     ...
     */
    protected PipelineViewportCoarseSampleOrderStateCreateInfoNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineViewportCoarseSampleOrderStateCreateInfoNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineViewportCoarseSampleOrderStateCreateInfoNV(input);
}
