...
public class SemaphoreImportFlagBits extends Struct {
    ...
    public static SemaphoreImportFlagBits allocate() {
        ...
        SemaphoreImportFlagBits newInstance = new SemaphoreImportFlagBits(segment.address());
     ...
     */
    protected SemaphoreImportFlagBits(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SemaphoreImportFlagBits> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SemaphoreImportFlagBits(input);
}
