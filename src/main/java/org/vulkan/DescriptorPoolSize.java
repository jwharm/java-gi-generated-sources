...
public class DescriptorPoolSize extends Struct {
     ...
     */
    protected DescriptorPoolSize(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorPoolSize> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorPoolSize(input, ownership);
}
