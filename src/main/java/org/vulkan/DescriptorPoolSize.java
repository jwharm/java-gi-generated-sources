...
public class DescriptorPoolSize extends Struct {
    ...
    public static DescriptorPoolSize allocate() {
        ...
        DescriptorPoolSize newInstance = new DescriptorPoolSize(segment.address());
     ...
     */
    protected DescriptorPoolSize(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorPoolSize> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorPoolSize(input);
}
