...
public class DispatchIndirectCommand extends Struct {
    ...
    public static DispatchIndirectCommand allocate() {
        ...
        DispatchIndirectCommand newInstance = new DispatchIndirectCommand(segment.address());
     ...
     */
    protected DispatchIndirectCommand(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DispatchIndirectCommand> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DispatchIndirectCommand(input);
}
