...
public class MemoryPropertyFlagBits extends Struct {
     ...
     */
    protected MemoryPropertyFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryPropertyFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MemoryPropertyFlagBits(input, ownership);
}
