...
public class MemoryPropertyFlagBits extends Struct {
    ...
    public static MemoryPropertyFlagBits allocate() {
        ...
        MemoryPropertyFlagBits newInstance = new MemoryPropertyFlagBits(segment.address());
     ...
     */
    protected MemoryPropertyFlagBits(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryPropertyFlagBits> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MemoryPropertyFlagBits(input);
}
