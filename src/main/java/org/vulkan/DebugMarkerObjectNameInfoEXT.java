...
public class DebugMarkerObjectNameInfoEXT extends Struct {
     ...
     */
    protected DebugMarkerObjectNameInfoEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DebugMarkerObjectNameInfoEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DebugMarkerObjectNameInfoEXT(input, ownership);
}
