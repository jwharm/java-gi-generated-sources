...
public class DescriptorSetLayout extends Struct {
    ...
    public static DescriptorSetLayout allocate() {
        ...
        DescriptorSetLayout newInstance = new DescriptorSetLayout(segment.address(), Ownership.NONE);
     ...
     */
    protected DescriptorSetLayout(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorSetLayout> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorSetLayout(input, ownership);
}
