...
public class CullModeFlagBits extends Struct {
    ...
    public static CullModeFlagBits allocate() {
        ...
        CullModeFlagBits newInstance = new CullModeFlagBits(segment.address());
     ...
     */
    protected CullModeFlagBits(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CullModeFlagBits> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CullModeFlagBits(input);
}
