...
public class CullModeFlagBits extends Struct {
     ...
     */
    protected CullModeFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CullModeFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CullModeFlagBits(input, ownership);
}
