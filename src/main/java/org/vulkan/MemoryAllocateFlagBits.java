...
public class MemoryAllocateFlagBits extends Struct {
    ...
    public static MemoryAllocateFlagBits allocate() {
        ...
        MemoryAllocateFlagBits newInstance = new MemoryAllocateFlagBits(segment.address(), Ownership.NONE);
     ...
     */
    protected MemoryAllocateFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryAllocateFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MemoryAllocateFlagBits(input, ownership);
}
