...
public class QueryType extends Struct {
    ...
    public static QueryType allocate() {
        ...
        QueryType newInstance = new QueryType(segment.address());
     ...
     */
    protected QueryType(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, QueryType> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new QueryType(input);
}
