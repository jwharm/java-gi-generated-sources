...
public class ImageFormatListCreateInfoKHR extends Struct {
    ...
    public static ImageFormatListCreateInfoKHR allocate() {
        ...
        ImageFormatListCreateInfoKHR newInstance = new ImageFormatListCreateInfoKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected ImageFormatListCreateInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageFormatListCreateInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageFormatListCreateInfoKHR(input, ownership);
}
