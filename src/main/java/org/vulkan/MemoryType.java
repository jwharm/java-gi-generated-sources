...
public class MemoryType extends Struct {
    ...
    public static MemoryType allocate() {
        ...
        MemoryType newInstance = new MemoryType(segment.address());
     ...
     */
    protected MemoryType(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryType> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MemoryType(input);
}
