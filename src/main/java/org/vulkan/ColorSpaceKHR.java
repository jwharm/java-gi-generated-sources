...
public class ColorSpaceKHR extends Struct {
    ...
    public static ColorSpaceKHR allocate() {
        ...
        ColorSpaceKHR newInstance = new ColorSpaceKHR(segment.address());
     ...
     */
    protected ColorSpaceKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ColorSpaceKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ColorSpaceKHR(input);
}
