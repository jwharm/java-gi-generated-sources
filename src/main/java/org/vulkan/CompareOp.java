...
public class CompareOp extends Struct {
    ...
    public static CompareOp allocate() {
        ...
        CompareOp newInstance = new CompareOp(segment.address());
     ...
     */
    protected CompareOp(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CompareOp> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CompareOp(input);
}
