...
public class DeviceGroupPresentModeFlagsKHR extends Struct {
    ...
    public static DeviceGroupPresentModeFlagsKHR allocate() {
        ...
        DeviceGroupPresentModeFlagsKHR newInstance = new DeviceGroupPresentModeFlagsKHR(segment.address());
     ...
     */
    protected DeviceGroupPresentModeFlagsKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceGroupPresentModeFlagsKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DeviceGroupPresentModeFlagsKHR(input);
}
