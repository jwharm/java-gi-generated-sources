...
public class SurfaceCounterFlagsEXT extends Struct {
    ...
    public static SurfaceCounterFlagsEXT allocate() {
        ...
        SurfaceCounterFlagsEXT newInstance = new SurfaceCounterFlagsEXT(segment.address(), Ownership.NONE);
     ...
     */
    protected SurfaceCounterFlagsEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SurfaceCounterFlagsEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SurfaceCounterFlagsEXT(input, ownership);
}
