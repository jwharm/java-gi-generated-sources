...
public class SemaphoreImportFlagsKHR extends Struct {
    ...
    public static SemaphoreImportFlagsKHR allocate() {
        ...
        SemaphoreImportFlagsKHR newInstance = new SemaphoreImportFlagsKHR(segment.address());
     ...
     */
    protected SemaphoreImportFlagsKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SemaphoreImportFlagsKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SemaphoreImportFlagsKHR(input);
}
