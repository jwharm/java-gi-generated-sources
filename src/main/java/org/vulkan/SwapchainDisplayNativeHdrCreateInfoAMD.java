...
public class SwapchainDisplayNativeHdrCreateInfoAMD extends Struct {
    ...
    public static SwapchainDisplayNativeHdrCreateInfoAMD allocate() {
        ...
        SwapchainDisplayNativeHdrCreateInfoAMD newInstance = new SwapchainDisplayNativeHdrCreateInfoAMD(segment.address());
     ...
     */
    protected SwapchainDisplayNativeHdrCreateInfoAMD(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SwapchainDisplayNativeHdrCreateInfoAMD> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SwapchainDisplayNativeHdrCreateInfoAMD(input);
}
