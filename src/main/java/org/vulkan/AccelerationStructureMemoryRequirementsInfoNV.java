...
public class AccelerationStructureMemoryRequirementsInfoNV extends Struct {
    ...
    public static AccelerationStructureMemoryRequirementsInfoNV allocate() {
        ...
        AccelerationStructureMemoryRequirementsInfoNV newInstance = new AccelerationStructureMemoryRequirementsInfoNV(segment.address(), Ownership.NONE);
     ...
     */
    protected AccelerationStructureMemoryRequirementsInfoNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AccelerationStructureMemoryRequirementsInfoNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AccelerationStructureMemoryRequirementsInfoNV(input, ownership);
}
