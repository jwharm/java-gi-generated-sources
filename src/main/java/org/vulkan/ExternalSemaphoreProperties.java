...
public class ExternalSemaphoreProperties extends Struct {
     ...
     */
    protected ExternalSemaphoreProperties(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalSemaphoreProperties> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalSemaphoreProperties(input, ownership);
}
