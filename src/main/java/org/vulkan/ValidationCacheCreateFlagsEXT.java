...
public class ValidationCacheCreateFlagsEXT extends Struct {
     ...
     */
    protected ValidationCacheCreateFlagsEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ValidationCacheCreateFlagsEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ValidationCacheCreateFlagsEXT(input, ownership);
}
