...
public class ExternalMemoryHandleTypeFlags extends Struct {
     ...
     */
    protected ExternalMemoryHandleTypeFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryHandleTypeFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryHandleTypeFlags(input, ownership);
}
