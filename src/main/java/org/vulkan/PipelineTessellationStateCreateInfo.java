...
public class PipelineTessellationStateCreateInfo extends Struct {
    ...
    public static PipelineTessellationStateCreateInfo allocate() {
        ...
        PipelineTessellationStateCreateInfo newInstance = new PipelineTessellationStateCreateInfo(segment.address(), Ownership.NONE);
     ...
     */
    protected PipelineTessellationStateCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineTessellationStateCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineTessellationStateCreateInfo(input, ownership);
}
