...
public class ShaderModuleCreateFlags extends Struct {
    ...
    public static ShaderModuleCreateFlags allocate() {
        ...
        ShaderModuleCreateFlags newInstance = new ShaderModuleCreateFlags(segment.address(), Ownership.NONE);
     ...
     */
    protected ShaderModuleCreateFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShaderModuleCreateFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ShaderModuleCreateFlags(input, ownership);
}
