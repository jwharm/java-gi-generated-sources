...
public class MemoryHeapFlagBits extends Struct {
    ...
    public static MemoryHeapFlagBits allocate() {
        ...
        MemoryHeapFlagBits newInstance = new MemoryHeapFlagBits(segment.address(), Ownership.NONE);
     ...
     */
    protected MemoryHeapFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryHeapFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MemoryHeapFlagBits(input, ownership);
}
