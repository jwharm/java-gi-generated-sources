...
public class IndirectCommandsTokenTypeNVX extends Struct {
     ...
     */
    protected IndirectCommandsTokenTypeNVX(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, IndirectCommandsTokenTypeNVX> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new IndirectCommandsTokenTypeNVX(input, ownership);
}
