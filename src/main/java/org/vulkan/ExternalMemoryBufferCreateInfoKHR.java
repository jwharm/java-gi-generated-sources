...
public class ExternalMemoryBufferCreateInfoKHR extends Struct {
    ...
    public static ExternalMemoryBufferCreateInfoKHR allocate() {
        ...
        ExternalMemoryBufferCreateInfoKHR newInstance = new ExternalMemoryBufferCreateInfoKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected ExternalMemoryBufferCreateInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryBufferCreateInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryBufferCreateInfoKHR(input, ownership);
}
