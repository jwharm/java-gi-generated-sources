...
public class SurfaceCapabilitiesKHR extends Struct {
    ...
    public static SurfaceCapabilitiesKHR allocate() {
        ...
        SurfaceCapabilitiesKHR newInstance = new SurfaceCapabilitiesKHR(segment.address());
     ...
     */
    protected SurfaceCapabilitiesKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SurfaceCapabilitiesKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SurfaceCapabilitiesKHR(input);
}
