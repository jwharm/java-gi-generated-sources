...
public class RenderPassCreateInfo extends Struct {
    ...
    public static RenderPassCreateInfo allocate() {
        ...
        RenderPassCreateInfo newInstance = new RenderPassCreateInfo(segment.address());
     ...
     */
    protected RenderPassCreateInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, RenderPassCreateInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new RenderPassCreateInfo(input);
}
