...
public class RenderPassCreateInfo extends Struct {
     ...
     */
    protected RenderPassCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RenderPassCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RenderPassCreateInfo(input, ownership);
}
