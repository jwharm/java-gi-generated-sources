...
public class PhysicalDeviceDescriptorIndexingFeaturesEXT extends Struct {
    ...
    public static PhysicalDeviceDescriptorIndexingFeaturesEXT allocate() {
        ...
        PhysicalDeviceDescriptorIndexingFeaturesEXT newInstance = new PhysicalDeviceDescriptorIndexingFeaturesEXT(segment.address());
     ...
     */
    protected PhysicalDeviceDescriptorIndexingFeaturesEXT(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceDescriptorIndexingFeaturesEXT> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceDescriptorIndexingFeaturesEXT(input);
}
