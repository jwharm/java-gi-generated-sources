...
public class ObjectTableCreateInfoNVX extends Struct {
    ...
    public static ObjectTableCreateInfoNVX allocate() {
        ...
        ObjectTableCreateInfoNVX newInstance = new ObjectTableCreateInfoNVX(segment.address());
     ...
     */
    protected ObjectTableCreateInfoNVX(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ObjectTableCreateInfoNVX> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ObjectTableCreateInfoNVX(input);
}
