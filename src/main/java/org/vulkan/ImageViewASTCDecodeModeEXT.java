...
public class ImageViewASTCDecodeModeEXT extends Struct {
    ...
    public static ImageViewASTCDecodeModeEXT allocate() {
        ...
        ImageViewASTCDecodeModeEXT newInstance = new ImageViewASTCDecodeModeEXT(segment.address(), Ownership.NONE);
     ...
     */
    protected ImageViewASTCDecodeModeEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ImageViewASTCDecodeModeEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ImageViewASTCDecodeModeEXT(input, ownership);
}
