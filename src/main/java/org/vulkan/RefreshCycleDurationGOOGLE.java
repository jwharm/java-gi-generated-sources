...
public class RefreshCycleDurationGOOGLE extends Struct {
    ...
    public static RefreshCycleDurationGOOGLE allocate() {
        ...
        RefreshCycleDurationGOOGLE newInstance = new RefreshCycleDurationGOOGLE(segment.address(), Ownership.NONE);
     ...
     */
    protected RefreshCycleDurationGOOGLE(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RefreshCycleDurationGOOGLE> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RefreshCycleDurationGOOGLE(input, ownership);
}
