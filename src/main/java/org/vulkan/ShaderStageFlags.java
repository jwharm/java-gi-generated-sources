...
public class ShaderStageFlags extends Struct {
    ...
    public static ShaderStageFlags allocate() {
        ...
        ShaderStageFlags newInstance = new ShaderStageFlags(segment.address());
     ...
     */
    protected ShaderStageFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShaderStageFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ShaderStageFlags(input);
}
