...
public class ShaderStageFlags extends Struct {
     ...
     */
    protected ShaderStageFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShaderStageFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ShaderStageFlags(input, ownership);
}
