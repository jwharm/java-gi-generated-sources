...
public class PhysicalDeviceMeshShaderPropertiesNV extends Struct {
     ...
     */
    protected PhysicalDeviceMeshShaderPropertiesNV(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceMeshShaderPropertiesNV> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceMeshShaderPropertiesNV(input, ownership);
}
