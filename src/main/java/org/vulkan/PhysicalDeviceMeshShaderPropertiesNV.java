...
public class PhysicalDeviceMeshShaderPropertiesNV extends Struct {
    ...
    public static PhysicalDeviceMeshShaderPropertiesNV allocate() {
        ...
        PhysicalDeviceMeshShaderPropertiesNV newInstance = new PhysicalDeviceMeshShaderPropertiesNV(segment.address());
     ...
     */
    protected PhysicalDeviceMeshShaderPropertiesNV(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceMeshShaderPropertiesNV> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceMeshShaderPropertiesNV(input);
}
