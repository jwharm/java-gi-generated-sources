...
public class ValidationFeaturesEXT extends Struct {
     ...
     */
    protected ValidationFeaturesEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ValidationFeaturesEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ValidationFeaturesEXT(input, ownership);
}
