...
public class ExportFenceCreateInfoKHR extends Struct {
    ...
    public static ExportFenceCreateInfoKHR allocate() {
        ...
        ExportFenceCreateInfoKHR newInstance = new ExportFenceCreateInfoKHR(segment.address(), Ownership.NONE);
     ...
     */
    protected ExportFenceCreateInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExportFenceCreateInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExportFenceCreateInfoKHR(input, ownership);
}
