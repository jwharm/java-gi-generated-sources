...
public class ExternalMemoryHandleTypeFlagBits extends Struct {
    ...
    public static ExternalMemoryHandleTypeFlagBits allocate() {
        ...
        ExternalMemoryHandleTypeFlagBits newInstance = new ExternalMemoryHandleTypeFlagBits(segment.address(), Ownership.NONE);
     ...
     */
    protected ExternalMemoryHandleTypeFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryHandleTypeFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryHandleTypeFlagBits(input, ownership);
}
