...
public class FramebufferCreateInfo extends Struct {
    
    static {
        Vulkan.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "VkFramebufferCreateInfo";
    ...
    /**
     * Allocate a new {@link FramebufferCreateInfo}
     ...
     */
    @ApiStatus.Internal
    public FramebufferCreateInfo(Addressable address, Ownership ownership) {
