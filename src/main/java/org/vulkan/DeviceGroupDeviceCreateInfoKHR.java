...
public class DeviceGroupDeviceCreateInfoKHR extends Struct {
    ...
    public static DeviceGroupDeviceCreateInfoKHR allocate() {
        ...
        DeviceGroupDeviceCreateInfoKHR newInstance = new DeviceGroupDeviceCreateInfoKHR(segment.address());
     ...
     */
    protected DeviceGroupDeviceCreateInfoKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceGroupDeviceCreateInfoKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DeviceGroupDeviceCreateInfoKHR(input);
}
