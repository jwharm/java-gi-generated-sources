...
public class DeviceGroupDeviceCreateInfoKHR extends Struct {
     ...
     */
    protected DeviceGroupDeviceCreateInfoKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceGroupDeviceCreateInfoKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DeviceGroupDeviceCreateInfoKHR(input, ownership);
}
