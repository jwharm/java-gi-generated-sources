...
public class ExternalFencePropertiesKHR extends Struct {
     ...
     */
    protected ExternalFencePropertiesKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalFencePropertiesKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExternalFencePropertiesKHR(input, ownership);
}
