...
public class SpecializationInfo extends Struct {
    ...
    public static SpecializationInfo allocate() {
        ...
        SpecializationInfo newInstance = new SpecializationInfo(segment.address(), Ownership.NONE);
     ...
     */
    protected SpecializationInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SpecializationInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SpecializationInfo(input, ownership);
}
