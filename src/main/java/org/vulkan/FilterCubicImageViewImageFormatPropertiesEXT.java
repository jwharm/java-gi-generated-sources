...
public class FilterCubicImageViewImageFormatPropertiesEXT extends Struct {
     ...
     */
    protected FilterCubicImageViewImageFormatPropertiesEXT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, FilterCubicImageViewImageFormatPropertiesEXT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new FilterCubicImageViewImageFormatPropertiesEXT(input, ownership);
}
