...
public class PhysicalDeviceShaderDrawParameterFeatures extends Struct {
    ...
    public static PhysicalDeviceShaderDrawParameterFeatures allocate() {
        ...
        PhysicalDeviceShaderDrawParameterFeatures newInstance = new PhysicalDeviceShaderDrawParameterFeatures(segment.address());
     ...
     */
    protected PhysicalDeviceShaderDrawParameterFeatures(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceShaderDrawParameterFeatures> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceShaderDrawParameterFeatures(input);
}
