...
public class DisplayModePropertiesKHR extends Struct {
     ...
     */
    protected DisplayModePropertiesKHR(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DisplayModePropertiesKHR> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DisplayModePropertiesKHR(input, ownership);
}
