...
public class BindBufferMemoryDeviceGroupInfo extends Struct {
    ...
    public static BindBufferMemoryDeviceGroupInfo allocate() {
        ...
        BindBufferMemoryDeviceGroupInfo newInstance = new BindBufferMemoryDeviceGroupInfo(segment.address());
     ...
     */
    protected BindBufferMemoryDeviceGroupInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BindBufferMemoryDeviceGroupInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BindBufferMemoryDeviceGroupInfo(input);
}
