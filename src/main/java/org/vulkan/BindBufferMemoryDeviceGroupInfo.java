...
public class BindBufferMemoryDeviceGroupInfo extends Struct {
     ...
     */
    protected BindBufferMemoryDeviceGroupInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BindBufferMemoryDeviceGroupInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BindBufferMemoryDeviceGroupInfo(input, ownership);
}
