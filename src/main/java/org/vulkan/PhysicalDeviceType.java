...
public class PhysicalDeviceType extends Struct {
    ...
    public static PhysicalDeviceType allocate() {
        ...
        PhysicalDeviceType newInstance = new PhysicalDeviceType(segment.address(), Ownership.NONE);
     ...
     */
    protected PhysicalDeviceType(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PhysicalDeviceType> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PhysicalDeviceType(input, ownership);
}
