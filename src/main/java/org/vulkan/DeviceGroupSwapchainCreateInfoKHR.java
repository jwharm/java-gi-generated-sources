...
public class DeviceGroupSwapchainCreateInfoKHR extends Struct {
    ...
    public static DeviceGroupSwapchainCreateInfoKHR allocate() {
        ...
        DeviceGroupSwapchainCreateInfoKHR newInstance = new DeviceGroupSwapchainCreateInfoKHR(segment.address());
     ...
     */
    protected DeviceGroupSwapchainCreateInfoKHR(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceGroupSwapchainCreateInfoKHR> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DeviceGroupSwapchainCreateInfoKHR(input);
}
