...
public class CommandBufferResetFlags extends Struct {
    ...
    public static CommandBufferResetFlags allocate() {
        ...
        CommandBufferResetFlags newInstance = new CommandBufferResetFlags(segment.address(), Ownership.NONE);
     ...
     */
    protected CommandBufferResetFlags(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CommandBufferResetFlags> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CommandBufferResetFlags(input, ownership);
}
