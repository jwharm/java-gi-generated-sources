...
public class ExternalMemoryFeatureFlags extends Struct {
    ...
    public static ExternalMemoryFeatureFlags allocate() {
        ...
        ExternalMemoryFeatureFlags newInstance = new ExternalMemoryFeatureFlags(segment.address());
     ...
     */
    protected ExternalMemoryFeatureFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExternalMemoryFeatureFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ExternalMemoryFeatureFlags(input);
}
