...
public class DescriptorSetLayoutSupport extends Struct {
    ...
    public static DescriptorSetLayoutSupport allocate() {
        ...
        DescriptorSetLayoutSupport newInstance = new DescriptorSetLayoutSupport(segment.address(), Ownership.NONE);
     ...
     */
    protected DescriptorSetLayoutSupport(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DescriptorSetLayoutSupport> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DescriptorSetLayoutSupport(input, ownership);
}
