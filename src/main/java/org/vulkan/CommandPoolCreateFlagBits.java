...
public class CommandPoolCreateFlagBits extends Struct {
    ...
    public static CommandPoolCreateFlagBits allocate() {
        ...
        CommandPoolCreateFlagBits newInstance = new CommandPoolCreateFlagBits(segment.address());
     ...
     */
    protected CommandPoolCreateFlagBits(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CommandPoolCreateFlagBits> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CommandPoolCreateFlagBits(input);
}
