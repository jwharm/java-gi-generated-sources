...
public class CommandPoolCreateFlagBits extends Struct {
     ...
     */
    protected CommandPoolCreateFlagBits(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CommandPoolCreateFlagBits> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CommandPoolCreateFlagBits(input, ownership);
}
