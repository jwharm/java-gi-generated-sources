...
public class CmdProcessCommandsInfoNVX extends Struct {
    ...
    public static CmdProcessCommandsInfoNVX allocate() {
        ...
        CmdProcessCommandsInfoNVX newInstance = new CmdProcessCommandsInfoNVX(segment.address());
     ...
     */
    protected CmdProcessCommandsInfoNVX(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CmdProcessCommandsInfoNVX> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CmdProcessCommandsInfoNVX(input);
}
