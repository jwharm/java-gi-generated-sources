...
public class BufferCreateFlags extends Struct {
    ...
    public static BufferCreateFlags allocate() {
        ...
        BufferCreateFlags newInstance = new BufferCreateFlags(segment.address());
     ...
     */
    protected BufferCreateFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferCreateFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BufferCreateFlags(input);
}
