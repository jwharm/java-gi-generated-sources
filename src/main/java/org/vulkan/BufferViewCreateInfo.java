...
public class BufferViewCreateInfo extends Struct {
    ...
    public static BufferViewCreateInfo allocate() {
        ...
        BufferViewCreateInfo newInstance = new BufferViewCreateInfo(segment.address());
     ...
     */
    protected BufferViewCreateInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferViewCreateInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BufferViewCreateInfo(input);
}
