...
public class BufferViewCreateInfo extends Struct {
     ...
     */
    protected BufferViewCreateInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferViewCreateInfo> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BufferViewCreateInfo(input, ownership);
}
