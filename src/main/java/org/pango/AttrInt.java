...
public class AttrInt extends Struct {
    ...
    public static AttrInt allocate() {
        ...
        AttrInt newInstance = new AttrInt(segment.address());
     ...
     */
    protected AttrInt(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, AttrInt> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new AttrInt(input);
