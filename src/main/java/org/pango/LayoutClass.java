...
public class LayoutClass extends Struct {
    ...
    public static LayoutClass allocate() {
        ...
        LayoutClass newInstance = new LayoutClass(segment.address());
     ...
     */
    protected LayoutClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, LayoutClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new LayoutClass(input);
}
