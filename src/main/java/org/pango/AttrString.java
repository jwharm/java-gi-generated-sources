...
public class AttrString extends Struct {
    ...
    public static AttrString allocate() {
        ...
        AttrString newInstance = new AttrString(segment.address());
     ...
     */
    protected AttrString(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, AttrString> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new AttrString(input);
