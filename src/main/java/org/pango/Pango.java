...
public static org.pango.Attribute attrAllowBreaksNew(boolean allowBreaks) {
    ...
    try {
        RESULT = (MemoryAddress) DowncallHandles.pango_attr_allow_breaks_new.invokeExact(Marshal.booleanToInteger.marshal(allowBreaks, null).intValue());
    } catch (Throwable ERR) {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.pango_attr_break.invokeExact(
                    ...
                    attrList.handle(),
                    offset,
                    Interop.allocateNativeArray(attrs, org.pango.LogAttr.getMemoryLayout(), false, SCOPE),
                    attrsLen);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static org.pango.Attribute attrFallbackNew(boolean enableFallback) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.pango_attr_fallback_new.invokeExact(Marshal.booleanToInteger.marshal(enableFallback, null).intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    var OBJECT = org.pango.Attribute.fromAddress.marshal(RESULT, null);
...
public static org.pango.Attribute attrFamilyNew(java.lang.String family) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.pango_attr_family_new.invokeExact(Marshal.stringToAddress.marshal(family, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        var OBJECT = org.pango.Attribute.fromAddress.marshal(RESULT, null);
...
public static org.pango.Attribute attrInsertHyphensNew(boolean insertHyphens) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.pango_attr_insert_hyphens_new.invokeExact(Marshal.booleanToInteger.marshal(insertHyphens, null).intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    var OBJECT = org.pango.Attribute.fromAddress.marshal(RESULT, null);
...
public static org.pango.Attribute attrStrikethroughNew(boolean strikethrough) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.pango_attr_strikethrough_new.invokeExact(Marshal.booleanToInteger.marshal(strikethrough, null).intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    var OBJECT = org.pango.Attribute.fromAddress.marshal(RESULT, null);
...
public static void findParagraphBoundary(java.lang.String text, int length, Out<Integer> paragraphDelimiterIndex, Out<Integer> nextParagraphStart) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment paragraphDelimiterIndexPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment nextParagraphStartPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        try {
...
public static org.pango.FontDescription fontDescriptionFromString(java.lang.String str) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.pango_font_description_from_string.invokeExact(Marshal.stringToAddress.marshal(str, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static boolean markupParserFinish(org.gtk.glib.MarkupParseContext context, @Nullable Out<org.pango.AttrList> attrList, @Nullable Out<java.lang.String> text, Out<Integer> accelChar) throws io.github.jwharm.javagi.GErrorException {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment attrListPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        ...
        if (GErrorException.isErrorSet(GERROR)) {
            throw new GErrorException(GERROR);
                ...
                if (attrList != null) attrList.set(org.pango.AttrList.fromAddress.marshal(attrListPOINTER.get(Interop.valueLayout.ADDRESS, 0), null));
...
public static org.gtk.glib.MarkupParseContext markupParserNew(int accelMarker) {
    ...
    return org.gtk.glib.MarkupParseContext.fromAddress.marshal(RESULT, null);
}
...
public static boolean parseEnum(org.gtk.glib.Type type, @Nullable java.lang.String str, Out<Integer> value, boolean warn, @Nullable Out<java.lang.String> possibleValues) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        MemorySegment possibleValuesPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.pango_parse_markup.invokeExact(
                    Marshal.stringToAddress.marshal(markupText, SCOPE),
                    length,
                    accelMarker,
                    (Addressable) (attrList == null ? MemoryAddress.NULL : (Addressable) attrListPOINTER.address()),
                    (Addressable) (text == null ? MemoryAddress.NULL : (Addressable) textPOINTER.address()),
...
public static boolean parseStretch(java.lang.String str, Out<org.pango.Stretch> stretch, boolean warn) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment stretchPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static boolean parseStyle(java.lang.String str, Out<org.pango.Style> style, boolean warn) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment stylePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static boolean parseVariant(java.lang.String str, Out<org.pango.Variant> variant, boolean warn) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment variantPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static boolean parseWeight(java.lang.String str, Out<org.pango.Weight> weight, boolean warn) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment weightPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static void quantizeLineGeometry(Out<Integer> thickness, Out<Integer> position) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment thicknessPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
...
public static boolean scanInt(Out<java.lang.String> pos, Out<Integer> out) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment posPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        MemorySegment outPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.pango_shape_full.invokeExact(
                    Marshal.stringToAddress.marshal(itemText, SCOPE),
                    itemLength,
                    (Addressable) (paragraphText == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(paragraphText, SCOPE)),
                    paragraphLength,
                    analysis.handle(),
                    glyphs.handle());
        } catch (Throwable ERR) {
...
public static PointerString splitFileList(java.lang.String str) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.pango_split_file_list.invokeExact(Marshal.stringToAddress.marshal(str, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static @Nullable org.pango.TabArray tabArrayFromString(java.lang.String text) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.pango_tab_array_from_string.invokeExact(Marshal.stringToAddress.marshal(text, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static java.lang.String trimString(java.lang.String str) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.pango_trim_string.invokeExact(Marshal.stringToAddress.marshal(str, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
private static final MethodHandle pango_version_string = Interop.downcallHandle(
    ...
    private static void registerTypes() {
        if (Context.isAvailable()) Interop.register(Context.getType(), Context.fromAddress);
        if (Coverage.isAvailable()) Interop.register(Coverage.getType(), Coverage.fromAddress);
        if (Font.isAvailable()) Interop.register(Font.getType(), Font.fromAddress);
        if (FontFace.isAvailable()) Interop.register(FontFace.getType(), FontFace.fromAddress);
        if (FontFamily.isAvailable()) Interop.register(FontFamily.getType(), FontFamily.fromAddress);
        if (FontMap.isAvailable()) Interop.register(FontMap.getType(), FontMap.fromAddress);
        if (Fontset.isAvailable()) Interop.register(Fontset.getType(), Fontset.fromAddress);
        if (FontsetSimple.isAvailable()) Interop.register(FontsetSimple.getType(), FontsetSimple.fromAddress);
        if (Layout.isAvailable()) Interop.register(Layout.getType(), Layout.fromAddress);
