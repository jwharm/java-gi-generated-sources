...
public class PreferencesWindowClass extends Struct {
     ...
     */
    protected PreferencesWindowClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PreferencesWindowClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PreferencesWindowClass(input, ownership);
