...
public class AboutWindowClass extends Struct {
    ...
    public static AboutWindowClass allocate() {
        ...
        AboutWindowClass newInstance = new AboutWindowClass(segment.address());
     ...
     */
    protected AboutWindowClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, AboutWindowClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new AboutWindowClass(input);
