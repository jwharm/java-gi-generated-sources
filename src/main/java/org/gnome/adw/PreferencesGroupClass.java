...
public class PreferencesGroupClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static PreferencesGroupClass allocate() {
        ...
        PreferencesGroupClass newInstance = new PreferencesGroupClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public PreferencesGroupClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
