...
public class PreferencesGroupClass extends Struct {
    ...
    public static PreferencesGroupClass allocate() {
        ...
        PreferencesGroupClass newInstance = new PreferencesGroupClass(segment.address());
     ...
     */
    protected PreferencesGroupClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PreferencesGroupClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PreferencesGroupClass(input);
