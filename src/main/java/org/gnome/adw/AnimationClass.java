...
public class AnimationClass extends Struct {
     ...
     */
    protected AnimationClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AnimationClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AnimationClass(input, ownership);
}
