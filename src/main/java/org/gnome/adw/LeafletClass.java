...
public class LeafletClass extends Struct {
     ...
     */
    protected LeafletClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, LeafletClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new LeafletClass(input, ownership);
