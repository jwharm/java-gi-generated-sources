...
public class ComboRowClass extends Struct {
    ...
    public static ComboRowClass allocate() {
        ...
        ComboRowClass newInstance = new ComboRowClass(segment.address());
    ...
    public org.gnome.adw.ActionRowClass getParentClass() {
        ...
        return org.gnome.adw.ActionRowClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected ComboRowClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ComboRowClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ComboRowClass(input);
