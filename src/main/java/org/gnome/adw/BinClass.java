...
public class BinClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    private static final java.lang.String C_TYPE_NAME = "AdwBinClass";
    ...
    public static BinClass allocate() {
        ...
        BinClass newInstance = new BinClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public BinClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
