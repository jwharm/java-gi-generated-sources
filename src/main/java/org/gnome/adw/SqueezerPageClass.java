...
public class SqueezerPageClass extends Struct {
    ...
    public static SqueezerPageClass allocate() {
        ...
        SqueezerPageClass newInstance = new SqueezerPageClass(segment.address());
     ...
     */
    protected SqueezerPageClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SqueezerPageClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SqueezerPageClass(input);
