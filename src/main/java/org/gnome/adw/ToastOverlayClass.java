...
public class ToastOverlayClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public ToastOverlayClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private ToastOverlayClass struct;
        
         /**
         * A {@link ToastOverlayClass.Build} object constructs a {@link ToastOverlayClass} 
         ...
         */
        public ToastOverlayClass construct() {
            return struct;
        }
