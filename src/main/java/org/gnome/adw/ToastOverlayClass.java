...
public class ToastOverlayClass extends Struct {
    ...
    public static ToastOverlayClass allocate() {
        ...
        ToastOverlayClass newInstance = new ToastOverlayClass(segment.address());
     ...
     */
    protected ToastOverlayClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ToastOverlayClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ToastOverlayClass(input);
