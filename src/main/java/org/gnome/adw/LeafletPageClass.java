...
public class LeafletPageClass extends Struct {
    ...
    public static LeafletPageClass allocate() {
        ...
        LeafletPageClass newInstance = new LeafletPageClass(segment.address());
     ...
     */
    protected LeafletPageClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, LeafletPageClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new LeafletPageClass(input);
