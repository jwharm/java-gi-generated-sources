...
public class PreferencesPageClass extends Struct {
    ...
    public static PreferencesPageClass allocate() {
        ...
        PreferencesPageClass newInstance = new PreferencesPageClass(segment.address());
     ...
     */
    protected PreferencesPageClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PreferencesPageClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PreferencesPageClass(input);
