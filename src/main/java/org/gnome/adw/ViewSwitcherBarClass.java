...
public class ViewSwitcherBarClass extends Struct {
    ...
    public static ViewSwitcherBarClass allocate() {
        ...
        ViewSwitcherBarClass newInstance = new ViewSwitcherBarClass(segment.address());
     ...
     */
    protected ViewSwitcherBarClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ViewSwitcherBarClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ViewSwitcherBarClass(input);
