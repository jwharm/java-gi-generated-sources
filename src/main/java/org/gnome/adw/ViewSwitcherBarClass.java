...
public class ViewSwitcherBarClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public ViewSwitcherBarClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private ViewSwitcherBarClass struct;
        
         /**
         * A {@link ViewSwitcherBarClass.Build} object constructs a {@link ViewSwitcherBarClass} 
         ...
         */
        public ViewSwitcherBarClass construct() {
            return struct;
        }
