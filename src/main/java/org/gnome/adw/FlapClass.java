...
public class FlapClass extends Struct {
    ...
    public static FlapClass allocate() {
        ...
        FlapClass newInstance = new FlapClass(segment.address());
     ...
     */
    protected FlapClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FlapClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FlapClass(input);
