...
public class HeaderBarClass extends Struct {
    ...
    public static HeaderBarClass allocate() {
        ...
        HeaderBarClass newInstance = new HeaderBarClass(segment.address());
     ...
     */
    protected HeaderBarClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, HeaderBarClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new HeaderBarClass(input);
