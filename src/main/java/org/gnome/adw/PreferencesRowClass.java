...
public class PreferencesRowClass extends Struct {
    ...
    public org.gtk.gtk.ListBoxRowClass getParentClass() {
        ...
        return org.gtk.gtk.ListBoxRowClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), Ownership.UNKNOWN);
    }
     ...
     */
    protected PreferencesRowClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PreferencesRowClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PreferencesRowClass(input, ownership);
