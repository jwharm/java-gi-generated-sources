...
public class EntryRowClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static EntryRowClass allocate() {
        ...
        EntryRowClass newInstance = new EntryRowClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public EntryRowClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
