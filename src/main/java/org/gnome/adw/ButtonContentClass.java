...
public class ButtonContentClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static ButtonContentClass allocate() {
        ...
        ButtonContentClass newInstance = new ButtonContentClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public ButtonContentClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
