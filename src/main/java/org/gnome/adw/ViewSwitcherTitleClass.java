...
public class ViewSwitcherTitleClass extends Struct {
    ...
    public static ViewSwitcherTitleClass allocate() {
        ...
        ViewSwitcherTitleClass newInstance = new ViewSwitcherTitleClass(segment.address());
     ...
     */
    protected ViewSwitcherTitleClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ViewSwitcherTitleClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ViewSwitcherTitleClass(input);
