...
public class ViewSwitcherTitleClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static ViewSwitcherTitleClass allocate() {
        ...
        ViewSwitcherTitleClass newInstance = new ViewSwitcherTitleClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public ViewSwitcherTitleClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
