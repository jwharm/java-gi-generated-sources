...
public class ViewSwitcherTitleClass extends Struct {
     ...
     */
    protected ViewSwitcherTitleClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ViewSwitcherTitleClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ViewSwitcherTitleClass(input, ownership);
    
    /**
     * A {@link ViewSwitcherTitleClass.Builder} object constructs a {@link ViewSwitcherTitleClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link ViewSwitcherTitleClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final ViewSwitcherTitleClass struct;
         ...
         */
        public ViewSwitcherTitleClass build() {
            return struct;
        }
