...
public class EnumListModelClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public EnumListModelClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private EnumListModelClass struct;
        
         /**
         * A {@link EnumListModelClass.Build} object constructs a {@link EnumListModelClass} 
         ...
         */
        public EnumListModelClass construct() {
            return struct;
        }
