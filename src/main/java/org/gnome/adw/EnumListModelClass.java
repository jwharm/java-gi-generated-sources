...
public class EnumListModelClass extends Struct {
    ...
    public static EnumListModelClass allocate() {
        ...
        EnumListModelClass newInstance = new EnumListModelClass(segment.address());
     ...
     */
    protected EnumListModelClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, EnumListModelClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new EnumListModelClass(input);
