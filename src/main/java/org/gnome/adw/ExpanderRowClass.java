...
public class ExpanderRowClass extends Struct {
     ...
     */
    protected ExpanderRowClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ExpanderRowClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ExpanderRowClass(input, ownership);
