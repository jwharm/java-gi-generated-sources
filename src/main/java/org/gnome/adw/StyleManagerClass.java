...
public class StyleManagerClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public StyleManagerClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private StyleManagerClass struct;
        
         /**
         * A {@link StyleManagerClass.Build} object constructs a {@link StyleManagerClass} 
         ...
         */
        public StyleManagerClass construct() {
            return struct;
        }
