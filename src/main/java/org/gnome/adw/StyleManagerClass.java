...
public class StyleManagerClass extends Struct {
    ...
    public static StyleManagerClass allocate() {
        ...
        StyleManagerClass newInstance = new StyleManagerClass(segment.address());
     ...
     */
    protected StyleManagerClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, StyleManagerClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new StyleManagerClass(input);
