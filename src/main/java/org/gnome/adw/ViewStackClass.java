...
public class ViewStackClass extends Struct {
    ...
    public static ViewStackClass allocate() {
        ...
        ViewStackClass newInstance = new ViewStackClass(segment.address(), Ownership.NONE);
     ...
     */
    @ApiStatus.Internal
    public ViewStackClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private ViewStackClass struct;
        
         /**
         * A {@link ViewStackClass.Build} object constructs a {@link ViewStackClass} 
         ...
         */
        public ViewStackClass construct() {
            return struct;
        }
