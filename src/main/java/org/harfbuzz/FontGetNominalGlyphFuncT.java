 ...
 */
/**
 * Functional interface declaration of the {@code FontGetNominalGlyphFuncT} callback.
 */
@FunctionalInterface
public interface FontGetNominalGlyphFuncT {
    ...
    @ApiStatus.Internal default int upcall(MemoryAddress font, MemoryAddress fontData, int unicode, MemoryAddress glyph, MemoryAddress userData) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            ...
            var RESULT = run(org.harfbuzz.FontT.fromAddress.marshal(font, null), fontData, new org.harfbuzz.CodepointT(unicode), glyphALIAS, userData);
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), FontGetNominalGlyphFuncT.class, DESCRIPTOR);
