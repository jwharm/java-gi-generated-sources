...
public static int aatLayoutFeatureTypeGetSelectorInfos(org.harfbuzz.FaceT face, org.harfbuzz.AatLayoutFeatureTypeT featureType, int startOffset, Out<Integer> selectorCount, @Nullable Out<org.harfbuzz.AatLayoutFeatureSelectorInfoT[]> selectors, Out<Integer> defaultIndex) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment selectorCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment selectorsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        MemorySegment defaultIndexPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
        ...
        for (int I = 0; I < selectorCount.get().intValue(); I++) {
            ...
            selectorsARRAY[I] = org.harfbuzz.AatLayoutFeatureSelectorInfoT.fromAddress.marshal(OBJ, null);
            }
...
public static int aatLayoutGetFeatureTypes(org.harfbuzz.FaceT face, int startOffset, Out<Integer> featureCount, Out<org.harfbuzz.AatLayoutFeatureTypeT[]> features) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment featureCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
...
public static org.harfbuzz.BlobT blobCopyWritableOrFail(org.harfbuzz.BlobT blob) {
    ...
    var OBJECT = org.harfbuzz.BlobT.fromAddress.marshal(RESULT, null);
...
public static org.harfbuzz.BlobT blobCreateFromFile(java.lang.String fileName) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.hb_blob_create_from_file.invokeExact(Marshal.stringToAddress.marshal(fileName, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        var OBJECT = org.harfbuzz.BlobT.fromAddress.marshal(RESULT, null);
...
public static org.harfbuzz.BlobT blobCreateFromFileOrFail(java.lang.String fileName) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.hb_blob_create_from_file_or_fail.invokeExact(Marshal.stringToAddress.marshal(fileName, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        var OBJECT = org.harfbuzz.BlobT.fromAddress.marshal(RESULT, null);
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.hb_buffer_add_codepoints.invokeExact(
                    buffer.handle(),
                    Interop.allocateNativeArray(org.harfbuzz.CodepointT.getIntegerValues(text), false, SCOPE),
                    textLength,
                    itemOffset,
                    itemLength);
        } catch (Throwable ERR) {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.hb_buffer_add_latin1.invokeExact(
                    buffer.handle(),
                    Interop.allocateNativeArray(text, false, SCOPE),
                    textLength,
                    itemOffset,
                    itemLength);
        } catch (Throwable ERR) {
...
public static org.harfbuzz.BufferT bufferCreate() {
    ...
    var OBJECT = org.harfbuzz.BufferT.fromAddress.marshal(RESULT, null);
    OBJECT.takeOwnership();
    return OBJECT;
}
...
public static org.harfbuzz.GlyphInfoT[] bufferGetGlyphInfos(org.harfbuzz.BufferT buffer, Out<Integer> length) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        for (int I = 0; I < length.get().intValue(); I++) {
            var OBJ = RESULT.get(Interop.valueLayout.ADDRESS, I);
            resultARRAY[I] = org.harfbuzz.GlyphInfoT.fromAddress.marshal(OBJ, null);
        }
        return resultARRAY;
    }
}
...
public static org.harfbuzz.GlyphPositionT[] bufferGetGlyphPositions(org.harfbuzz.BufferT buffer, Out<Integer> length) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        for (int I = 0; I < length.get().intValue(); I++) {
            var OBJ = RESULT.get(Interop.valueLayout.ADDRESS, I);
            resultARRAY[I] = org.harfbuzz.GlyphPositionT.fromAddress.marshal(OBJ, null);
        }
        return resultARRAY;
    }
}
...
public static org.harfbuzz.LanguageT bufferGetLanguage(org.harfbuzz.BufferT buffer) {
    ...
    return org.harfbuzz.LanguageT.fromAddress.marshal(RESULT, null);
}
...
public static org.harfbuzz.UnicodeFuncsT bufferGetUnicodeFuncs(org.harfbuzz.BufferT buffer) {
    ...
    var OBJECT = org.harfbuzz.UnicodeFuncsT.fromAddress.marshal(RESULT, null);
    OBJECT.takeOwnership();
    return OBJECT;
}
...
public static int bufferSerialize(org.harfbuzz.BufferT buffer, int start, int end, Out<byte[]> buf, int bufSize, Out<Integer> bufConsumed, @Nullable org.harfbuzz.FontT font, org.harfbuzz.BufferSerializeFormatT format, org.harfbuzz.BufferSerializeFlagsT flags) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        MemorySegment bufConsumedPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
        ...
        buf.set(MemorySegment.ofAddress(bufPOINTER.get(Interop.valueLayout.ADDRESS, 0), bufSize * Interop.valueLayout.C_BYTE.byteSize(), SCOPE).toArray(Interop.valueLayout.C_BYTE));
        return RESULT;
    }
}
...
public static byte colorGetAlpha(org.harfbuzz.ColorT color) {
    byte RESULT;
    try {
        RESULT = (byte) DowncallHandles.hb_color_get_alpha.invokeExact(color.getValue().intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static byte colorGetBlue(org.harfbuzz.ColorT color) {
    byte RESULT;
    try {
        RESULT = (byte) DowncallHandles.hb_color_get_blue.invokeExact(color.getValue().intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static byte colorGetGreen(org.harfbuzz.ColorT color) {
    byte RESULT;
    try {
        RESULT = (byte) DowncallHandles.hb_color_get_green.invokeExact(color.getValue().intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static byte colorGetRed(org.harfbuzz.ColorT color) {
    byte RESULT;
    try {
        RESULT = (byte) DowncallHandles.hb_color_get_red.invokeExact(color.getValue().intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static org.harfbuzz.DrawFuncsT drawFuncsCreate() {
    ...
    var OBJECT = org.harfbuzz.DrawFuncsT.fromAddress.marshal(RESULT, null);
    OBJECT.takeOwnership();
    return OBJECT;
}
...
public static org.harfbuzz.FaceT faceBuilderCreate() {
    ...
    var OBJECT = org.harfbuzz.FaceT.fromAddress.marshal(RESULT, null);
    OBJECT.takeOwnership();
    return OBJECT;
}
...
public static int faceGetTableTags(org.harfbuzz.FaceT face, int startOffset, Out<Integer> tableCount, Out<org.harfbuzz.TagT[]> tableTags) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment tableCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment tableTagsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
...
public static void fontChanged(org.harfbuzz.FontT font) {
    try {
        DowncallHandles.hb_font_changed.invokeExact(font.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
}
...
public static org.harfbuzz.FontT fontCreate(org.harfbuzz.FaceT face) {
    ...
    var OBJECT = org.harfbuzz.FontT.fromAddress.marshal(RESULT, null);
    OBJECT.takeOwnership();
    return OBJECT;
}
...
public static org.harfbuzz.FontFuncsT fontFuncsCreate() {
    ...
    var OBJECT = org.harfbuzz.FontFuncsT.fromAddress.marshal(RESULT, null);
    OBJECT.takeOwnership();
    return OBJECT;
}
...
public static org.harfbuzz.FaceT fontGetFace(org.harfbuzz.FontT font) {
    ...
    return org.harfbuzz.FaceT.fromAddress.marshal(RESULT, null);
}
...
public static org.harfbuzz.BoolT fontGetGlyph(org.harfbuzz.FontT font, org.harfbuzz.CodepointT unicode, org.harfbuzz.CodepointT variationSelector, org.harfbuzz.CodepointT glyph) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment glyphPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static void fontGetGlyphAdvancesForDirection(org.harfbuzz.FontT font, org.harfbuzz.DirectionT direction, int count, org.harfbuzz.CodepointT firstGlyph, int glyphStride, org.harfbuzz.PositionT firstAdvance, int advanceStride) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment firstGlyphPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment firstAdvancePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        try {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.hb_font_get_glyph_from_name.invokeExact(
                    font.handle(),
                    Interop.allocateNativeArray(name, false, SCOPE),
                    len,
                    (Addressable) glyphPOINTER.address());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
...
public static int fontGetNominalGlyphs(org.harfbuzz.FontT font, int count, org.harfbuzz.CodepointT firstUnicode, int unicodeStride, org.harfbuzz.CodepointT firstGlyph, int glyphStride) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment firstUnicodePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment firstGlyphPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static void fontGetPpem(org.harfbuzz.FontT font, Out<Integer> xPpem, Out<Integer> yPpem) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment xPpemPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment yPpemPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        try {
...
public static void fontGetScale(org.harfbuzz.FontT font, Out<Integer> xScale, Out<Integer> yScale) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment xScalePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment yScalePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        try {
...
public static int fontGetSerial(org.harfbuzz.FontT font) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.hb_font_get_serial.invokeExact(font.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.hb_font_glyph_from_string.invokeExact(
                    font.handle(),
                    Interop.allocateNativeArray(s, false, SCOPE),
                    len,
                    (Addressable) glyphPOINTER.address());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
...
public static void fontGlyphToString(org.harfbuzz.FontT font, org.harfbuzz.CodepointT glyph, Out<java.lang.String[]> s, int size) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment sPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        try {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.hb_font_set_var_coords_design.invokeExact(
                    font.handle(),
                    Interop.allocateNativeArray(coords, false, SCOPE),
                    coordsLength);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.hb_font_set_variations.invokeExact(
                    font.handle(),
                    Interop.allocateNativeArray(variations, org.harfbuzz.VariationT.getMemoryLayout(), false, SCOPE),
                    variationsLength);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static org.harfbuzz.FaceT ftFaceCreateCached(org.freetype.Face ftFace) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_ft_face_create_cached.invokeExact(ftFace.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    var OBJECT = org.harfbuzz.FaceT.fromAddress.marshal(RESULT, null);
...
public static org.harfbuzz.FaceT ftFaceCreateReferenced(org.freetype.Face ftFace) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_ft_face_create_referenced.invokeExact(ftFace.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    var OBJECT = org.harfbuzz.FaceT.fromAddress.marshal(RESULT, null);
...
public static org.harfbuzz.FontT ftFontCreateReferenced(org.freetype.Face ftFace) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_ft_font_create_referenced.invokeExact(ftFace.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    var OBJECT = org.harfbuzz.FontT.fromAddress.marshal(RESULT, null);
...
public static @Nullable org.freetype.Face ftFontGetFace(org.harfbuzz.FontT font) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_ft_font_get_face.invokeExact(font.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.freetype.Face.fromAddress.marshal(RESULT, null);
}
...
public static @Nullable org.freetype.Face ftFontLockFace(org.harfbuzz.FontT font) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_ft_font_lock_face.invokeExact(font.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.freetype.Face.fromAddress.marshal(RESULT, null);
...
public static org.harfbuzz.BoolT ftHbFontChanged(org.harfbuzz.FontT font) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.hb_ft_hb_font_changed.invokeExact(font.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return new org.harfbuzz.BoolT(RESULT);
...
public static org.harfbuzz.UnicodeFuncsT glibGetUnicodeFuncs() {
    ...
    return org.harfbuzz.UnicodeFuncsT.fromAddress.marshal(RESULT, null);
}
...
public static java.lang.foreign.MemoryAddress graphite2FaceGetGrFace(org.harfbuzz.FaceT face) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_graphite2_face_get_gr_face.invokeExact(face.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static @Nullable java.lang.foreign.MemoryAddress graphite2FontGetGrFont(org.harfbuzz.FontT font) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_graphite2_font_get_gr_font.invokeExact(font.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static org.harfbuzz.MapT mapCopy(org.harfbuzz.MapT map) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_map_copy.invokeExact(map.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    var OBJECT = org.harfbuzz.MapT.fromAddress.marshal(RESULT, null);
    OBJECT.takeOwnership();
    return OBJECT;
}
...
public static int mapHash(org.harfbuzz.MapT map) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.hb_map_hash.invokeExact(map.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static int otColorGlyphGetLayers(org.harfbuzz.FaceT face, org.harfbuzz.CodepointT glyph, int startOffset, Out<Integer> layerCount, @Nullable Out<org.harfbuzz.OtColorLayerT[]> layers) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment layerCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment layersPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
        ...
        for (int I = 0; I < layerCount.get().intValue(); I++) {
            ...
            layersARRAY[I] = org.harfbuzz.OtColorLayerT.fromAddress.marshal(OBJ, null);
            }
...
public static int otColorPaletteGetColors(org.harfbuzz.FaceT face, int paletteIndex, int startOffset, Out<Integer> colorCount, @Nullable Out<org.harfbuzz.ColorT[]> colors) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment colorCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment colorsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.hb_ot_layout_collect_features.invokeExact(
                    ...
                    (Addressable) (scripts == null ? MemoryAddress.NULL : Interop.allocateNativeArray(org.harfbuzz.TagT.getIntegerValues(scripts), false, SCOPE)),
                    (Addressable) (languages == null ? MemoryAddress.NULL : Interop.allocateNativeArray(org.harfbuzz.TagT.getIntegerValues(languages), false, SCOPE)),
                    (Addressable) (features == null ? MemoryAddress.NULL : Interop.allocateNativeArray(org.harfbuzz.TagT.getIntegerValues(features), false, SCOPE)),
...
public static int otLayoutFeatureGetCharacters(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int featureIndex, int startOffset, Out<Integer> charCount, Out<org.harfbuzz.CodepointT[]> characters) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment charCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment charactersPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
...
public static int otLayoutFeatureGetLookups(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int featureIndex, int startOffset, Out<Integer> lookupCount, Out<int[]> lookupIndexes) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment lookupCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment lookupIndexesPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
        ...
        lookupIndexes.set(MemorySegment.ofAddress(lookupIndexesPOINTER.get(Interop.valueLayout.ADDRESS, 0), lookupCount.get().intValue() * Interop.valueLayout.C_INT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_INT));
        return RESULT;
    }
}
...
public static org.harfbuzz.BoolT otLayoutFeatureGetNameIds(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int featureIndex, @Nullable org.harfbuzz.OtNameIdT labelId, @Nullable org.harfbuzz.OtNameIdT tooltipId, @Nullable org.harfbuzz.OtNameIdT sampleId, Out<Integer> numNamedParameters, @Nullable org.harfbuzz.OtNameIdT firstParamId) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment labelIdPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment tooltipIdPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment sampleIdPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment numNamedParametersPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment firstParamIdPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static int otLayoutGetAttachPoints(org.harfbuzz.FaceT face, org.harfbuzz.CodepointT glyph, int startOffset, Out<Integer> pointCount, Out<int[]> pointArray) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment pointCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment pointArrayPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
        ...
        pointArray.set(MemorySegment.ofAddress(pointArrayPOINTER.get(Interop.valueLayout.ADDRESS, 0), pointCount.get().intValue() * Interop.valueLayout.C_INT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_INT));
        return RESULT;
    }
}
...
public static org.harfbuzz.BoolT otLayoutGetBaseline(org.harfbuzz.FontT font, org.harfbuzz.OtLayoutBaselineTagT baselineTag, org.harfbuzz.DirectionT direction, org.harfbuzz.TagT scriptTag, org.harfbuzz.TagT languageTag, @Nullable org.harfbuzz.PositionT coord) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment coordPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static int otLayoutGetLigatureCarets(org.harfbuzz.FontT font, org.harfbuzz.DirectionT direction, org.harfbuzz.CodepointT glyph, int startOffset, Out<Integer> caretCount, Out<org.harfbuzz.PositionT[]> caretArray) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment caretCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment caretArrayPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
...
public static org.harfbuzz.BoolT otLayoutGetSizeParams(org.harfbuzz.FaceT face, Out<Integer> designSize, Out<Integer> subfamilyId, org.harfbuzz.OtNameIdT subfamilyNameId, Out<Integer> rangeStart, Out<Integer> rangeEnd) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment designSizePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment subfamilyIdPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment subfamilyNameIdPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment rangeStartPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment rangeEndPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static org.harfbuzz.BoolT otLayoutLanguageFindFeature(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int scriptIndex, int languageIndex, org.harfbuzz.TagT featureTag, Out<Integer> featureIndex) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment featureIndexPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static int otLayoutLanguageGetFeatureIndexes(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int scriptIndex, int languageIndex, int startOffset, Out<Integer> featureCount, Out<int[]> featureIndexes) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment featureCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment featureIndexesPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
            ...
            throw new AssertionError("Unexpected exception occured: ", ERR);
                ...
                if (featureCount != null) featureCount.set(featureCountPOINTER.get(Interop.valueLayout.C_INT, 0));
        featureIndexes.set(MemorySegment.ofAddress(featureIndexesPOINTER.get(Interop.valueLayout.ADDRESS, 0), featureCount.get().intValue() * Interop.valueLayout.C_INT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_INT));
        return RESULT;
    }
}
...
public static int otLayoutLanguageGetFeatureTags(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int scriptIndex, int languageIndex, int startOffset, Out<Integer> featureCount, Out<org.harfbuzz.TagT[]> featureTags) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment featureCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment featureTagsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
...
public static org.harfbuzz.BoolT otLayoutLanguageGetRequiredFeature(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int scriptIndex, int languageIndex, Out<Integer> featureIndex, org.harfbuzz.TagT featureTag) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment featureIndexPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment featureTagPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static int otLayoutLookupGetGlyphAlternates(org.harfbuzz.FaceT face, int lookupIndex, org.harfbuzz.CodepointT glyph, int startOffset, Out<Integer> alternateCount, Out<org.harfbuzz.CodepointT[]> alternateGlyphs) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment alternateCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment alternateGlyphsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
...
public static org.harfbuzz.BoolT otLayoutLookupWouldSubstitute(org.harfbuzz.FaceT face, int lookupIndex, org.harfbuzz.CodepointT glyphs, int glyphsLength, org.harfbuzz.BoolT zeroContext) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment glyphsPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static int otLayoutScriptGetLanguageTags(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int scriptIndex, int startOffset, Out<Integer> languageCount, Out<org.harfbuzz.TagT[]> languageTags) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment languageCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment languageTagsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
...
public static org.harfbuzz.BoolT otLayoutScriptSelectLanguage(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int scriptIndex, int languageCount, org.harfbuzz.TagT languageTags, Out<Integer> languageIndex) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment languageTagsPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment languageIndexPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static org.harfbuzz.BoolT otLayoutTableChooseScript(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, org.harfbuzz.TagT scriptTags, Out<Integer> scriptIndex, org.harfbuzz.TagT chosenScript) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment scriptTagsPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment scriptIndexPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment chosenScriptPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static org.harfbuzz.BoolT otLayoutTableFindFeatureVariations(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, PointerInteger coords, int numCoords, Out<Integer> variationsIndex) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment variationsIndexPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static int otLayoutTableGetScriptTags(org.harfbuzz.FaceT face, org.harfbuzz.TagT tableTag, int startOffset, Out<Integer> scriptCount, Out<org.harfbuzz.TagT[]> scriptTags) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment scriptCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment scriptTagsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
...
public static int otMathGetGlyphAssembly(org.harfbuzz.FontT font, org.harfbuzz.CodepointT glyph, org.harfbuzz.DirectionT direction, int startOffset, Out<Integer> partsCount, Out<org.harfbuzz.OtMathGlyphPartT[]> parts, org.harfbuzz.PositionT italicsCorrection) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment partsCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment partsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        MemorySegment italicsCorrectionPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
        ...
        for (int I = 0; I < partsCount.get().intValue(); I++) {
            ...
            partsARRAY[I] = org.harfbuzz.OtMathGlyphPartT.fromAddress.marshal(OBJ, null);
            }
...
public static int otMathGetGlyphKernings(org.harfbuzz.FontT font, org.harfbuzz.CodepointT glyph, org.harfbuzz.OtMathKernT kern, int startOffset, Out<Integer> entriesCount, Out<org.harfbuzz.OtMathKernEntryT[]> kernEntries) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment entriesCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment kernEntriesPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
        ...
        for (int I = 0; I < entriesCount.get().intValue(); I++) {
            ...
            kernEntriesARRAY[I] = org.harfbuzz.OtMathKernEntryT.fromAddress.marshal(OBJ, null);
            }
...
public static int otMathGetGlyphVariants(org.harfbuzz.FontT font, org.harfbuzz.CodepointT glyph, org.harfbuzz.DirectionT direction, int startOffset, Out<Integer> variantsCount, Out<org.harfbuzz.OtMathGlyphVariantT[]> variants) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment variantsCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment variantsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
        ...
        for (int I = 0; I < variantsCount.get().intValue(); I++) {
            ...
            variantsARRAY[I] = org.harfbuzz.OtMathGlyphVariantT.fromAddress.marshal(OBJ, null);
            }
...
public static int otMetaGetEntryTags(org.harfbuzz.FaceT face, int startOffset, Out<Integer> entriesCount, Out<org.harfbuzz.OtMetaTagT[]> entries) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment entriesCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment entriesPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
...
public static int otNameGetUtf16(org.harfbuzz.FaceT face, org.harfbuzz.OtNameIdT nameId, org.harfbuzz.LanguageT language, Out<Integer> textSize, Out<short[]> text) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment textSizePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        ...
        text.set(MemorySegment.ofAddress(textPOINTER.get(Interop.valueLayout.ADDRESS, 0), textSize.get().intValue() * Interop.valueLayout.C_SHORT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_SHORT));
        return RESULT;
    }
}
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            ...
            throw new AssertionError("Unexpected exception occured: ", ERR);
                ...
                if (textSize != null) textSize.set(textSizePOINTER.get(Interop.valueLayout.C_INT, 0));
        text.set(MemorySegment.ofAddress(textPOINTER.get(Interop.valueLayout.ADDRESS, 0), textSize.get().intValue() * Interop.valueLayout.C_INT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_INT));
        return RESULT;
    }
}
...
public static org.harfbuzz.OtNameEntryT[] otNameListNames(org.harfbuzz.FaceT face, Out<Integer> numEntries) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment numEntriesPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemoryAddress RESULT;
        try {
        ...
        for (int I = 0; I < numEntries.get().intValue(); I++) {
            var OBJ = RESULT.get(Interop.valueLayout.ADDRESS, I);
            resultARRAY[I] = org.harfbuzz.OtNameEntryT.fromAddress.marshal(OBJ, null);
        }
        return resultARRAY;
    }
}
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.hb_ot_shape_glyphs_closure.invokeExact(
                    font.handle(),
                    buffer.handle(),
                    Interop.allocateNativeArray(features, org.harfbuzz.FeatureT.getMemoryLayout(), false, SCOPE),
                    numFeatures,
                    glyphs.handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
...
public static @Nullable org.harfbuzz.LanguageT otTagToLanguage(org.harfbuzz.TagT tag) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_ot_tag_to_language.invokeExact(tag.getValue().intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.harfbuzz.LanguageT.fromAddress.marshal(RESULT, null);
...
public static org.harfbuzz.ScriptT otTagToScript(org.harfbuzz.TagT tag) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.hb_ot_tag_to_script.invokeExact(tag.getValue().intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.harfbuzz.ScriptT.of(RESULT);
...
public static void otTagsFromScript(org.harfbuzz.ScriptT script, org.harfbuzz.TagT scriptTag1, org.harfbuzz.TagT scriptTag2) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment scriptTag1POINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment scriptTag2POINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        try {
...
public static int otVarGetAxes(org.harfbuzz.FaceT face, int startOffset, Out<Integer> axesCount, Out<org.harfbuzz.OtVarAxisT[]> axesArray) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment axesCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment axesArrayPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
        ...
        for (int I = 0; I < axesCount.get().intValue(); I++) {
            ...
            axesArrayARRAY[I] = org.harfbuzz.OtVarAxisT.fromAddress.marshal(OBJ, null);
            }
...
public static int otVarGetAxisInfos(org.harfbuzz.FaceT face, int startOffset, Out<Integer> axesCount, Out<org.harfbuzz.OtVarAxisInfoT[]> axesArray) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        for (int I = 0; I < axesCount.get().intValue(); I++) {
            var OBJ = axesArrayPOINTER.get(Interop.valueLayout.ADDRESS, I);
            axesArrayARRAY[I] = org.harfbuzz.OtVarAxisInfoT.fromAddress.marshal(OBJ, null);
            }
        axesArray.set(axesArrayARRAY);
        return RESULT;
    }
...
public static int otVarNamedInstanceGetDesignCoords(org.harfbuzz.FaceT face, int instanceIndex, Out<Integer> coordsLength, Out<float[]> coords) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment coordsLengthPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment coordsPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
        ...
        coords.set(MemorySegment.ofAddress(coordsPOINTER.get(Interop.valueLayout.ADDRESS, 0), coordsLength.get().intValue() * Interop.valueLayout.C_FLOAT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_FLOAT));
        return RESULT;
    }
}
...
public static void otVarNormalizeCoords(org.harfbuzz.FaceT face, int coordsLength, PointerFloat designCoords, Out<Integer> normalizedCoords) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment normalizedCoordsPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        try {
...
public static void otVarNormalizeVariations(org.harfbuzz.FaceT face, org.harfbuzz.VariationT variations, int variationsLength, Out<int[]> coords, int coordsLength) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        coords.set(MemorySegment.ofAddress(coordsPOINTER.get(Interop.valueLayout.ADDRESS, 0), coordsLength * Interop.valueLayout.C_INT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_INT));
    }
}
...
public static org.harfbuzz.ScriptT scriptFromIso15924Tag(org.harfbuzz.TagT tag) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.hb_script_from_iso15924_tag.invokeExact(tag.getValue().intValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.harfbuzz.ScriptT.of(RESULT);
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.hb_set_add_sorted_array.invokeExact(
                    set.handle(),
                    Interop.allocateNativeArray(org.harfbuzz.CodepointT.getIntegerValues(sortedCodepoints), false, SCOPE),
                    numCodepoints);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static org.harfbuzz.SetT setCopy(org.harfbuzz.SetT set) {
    ...
    var OBJECT = org.harfbuzz.SetT.fromAddress.marshal(RESULT, null);
    OBJECT.takeOwnership();
    return OBJECT;
}
...
public static int setHash(org.harfbuzz.SetT set) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.hb_set_hash.invokeExact(set.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static org.harfbuzz.BoolT setNext(org.harfbuzz.SetT set, org.harfbuzz.CodepointT codepoint) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment codepointPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.hb_set_next_many.invokeExact(
                    set.handle(),
                    codepoint.getValue().intValue(),
                    Interop.allocateNativeArray(org.harfbuzz.CodepointT.getIntegerValues(out), false, SCOPE),
                    size);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static org.harfbuzz.BoolT setNextRange(org.harfbuzz.SetT set, org.harfbuzz.CodepointT first, org.harfbuzz.CodepointT last) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment firstPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment lastPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.hb_shape.invokeExact(
                    font.handle(),
                    buffer.handle(),
                    (Addressable) (features == null ? MemoryAddress.NULL : Interop.allocateNativeArray(features, org.harfbuzz.FeatureT.getMemoryLayout(), false, SCOPE)),
                    numFeatures);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.hb_shape_full.invokeExact(
                    ...
                    (Addressable) (features == null ? MemoryAddress.NULL : Interop.allocateNativeArray(features, org.harfbuzz.FeatureT.getMemoryLayout(), false, SCOPE)),
                    numFeatures,
                    (Addressable) (shaperList == null ? MemoryAddress.NULL : Interop.allocateNativeArray(shaperList, false, SCOPE)));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return new org.harfbuzz.BoolT(RESULT);
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (MemoryAddress) DowncallHandles.hb_shape_plan_create.invokeExact(
                    face.handle(),
                    props.handle(),
                    Interop.allocateNativeArray(userFeatures, org.harfbuzz.FeatureT.getMemoryLayout(), false, SCOPE),
                    numUserFeatures,
                    Interop.allocateNativeArray(shaperList, false, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        var OBJECT = org.harfbuzz.ShapePlanT.fromAddress.marshal(RESULT, null);
        OBJECT.takeOwnership();
        return OBJECT;
    }
}
...
public static void tagToString(org.harfbuzz.TagT tag, Out<byte[]> buf) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        buf.set(MemorySegment.ofAddress(bufPOINTER.get(Interop.valueLayout.ADDRESS, 0), 4 * Interop.valueLayout.C_BYTE.byteSize(), SCOPE).toArray(Interop.valueLayout.C_BYTE));
    }
}
...
public static org.harfbuzz.BoolT unicodeCompose(org.harfbuzz.UnicodeFuncsT ufuncs, org.harfbuzz.CodepointT a, org.harfbuzz.CodepointT b, org.harfbuzz.CodepointT ab) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment abPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static int unicodeDecomposeCompatibility(org.harfbuzz.UnicodeFuncsT ufuncs, org.harfbuzz.CodepointT u, org.harfbuzz.CodepointT decomposed) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment decomposedPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static org.harfbuzz.UnicodeFuncsT unicodeFuncsCreate(@Nullable org.harfbuzz.UnicodeFuncsT parent) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.hb_unicode_funcs_create.invokeExact((Addressable) (parent == null ? MemoryAddress.NULL : parent.handle()));
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    var OBJECT = org.harfbuzz.UnicodeFuncsT.fromAddress.marshal(RESULT, null);
