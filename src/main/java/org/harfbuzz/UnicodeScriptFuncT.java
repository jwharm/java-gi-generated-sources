 ...
 */
/**
 * Functional interface declaration of the {@code UnicodeScriptFuncT} callback.
 */
@FunctionalInterface
public interface UnicodeScriptFuncT {
     ...
     * specified Unicode code point.
     */
    org.harfbuzz.ScriptT run(org.harfbuzz.UnicodeFuncsT ufuncs, org.harfbuzz.CodepointT unicode, @Nullable java.lang.foreign.MemoryAddress userData);
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), UnicodeScriptFuncT.class, DESCRIPTOR);
