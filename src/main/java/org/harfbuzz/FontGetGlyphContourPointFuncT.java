 ...
 */
/**
 * Functional interface declaration of the {@code FontGetGlyphContourPointFuncT} callback.
 */
@FunctionalInterface
public interface FontGetGlyphContourPointFuncT {
    ...
    @ApiStatus.Internal default int upcall(MemoryAddress font, MemoryAddress fontData, int glyph, int pointIndex, MemoryAddress x, MemoryAddress y, MemoryAddress userData) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            ...
            var RESULT = run(org.harfbuzz.FontT.fromAddress.marshal(font, null), fontData, new org.harfbuzz.CodepointT(glyph), pointIndex, xALIAS, yALIAS, userData);
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), FontGetGlyphContourPointFuncT.class, DESCRIPTOR);
