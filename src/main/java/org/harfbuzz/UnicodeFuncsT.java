...
public class UnicodeFuncsT extends Struct {
     ...
     */
    protected UnicodeFuncsT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnicodeFuncsT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new UnicodeFuncsT(input, ownership);
}
