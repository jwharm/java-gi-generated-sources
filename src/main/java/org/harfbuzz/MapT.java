...
public class MapT extends Struct {
     ...
     */
    protected MapT(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MapT> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MapT(input, ownership);
}
