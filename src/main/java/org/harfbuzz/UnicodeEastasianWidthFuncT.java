 ...
 */
/**
 * Functional interface declaration of the {@code UnicodeEastasianWidthFuncT} callback.
 */
@FunctionalInterface
public interface UnicodeEastasianWidthFuncT {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), UnicodeEastasianWidthFuncT.class, DESCRIPTOR);
