 ...
 */
/**
 * Functional interface declaration of the {@code DrawLineToFuncT} callback.
 */
@FunctionalInterface
public interface DrawLineToFuncT {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), DrawLineToFuncT.class, DESCRIPTOR);
