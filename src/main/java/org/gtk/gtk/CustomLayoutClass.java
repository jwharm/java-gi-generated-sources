...
public class CustomLayoutClass extends Struct {
    ...
    public static CustomLayoutClass allocate() {
        ...
        CustomLayoutClass newInstance = new CustomLayoutClass(segment.address());
     ...
     */
    protected CustomLayoutClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CustomLayoutClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CustomLayoutClass(input);
    
    /**
     * A {@link CustomLayoutClass.Builder} object constructs a {@link CustomLayoutClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link CustomLayoutClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final CustomLayoutClass struct;
         ...
         */
        public CustomLayoutClass build() {
            return struct;
        }
