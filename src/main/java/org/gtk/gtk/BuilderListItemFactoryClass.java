...
public class BuilderListItemFactoryClass extends Struct {
    ...
    public static BuilderListItemFactoryClass allocate() {
        ...
        BuilderListItemFactoryClass newInstance = new BuilderListItemFactoryClass(segment.address());
     ...
     */
    protected BuilderListItemFactoryClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BuilderListItemFactoryClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BuilderListItemFactoryClass(input);
}
