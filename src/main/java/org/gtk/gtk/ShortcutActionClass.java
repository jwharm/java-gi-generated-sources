...
public class ShortcutActionClass extends Struct {
    ...
    public static ShortcutActionClass allocate() {
        ...
        ShortcutActionClass newInstance = new ShortcutActionClass(segment.address());
     ...
     */
    protected ShortcutActionClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShortcutActionClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ShortcutActionClass(input);
}
