...
public class ShortcutActionClass extends Struct {
     ...
     */
    protected ShortcutActionClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShortcutActionClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ShortcutActionClass(input, ownership);
}
