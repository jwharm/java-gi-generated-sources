...
public class CellRendererClassPrivate extends Struct {
    ...
    public static CellRendererClassPrivate allocate() {
        ...
        CellRendererClassPrivate newInstance = new CellRendererClassPrivate(segment.address());
     ...
     */
    protected CellRendererClassPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CellRendererClassPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CellRendererClassPrivate(input);
}
