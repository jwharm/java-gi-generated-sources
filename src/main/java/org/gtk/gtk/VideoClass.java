...
public class VideoClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static VideoClass allocate() {
        ...
        VideoClass newInstance = new VideoClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public VideoClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
