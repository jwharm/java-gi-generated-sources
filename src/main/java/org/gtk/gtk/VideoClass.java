...
public class VideoClass extends Struct {
    ...
    public static VideoClass allocate() {
        ...
        VideoClass newInstance = new VideoClass(segment.address());
     ...
     */
    protected VideoClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VideoClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VideoClass(input);
