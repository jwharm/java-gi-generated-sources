...
public class OverlayLayoutClass extends Struct {
     ...
     */
    protected OverlayLayoutClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, OverlayLayoutClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new OverlayLayoutClass(input, ownership);
    
    /**
     * A {@link OverlayLayoutClass.Builder} object constructs a {@link OverlayLayoutClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link OverlayLayoutClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final OverlayLayoutClass struct;
         ...
         */
        public OverlayLayoutClass build() {
            return struct;
        }
