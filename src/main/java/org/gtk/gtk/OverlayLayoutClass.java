...
public class OverlayLayoutClass extends Struct {
    ...
    public static OverlayLayoutClass allocate() {
        ...
        OverlayLayoutClass newInstance = new OverlayLayoutClass(segment.address());
     ...
     */
    protected OverlayLayoutClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, OverlayLayoutClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new OverlayLayoutClass(input);
