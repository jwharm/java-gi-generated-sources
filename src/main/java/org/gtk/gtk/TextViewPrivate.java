...
public class TextViewPrivate extends Struct {
     ...
     */
    protected TextViewPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TextViewPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TextViewPrivate(input, ownership);
}
