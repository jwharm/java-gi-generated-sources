...
public class SelectionFilterModelClass extends Struct {
     ...
     */
    protected SelectionFilterModelClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SelectionFilterModelClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SelectionFilterModelClass(input, ownership);
