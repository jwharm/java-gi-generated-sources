...
public class GridViewClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public GridViewClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private GridViewClass struct;
        
         /**
         * A {@link GridViewClass.Build} object constructs a {@link GridViewClass} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = GridViewClass.allocate();
        }
        
         /**
         * Finish building the {@link GridViewClass} struct.
         * @return A new instance of {@code GridViewClass} with the fields 
         *         that were set in the Build object.
         */
        public GridViewClass construct() {
            return struct;
        }
    }
}
