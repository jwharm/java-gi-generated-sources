...
public class DirectoryListClass extends Struct {
    ...
    public static DirectoryListClass allocate() {
        ...
        DirectoryListClass newInstance = new DirectoryListClass(segment.address());
     ...
     */
    protected DirectoryListClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DirectoryListClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DirectoryListClass(input);
