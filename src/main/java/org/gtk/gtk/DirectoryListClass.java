...
public class DirectoryListClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public DirectoryListClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private DirectoryListClass struct;
        
         /**
         * A {@link DirectoryListClass.Build} object constructs a {@link DirectoryListClass} 
         ...
         */
        public DirectoryListClass construct() {
            return struct;
        }
