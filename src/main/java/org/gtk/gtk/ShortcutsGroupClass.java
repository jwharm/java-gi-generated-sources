...
public class ShortcutsGroupClass extends Struct {
     ...
     */
    protected ShortcutsGroupClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShortcutsGroupClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ShortcutsGroupClass(input, ownership);
}
