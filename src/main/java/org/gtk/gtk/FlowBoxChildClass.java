...
public class FlowBoxChildClass extends Struct {
    ...
    public static FlowBoxChildClass allocate() {
        ...
        FlowBoxChildClass newInstance = new FlowBoxChildClass(segment.address());
     ...
     */
    protected FlowBoxChildClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FlowBoxChildClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FlowBoxChildClass(input);
