...
public class TreeModelFilterPrivate extends Struct {
     ...
     */
    protected TreeModelFilterPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TreeModelFilterPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TreeModelFilterPrivate(input, ownership);
}
