...
public class GridLayoutClass extends Struct {
    ...
    public static GridLayoutClass allocate() {
        ...
        GridLayoutClass newInstance = new GridLayoutClass(segment.address());
     ...
     */
    protected GridLayoutClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, GridLayoutClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new GridLayoutClass(input);
