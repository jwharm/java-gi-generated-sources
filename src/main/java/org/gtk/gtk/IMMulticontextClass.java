...
public class IMMulticontextClass extends Struct {
    ...
    public static IMMulticontextClass allocate() {
        ...
        IMMulticontextClass newInstance = new IMMulticontextClass(segment.address());
     ...
     */
    protected IMMulticontextClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, IMMulticontextClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new IMMulticontextClass(input);
