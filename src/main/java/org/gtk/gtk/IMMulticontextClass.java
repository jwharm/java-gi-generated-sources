...
public class IMMulticontextClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static IMMulticontextClass allocate() {
        ...
        IMMulticontextClass newInstance = new IMMulticontextClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public IMMulticontextClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
