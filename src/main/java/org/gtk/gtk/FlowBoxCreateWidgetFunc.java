 ...
 */
/**
 * Functional interface declaration of the {@code FlowBoxCreateWidgetFunc} callback.
 */
@FunctionalInterface
public interface FlowBoxCreateWidgetFunc {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), FlowBoxCreateWidgetFunc.class, DESCRIPTOR);
