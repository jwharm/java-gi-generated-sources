...
public class BuilderCScopeClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public BuilderCScopeClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private BuilderCScopeClass struct;
        
         /**
         * A {@link BuilderCScopeClass.Build} object constructs a {@link BuilderCScopeClass} 
         ...
         */
        public BuilderCScopeClass construct() {
            return struct;
        }
