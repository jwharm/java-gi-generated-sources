...
public class BuilderCScopeClass extends Struct {
    ...
    public static BuilderCScopeClass allocate() {
        ...
        BuilderCScopeClass newInstance = new BuilderCScopeClass(segment.address());
     ...
     */
    protected BuilderCScopeClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BuilderCScopeClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BuilderCScopeClass(input);
