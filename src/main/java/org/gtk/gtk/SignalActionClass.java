...
public class SignalActionClass extends Struct {
     ...
     */
    protected SignalActionClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SignalActionClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SignalActionClass(input, ownership);
}
