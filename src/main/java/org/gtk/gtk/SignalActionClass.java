...
public class SignalActionClass extends Struct {
    ...
    public static SignalActionClass allocate() {
        ...
        SignalActionClass newInstance = new SignalActionClass(segment.address());
     ...
     */
    protected SignalActionClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SignalActionClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SignalActionClass(input);
}
