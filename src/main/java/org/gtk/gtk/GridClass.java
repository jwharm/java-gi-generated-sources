...
public class GridClass extends Struct {
     ...
     */
    protected GridClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GridClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GridClass(input, ownership);
    
    /**
     * A {@link GridClass.Builder} object constructs a {@link GridClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link GridClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final GridClass struct;
