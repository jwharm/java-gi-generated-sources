...
public class GridClass extends Struct {
    ...
    public static GridClass allocate() {
        ...
        GridClass newInstance = new GridClass(segment.address());
     ...
     */
    protected GridClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, GridClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new GridClass(input);
