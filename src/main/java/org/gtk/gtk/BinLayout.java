...
public class BinLayout extends org.gtk.gtk.LayoutManager {
     ...
     */
    protected BinLayout(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BinLayout> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BinLayout(input);
    ...
    public static boolean isAvailable() {
        return DowncallHandles.gtk_bin_layout_get_type != null;
    }
}
