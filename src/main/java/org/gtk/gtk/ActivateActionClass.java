...
public class ActivateActionClass extends Struct {
     ...
     */
    protected ActivateActionClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ActivateActionClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ActivateActionClass(input, ownership);
}
