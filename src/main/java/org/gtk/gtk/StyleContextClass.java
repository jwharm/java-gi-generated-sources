...
public class StyleContextClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public StyleContextClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private StyleContextClass struct;
        
         /**
         * A {@link StyleContextClass.Build} object constructs a {@link StyleContextClass} 
         ...
         */
        public StyleContextClass construct() {
            return struct;
        }
