...
public class FixedClass extends Struct {
    ...
    public static FixedClass allocate() {
        ...
        FixedClass newInstance = new FixedClass(segment.address());
     ...
     */
    protected FixedClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FixedClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FixedClass(input);
