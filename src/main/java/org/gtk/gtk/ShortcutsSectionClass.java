...
public class ShortcutsSectionClass extends Struct {
     ...
     */
    protected ShortcutsSectionClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShortcutsSectionClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ShortcutsSectionClass(input, ownership);
}
