...
public class TextBufferPrivate extends Struct {
     ...
     */
    protected TextBufferPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TextBufferPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TextBufferPrivate(input, ownership);
}
