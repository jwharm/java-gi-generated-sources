...
public class MediaFileClass extends Struct {
    ...
    public static MediaFileClass allocate() {
        ...
        MediaFileClass newInstance = new MediaFileClass(segment.address());
    ...
    public org.gtk.gtk.MediaStreamClass getParentClass() {
        ...
        return org.gtk.gtk.MediaStreamClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
    ...
    public interface OpenCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress self) {
            run((org.gtk.gtk.MediaFile) Interop.register(self, org.gtk.gtk.MediaFile.fromAddress).marshal(self, null));
        }
     ...
     */
    protected MediaFileClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MediaFileClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MediaFileClass(input);
