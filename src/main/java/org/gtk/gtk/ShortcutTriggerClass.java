...
public class ShortcutTriggerClass extends Struct {
     ...
     */
    protected ShortcutTriggerClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShortcutTriggerClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ShortcutTriggerClass(input, ownership);
}
