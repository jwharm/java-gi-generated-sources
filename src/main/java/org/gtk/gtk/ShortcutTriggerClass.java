...
public class ShortcutTriggerClass extends Struct {
    ...
    public static ShortcutTriggerClass allocate() {
        ...
        ShortcutTriggerClass newInstance = new ShortcutTriggerClass(segment.address());
     ...
     */
    protected ShortcutTriggerClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShortcutTriggerClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ShortcutTriggerClass(input);
}
