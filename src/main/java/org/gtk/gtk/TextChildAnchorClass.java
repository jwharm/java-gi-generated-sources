...
public class TextChildAnchorClass extends Struct {
    ...
    public static TextChildAnchorClass allocate() {
        ...
        TextChildAnchorClass newInstance = new TextChildAnchorClass(segment.address());
     ...
     */
    protected TextChildAnchorClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, TextChildAnchorClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new TextChildAnchorClass(input);
