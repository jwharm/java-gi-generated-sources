...
public class NoSelectionClass extends Struct {
    ...
    public static NoSelectionClass allocate() {
        ...
        NoSelectionClass newInstance = new NoSelectionClass(segment.address());
     ...
     */
    protected NoSelectionClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, NoSelectionClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new NoSelectionClass(input);
