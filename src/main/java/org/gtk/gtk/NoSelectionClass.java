...
public class NoSelectionClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public NoSelectionClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private NoSelectionClass struct;
        
         /**
         * A {@link NoSelectionClass.Build} object constructs a {@link NoSelectionClass} 
         ...
         */
        public NoSelectionClass construct() {
            return struct;
        }
