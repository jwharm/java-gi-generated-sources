...
public class CssStyleChange extends Struct {
     ...
     */
    protected CssStyleChange(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CssStyleChange> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CssStyleChange(input, ownership);
}
