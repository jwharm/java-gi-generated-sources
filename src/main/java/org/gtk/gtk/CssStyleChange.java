...
public class CssStyleChange extends Struct {
    ...
    public static CssStyleChange allocate() {
        ...
        CssStyleChange newInstance = new CssStyleChange(segment.address());
     ...
     */
    protected CssStyleChange(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CssStyleChange> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CssStyleChange(input);
}
