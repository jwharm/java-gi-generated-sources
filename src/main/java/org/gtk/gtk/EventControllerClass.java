...
public class EventControllerClass extends Struct {
    ...
    public static EventControllerClass allocate() {
        ...
        EventControllerClass newInstance = new EventControllerClass(segment.address());
     ...
     */
    protected EventControllerClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, EventControllerClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new EventControllerClass(input);
}
