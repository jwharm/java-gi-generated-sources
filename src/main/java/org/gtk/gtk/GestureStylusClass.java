...
public class GestureStylusClass extends Struct {
     ...
     */
    protected GestureStylusClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GestureStylusClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GestureStylusClass(input, ownership);
}
