...
public class NothingActionClass extends Struct {
    ...
    public static NothingActionClass allocate() {
        ...
        NothingActionClass newInstance = new NothingActionClass(segment.address());
     ...
     */
    protected NothingActionClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, NothingActionClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new NothingActionClass(input);
}
