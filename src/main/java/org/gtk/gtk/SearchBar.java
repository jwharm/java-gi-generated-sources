...
public class SearchBar extends org.gtk.gtk.Widget implements org.gtk.gtk.Accessible, org.gtk.gtk.Buildable, org.gtk.gtk.ConstraintTarget {
     ...
     */
    protected SearchBar(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SearchBar> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SearchBar(input);
    ...
    public static boolean isAvailable() {
        return DowncallHandles.gtk_search_bar_get_type != null;
    }
}
