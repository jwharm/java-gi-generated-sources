...
public class ColumnViewColumnClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static ColumnViewColumnClass allocate() {
        ...
        ColumnViewColumnClass newInstance = new ColumnViewColumnClass(Refcounted.get(segment.address()));
        newInstance.allocatedMemorySegment = segment;
        return newInstance;
    }
    
    @ApiStatus.Internal
    public ColumnViewColumnClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
