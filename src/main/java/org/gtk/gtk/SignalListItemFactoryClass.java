...
public class SignalListItemFactoryClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static SignalListItemFactoryClass allocate() {
        ...
        SignalListItemFactoryClass newInstance = new SignalListItemFactoryClass(Refcounted.get(segment.address()));
        newInstance.allocatedMemorySegment = segment;
        return newInstance;
    }
    
    @ApiStatus.Internal
    public SignalListItemFactoryClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
