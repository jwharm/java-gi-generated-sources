...
public class ButtonPrivate extends Struct {
    ...
    public static ButtonPrivate allocate() {
        ...
        ButtonPrivate newInstance = new ButtonPrivate(segment.address());
     ...
     */
    protected ButtonPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ButtonPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ButtonPrivate(input);
}
