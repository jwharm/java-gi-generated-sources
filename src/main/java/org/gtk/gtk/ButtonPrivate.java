...
public class ButtonPrivate extends Struct {
     ...
     */
    protected ButtonPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ButtonPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ButtonPrivate(input, ownership);
}
