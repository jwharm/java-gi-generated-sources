...
public class EmojiChooserClass extends Struct {
     ...
     */
    protected EmojiChooserClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, EmojiChooserClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new EmojiChooserClass(input, ownership);
}
