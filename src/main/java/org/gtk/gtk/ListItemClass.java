...
public class ListItemClass extends Struct {
     ...
     */
    protected ListItemClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ListItemClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ListItemClass(input, ownership);
}
