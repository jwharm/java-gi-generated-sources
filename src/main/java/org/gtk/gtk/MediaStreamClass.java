...
public class MediaStreamClass extends Struct {
    ...
    public static class Build {
        ...
        public Build setUpdateAudio(java.lang.foreign.MemoryAddress updateAudio) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("update_audio"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (updateAudio == null ? MemoryAddress.NULL : updateAudio));
            return this;
        }
