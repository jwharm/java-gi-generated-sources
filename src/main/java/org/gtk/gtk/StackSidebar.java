...
public class StackSidebar extends org.gtk.gtk.Widget implements org.gtk.gtk.Accessible, org.gtk.gtk.Buildable, org.gtk.gtk.ConstraintTarget {
     ...
     */
    protected StackSidebar(Addressable address, Ownership ownership) {
    ...
    @ApiStatus.Internal
    public static final Marshal<Addressable, StackSidebar> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new StackSidebar(input, ownership);
