...
public class FlowBoxChild extends org.gtk.gtk.Widget implements org.gtk.gtk.Accessible, org.gtk.gtk.Buildable, org.gtk.gtk.ConstraintTarget {
     ...
     */
    protected FlowBoxChild(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FlowBoxChild> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FlowBoxChild(input);
    ...
    public static boolean isAvailable() {
        return DowncallHandles.gtk_flow_box_child_get_type != null;
    }
}
