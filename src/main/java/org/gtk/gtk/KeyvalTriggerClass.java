...
public class KeyvalTriggerClass extends Struct {
     ...
     */
    protected KeyvalTriggerClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, KeyvalTriggerClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new KeyvalTriggerClass(input, ownership);
}
