...
public class WindowControlsClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static WindowControlsClass allocate() {
        ...
        WindowControlsClass newInstance = new WindowControlsClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public WindowControlsClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
