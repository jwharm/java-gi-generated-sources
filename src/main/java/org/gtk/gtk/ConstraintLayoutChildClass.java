...
public class ConstraintLayoutChildClass extends Struct {
     ...
     */
    protected ConstraintLayoutChildClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ConstraintLayoutChildClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ConstraintLayoutChildClass(input, ownership);
