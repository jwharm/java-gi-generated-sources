...
public class CenterBoxClass extends Struct {
    ...
    public static CenterBoxClass allocate() {
        ...
        CenterBoxClass newInstance = new CenterBoxClass(segment.address());
     ...
     */
    protected CenterBoxClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CenterBoxClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CenterBoxClass(input);
}
