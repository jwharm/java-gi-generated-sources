...
public class CenterBoxClass extends Struct {
     ...
     */
    protected CenterBoxClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CenterBoxClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CenterBoxClass(input, ownership);
}
