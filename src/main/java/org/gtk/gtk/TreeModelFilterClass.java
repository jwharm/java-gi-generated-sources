...
public class TreeModelFilterClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static TreeModelFilterClass allocate() {
        ...
        TreeModelFilterClass newInstance = new TreeModelFilterClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public TreeModelFilterClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
