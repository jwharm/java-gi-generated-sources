...
public class GestureLongPressClass extends Struct {
     ...
     */
    protected GestureLongPressClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GestureLongPressClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GestureLongPressClass(input, ownership);
}
