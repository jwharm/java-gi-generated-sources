...
public class FixedLayoutClass extends Struct {
    ...
    public static FixedLayoutClass allocate() {
        ...
        FixedLayoutClass newInstance = new FixedLayoutClass(segment.address());
     ...
     */
    protected FixedLayoutClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FixedLayoutClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FixedLayoutClass(input);
