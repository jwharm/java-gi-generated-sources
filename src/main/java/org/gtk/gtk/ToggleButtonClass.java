...
public class ToggleButtonClass extends Struct {
     ...
     */
    public org.gtk.gtk.ButtonClass parentClass$get() {
    ...
    public static class Build {
        ...
        private ToggleButtonClass struct;
        
         /**
         * A {@link ToggleButtonClass.Build} object constructs a {@link ToggleButtonClass} 
         ...
         */
        public ToggleButtonClass construct() {
            return struct;
        }
        
        public Build setParentClass(org.gtk.gtk.ButtonClass parentClass) {
            getMemoryLayout()
