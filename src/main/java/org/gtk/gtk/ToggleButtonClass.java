...
public class ToggleButtonClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static ToggleButtonClass allocate() {
        ...
        ToggleButtonClass newInstance = new ToggleButtonClass(Refcounted.get(segment.address()));
    ...
    public org.gtk.gtk.ButtonClass parent_class$get() {
        ...
        return new org.gtk.gtk.ButtonClass(Refcounted.get(((MemoryAddress) handle()).addOffset(OFFSET), false));
    }
