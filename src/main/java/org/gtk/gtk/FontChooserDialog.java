...
public class FontChooserDialog extends org.gtk.gtk.Dialog implements org.gtk.gtk.Accessible, org.gtk.gtk.Buildable, org.gtk.gtk.ConstraintTarget, org.gtk.gtk.FontChooser, org.gtk.gtk.Native, org.gtk.gtk.Root, org.gtk.gtk.ShortcutManager {
     ...
     */
    protected FontChooserDialog(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FontChooserDialog> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FontChooserDialog(input);
    ...
    public static boolean isAvailable() {
        return DowncallHandles.gtk_font_chooser_dialog_get_type != null;
    }
}
