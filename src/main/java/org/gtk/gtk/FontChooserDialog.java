...
public class FontChooserDialog extends org.gtk.gtk.Dialog implements org.gtk.gtk.Accessible, org.gtk.gtk.Buildable, org.gtk.gtk.ConstraintTarget, org.gtk.gtk.FontChooser, org.gtk.gtk.Native, org.gtk.gtk.Root, org.gtk.gtk.ShortcutManager {
     ...
     * <p>
     * Because FontChooserDialog is an {@code InitiallyUnowned} instance, when 
     * {@code ownership == Ownership.NONE}, the ownership is set to {@code FULL} 
     * and a call to {@code g_object_ref_sink()} is executed to sink the floating reference.
     * @param address   The memory address of the native object
     * @param ownership The ownership indicator used for ref-counted objects
     */
    protected FontChooserDialog(Addressable address, Ownership ownership) {
    ...
    @ApiStatus.Internal
    public static final Marshal<Addressable, FontChooserDialog> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new FontChooserDialog(input, ownership);
    ...
    /**
     * A {@link FontChooserDialog.Builder} object constructs a {@link FontChooserDialog} 
     * using the <em>builder pattern</em> to set property values. 
     * Use the various {@code set...()} methods to set properties, 
     * and finish construction with {@link FontChooserDialog.Builder#build()}. 
     */
    ...
    public static class Builder extends org.gtk.gtk.Dialog.Builder {
         ...
         * {@link FontChooserDialog}.
         * @return A new instance of {@code FontChooserDialog} with the properties 
         *         that were set in the Builder object.
         */
        public FontChooserDialog build() {
            return (FontChooserDialog) org.gtk.gobject.GObject.newWithProperties(
