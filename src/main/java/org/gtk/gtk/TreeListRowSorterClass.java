...
public class TreeListRowSorterClass extends Struct {
     ...
     */
    protected TreeListRowSorterClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TreeListRowSorterClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TreeListRowSorterClass(input, ownership);
