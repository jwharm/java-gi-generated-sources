...
public class TreeListRowSorterClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static TreeListRowSorterClass allocate() {
        ...
        TreeListRowSorterClass newInstance = new TreeListRowSorterClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public TreeListRowSorterClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
