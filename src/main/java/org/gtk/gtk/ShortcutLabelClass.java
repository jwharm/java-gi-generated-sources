...
public class ShortcutLabelClass extends Struct {
     ...
     */
    protected ShortcutLabelClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShortcutLabelClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ShortcutLabelClass(input, ownership);
}
