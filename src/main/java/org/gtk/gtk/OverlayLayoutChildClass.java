...
public class OverlayLayoutChildClass extends Struct {
    ...
    public static OverlayLayoutChildClass allocate() {
        ...
        OverlayLayoutChildClass newInstance = new OverlayLayoutChildClass(segment.address());
     ...
     */
    protected OverlayLayoutChildClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, OverlayLayoutChildClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new OverlayLayoutChildClass(input);
