...
public class ConstraintGuideClass extends Struct {
    ...
    public static ConstraintGuideClass allocate() {
        ...
        ConstraintGuideClass newInstance = new ConstraintGuideClass(segment.address());
     ...
     */
    protected ConstraintGuideClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ConstraintGuideClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ConstraintGuideClass(input);
