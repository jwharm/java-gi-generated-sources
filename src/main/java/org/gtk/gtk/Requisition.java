...
public class Requisition extends Struct {
    ...
    public static Requisition allocate() {
        ...
        Requisition newInstance = new Requisition(segment.address());
     ...
     */
    protected Requisition(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, Requisition> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new Requisition(input);
    ...
    public org.gtk.gtk.Requisition copy() {
        ...
        var OBJECT = org.gtk.gtk.Requisition.fromAddress.marshal(RESULT, null);
