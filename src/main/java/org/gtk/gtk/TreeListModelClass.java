...
public class TreeListModelClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TreeListModelClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TreeListModelClass struct;
        
         /**
         * A {@link TreeListModelClass.Build} object constructs a {@link TreeListModelClass} 
         ...
         */
        public TreeListModelClass construct() {
            return struct;
        }
