...
public class TreeListModelClass extends Struct {
    ...
    public static TreeListModelClass allocate() {
        ...
        TreeListModelClass newInstance = new TreeListModelClass(segment.address(), Ownership.NONE);
     ...
     */
    protected TreeListModelClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TreeListModelClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TreeListModelClass(input, ownership);
