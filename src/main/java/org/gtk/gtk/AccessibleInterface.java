...
public class AccessibleInterface extends Struct {
    ...
    public static class Build {
        ...
        private AccessibleInterface struct;
        
         /**
         * A {@link AccessibleInterface.Build} object constructs a {@link AccessibleInterface} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = AccessibleInterface.allocate();
        }
        
         /**
         * Finish building the {@link AccessibleInterface} struct.
         * @return A new instance of {@code AccessibleInterface} with the fields 
         *         that were set in the Build object.
         */
        public AccessibleInterface construct() {
            return struct;
        }
    }
}
