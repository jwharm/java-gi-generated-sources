...
public class AccessibleInterface extends Struct {
     ...
     */
    protected AccessibleInterface(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AccessibleInterface> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AccessibleInterface(input, ownership);
}
