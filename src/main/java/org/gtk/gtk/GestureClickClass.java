...
public class GestureClickClass extends Struct {
     ...
     */
    protected GestureClickClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GestureClickClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GestureClickClass(input, ownership);
}
