...
public class MediaControlsClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public MediaControlsClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private MediaControlsClass struct;
        
         /**
         * A {@link MediaControlsClass.Build} object constructs a {@link MediaControlsClass} 
         ...
         */
        public MediaControlsClass construct() {
            return struct;
        }
