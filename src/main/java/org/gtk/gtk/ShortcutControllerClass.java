...
public class ShortcutControllerClass extends Struct {
    ...
    public static ShortcutControllerClass allocate() {
        ...
        ShortcutControllerClass newInstance = new ShortcutControllerClass(segment.address());
     ...
     */
    protected ShortcutControllerClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ShortcutControllerClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ShortcutControllerClass(input);
}
