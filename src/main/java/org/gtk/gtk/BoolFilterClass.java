...
public class BoolFilterClass extends Struct {
     ...
     */
    protected BoolFilterClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BoolFilterClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BoolFilterClass(input, ownership);
