...
public class TreeModelSortClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TreeModelSortClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TreeModelSortClass struct;
        
         /**
         * A {@link TreeModelSortClass.Build} object constructs a {@link TreeModelSortClass} 
         ...
         */
        public TreeModelSortClass construct() {
            return struct;
        }
