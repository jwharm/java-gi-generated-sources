...
public class TreeModelSortClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static TreeModelSortClass allocate() {
        ...
        TreeModelSortClass newInstance = new TreeModelSortClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public TreeModelSortClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
