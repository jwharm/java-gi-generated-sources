...
public class TreeModelSortClass extends Struct {
    ...
    public static TreeModelSortClass allocate() {
        ...
        TreeModelSortClass newInstance = new TreeModelSortClass(segment.address());
     ...
     */
    protected TreeModelSortClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, TreeModelSortClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new TreeModelSortClass(input);
