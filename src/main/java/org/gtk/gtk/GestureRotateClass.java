...
public class GestureRotateClass extends Struct {
     ...
     */
    protected GestureRotateClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GestureRotateClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GestureRotateClass(input, ownership);
}
