...
public class GestureRotateClass extends Struct {
    ...
    public static GestureRotateClass allocate() {
        ...
        GestureRotateClass newInstance = new GestureRotateClass(segment.address());
     ...
     */
    protected GestureRotateClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, GestureRotateClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new GestureRotateClass(input);
}
