...
public class MultiFilterClass extends Struct {
    ...
    public static MultiFilterClass allocate() {
        ...
        MultiFilterClass newInstance = new MultiFilterClass(segment.address());
     ...
     */
    protected MultiFilterClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MultiFilterClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MultiFilterClass(input);
}
