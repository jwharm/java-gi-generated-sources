...
public class WindowHandle extends org.gtk.gtk.Widget implements org.gtk.gtk.Accessible, org.gtk.gtk.Buildable, org.gtk.gtk.ConstraintTarget {
    ...
    /**
     * A {@link WindowHandle.Builder} object constructs a {@link WindowHandle} 
     * using the <em>builder pattern</em> to set property values. 
     * Use the various {@code set...()} methods to set properties, 
     * and finish construction with {@link WindowHandle.Builder#build()}. 
     */
    ...
    public static class Builder extends org.gtk.gtk.Widget.Builder {
        ...
        public WindowHandle build() {
            return (WindowHandle) org.gtk.gobject.GObject.newWithProperties(
