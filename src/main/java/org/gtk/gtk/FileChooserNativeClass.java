...
public class FileChooserNativeClass extends Struct {
    ...
    public static FileChooserNativeClass allocate() {
        ...
        FileChooserNativeClass newInstance = new FileChooserNativeClass(segment.address());
    ...
    public org.gtk.gtk.NativeDialogClass getParentClass() {
        ...
        return org.gtk.gtk.NativeDialogClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected FileChooserNativeClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FileChooserNativeClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FileChooserNativeClass(input);
