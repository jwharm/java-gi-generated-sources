...
public class EditableLabelClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public EditableLabelClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private EditableLabelClass struct;
        
         /**
         * A {@link EditableLabelClass.Build} object constructs a {@link EditableLabelClass} 
         ...
         */
        public EditableLabelClass construct() {
            return struct;
        }
