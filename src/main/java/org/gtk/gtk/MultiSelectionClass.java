...
public class MultiSelectionClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public MultiSelectionClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private MultiSelectionClass struct;
        
         /**
         * A {@link MultiSelectionClass.Build} object constructs a {@link MultiSelectionClass} 
         ...
         */
        public MultiSelectionClass construct() {
            return struct;
        }
