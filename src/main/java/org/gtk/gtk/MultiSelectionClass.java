...
public class MultiSelectionClass extends Struct {
    ...
    public static MultiSelectionClass allocate() {
        ...
        MultiSelectionClass newInstance = new MultiSelectionClass(segment.address());
     ...
     */
    protected MultiSelectionClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MultiSelectionClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MultiSelectionClass(input);
