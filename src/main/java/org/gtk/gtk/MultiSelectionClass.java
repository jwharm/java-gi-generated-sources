...
public class MultiSelectionClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static MultiSelectionClass allocate() {
        ...
        MultiSelectionClass newInstance = new MultiSelectionClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public MultiSelectionClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
