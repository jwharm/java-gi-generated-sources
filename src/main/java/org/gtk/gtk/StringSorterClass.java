...
public class StringSorterClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static StringSorterClass allocate() {
        ...
        StringSorterClass newInstance = new StringSorterClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public StringSorterClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
