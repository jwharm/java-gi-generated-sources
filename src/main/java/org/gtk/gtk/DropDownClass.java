...
public class DropDownClass extends Struct {
    ...
    public static DropDownClass allocate() {
        ...
        DropDownClass newInstance = new DropDownClass(segment.address());
     ...
     */
    protected DropDownClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DropDownClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DropDownClass(input);
