...
public class DropDownClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public DropDownClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private DropDownClass struct;
        
         /**
         * A {@link DropDownClass.Build} object constructs a {@link DropDownClass} 
         ...
         */
        public DropDownClass construct() {
            return struct;
        }
