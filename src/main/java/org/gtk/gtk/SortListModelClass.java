...
public class SortListModelClass extends Struct {
     ...
     */
    protected SortListModelClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SortListModelClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SortListModelClass(input, ownership);
