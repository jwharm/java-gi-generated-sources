...
public class EventControllerScrollClass extends Struct {
     ...
     */
    protected EventControllerScrollClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, EventControllerScrollClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new EventControllerScrollClass(input, ownership);
}
