...
public class WindowGroupPrivate extends Struct {
    ...
    public static WindowGroupPrivate allocate() {
        ...
        WindowGroupPrivate newInstance = new WindowGroupPrivate(segment.address(), Ownership.NONE);
     ...
     */
    protected WindowGroupPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, WindowGroupPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new WindowGroupPrivate(input, ownership);
}
