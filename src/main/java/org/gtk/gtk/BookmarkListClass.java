...
public class BookmarkListClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public BookmarkListClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private BookmarkListClass struct;
        
         /**
         * A {@link BookmarkListClass.Build} object constructs a {@link BookmarkListClass} 
         ...
         */
        public BookmarkListClass construct() {
            return struct;
        }
