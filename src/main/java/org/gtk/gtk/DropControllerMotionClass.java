...
public class DropControllerMotionClass extends Struct {
     ...
     */
    protected DropControllerMotionClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DropControllerMotionClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DropControllerMotionClass(input, ownership);
}
