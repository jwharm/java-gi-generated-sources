...
public class ButtonClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public ButtonClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private ButtonClass struct;
        
         /**
         * A {@link ButtonClass.Build} object constructs a {@link ButtonClass} 
        ...
        public Build setClicked(java.lang.foreign.MemoryAddress clicked) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("clicked"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (clicked == null ? MemoryAddress.NULL : clicked));
            return this;
        }
