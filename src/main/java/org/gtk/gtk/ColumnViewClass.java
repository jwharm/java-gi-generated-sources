...
public class ColumnViewClass extends Struct {
     ...
     */
    protected ColumnViewClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ColumnViewClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ColumnViewClass(input, ownership);
}
