...
public class CancellableClass extends Struct {
    
    static {
        Gio.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "GCancellableClass";
    ...
    public static MemoryLayout getMemoryLayout() {
        return MemoryLayout.structLayout(
            ...
            Interop.valueLayout.ADDRESS.withName("cancelled"),
    ...
    /**
     * Allocate a new {@link CancellableClass}
     * @return A new, uninitialized @{link CancellableClass}
     */
    public static CancellableClass allocate() {
        MemorySegment segment = Interop.getAllocator().allocate(getMemoryLayout());
        CancellableClass newInstance = new CancellableClass(segment.address(), Ownership.NONE);
    ...
    public interface CancelledCallback {
        void run(@Nullable org.gtk.gio.Cancellable cancellable);

        @ApiStatus.Internal default void upcall(MemoryAddress cancellable) {
            run((org.gtk.gio.Cancellable) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(cancellable)), org.gtk.gio.Cancellable.fromAddress).marshal(cancellable, Ownership.NONE));
        }
        
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.ofVoid(Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(CancelledCallback.class, DESCRIPTOR);
    ...
    /**
     * Change the value of the field {@code cancelled}
     * @param cancelled The new value of the field {@code cancelled}
     */
    public void setCancelled(CancelledCallback cancelled) {
        getMemoryLayout()
            .varHandle(MemoryLayout.PathElement.groupElement("cancelled"))
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (cancelled == null ? MemoryAddress.NULL : cancelled.toCallback()));
    }
     ...
     */
    protected CancellableClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CancellableClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CancellableClass(input, ownership);
    
    /**
     * A {@link CancellableClass.Builder} object constructs a {@link CancellableClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link CancellableClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final CancellableClass struct;
        
        private Builder() {
            struct = CancellableClass.allocate();
        }
        
         /**
         * Finish building the {@link CancellableClass} struct.
         * @return A new instance of {@code CancellableClass} with the fields 
         *         that were set in the Builder object.
         */
        public CancellableClass build() {
            return struct;
        }
        ...
        public Builder setCancelled(CancelledCallback cancelled) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("cancelled"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (cancelled == null ? MemoryAddress.NULL : cancelled.toCallback()));
            return this;
        }
