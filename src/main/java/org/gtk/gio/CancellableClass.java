...
public class CancellableClass extends Struct {
    ...
    public static CancellableClass allocate() {
        ...
        CancellableClass newInstance = new CancellableClass(segment.address());
    ...
    /**
     * Functional interface declaration of the {@code CancelledCallback} callback.
     */
    @FunctionalInterface
    public interface CancelledCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress cancellable) {
            run((org.gtk.gio.Cancellable) Interop.register(cancellable, org.gtk.gio.Cancellable.fromAddress).marshal(cancellable, null));
        }
         ...
         */
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), CancelledCallback.class, DESCRIPTOR);
    ...
    public void setCancelled(CancelledCallback cancelled) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (cancelled == null ? MemoryAddress.NULL : cancelled.toCallback()));
        }
    }
     ...
     */
    protected CancellableClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CancellableClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CancellableClass(input);
    ...
    public static class Builder {
        ...
        public Builder setCancelled(CancelledCallback cancelled) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("cancelled"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (cancelled == null ? MemoryAddress.NULL : cancelled.toCallback()));
                return this;
            }
        }
