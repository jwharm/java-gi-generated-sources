...
public class ThemedIconClass extends Struct {
     ...
     */
    protected ThemedIconClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ThemedIconClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ThemedIconClass(input, ownership);
}
