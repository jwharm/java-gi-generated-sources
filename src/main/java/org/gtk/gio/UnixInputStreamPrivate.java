...
public class UnixInputStreamPrivate extends Struct {
     ...
     */
    protected UnixInputStreamPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixInputStreamPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new UnixInputStreamPrivate(input, ownership);
}
