...
public class ConverterOutputStreamClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static ConverterOutputStreamClass allocate() {
        ...
        ConverterOutputStreamClass newInstance = new ConverterOutputStreamClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public ConverterOutputStreamClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
