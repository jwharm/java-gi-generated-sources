...
public class ConverterOutputStreamClass extends Struct {
    ...
    public static ConverterOutputStreamClass allocate() {
        ...
        ConverterOutputStreamClass newInstance = new ConverterOutputStreamClass(segment.address());
     ...
     */
    protected ConverterOutputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ConverterOutputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ConverterOutputStreamClass(input);
