 ...
 */
/**
 * Functional interface declaration of the {@code BusNameAcquiredCallback} callback.
 */
@FunctionalInterface
public interface BusNameAcquiredCallback {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), BusNameAcquiredCallback.class, DESCRIPTOR);
