...
public class InetSocketAddressPrivate extends Struct {
    ...
    public static InetSocketAddressPrivate allocate() {
        ...
        InetSocketAddressPrivate newInstance = new InetSocketAddressPrivate(segment.address());
     ...
     */
    protected InetSocketAddressPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, InetSocketAddressPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new InetSocketAddressPrivate(input);
}
