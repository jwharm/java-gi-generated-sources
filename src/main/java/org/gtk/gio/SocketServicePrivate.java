...
public class SocketServicePrivate extends Struct {
    ...
    public static class Build {
        ...
        private SocketServicePrivate struct;
        
         /**
         * A {@link SocketServicePrivate.Build} object constructs a {@link SocketServicePrivate} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = SocketServicePrivate.allocate();
        }
        
         /**
         * Finish building the {@link SocketServicePrivate} struct.
         * @return A new instance of {@code SocketServicePrivate} with the fields 
         *         that were set in the Build object.
         */
        public SocketServicePrivate construct() {
            return struct;
        }
    }
}
