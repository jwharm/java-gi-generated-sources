...
public class SocketClass extends Struct {
    ...
    public static SocketClass allocate() {
        ...
        SocketClass newInstance = new SocketClass(segment.address());
     ...
     */
    protected SocketClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SocketClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SocketClass(input);
    
    /**
     * A {@link SocketClass.Builder} object constructs a {@link SocketClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link SocketClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final SocketClass struct;
