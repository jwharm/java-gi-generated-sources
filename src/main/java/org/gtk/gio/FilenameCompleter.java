...
public class FilenameCompleter extends org.gtk.gobject.Object {
    ...
    static final MethodHandle g_filename_completer_new = Interop.downcallHandle(
    ...
    static final MethodHandle g_filename_completer_get_completion_suffix = Interop.downcallHandle(
    ...
    public java.lang.String getCompletionSuffix(java.lang.String initialText) {
        try {
            var RESULT = (MemoryAddress) g_filename_completer_get_completion_suffix.invokeExact(handle(), Interop.allocateNativeString(initialText).handle());
    ...
    static final MethodHandle g_filename_completer_get_completions = Interop.downcallHandle(
    ...
    static final MethodHandle g_filename_completer_set_dirs_only = Interop.downcallHandle(
