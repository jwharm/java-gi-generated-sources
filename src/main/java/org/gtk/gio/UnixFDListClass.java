...
public class UnixFDListClass extends Struct {
    ...
    public static UnixFDListClass allocate() {
        ...
        UnixFDListClass newInstance = new UnixFDListClass(segment.address());
     ...
     */
    protected UnixFDListClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixFDListClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new UnixFDListClass(input);
