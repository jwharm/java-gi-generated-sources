...
public class UnixFDListClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public UnixFDListClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private UnixFDListClass struct;
        
         /**
         * A {@link UnixFDListClass.Build} object constructs a {@link UnixFDListClass} 
         ...
         */
        public UnixFDListClass construct() {
            return struct;
        }
