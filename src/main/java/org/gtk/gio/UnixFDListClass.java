...
public class UnixFDListClass extends Struct {
    
    static {
        Gio.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "GUnixFDListClass";
    ...
    /**
     * Allocate a new {@link UnixFDListClass}
     * @return A new, uninitialized @{link UnixFDListClass}
     */
    public static UnixFDListClass allocate() {
        MemorySegment segment = Interop.getAllocator().allocate(getMemoryLayout());
        UnixFDListClass newInstance = new UnixFDListClass(segment.address(), Ownership.NONE);
     ...
     */
    protected UnixFDListClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixFDListClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new UnixFDListClass(input, ownership);
    
    /**
     * A {@link UnixFDListClass.Builder} object constructs a {@link UnixFDListClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link UnixFDListClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final UnixFDListClass struct;
        
        private Builder() {
            struct = UnixFDListClass.allocate();
        }
        
         /**
         * Finish building the {@link UnixFDListClass} struct.
         * @return A new instance of {@code UnixFDListClass} with the fields 
         *         that were set in the Builder object.
         */
        public UnixFDListClass build() {
            return struct;
        }
