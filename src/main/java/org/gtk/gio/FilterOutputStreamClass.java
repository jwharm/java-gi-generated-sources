...
public class FilterOutputStreamClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static FilterOutputStreamClass allocate() {
        ...
        FilterOutputStreamClass newInstance = new FilterOutputStreamClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public FilterOutputStreamClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
