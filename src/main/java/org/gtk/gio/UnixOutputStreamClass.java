...
public class UnixOutputStreamClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static UnixOutputStreamClass allocate() {
        ...
        UnixOutputStreamClass newInstance = new UnixOutputStreamClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public UnixOutputStreamClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
