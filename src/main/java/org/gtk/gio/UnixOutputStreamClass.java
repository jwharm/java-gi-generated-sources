...
public class UnixOutputStreamClass extends Struct {
    ...
    public static UnixOutputStreamClass allocate() {
        ...
        UnixOutputStreamClass newInstance = new UnixOutputStreamClass(segment.address());
     ...
     */
    protected UnixOutputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixOutputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new UnixOutputStreamClass(input);
