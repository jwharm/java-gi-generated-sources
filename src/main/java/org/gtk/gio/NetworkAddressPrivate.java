...
public class NetworkAddressPrivate extends Struct {
     ...
     */
    protected NetworkAddressPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, NetworkAddressPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new NetworkAddressPrivate(input, ownership);
}
