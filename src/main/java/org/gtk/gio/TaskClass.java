...
public class TaskClass extends Struct {
    ...
    public static TaskClass allocate() {
        ...
        TaskClass newInstance = new TaskClass(segment.address());
     ...
     */
    protected TaskClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, TaskClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new TaskClass(input);
}
