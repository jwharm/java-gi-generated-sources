...
public class SocketListenerPrivate extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static SocketListenerPrivate allocate() {
        ...
        SocketListenerPrivate newInstance = new SocketListenerPrivate(Refcounted.get(segment.address()));
        newInstance.allocatedMemorySegment = segment;
        return newInstance;
    }
    
    @ApiStatus.Internal
    public SocketListenerPrivate(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
