...
public static boolean contentTypeCanBeExecutable(java.lang.String type) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_content_type_can_be_executable.invokeExact(Marshal.stringToAddress.marshal(type, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.g_content_type_equals.invokeExact(
                    Marshal.stringToAddress.marshal(type1, SCOPE),
                    Marshal.stringToAddress.marshal(type2, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static @Nullable java.lang.String contentTypeFromMimeType(java.lang.String mimeType) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_content_type_from_mime_type.invokeExact(Marshal.stringToAddress.marshal(mimeType, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String contentTypeGetDescription(java.lang.String type) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_content_type_get_description.invokeExact(Marshal.stringToAddress.marshal(type, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static @Nullable java.lang.String contentTypeGetGenericIconName(java.lang.String type) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_content_type_get_generic_icon_name.invokeExact(Marshal.stringToAddress.marshal(type, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static org.gtk.gio.Icon contentTypeGetIcon(java.lang.String type) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_content_type_get_icon.invokeExact(Marshal.stringToAddress.marshal(type, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static @Nullable java.lang.String contentTypeGetMimeType(java.lang.String type) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_content_type_get_mime_type.invokeExact(Marshal.stringToAddress.marshal(type, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static org.gtk.gio.Icon contentTypeGetSymbolicIcon(java.lang.String type) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_content_type_get_symbolic_icon.invokeExact(Marshal.stringToAddress.marshal(type, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        var OBJECT = (org.gtk.gio.Icon) Interop.register(RESULT, org.gtk.gio.Icon.fromAddress).marshal(RESULT, null);
...
public static java.lang.String contentTypeGuess(@Nullable java.lang.String filename, byte[] data, long dataSize, Out<Boolean> resultUncertain) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment resultUncertainPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemoryAddress RESULT;
        try {
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.g_content_type_is_a.invokeExact(
                    ...
                    Marshal.stringToAddress.marshal(supertype, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean contentTypeIsUnknown(java.lang.String type) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_content_type_is_unknown.invokeExact(Marshal.stringToAddress.marshal(type, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static void contentTypeSetMimeDirs(@Nullable java.lang.String[] dirs) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.g_content_type_set_mime_dirs.invokeExact((Addressable) (dirs == null ? MemoryAddress.NULL : Interop.allocateNativeArray(dirs, false, SCOPE)));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    }
...
public static java.lang.String dbusAddressEscapeValue(java.lang.String string) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_dbus_address_escape_value.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static org.gtk.gio.IOStream dbusAddressGetStreamFinish(org.gtk.gio.AsyncResult res, @Nullable Out<java.lang.String> outGuid) throws io.github.jwharm.javagi.GErrorException {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment outGuidPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        MemorySegment GERROR = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        MemoryAddress RESULT;
        try {
...
public static java.lang.String dbusEscapeObjectPath(java.lang.String s) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_dbus_escape_object_path.invokeExact(Marshal.stringToAddress.marshal(s, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String dbusEscapeObjectPathBytestring(byte[] bytes) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_dbus_escape_object_path_bytestring.invokeExact(Interop.allocateNativeArray(bytes, false, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static boolean dbusIsAddress(java.lang.String string) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_dbus_is_address.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean dbusIsErrorName(java.lang.String string) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_dbus_is_error_name.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean dbusIsGuid(java.lang.String string) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_dbus_is_guid.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean dbusIsInterfaceName(java.lang.String string) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_dbus_is_interface_name.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean dbusIsMemberName(java.lang.String string) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_dbus_is_member_name.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean dbusIsName(java.lang.String string) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_dbus_is_name.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean dbusIsSupportedAddress(java.lang.String string) throws io.github.jwharm.javagi.GErrorException {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_dbus_is_supported_address.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE),(Addressable) GERROR);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        if (GErrorException.isErrorSet(GERROR)) {
...
public static boolean dbusIsUniqueName(java.lang.String string) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_dbus_is_unique_name.invokeExact(Marshal.stringToAddress.marshal(string, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static PointerByte dbusUnescapeObjectPath(java.lang.String s) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_dbus_unescape_object_path.invokeExact(Marshal.stringToAddress.marshal(s, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static org.gtk.gio.IOErrorEnum ioErrorFromFileError(org.gtk.glib.FileError fileError) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.g_io_error_from_file_error.invokeExact(fileError.getValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.gtk.gio.IOErrorEnum.of(RESULT);
...
public static org.gtk.glib.List ioModulesLoadAllInDirectory(java.lang.String dirname) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_io_modules_load_all_in_directory.invokeExact(Marshal.stringToAddress.marshal(dirname, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        var OBJECT = org.gtk.glib.List.fromAddress.marshal(RESULT, null);
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_io_modules_load_all_in_directory_with_scope.invokeExact(
                    Marshal.stringToAddress.marshal(dirname, SCOPE),
                    scope.handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static void ioModulesScanAllInDirectory(java.lang.String dirname) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.g_io_modules_scan_all_in_directory.invokeExact(Marshal.stringToAddress.marshal(dirname, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    }
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_keyfile_settings_backend_new.invokeExact(
                    ...
                    Marshal.stringToAddress.marshal(rootPath, SCOPE),
                    (Addressable) (rootGroup == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(rootGroup, SCOPE)));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static boolean unixIsMountPathSystemInternal(java.lang.String mountPath) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_unix_is_mount_path_system_internal.invokeExact(Marshal.stringToAddress.marshal(mountPath, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean unixIsSystemDevicePath(java.lang.String devicePath) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_unix_is_system_device_path.invokeExact(Marshal.stringToAddress.marshal(devicePath, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean unixIsSystemFsType(java.lang.String fsType) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_unix_is_system_fs_type.invokeExact(Marshal.stringToAddress.marshal(fsType, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static @Nullable org.gtk.gio.UnixMountEntry unixMountAt(java.lang.String mountPath, Out<Long> timeRead) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        var OBJECT = org.gtk.gio.UnixMountEntry.fromAddress.marshal(RESULT, null);
        OBJECT.takeOwnership();
        return OBJECT;
    }
}
...
public static org.gtk.glib.List unixMountPointsGet(Out<Long> timeRead) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_unix_mount_points_get.invokeExact((Addressable) (timeRead == null ? MemoryAddress.NULL : (Addressable) timeReadPOINTER.address()));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
                if (timeRead != null) timeRead.set(timeReadPOINTER.get(Interop.valueLayout.C_LONG, 0));
...
public static org.gtk.glib.List unixMountsGet(Out<Long> timeRead) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_unix_mounts_get.invokeExact((Addressable) (timeRead == null ? MemoryAddress.NULL : (Addressable) timeReadPOINTER.address()));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
                if (timeRead != null) timeRead.set(timeReadPOINTER.get(Interop.valueLayout.C_LONG, 0));
...
private static final MethodHandle g_unix_mounts_get = Interop.downcallHandle(
    ...
    private static void registerTypes() {
        if (AppInfoMonitor.isAvailable()) Interop.register(AppInfoMonitor.getType(), AppInfoMonitor.fromAddress);
        ...
        if (ApplicationCommandLine.isAvailable()) Interop.register(ApplicationCommandLine.getType(), ApplicationCommandLine.fromAddress);
        if (BufferedInputStream.isAvailable()) Interop.register(BufferedInputStream.getType(), BufferedInputStream.fromAddress);
        if (BufferedOutputStream.isAvailable()) Interop.register(BufferedOutputStream.getType(), BufferedOutputStream.fromAddress);
        if (BytesIcon.isAvailable()) Interop.register(BytesIcon.getType(), BytesIcon.fromAddress);
        if (Cancellable.isAvailable()) Interop.register(Cancellable.getType(), Cancellable.fromAddress);
        if (CharsetConverter.isAvailable()) Interop.register(CharsetConverter.getType(), CharsetConverter.fromAddress);
        if (ConverterInputStream.isAvailable()) Interop.register(ConverterInputStream.getType(), ConverterInputStream.fromAddress);
        if (ConverterOutputStream.isAvailable()) Interop.register(ConverterOutputStream.getType(), ConverterOutputStream.fromAddress);
        if (Credentials.isAvailable()) Interop.register(Credentials.getType(), Credentials.fromAddress);
        if (DBusActionGroup.isAvailable()) Interop.register(DBusActionGroup.getType(), DBusActionGroup.fromAddress);
        if (DBusAuthObserver.isAvailable()) Interop.register(DBusAuthObserver.getType(), DBusAuthObserver.fromAddress);
        if (DBusConnection.isAvailable()) Interop.register(DBusConnection.getType(), DBusConnection.fromAddress);
        if (DBusInterfaceSkeleton.isAvailable()) Interop.register(DBusInterfaceSkeleton.getType(), DBusInterfaceSkeleton.fromAddress);
        if (DBusMenuModel.isAvailable()) Interop.register(DBusMenuModel.getType(), DBusMenuModel.fromAddress);
        if (DBusMessage.isAvailable()) Interop.register(DBusMessage.getType(), DBusMessage.fromAddress);
        if (DBusMethodInvocation.isAvailable()) Interop.register(DBusMethodInvocation.getType(), DBusMethodInvocation.fromAddress);
        if (DBusObjectManagerClient.isAvailable()) Interop.register(DBusObjectManagerClient.getType(), DBusObjectManagerClient.fromAddress);
        if (DBusObjectManagerServer.isAvailable()) Interop.register(DBusObjectManagerServer.getType(), DBusObjectManagerServer.fromAddress);
        if (DBusObjectProxy.isAvailable()) Interop.register(DBusObjectProxy.getType(), DBusObjectProxy.fromAddress);
        if (DBusObjectSkeleton.isAvailable()) Interop.register(DBusObjectSkeleton.getType(), DBusObjectSkeleton.fromAddress);
        if (DBusProxy.isAvailable()) Interop.register(DBusProxy.getType(), DBusProxy.fromAddress);
        if (DBusServer.isAvailable()) Interop.register(DBusServer.getType(), DBusServer.fromAddress);
        if (DataInputStream.isAvailable()) Interop.register(DataInputStream.getType(), DataInputStream.fromAddress);
        if (DataOutputStream.isAvailable()) Interop.register(DataOutputStream.getType(), DataOutputStream.fromAddress);
        if (DebugControllerDBus.isAvailable()) Interop.register(DebugControllerDBus.getType(), DebugControllerDBus.fromAddress);
        if (DesktopAppInfo.isAvailable()) Interop.register(DesktopAppInfo.getType(), DesktopAppInfo.fromAddress);
        if (Emblem.isAvailable()) Interop.register(Emblem.getType(), Emblem.fromAddress);
        if (EmblemedIcon.isAvailable()) Interop.register(EmblemedIcon.getType(), EmblemedIcon.fromAddress);
        if (FileEnumerator.isAvailable()) Interop.register(FileEnumerator.getType(), FileEnumerator.fromAddress);
        if (FileIOStream.isAvailable()) Interop.register(FileIOStream.getType(), FileIOStream.fromAddress);
        if (FileIcon.isAvailable()) Interop.register(FileIcon.getType(), FileIcon.fromAddress);
        if (FileInfo.isAvailable()) Interop.register(FileInfo.getType(), FileInfo.fromAddress);
        if (FileInputStream.isAvailable()) Interop.register(FileInputStream.getType(), FileInputStream.fromAddress);
        if (FileMonitor.isAvailable()) Interop.register(FileMonitor.getType(), FileMonitor.fromAddress);
        if (FileOutputStream.isAvailable()) Interop.register(FileOutputStream.getType(), FileOutputStream.fromAddress);
        if (FilenameCompleter.isAvailable()) Interop.register(FilenameCompleter.getType(), FilenameCompleter.fromAddress);
        if (FilterInputStream.isAvailable()) Interop.register(FilterInputStream.getType(), FilterInputStream.fromAddress);
        if (FilterOutputStream.isAvailable()) Interop.register(FilterOutputStream.getType(), FilterOutputStream.fromAddress);
        if (IOModule.isAvailable()) Interop.register(IOModule.getType(), IOModule.fromAddress);
        if (IOStream.isAvailable()) Interop.register(IOStream.getType(), IOStream.fromAddress);
        if (InetAddress.isAvailable()) Interop.register(InetAddress.getType(), InetAddress.fromAddress);
        if (InetAddressMask.isAvailable()) Interop.register(InetAddressMask.getType(), InetAddressMask.fromAddress);
        if (InetSocketAddress.isAvailable()) Interop.register(InetSocketAddress.getType(), InetSocketAddress.fromAddress);
        if (InputStream.isAvailable()) Interop.register(InputStream.getType(), InputStream.fromAddress);
        if (ListStore.isAvailable()) Interop.register(ListStore.getType(), ListStore.fromAddress);
        if (MemoryInputStream.isAvailable()) Interop.register(MemoryInputStream.getType(), MemoryInputStream.fromAddress);
        if (MemoryOutputStream.isAvailable()) Interop.register(MemoryOutputStream.getType(), MemoryOutputStream.fromAddress);
        if (Menu.isAvailable()) Interop.register(Menu.getType(), Menu.fromAddress);
        if (MenuAttributeIter.isAvailable()) Interop.register(MenuAttributeIter.getType(), MenuAttributeIter.fromAddress);
        if (MenuItem.isAvailable()) Interop.register(MenuItem.getType(), MenuItem.fromAddress);
        if (MenuLinkIter.isAvailable()) Interop.register(MenuLinkIter.getType(), MenuLinkIter.fromAddress);
        if (MenuModel.isAvailable()) Interop.register(MenuModel.getType(), MenuModel.fromAddress);
        if (MountOperation.isAvailable()) Interop.register(MountOperation.getType(), MountOperation.fromAddress);
        if (NativeSocketAddress.isAvailable()) Interop.register(NativeSocketAddress.getType(), NativeSocketAddress.fromAddress);
        if (NativeVolumeMonitor.isAvailable()) Interop.register(NativeVolumeMonitor.getType(), NativeVolumeMonitor.fromAddress);
        if (NetworkAddress.isAvailable()) Interop.register(NetworkAddress.getType(), NetworkAddress.fromAddress);
        if (NetworkService.isAvailable()) Interop.register(NetworkService.getType(), NetworkService.fromAddress);
        if (Notification.isAvailable()) Interop.register(Notification.getType(), Notification.fromAddress);
        if (OutputStream.isAvailable()) Interop.register(OutputStream.getType(), OutputStream.fromAddress);
        if (Permission.isAvailable()) Interop.register(Permission.getType(), Permission.fromAddress);
        if (PropertyAction.isAvailable()) Interop.register(PropertyAction.getType(), PropertyAction.fromAddress);
        if (ProxyAddress.isAvailable()) Interop.register(ProxyAddress.getType(), ProxyAddress.fromAddress);
        if (ProxyAddressEnumerator.isAvailable()) Interop.register(ProxyAddressEnumerator.getType(), ProxyAddressEnumerator.fromAddress);
        if (Resolver.isAvailable()) Interop.register(Resolver.getType(), Resolver.fromAddress);
        if (Settings.isAvailable()) Interop.register(Settings.getType(), Settings.fromAddress);
        if (SettingsBackend.isAvailable()) Interop.register(SettingsBackend.getType(), SettingsBackend.fromAddress);
        if (SimpleAction.isAvailable()) Interop.register(SimpleAction.getType(), SimpleAction.fromAddress);
        if (SimpleActionGroup.isAvailable()) Interop.register(SimpleActionGroup.getType(), SimpleActionGroup.fromAddress);
        if (SimpleAsyncResult.isAvailable()) Interop.register(SimpleAsyncResult.getType(), SimpleAsyncResult.fromAddress);
        if (SimpleIOStream.isAvailable()) Interop.register(SimpleIOStream.getType(), SimpleIOStream.fromAddress);
        if (SimplePermission.isAvailable()) Interop.register(SimplePermission.getType(), SimplePermission.fromAddress);
        if (SimpleProxyResolver.isAvailable()) Interop.register(SimpleProxyResolver.getType(), SimpleProxyResolver.fromAddress);
        if (Socket.isAvailable()) Interop.register(Socket.getType(), Socket.fromAddress);
        if (SocketAddress.isAvailable()) Interop.register(SocketAddress.getType(), SocketAddress.fromAddress);
        if (SocketAddressEnumerator.isAvailable()) Interop.register(SocketAddressEnumerator.getType(), SocketAddressEnumerator.fromAddress);
        if (SocketClient.isAvailable()) Interop.register(SocketClient.getType(), SocketClient.fromAddress);
        if (SocketConnection.isAvailable()) Interop.register(SocketConnection.getType(), SocketConnection.fromAddress);
        if (SocketControlMessage.isAvailable()) Interop.register(SocketControlMessage.getType(), SocketControlMessage.fromAddress);
        if (SocketListener.isAvailable()) Interop.register(SocketListener.getType(), SocketListener.fromAddress);
        if (SocketService.isAvailable()) Interop.register(SocketService.getType(), SocketService.fromAddress);
        if (Subprocess.isAvailable()) Interop.register(Subprocess.getType(), Subprocess.fromAddress);
        if (SubprocessLauncher.isAvailable()) Interop.register(SubprocessLauncher.getType(), SubprocessLauncher.fromAddress);
        if (Task.isAvailable()) Interop.register(Task.getType(), Task.fromAddress);
        if (TcpConnection.isAvailable()) Interop.register(TcpConnection.getType(), TcpConnection.fromAddress);
        if (TcpWrapperConnection.isAvailable()) Interop.register(TcpWrapperConnection.getType(), TcpWrapperConnection.fromAddress);
        if (TestDBus.isAvailable()) Interop.register(TestDBus.getType(), TestDBus.fromAddress);
        if (ThemedIcon.isAvailable()) Interop.register(ThemedIcon.getType(), ThemedIcon.fromAddress);
        if (ThreadedSocketService.isAvailable()) Interop.register(ThreadedSocketService.getType(), ThreadedSocketService.fromAddress);
        if (TlsCertificate.isAvailable()) Interop.register(TlsCertificate.getType(), TlsCertificate.fromAddress);
        if (TlsConnection.isAvailable()) Interop.register(TlsConnection.getType(), TlsConnection.fromAddress);
        if (TlsDatabase.isAvailable()) Interop.register(TlsDatabase.getType(), TlsDatabase.fromAddress);
        if (TlsInteraction.isAvailable()) Interop.register(TlsInteraction.getType(), TlsInteraction.fromAddress);
        if (TlsPassword.isAvailable()) Interop.register(TlsPassword.getType(), TlsPassword.fromAddress);
        if (UnixConnection.isAvailable()) Interop.register(UnixConnection.getType(), UnixConnection.fromAddress);
        if (UnixCredentialsMessage.isAvailable()) Interop.register(UnixCredentialsMessage.getType(), UnixCredentialsMessage.fromAddress);
        if (UnixFDList.isAvailable()) Interop.register(UnixFDList.getType(), UnixFDList.fromAddress);
        if (UnixFDMessage.isAvailable()) Interop.register(UnixFDMessage.getType(), UnixFDMessage.fromAddress);
        if (UnixInputStream.isAvailable()) Interop.register(UnixInputStream.getType(), UnixInputStream.fromAddress);
        if (UnixMountMonitor.isAvailable()) Interop.register(UnixMountMonitor.getType(), UnixMountMonitor.fromAddress);
        if (UnixOutputStream.isAvailable()) Interop.register(UnixOutputStream.getType(), UnixOutputStream.fromAddress);
        if (UnixSocketAddress.isAvailable()) Interop.register(UnixSocketAddress.getType(), UnixSocketAddress.fromAddress);
        if (Vfs.isAvailable()) Interop.register(Vfs.getType(), Vfs.fromAddress);
        if (VolumeMonitor.isAvailable()) Interop.register(VolumeMonitor.getType(), VolumeMonitor.fromAddress);
        if (ZlibCompressor.isAvailable()) Interop.register(ZlibCompressor.getType(), ZlibCompressor.fromAddress);
        if (ZlibDecompressor.isAvailable()) Interop.register(ZlibDecompressor.getType(), ZlibDecompressor.fromAddress);
        if (Action.isAvailable()) Interop.register(Action.getType(), Action.fromAddress);
        if (ActionGroup.isAvailable()) Interop.register(ActionGroup.getType(), ActionGroup.fromAddress);
        if (ActionMap.isAvailable()) Interop.register(ActionMap.getType(), ActionMap.fromAddress);
        if (AppInfo.isAvailable()) Interop.register(AppInfo.getType(), AppInfo.fromAddress);
        if (AsyncInitable.isAvailable()) Interop.register(AsyncInitable.getType(), AsyncInitable.fromAddress);
        if (AsyncResult.isAvailable()) Interop.register(AsyncResult.getType(), AsyncResult.fromAddress);
        if (Converter.isAvailable()) Interop.register(Converter.getType(), Converter.fromAddress);
        if (DBusInterface.isAvailable()) Interop.register(DBusInterface.getType(), DBusInterface.fromAddress);
        if (DBusObject.isAvailable()) Interop.register(DBusObject.getType(), DBusObject.fromAddress);
        if (DBusObjectManager.isAvailable()) Interop.register(DBusObjectManager.getType(), DBusObjectManager.fromAddress);
        if (DatagramBased.isAvailable()) Interop.register(DatagramBased.getType(), DatagramBased.fromAddress);
        if (DebugController.isAvailable()) Interop.register(DebugController.getType(), DebugController.fromAddress);
        if (DesktopAppInfoLookup.isAvailable()) Interop.register(DesktopAppInfoLookup.getType(), DesktopAppInfoLookup.fromAddress);
        if (Drive.isAvailable()) Interop.register(Drive.getType(), Drive.fromAddress);
        if (DtlsClientConnection.isAvailable()) Interop.register(DtlsClientConnection.getType(), DtlsClientConnection.fromAddress);
        if (DtlsConnection.isAvailable()) Interop.register(DtlsConnection.getType(), DtlsConnection.fromAddress);
        if (DtlsServerConnection.isAvailable()) Interop.register(DtlsServerConnection.getType(), DtlsServerConnection.fromAddress);
        if (File.isAvailable()) Interop.register(File.getType(), File.fromAddress);
        if (FileDescriptorBased.isAvailable()) Interop.register(FileDescriptorBased.getType(), FileDescriptorBased.fromAddress);
        if (Icon.isAvailable()) Interop.register(Icon.getType(), Icon.fromAddress);
        if (Initable.isAvailable()) Interop.register(Initable.getType(), Initable.fromAddress);
        if (ListModel.isAvailable()) Interop.register(ListModel.getType(), ListModel.fromAddress);
        if (LoadableIcon.isAvailable()) Interop.register(LoadableIcon.getType(), LoadableIcon.fromAddress);
        if (MemoryMonitor.isAvailable()) Interop.register(MemoryMonitor.getType(), MemoryMonitor.fromAddress);
        if (Mount.isAvailable()) Interop.register(Mount.getType(), Mount.fromAddress);
        if (NetworkMonitor.isAvailable()) Interop.register(NetworkMonitor.getType(), NetworkMonitor.fromAddress);
        if (PollableInputStream.isAvailable()) Interop.register(PollableInputStream.getType(), PollableInputStream.fromAddress);
        if (PollableOutputStream.isAvailable()) Interop.register(PollableOutputStream.getType(), PollableOutputStream.fromAddress);
        if (PowerProfileMonitor.isAvailable()) Interop.register(PowerProfileMonitor.getType(), PowerProfileMonitor.fromAddress);
        if (Proxy.isAvailable()) Interop.register(Proxy.getType(), Proxy.fromAddress);
        if (ProxyResolver.isAvailable()) Interop.register(ProxyResolver.getType(), ProxyResolver.fromAddress);
        if (RemoteActionGroup.isAvailable()) Interop.register(RemoteActionGroup.getType(), RemoteActionGroup.fromAddress);
        if (Seekable.isAvailable()) Interop.register(Seekable.getType(), Seekable.fromAddress);
        if (SocketConnectable.isAvailable()) Interop.register(SocketConnectable.getType(), SocketConnectable.fromAddress);
        if (TlsBackend.isAvailable()) Interop.register(TlsBackend.getType(), TlsBackend.fromAddress);
        if (TlsClientConnection.isAvailable()) Interop.register(TlsClientConnection.getType(), TlsClientConnection.fromAddress);
        if (TlsFileDatabase.isAvailable()) Interop.register(TlsFileDatabase.getType(), TlsFileDatabase.fromAddress);
        if (TlsServerConnection.isAvailable()) Interop.register(TlsServerConnection.getType(), TlsServerConnection.fromAddress);
        if (Volume.isAvailable()) Interop.register(Volume.getType(), Volume.fromAddress);
    }
}
