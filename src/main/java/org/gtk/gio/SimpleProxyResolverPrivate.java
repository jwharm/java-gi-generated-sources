...
public class SimpleProxyResolverPrivate extends Struct {
     ...
     */
    protected SimpleProxyResolverPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SimpleProxyResolverPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SimpleProxyResolverPrivate(input, ownership);
}
