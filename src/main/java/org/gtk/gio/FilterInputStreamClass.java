...
public class FilterInputStreamClass extends Struct {
    ...
    public static FilterInputStreamClass allocate() {
        ...
        FilterInputStreamClass newInstance = new FilterInputStreamClass(segment.address());
     ...
     */
    protected FilterInputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FilterInputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FilterInputStreamClass(input);
