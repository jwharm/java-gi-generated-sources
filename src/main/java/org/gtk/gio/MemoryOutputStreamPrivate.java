...
public class MemoryOutputStreamPrivate extends Struct {
    ...
    public static MemoryOutputStreamPrivate allocate() {
        ...
        MemoryOutputStreamPrivate newInstance = new MemoryOutputStreamPrivate(segment.address());
     ...
     */
    protected MemoryOutputStreamPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryOutputStreamPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MemoryOutputStreamPrivate(input);
}
