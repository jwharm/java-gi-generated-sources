...
public class ZlibCompressorClass extends Struct {
     ...
     */
    protected ZlibCompressorClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ZlibCompressorClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ZlibCompressorClass(input, ownership);
