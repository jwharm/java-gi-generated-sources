...
public class TcpWrapperConnectionClass extends Struct {
    ...
    public org.gtk.gio.TcpConnectionClass getParentClass() {
        ...
        return org.gtk.gio.TcpConnectionClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), Ownership.UNKNOWN);
    }
     ...
     */
    protected TcpWrapperConnectionClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TcpWrapperConnectionClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TcpWrapperConnectionClass(input, ownership);
