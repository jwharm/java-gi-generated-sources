...
public class FileInputStreamPrivate extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static FileInputStreamPrivate allocate() {
        ...
        FileInputStreamPrivate newInstance = new FileInputStreamPrivate(Refcounted.get(segment.address()));
        newInstance.allocatedMemorySegment = segment;
        return newInstance;
    }
    
    @ApiStatus.Internal
    public FileInputStreamPrivate(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
