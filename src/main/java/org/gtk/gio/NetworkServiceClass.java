...
public class NetworkServiceClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static NetworkServiceClass allocate() {
        ...
        NetworkServiceClass newInstance = new NetworkServiceClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public NetworkServiceClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
