...
public class NetworkServiceClass extends Struct {
    ...
    public static NetworkServiceClass allocate() {
        ...
        NetworkServiceClass newInstance = new NetworkServiceClass(segment.address());
     ...
     */
    protected NetworkServiceClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, NetworkServiceClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new NetworkServiceClass(input);
