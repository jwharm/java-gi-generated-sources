...
public class NetworkServiceClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public NetworkServiceClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private NetworkServiceClass struct;
        
         /**
         * A {@link NetworkServiceClass.Build} object constructs a {@link NetworkServiceClass} 
         ...
         */
        public NetworkServiceClass construct() {
            return struct;
        }
