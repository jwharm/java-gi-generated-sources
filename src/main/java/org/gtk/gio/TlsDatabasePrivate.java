...
public class TlsDatabasePrivate extends Struct {
     ...
     */
    protected TlsDatabasePrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TlsDatabasePrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TlsDatabasePrivate(input, ownership);
}
