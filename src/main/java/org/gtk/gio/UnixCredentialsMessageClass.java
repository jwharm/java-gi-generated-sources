...
public class UnixCredentialsMessageClass extends Struct {
     ...
     */
    protected UnixCredentialsMessageClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixCredentialsMessageClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new UnixCredentialsMessageClass(input, ownership);
