...
public class UnixCredentialsMessageClass extends Struct {
    ...
    public static UnixCredentialsMessageClass allocate() {
        ...
        UnixCredentialsMessageClass newInstance = new UnixCredentialsMessageClass(segment.address());
    ...
    public org.gtk.gio.SocketControlMessageClass getParentClass() {
        ...
        return org.gtk.gio.SocketControlMessageClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected UnixCredentialsMessageClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixCredentialsMessageClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new UnixCredentialsMessageClass(input);
    
    /**
     * A {@link UnixCredentialsMessageClass.Builder} object constructs a {@link UnixCredentialsMessageClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link UnixCredentialsMessageClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final UnixCredentialsMessageClass struct;
         ...
         */
        public UnixCredentialsMessageClass build() {
            return struct;
        }
