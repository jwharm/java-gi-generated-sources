...
public class DataOutputStreamClass extends Struct {
     ...
     */
    protected DataOutputStreamClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DataOutputStreamClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DataOutputStreamClass(input, ownership);
