...
public class DataOutputStreamClass extends Struct {
    ...
    public static DataOutputStreamClass allocate() {
        ...
        DataOutputStreamClass newInstance = new DataOutputStreamClass(segment.address());
    ...
    public org.gtk.gio.FilterOutputStreamClass getParentClass() {
        ...
        return org.gtk.gio.FilterOutputStreamClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected DataOutputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DataOutputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DataOutputStreamClass(input);
    
    /**
     * A {@link DataOutputStreamClass.Builder} object constructs a {@link DataOutputStreamClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link DataOutputStreamClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final DataOutputStreamClass struct;
         ...
         */
        public DataOutputStreamClass build() {
            return struct;
        }
