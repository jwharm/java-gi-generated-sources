...
public class ResolverPrivate extends Struct {
     ...
     */
    protected ResolverPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ResolverPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ResolverPrivate(input, ownership);
}
