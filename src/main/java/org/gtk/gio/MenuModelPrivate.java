...
public class MenuModelPrivate extends Struct {
     ...
     */
    protected MenuModelPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MenuModelPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MenuModelPrivate(input, ownership);
}
