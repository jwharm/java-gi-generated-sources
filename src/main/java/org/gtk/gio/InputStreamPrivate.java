...
public class InputStreamPrivate extends Struct {
     ...
     */
    protected InputStreamPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, InputStreamPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new InputStreamPrivate(input, ownership);
}
