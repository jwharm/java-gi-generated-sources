...
public class SocketServiceClass extends Struct {
    ...
    public static SocketServiceClass allocate() {
        ...
        SocketServiceClass newInstance = new SocketServiceClass(segment.address());
    ...
    public org.gtk.gio.SocketListenerClass getParentClass() {
        ...
        return org.gtk.gio.SocketListenerClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
    ...
    /**
     * Functional interface declaration of the {@code IncomingCallback} callback.
     */
    @FunctionalInterface
    public interface IncomingCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress service, MemoryAddress connection, MemoryAddress sourceObject) {
            var RESULT = run((org.gtk.gio.SocketService) Interop.register(service, org.gtk.gio.SocketService.fromAddress).marshal(service, null), (org.gtk.gio.SocketConnection) Interop.register(connection, org.gtk.gio.SocketConnection.fromAddress).marshal(connection, null), (org.gtk.gobject.GObject) Interop.register(sourceObject, org.gtk.gobject.GObject.fromAddress).marshal(sourceObject, null));
         ...
         */
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), IncomingCallback.class, DESCRIPTOR);
    ...
    public void setIncoming(IncomingCallback incoming) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (incoming == null ? MemoryAddress.NULL : incoming.toCallback()));
        }
    }
     ...
     */
    protected SocketServiceClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SocketServiceClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SocketServiceClass(input);
    ...
    public static class Builder {
        ...
        public Builder setIncoming(IncomingCallback incoming) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("incoming"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (incoming == null ? MemoryAddress.NULL : incoming.toCallback()));
                return this;
            }
        }
