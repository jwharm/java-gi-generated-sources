...
public class SocketServiceClass extends Struct {
     ...
     */
    public org.gtk.gio.SocketListenerClass parentClass$get() {
    ...
    public static class Build {
        ...
        private SocketServiceClass struct;
        
         /**
         * A {@link SocketServiceClass.Build} object constructs a {@link SocketServiceClass} 
         ...
         */
        public SocketServiceClass construct() {
            return struct;
        }
        
        public Build setParentClass(org.gtk.gio.SocketListenerClass parentClass) {
            getMemoryLayout()
        ...
        public Build setIncoming(java.lang.foreign.MemoryAddress incoming) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("incoming"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (incoming == null ? MemoryAddress.NULL : incoming));
            return this;
        }
