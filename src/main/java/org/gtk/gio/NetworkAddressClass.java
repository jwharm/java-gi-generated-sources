...
public class NetworkAddressClass extends Struct {
    ...
    public static NetworkAddressClass allocate() {
        ...
        NetworkAddressClass newInstance = new NetworkAddressClass(segment.address());
     ...
     */
    protected NetworkAddressClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, NetworkAddressClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new NetworkAddressClass(input);
