...
public class NetworkAddressClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static NetworkAddressClass allocate() {
        ...
        NetworkAddressClass newInstance = new NetworkAddressClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public NetworkAddressClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
