...
public class UnixInputStreamClass extends Struct {
    
    static {
        Gio.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "GUnixInputStreamClass";
    ...
    /**
     * Allocate a new {@link UnixInputStreamClass}
     * @return A new, uninitialized @{link UnixInputStreamClass}
     */
    public static UnixInputStreamClass allocate() {
        MemorySegment segment = Interop.getAllocator().allocate(getMemoryLayout());
        UnixInputStreamClass newInstance = new UnixInputStreamClass(segment.address(), Ownership.NONE);
     ...
     */
    protected UnixInputStreamClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixInputStreamClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new UnixInputStreamClass(input, ownership);
    
    /**
     * A {@link UnixInputStreamClass.Builder} object constructs a {@link UnixInputStreamClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link UnixInputStreamClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final UnixInputStreamClass struct;
        
        private Builder() {
            struct = UnixInputStreamClass.allocate();
        }
        
         /**
         * Finish building the {@link UnixInputStreamClass} struct.
         * @return A new instance of {@code UnixInputStreamClass} with the fields 
         *         that were set in the Builder object.
         */
        public UnixInputStreamClass build() {
            return struct;
        }
