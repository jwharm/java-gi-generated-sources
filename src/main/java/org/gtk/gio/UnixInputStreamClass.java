...
public class UnixInputStreamClass extends Struct {
    ...
    public static UnixInputStreamClass allocate() {
        ...
        UnixInputStreamClass newInstance = new UnixInputStreamClass(segment.address());
     ...
     */
    protected UnixInputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixInputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new UnixInputStreamClass(input);
