...
public class DBusObjectSkeletonClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static DBusObjectSkeletonClass allocate() {
        ...
        DBusObjectSkeletonClass newInstance = new DBusObjectSkeletonClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public DBusObjectSkeletonClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
