...
public class DBusObjectSkeletonClass extends Struct {
    ...
    public static class Build {
        ...
        public Build setAuthorizeMethod(java.lang.foreign.MemoryAddress authorizeMethod) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("authorize_method"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (authorizeMethod == null ? MemoryAddress.NULL : authorizeMethod));
            return this;
        }
