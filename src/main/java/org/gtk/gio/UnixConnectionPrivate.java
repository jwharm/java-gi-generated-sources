...
public class UnixConnectionPrivate extends Struct {
    ...
    public static UnixConnectionPrivate allocate() {
        ...
        UnixConnectionPrivate newInstance = new UnixConnectionPrivate(segment.address());
     ...
     */
    protected UnixConnectionPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixConnectionPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new UnixConnectionPrivate(input);
}
