...
public class MenuAttributeIterPrivate extends Struct {
    ...
    public static MenuAttributeIterPrivate allocate() {
        ...
        MenuAttributeIterPrivate newInstance = new MenuAttributeIterPrivate(segment.address());
     ...
     */
    protected MenuAttributeIterPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MenuAttributeIterPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MenuAttributeIterPrivate(input);
}
