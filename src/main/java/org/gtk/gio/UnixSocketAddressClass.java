...
public class UnixSocketAddressClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static UnixSocketAddressClass allocate() {
        ...
        UnixSocketAddressClass newInstance = new UnixSocketAddressClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public UnixSocketAddressClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
