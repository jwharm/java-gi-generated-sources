...
public class FileDescriptorBasedIface extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static FileDescriptorBasedIface allocate() {
        ...
        FileDescriptorBasedIface newInstance = new FileDescriptorBasedIface(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public FileDescriptorBasedIface(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
