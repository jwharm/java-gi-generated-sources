...
public class FileOutputStreamClass extends Struct {
    ...
    /**
     * Allocate a new {@link FileOutputStreamClass}
     * @return A new, uninitialized @{link FileOutputStreamClass}
     */
    public static FileOutputStreamClass allocate() {
        MemorySegment segment = MemorySession.openImplicit().allocate(getMemoryLayout());
        FileOutputStreamClass newInstance = new FileOutputStreamClass(segment.address());
    ...
    public interface TellCallback {
        ...
        long run(org.gtk.gio.FileOutputStream stream);
        
        @ApiStatus.Internal default long upcall(MemoryAddress stream) {
            var RESULT = run((org.gtk.gio.FileOutputStream) Interop.register(stream, org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, null));
            return RESULT;
        }
    ...
    public interface CanSeekCallback {
        ...
        boolean run(org.gtk.gio.FileOutputStream stream);
    ...
    public interface SeekCallback {
        ...
        boolean run(org.gtk.gio.FileOutputStream stream, long offset, org.gtk.glib.SeekType type, @Nullable org.gtk.gio.Cancellable cancellable);
        
        @ApiStatus.Internal default int upcall(MemoryAddress stream, long offset, int type, MemoryAddress cancellable) {
            var RESULT = run((org.gtk.gio.FileOutputStream) Interop.register(stream, org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, null), offset, org.gtk.glib.SeekType.of(type), (org.gtk.gio.Cancellable) Interop.register(cancellable, org.gtk.gio.Cancellable.fromAddress).marshal(cancellable, null));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
    ...
    public interface TruncateFnCallback {
        ...
        boolean run(org.gtk.gio.FileOutputStream stream, long size, @Nullable org.gtk.gio.Cancellable cancellable);
        
        @ApiStatus.Internal default int upcall(MemoryAddress stream, long size, MemoryAddress cancellable) {
            var RESULT = run((org.gtk.gio.FileOutputStream) Interop.register(stream, org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, null), size, (org.gtk.gio.Cancellable) Interop.register(cancellable, org.gtk.gio.Cancellable.fromAddress).marshal(cancellable, null));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
    ...
    public interface QueryInfoCallback {
        ...
        org.gtk.gio.FileInfo run(org.gtk.gio.FileOutputStream stream, java.lang.String attributes, @Nullable org.gtk.gio.Cancellable cancellable);
        
        @ApiStatus.Internal default Addressable upcall(MemoryAddress stream, MemoryAddress attributes, MemoryAddress cancellable) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                var RESULT = run((org.gtk.gio.FileOutputStream) Interop.register(stream, org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, null), Marshal.addressToString.marshal(attributes, null), (org.gtk.gio.Cancellable) Interop.register(cancellable, org.gtk.gio.Cancellable.fromAddress).marshal(cancellable, null));
    ...
    public interface QueryInfoAsyncCallback {
        ...
        void run(org.gtk.gio.FileOutputStream stream, java.lang.String attributes, int ioPriority, @Nullable org.gtk.gio.Cancellable cancellable, @Nullable org.gtk.gio.AsyncReadyCallback callback);
    ...
    public interface QueryInfoFinishCallback {
        ...
        org.gtk.gio.FileInfo run(org.gtk.gio.FileOutputStream stream, org.gtk.gio.AsyncResult result);
        
        @ApiStatus.Internal default Addressable upcall(MemoryAddress stream, MemoryAddress result) {
            var RESULT = run((org.gtk.gio.FileOutputStream) Interop.register(stream, org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, null), (org.gtk.gio.AsyncResult) Interop.register(result, org.gtk.gio.AsyncResult.fromAddress).marshal(result, null));
            RESULT.yieldOwnership();
            return RESULT == null ? MemoryAddress.NULL.address() : (RESULT.handle()).address();
        }
    ...
    public interface GetEtagCallback {
        ...
        @Nullable java.lang.String run(org.gtk.gio.FileOutputStream stream);
     ...
     */
    protected FileOutputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FileOutputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FileOutputStreamClass(input);
    
    /**
     * A {@link FileOutputStreamClass.Builder} object constructs a {@link FileOutputStreamClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link FileOutputStreamClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final FileOutputStreamClass struct;
        
        private Builder() {
            struct = FileOutputStreamClass.allocate();
        }
        
        /**
         * Finish building the {@link FileOutputStreamClass} struct.
         * @return A new instance of {@code FileOutputStreamClass} with the fields 
         *         that were set in the Builder object.
         */
        public FileOutputStreamClass build() {
            return struct;
        }
