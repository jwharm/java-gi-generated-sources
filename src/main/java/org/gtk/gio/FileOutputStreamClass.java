...
public class FileOutputStreamClass extends Struct {
    ...
    public static FileOutputStreamClass allocate() {
        ...
        FileOutputStreamClass newInstance = new FileOutputStreamClass(segment.address(), Ownership.NONE);
    ...
    public interface TellCallback {
        ...
        @ApiStatus.Internal default long upcall(MemoryAddress stream) {
            var RESULT = run((org.gtk.gio.FileOutputStream) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(stream)), org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, Ownership.NONE));
            return RESULT;
        }
    ...
    public interface SeekCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress stream, long offset, int type, MemoryAddress cancellable) {
            var RESULT = run((org.gtk.gio.FileOutputStream) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(stream)), org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, Ownership.NONE), offset, org.gtk.glib.SeekType.of(type), (org.gtk.gio.Cancellable) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(cancellable)), org.gtk.gio.Cancellable.fromAddress).marshal(cancellable, Ownership.NONE));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
    ...
    public interface TruncateFnCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress stream, long size, MemoryAddress cancellable) {
            var RESULT = run((org.gtk.gio.FileOutputStream) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(stream)), org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, Ownership.NONE), size, (org.gtk.gio.Cancellable) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(cancellable)), org.gtk.gio.Cancellable.fromAddress).marshal(cancellable, Ownership.NONE));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
    ...
    public interface QueryInfoCallback {
        ...
        @ApiStatus.Internal default Addressable upcall(MemoryAddress stream, MemoryAddress attributes, MemoryAddress cancellable) {
            var RESULT = run((org.gtk.gio.FileOutputStream) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(stream)), org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, Ownership.NONE), Marshal.addressToString.marshal(attributes, null), (org.gtk.gio.Cancellable) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(cancellable)), org.gtk.gio.Cancellable.fromAddress).marshal(cancellable, Ownership.NONE));
    ...
    public interface QueryInfoFinishCallback {
        ...
        @ApiStatus.Internal default Addressable upcall(MemoryAddress stream, MemoryAddress result) {
            var RESULT = run((org.gtk.gio.FileOutputStream) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(stream)), org.gtk.gio.FileOutputStream.fromAddress).marshal(stream, Ownership.NONE), (org.gtk.gio.AsyncResult) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(result)), org.gtk.gio.AsyncResult.fromAddress).marshal(result, Ownership.NONE));
            return RESULT == null ? MemoryAddress.NULL.address() : (RESULT.handle()).address();
        }
     ...
     */
    protected FileOutputStreamClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, FileOutputStreamClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new FileOutputStreamClass(input, ownership);
