...
public class FileOutputStreamPrivate extends Struct {
     ...
     */
    protected FileOutputStreamPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, FileOutputStreamPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new FileOutputStreamPrivate(input, ownership);
}
