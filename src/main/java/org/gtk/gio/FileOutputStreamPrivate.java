...
public class FileOutputStreamPrivate extends Struct {
    ...
    public static FileOutputStreamPrivate allocate() {
        ...
        FileOutputStreamPrivate newInstance = new FileOutputStreamPrivate(segment.address());
     ...
     */
    protected FileOutputStreamPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FileOutputStreamPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FileOutputStreamPrivate(input);
}
