...
public class FilenameCompleterClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static FilenameCompleterClass allocate() {
        ...
        FilenameCompleterClass newInstance = new FilenameCompleterClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public FilenameCompleterClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
