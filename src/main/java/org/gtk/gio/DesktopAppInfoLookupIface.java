...
public class DesktopAppInfoLookupIface extends Struct {
    ...
    public static class Build {
        ...
        public Build setGetDefaultForUriScheme(java.lang.foreign.MemoryAddress getDefaultForUriScheme) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("get_default_for_uri_scheme"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getDefaultForUriScheme == null ? MemoryAddress.NULL : getDefaultForUriScheme));
            return this;
        }
    }
}
