...
public class TlsCertificateClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static TlsCertificateClass allocate() {
        ...
        TlsCertificateClass newInstance = new TlsCertificateClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public TlsCertificateClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
