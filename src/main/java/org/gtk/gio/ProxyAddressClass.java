...
public class ProxyAddressClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static ProxyAddressClass allocate() {
        ...
        ProxyAddressClass newInstance = new ProxyAddressClass(Refcounted.get(segment.address()));
    ...
    public org.gtk.gio.InetSocketAddressClass parent_class$get() {
        ...
        return new org.gtk.gio.InetSocketAddressClass(Refcounted.get(((MemoryAddress) handle()).addOffset(OFFSET), false));
    }
    
    @ApiStatus.Internal
    public ProxyAddressClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
