...
public class InetAddressMaskPrivate extends Struct {
     ...
     */
    protected InetAddressMaskPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, InetAddressMaskPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new InetAddressMaskPrivate(input, ownership);
}
