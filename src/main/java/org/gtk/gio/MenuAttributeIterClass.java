...
public class MenuAttributeIterClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static MenuAttributeIterClass allocate() {
        ...
        MenuAttributeIterClass newInstance = new MenuAttributeIterClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public MenuAttributeIterClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
