...
public class SimpleProxyResolverClass extends Struct {
    ...
    public static SimpleProxyResolverClass allocate() {
        ...
        SimpleProxyResolverClass newInstance = new SimpleProxyResolverClass(segment.address());
     ...
     */
    protected SimpleProxyResolverClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SimpleProxyResolverClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SimpleProxyResolverClass(input);
