...
public class SimpleProxyResolverClass extends Struct {
    
    static {
        Gio.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "GSimpleProxyResolverClass";
    ...
    /**
     * Allocate a new {@link SimpleProxyResolverClass}
     * @return A new, uninitialized @{link SimpleProxyResolverClass}
     */
    public static SimpleProxyResolverClass allocate() {
        MemorySegment segment = Interop.getAllocator().allocate(getMemoryLayout());
        SimpleProxyResolverClass newInstance = new SimpleProxyResolverClass(segment.address(), Ownership.NONE);
     ...
     */
    protected SimpleProxyResolverClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SimpleProxyResolverClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SimpleProxyResolverClass(input, ownership);
    
    /**
     * A {@link SimpleProxyResolverClass.Builder} object constructs a {@link SimpleProxyResolverClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link SimpleProxyResolverClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final SimpleProxyResolverClass struct;
        
        private Builder() {
            struct = SimpleProxyResolverClass.allocate();
        }
        
         /**
         * Finish building the {@link SimpleProxyResolverClass} struct.
         * @return A new instance of {@code SimpleProxyResolverClass} with the fields 
         *         that were set in the Builder object.
         */
        public SimpleProxyResolverClass build() {
            return struct;
        }
