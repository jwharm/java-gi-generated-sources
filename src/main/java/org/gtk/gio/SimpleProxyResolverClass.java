...
public class SimpleProxyResolverClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public SimpleProxyResolverClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private SimpleProxyResolverClass struct;
        
         /**
         * A {@link SimpleProxyResolverClass.Build} object constructs a {@link SimpleProxyResolverClass} 
         ...
         */
        public SimpleProxyResolverClass construct() {
            return struct;
        }
