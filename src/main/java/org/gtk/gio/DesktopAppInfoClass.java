...
public class DesktopAppInfoClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static DesktopAppInfoClass allocate() {
        ...
        DesktopAppInfoClass newInstance = new DesktopAppInfoClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public DesktopAppInfoClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
