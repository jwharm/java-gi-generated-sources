...
public class DesktopAppInfoClass extends Struct {
    ...
    public static DesktopAppInfoClass allocate() {
        ...
        DesktopAppInfoClass newInstance = new DesktopAppInfoClass(segment.address());
     ...
     */
    protected DesktopAppInfoClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DesktopAppInfoClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DesktopAppInfoClass(input);
