...
public class ProxyAddressEnumeratorClass extends Struct {
    ...
    public static ProxyAddressEnumeratorClass allocate() {
        ...
        ProxyAddressEnumeratorClass newInstance = new ProxyAddressEnumeratorClass(segment.address());
     ...
     */
    protected ProxyAddressEnumeratorClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ProxyAddressEnumeratorClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ProxyAddressEnumeratorClass(input);
