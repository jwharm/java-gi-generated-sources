...
public class PermissionPrivate extends Struct {
    ...
    public static PermissionPrivate allocate() {
        ...
        PermissionPrivate newInstance = new PermissionPrivate(segment.address());
     ...
     */
    protected PermissionPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PermissionPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PermissionPrivate(input);
}
