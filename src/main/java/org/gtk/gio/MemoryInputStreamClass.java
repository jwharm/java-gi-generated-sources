...
public class MemoryInputStreamClass extends Struct {
    
    static {
        Gio.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "GMemoryInputStreamClass";
    ...
    /**
     * Allocate a new {@link MemoryInputStreamClass}
     * @return A new, uninitialized @{link MemoryInputStreamClass}
     */
    public static MemoryInputStreamClass allocate() {
        MemorySegment segment = Interop.getAllocator().allocate(getMemoryLayout());
        MemoryInputStreamClass newInstance = new MemoryInputStreamClass(segment.address(), Ownership.NONE);
     ...
     */
    protected MemoryInputStreamClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryInputStreamClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MemoryInputStreamClass(input, ownership);
    
    /**
     * A {@link MemoryInputStreamClass.Builder} object constructs a {@link MemoryInputStreamClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link MemoryInputStreamClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final MemoryInputStreamClass struct;
        
        private Builder() {
            struct = MemoryInputStreamClass.allocate();
        }
        
         /**
         * Finish building the {@link MemoryInputStreamClass} struct.
         * @return A new instance of {@code MemoryInputStreamClass} with the fields 
         *         that were set in the Builder object.
         */
        public MemoryInputStreamClass build() {
            return struct;
        }
