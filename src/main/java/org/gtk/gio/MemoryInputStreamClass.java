...
public class MemoryInputStreamClass extends Struct {
    ...
    public static MemoryInputStreamClass allocate() {
        ...
        MemoryInputStreamClass newInstance = new MemoryInputStreamClass(segment.address());
     ...
     */
    protected MemoryInputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryInputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MemoryInputStreamClass(input);
