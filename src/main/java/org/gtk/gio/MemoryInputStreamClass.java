...
public class MemoryInputStreamClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public MemoryInputStreamClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private MemoryInputStreamClass struct;
        
         /**
         * A {@link MemoryInputStreamClass.Build} object constructs a {@link MemoryInputStreamClass} 
         ...
         */
        public MemoryInputStreamClass construct() {
            return struct;
        }
