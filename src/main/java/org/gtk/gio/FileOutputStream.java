...
public class FileOutputStream extends org.gtk.gio.OutputStream implements org.gtk.gio.Seekable {
     ...
     */
    protected FileOutputStream(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, FileOutputStream> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new FileOutputStream(input);
    ...
    public static boolean isAvailable() {
        return DowncallHandles.g_file_output_stream_get_type != null;
    }
}
