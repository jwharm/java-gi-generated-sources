...
public class BufferedInputStreamClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static BufferedInputStreamClass allocate() {
        ...
        BufferedInputStreamClass newInstance = new BufferedInputStreamClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public BufferedInputStreamClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
