...
public class DBusProxyPrivate extends Struct {
     ...
     */
    protected DBusProxyPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DBusProxyPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DBusProxyPrivate(input, ownership);
}
