...
public class SocketConnectionClass extends Struct {
    ...
    public static SocketConnectionClass allocate() {
        ...
        SocketConnectionClass newInstance = new SocketConnectionClass(segment.address(), Ownership.NONE);
     ...
     */
    protected SocketConnectionClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SocketConnectionClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SocketConnectionClass(input, ownership);
