...
public class SocketConnectionClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public SocketConnectionClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private SocketConnectionClass struct;
        
         /**
         * A {@link SocketConnectionClass.Build} object constructs a {@link SocketConnectionClass} 
         ...
         */
        public SocketConnectionClass construct() {
            return struct;
        }
