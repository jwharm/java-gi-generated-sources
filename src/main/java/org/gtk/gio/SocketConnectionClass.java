...
public class SocketConnectionClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static SocketConnectionClass allocate() {
        ...
        SocketConnectionClass newInstance = new SocketConnectionClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public SocketConnectionClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
