...
public class IOModuleClass extends Struct {
     ...
     */
    protected IOModuleClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, IOModuleClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new IOModuleClass(input, ownership);
}
