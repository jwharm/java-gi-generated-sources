...
public class TlsConnectionPrivate extends Struct {
     ...
     */
    protected TlsConnectionPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TlsConnectionPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TlsConnectionPrivate(input, ownership);
}
