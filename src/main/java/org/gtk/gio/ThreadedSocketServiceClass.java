...
public class ThreadedSocketServiceClass extends Struct {
    ...
    public static ThreadedSocketServiceClass allocate() {
        ...
        ThreadedSocketServiceClass newInstance = new ThreadedSocketServiceClass(segment.address());
    ...
    public org.gtk.gio.SocketServiceClass getParentClass() {
        ...
        return org.gtk.gio.SocketServiceClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected ThreadedSocketServiceClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ThreadedSocketServiceClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ThreadedSocketServiceClass(input);
