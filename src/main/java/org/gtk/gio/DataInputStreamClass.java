...
public class DataInputStreamClass extends Struct {
    ...
    public org.gtk.gio.BufferedInputStreamClass getParentClass() {
        ...
        return org.gtk.gio.BufferedInputStreamClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), Ownership.UNKNOWN);
    }
     ...
     */
    protected DataInputStreamClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DataInputStreamClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DataInputStreamClass(input, ownership);
