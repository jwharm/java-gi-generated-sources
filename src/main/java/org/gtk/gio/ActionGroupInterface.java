...
public class ActionGroupInterface extends Struct {
    ...
    public interface HasActionCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress actionGroup, MemoryAddress actionName) {
            var RESULT = run((org.gtk.gio.ActionGroup) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(actionGroup)), org.gtk.gio.ActionGroup.fromAddress).marshal(actionGroup, Ownership.NONE), Marshal.addressToString.marshal(actionName, null));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
        
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.of(Interop.valueLayout.C_INT, Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(HasActionCallback.class, DESCRIPTOR);
    ...
    public void setHasAction(HasActionCallback hasAction) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (hasAction == null ? MemoryAddress.NULL : hasAction.toCallback()));
    }
    ...
    public interface ListActionsCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress actionGroup) {
            run((org.gtk.gio.ActionGroup) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(actionGroup)), org.gtk.gio.ActionGroup.fromAddress).marshal(actionGroup, Ownership.NONE));
        }
        
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.ofVoid(Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(ListActionsCallback.class, DESCRIPTOR);
    ...
    public void setListActions(ListActionsCallback listActions) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (listActions == null ? MemoryAddress.NULL : listActions.toCallback()));
    }
    ...
    public interface GetActionEnabledCallback {
        ...
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.of(Interop.valueLayout.C_INT, Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(GetActionEnabledCallback.class, DESCRIPTOR);
    ...
    public void setGetActionEnabled(GetActionEnabledCallback getActionEnabled) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionEnabled == null ? MemoryAddress.NULL : getActionEnabled.toCallback()));
    }
    ...
    public interface GetActionParameterTypeCallback {
        ...
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(GetActionParameterTypeCallback.class, DESCRIPTOR);
    ...
    public void setGetActionParameterType(GetActionParameterTypeCallback getActionParameterType) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionParameterType == null ? MemoryAddress.NULL : getActionParameterType.toCallback()));
    }
    ...
    public interface GetActionStateTypeCallback {
        ...
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.of(Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(GetActionStateTypeCallback.class, DESCRIPTOR);
    ...
    public void setGetActionStateType(GetActionStateTypeCallback getActionStateType) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionStateType == null ? MemoryAddress.NULL : getActionStateType.toCallback()));
    }
    ...
    public interface GetActionStateHintCallback {
        ...
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.of(Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(GetActionStateHintCallback.class, DESCRIPTOR);
    ...
    public void setGetActionStateHint(GetActionStateHintCallback getActionStateHint) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionStateHint == null ? MemoryAddress.NULL : getActionStateHint.toCallback()));
    }
    ...
    public interface GetActionStateCallback {
        ...
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.of(Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(GetActionStateCallback.class, DESCRIPTOR);
    ...
    public void setGetActionState(GetActionStateCallback getActionState) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionState == null ? MemoryAddress.NULL : getActionState.toCallback()));
    }
    ...
    public interface ChangeActionStateCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress actionGroup, MemoryAddress actionName, MemoryAddress value) {
            run((org.gtk.gio.ActionGroup) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(actionGroup)), org.gtk.gio.ActionGroup.fromAddress).marshal(actionGroup, Ownership.NONE), Marshal.addressToString.marshal(actionName, null), org.gtk.glib.Variant.fromAddress.marshal(value, Ownership.NONE));
        }
        
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.ofVoid(Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(ChangeActionStateCallback.class, DESCRIPTOR);
    ...
    public void setChangeActionState(ChangeActionStateCallback changeActionState) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (changeActionState == null ? MemoryAddress.NULL : changeActionState.toCallback()));
    }
    ...
    public interface ActivateActionCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress actionGroup, MemoryAddress actionName, MemoryAddress parameter) {
            run((org.gtk.gio.ActionGroup) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(actionGroup)), org.gtk.gio.ActionGroup.fromAddress).marshal(actionGroup, Ownership.NONE), Marshal.addressToString.marshal(actionName, null), org.gtk.glib.Variant.fromAddress.marshal(parameter, Ownership.NONE));
        }
        
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.ofVoid(Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(ActivateActionCallback.class, DESCRIPTOR);
    ...
    public void setActivateAction(ActivateActionCallback activateAction) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (activateAction == null ? MemoryAddress.NULL : activateAction.toCallback()));
    }
    ...
    public interface ActionAddedCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress actionGroup, MemoryAddress actionName) {
            run((org.gtk.gio.ActionGroup) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(actionGroup)), org.gtk.gio.ActionGroup.fromAddress).marshal(actionGroup, Ownership.NONE), Marshal.addressToString.marshal(actionName, null));
        }
        
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.ofVoid(Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(ActionAddedCallback.class, DESCRIPTOR);
    ...
    public void setActionAdded(ActionAddedCallback actionAdded) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (actionAdded == null ? MemoryAddress.NULL : actionAdded.toCallback()));
    }
    ...
    public interface ActionRemovedCallback {
        ...
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.ofVoid(Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(ActionRemovedCallback.class, DESCRIPTOR);
    ...
    public void setActionRemoved(ActionRemovedCallback actionRemoved) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (actionRemoved == null ? MemoryAddress.NULL : actionRemoved.toCallback()));
    }
    ...
    public interface ActionEnabledChangedCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress actionGroup, MemoryAddress actionName, int enabled) {
            run((org.gtk.gio.ActionGroup) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(actionGroup)), org.gtk.gio.ActionGroup.fromAddress).marshal(actionGroup, Ownership.NONE), Marshal.addressToString.marshal(actionName, null), Marshal.integerToBoolean.marshal(enabled, null).booleanValue());
        }
        ...
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(ActionEnabledChangedCallback.class, DESCRIPTOR);
    ...
    public void setActionEnabledChanged(ActionEnabledChangedCallback actionEnabledChanged) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (actionEnabledChanged == null ? MemoryAddress.NULL : actionEnabledChanged.toCallback()));
    }
    ...
    public interface ActionStateChangedCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress actionGroup, MemoryAddress actionName, MemoryAddress state) {
            run((org.gtk.gio.ActionGroup) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(actionGroup)), org.gtk.gio.ActionGroup.fromAddress).marshal(actionGroup, Ownership.NONE), Marshal.addressToString.marshal(actionName, null), org.gtk.glib.Variant.fromAddress.marshal(state, Ownership.NONE));
        }
        
        @ApiStatus.Internal FunctionDescriptor DESCRIPTOR = FunctionDescriptor.ofVoid(Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS, Interop.valueLayout.ADDRESS);
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(ActionStateChangedCallback.class, DESCRIPTOR);
    ...
    public void setActionStateChanged(ActionStateChangedCallback actionStateChanged) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (actionStateChanged == null ? MemoryAddress.NULL : actionStateChanged.toCallback()));
    }
    ...
    public interface QueryActionCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress actionGroup, MemoryAddress actionName, MemoryAddress enabled, MemoryAddress parameterType, MemoryAddress stateType, MemoryAddress stateHint, MemoryAddress state) {
            ...
            Out<org.gtk.glib.VariantType> parameterTypeOUT = new Out<>(org.gtk.glib.VariantType.fromAddress.marshal(parameterType, Ownership.NONE));
            Out<org.gtk.glib.VariantType> stateTypeOUT = new Out<>(org.gtk.glib.VariantType.fromAddress.marshal(stateType, Ownership.NONE));
            Out<org.gtk.glib.Variant> stateHintOUT = new Out<>(org.gtk.glib.Variant.fromAddress.marshal(stateHint, Ownership.FULL));
            Out<org.gtk.glib.Variant> stateOUT = new Out<>(org.gtk.glib.Variant.fromAddress.marshal(state, Ownership.FULL));
            var RESULT = run((org.gtk.gio.ActionGroup) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(actionGroup)), org.gtk.gio.ActionGroup.fromAddress).marshal(actionGroup, Ownership.NONE), Marshal.addressToString.marshal(actionName, null), enabledOUT, parameterTypeOUT, stateTypeOUT, stateHintOUT, stateOUT);
        ...
        @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(QueryActionCallback.class, DESCRIPTOR);
    ...
    public void setQueryAction(QueryActionCallback queryAction) {
        getMemoryLayout()
            ...
            .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (queryAction == null ? MemoryAddress.NULL : queryAction.toCallback()));
    }
     ...
     */
    protected ActionGroupInterface(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ActionGroupInterface> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ActionGroupInterface(input, ownership);
    ...
    public static class Builder {
        ...
        public Builder setHasAction(HasActionCallback hasAction) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("has_action"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (hasAction == null ? MemoryAddress.NULL : hasAction.toCallback()));
            return this;
        }
        ...
        public Builder setListActions(ListActionsCallback listActions) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("list_actions"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (listActions == null ? MemoryAddress.NULL : listActions.toCallback()));
            return this;
        }
        ...
        public Builder setGetActionEnabled(GetActionEnabledCallback getActionEnabled) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("get_action_enabled"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionEnabled == null ? MemoryAddress.NULL : getActionEnabled.toCallback()));
            return this;
        }
        ...
        public Builder setGetActionParameterType(GetActionParameterTypeCallback getActionParameterType) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("get_action_parameter_type"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionParameterType == null ? MemoryAddress.NULL : getActionParameterType.toCallback()));
            return this;
        }
        ...
        public Builder setGetActionStateType(GetActionStateTypeCallback getActionStateType) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("get_action_state_type"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionStateType == null ? MemoryAddress.NULL : getActionStateType.toCallback()));
            return this;
        }
        ...
        public Builder setGetActionStateHint(GetActionStateHintCallback getActionStateHint) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("get_action_state_hint"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionStateHint == null ? MemoryAddress.NULL : getActionStateHint.toCallback()));
            return this;
        }
        ...
        public Builder setGetActionState(GetActionStateCallback getActionState) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("get_action_state"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (getActionState == null ? MemoryAddress.NULL : getActionState.toCallback()));
            return this;
        }
        ...
        public Builder setChangeActionState(ChangeActionStateCallback changeActionState) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("change_action_state"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (changeActionState == null ? MemoryAddress.NULL : changeActionState.toCallback()));
            return this;
        }
        ...
        public Builder setActivateAction(ActivateActionCallback activateAction) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("activate_action"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (activateAction == null ? MemoryAddress.NULL : activateAction.toCallback()));
            return this;
        }
        ...
        public Builder setActionAdded(ActionAddedCallback actionAdded) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("action_added"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (actionAdded == null ? MemoryAddress.NULL : actionAdded.toCallback()));
            return this;
        }
        ...
        public Builder setActionRemoved(ActionRemovedCallback actionRemoved) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("action_removed"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (actionRemoved == null ? MemoryAddress.NULL : actionRemoved.toCallback()));
            return this;
        }
        ...
        public Builder setActionEnabledChanged(ActionEnabledChangedCallback actionEnabledChanged) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("action_enabled_changed"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (actionEnabledChanged == null ? MemoryAddress.NULL : actionEnabledChanged.toCallback()));
            return this;
        }
        ...
        public Builder setActionStateChanged(ActionStateChangedCallback actionStateChanged) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("action_state_changed"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (actionStateChanged == null ? MemoryAddress.NULL : actionStateChanged.toCallback()));
            return this;
        }
        ...
        public Builder setQueryAction(QueryActionCallback queryAction) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("query_action"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (queryAction == null ? MemoryAddress.NULL : queryAction.toCallback()));
            return this;
        }
    }
}
