...
public class FileEnumeratorClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static FileEnumeratorClass allocate() {
        ...
        FileEnumeratorClass newInstance = new FileEnumeratorClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public FileEnumeratorClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
