...
public class ConverterInputStreamClass extends Struct {
    ...
    /**
     * Allocate a new {@link ConverterInputStreamClass}
     * @return A new, uninitialized @{link ConverterInputStreamClass}
     */
    public static ConverterInputStreamClass allocate() {
        MemorySegment segment = MemorySession.openImplicit().allocate(getMemoryLayout());
        ConverterInputStreamClass newInstance = new ConverterInputStreamClass(segment.address());
     ...
     */
    protected ConverterInputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ConverterInputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ConverterInputStreamClass(input);
    
    /**
     * A {@link ConverterInputStreamClass.Builder} object constructs a {@link ConverterInputStreamClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link ConverterInputStreamClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final ConverterInputStreamClass struct;
        
        private Builder() {
            struct = ConverterInputStreamClass.allocate();
        }
        
        /**
         * Finish building the {@link ConverterInputStreamClass} struct.
         * @return A new instance of {@code ConverterInputStreamClass} with the fields 
         *         that were set in the Builder object.
         */
        public ConverterInputStreamClass build() {
            return struct;
        }
