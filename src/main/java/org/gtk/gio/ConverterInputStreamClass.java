...
public class ConverterInputStreamClass extends Struct {
     ...
     */
    protected ConverterInputStreamClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ConverterInputStreamClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ConverterInputStreamClass(input, ownership);
