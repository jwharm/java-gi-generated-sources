...
public class SimpleActionGroupPrivate extends Struct {
     ...
     */
    protected SimpleActionGroupPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SimpleActionGroupPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SimpleActionGroupPrivate(input, ownership);
}
