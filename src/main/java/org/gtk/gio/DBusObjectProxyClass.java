...
public class DBusObjectProxyClass extends Struct {
    ...
    public static DBusObjectProxyClass allocate() {
        ...
        DBusObjectProxyClass newInstance = new DBusObjectProxyClass(segment.address());
     ...
     */
    protected DBusObjectProxyClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DBusObjectProxyClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DBusObjectProxyClass(input);
    
    /**
     * A {@link DBusObjectProxyClass.Builder} object constructs a {@link DBusObjectProxyClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link DBusObjectProxyClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final DBusObjectProxyClass struct;
         ...
         */
        public DBusObjectProxyClass build() {
            return struct;
        }
