...
public class CharsetConverterClass extends Struct {
    ...
    public static CharsetConverterClass allocate() {
        ...
        CharsetConverterClass newInstance = new CharsetConverterClass(segment.address());
     ...
     */
    protected CharsetConverterClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CharsetConverterClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CharsetConverterClass(input);
