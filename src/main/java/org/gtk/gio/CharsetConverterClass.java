...
public class CharsetConverterClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public CharsetConverterClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private CharsetConverterClass struct;
        
         /**
         * A {@link CharsetConverterClass.Build} object constructs a {@link CharsetConverterClass} 
         ...
         */
        public CharsetConverterClass construct() {
            return struct;
        }
