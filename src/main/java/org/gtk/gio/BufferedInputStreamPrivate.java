...
public class BufferedInputStreamPrivate extends Struct {
    ...
    public static BufferedInputStreamPrivate allocate() {
        ...
        BufferedInputStreamPrivate newInstance = new BufferedInputStreamPrivate(segment.address());
     ...
     */
    protected BufferedInputStreamPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferedInputStreamPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BufferedInputStreamPrivate(input);
}
