...
public class InetSocketAddressClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static InetSocketAddressClass allocate() {
        ...
        InetSocketAddressClass newInstance = new InetSocketAddressClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public InetSocketAddressClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
