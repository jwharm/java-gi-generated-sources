...
public class UnixMountMonitorClass extends Struct {
    ...
    public static UnixMountMonitorClass allocate() {
        ...
        UnixMountMonitorClass newInstance = new UnixMountMonitorClass(segment.address());
     ...
     */
    protected UnixMountMonitorClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, UnixMountMonitorClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new UnixMountMonitorClass(input);
}
