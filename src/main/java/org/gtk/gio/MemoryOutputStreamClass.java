...
public class MemoryOutputStreamClass extends Struct {
    ...
    public static MemoryOutputStreamClass allocate() {
        ...
        MemoryOutputStreamClass newInstance = new MemoryOutputStreamClass(segment.address());
     ...
     */
    protected MemoryOutputStreamClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryOutputStreamClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MemoryOutputStreamClass(input);
