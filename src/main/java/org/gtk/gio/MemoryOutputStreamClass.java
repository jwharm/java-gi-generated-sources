...
public class MemoryOutputStreamClass extends Struct {
    
    static {
        Gio.javagi$ensureInitialized();
    }
    
    private static final java.lang.String C_TYPE_NAME = "GMemoryOutputStreamClass";
    ...
    /**
     * Allocate a new {@link MemoryOutputStreamClass}
     * @return A new, uninitialized @{link MemoryOutputStreamClass}
     */
    public static MemoryOutputStreamClass allocate() {
        MemorySegment segment = Interop.getAllocator().allocate(getMemoryLayout());
        MemoryOutputStreamClass newInstance = new MemoryOutputStreamClass(segment.address(), Ownership.NONE);
     ...
     */
    protected MemoryOutputStreamClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, MemoryOutputStreamClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new MemoryOutputStreamClass(input, ownership);
    
    /**
     * A {@link MemoryOutputStreamClass.Builder} object constructs a {@link MemoryOutputStreamClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link MemoryOutputStreamClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final MemoryOutputStreamClass struct;
        
        private Builder() {
            struct = MemoryOutputStreamClass.allocate();
        }
        
         /**
         * Finish building the {@link MemoryOutputStreamClass} struct.
         * @return A new instance of {@code MemoryOutputStreamClass} with the fields 
         *         that were set in the Builder object.
         */
        public MemoryOutputStreamClass build() {
            return struct;
        }
