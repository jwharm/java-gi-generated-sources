...
public class MemoryOutputStreamClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public MemoryOutputStreamClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private MemoryOutputStreamClass struct;
        
         /**
         * A {@link MemoryOutputStreamClass.Build} object constructs a {@link MemoryOutputStreamClass} 
         ...
         */
        public MemoryOutputStreamClass construct() {
            return struct;
        }
        
        public Build setParentClass(org.gtk.gio.OutputStreamClass parent_class) {
            getMemoryLayout()
