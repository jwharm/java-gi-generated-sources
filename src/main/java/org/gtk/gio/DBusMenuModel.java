...
public class DBusMenuModel extends MenuModel {
     ...
     */
    public static @NotNull DBusMenuModel get(@NotNull DBusConnection connection, @Nullable java.lang.String busName, @NotNull java.lang.String objectPath) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) g_dbus_menu_model_get.invokeExact(connection.handle(), Interop.allocateNativeString(busName), Interop.allocateNativeString(objectPath));
        } catch (Throwable ERR) {
