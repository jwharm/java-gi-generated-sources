...
public class NativeSocketAddressPrivate extends Struct {
    ...
    public static NativeSocketAddressPrivate allocate() {
        ...
        NativeSocketAddressPrivate newInstance = new NativeSocketAddressPrivate(segment.address());
     ...
     */
    protected NativeSocketAddressPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, NativeSocketAddressPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new NativeSocketAddressPrivate(input);
}
