...
public class NativeSocketAddressClass extends Struct {
    ...
    public static NativeSocketAddressClass allocate() {
        ...
        NativeSocketAddressClass newInstance = new NativeSocketAddressClass(segment.address());
     ...
     */
    protected NativeSocketAddressClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, NativeSocketAddressClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new NativeSocketAddressClass(input);
