...
public class SocketListenerClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static SocketListenerClass allocate() {
        ...
        SocketListenerClass newInstance = new SocketListenerClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public SocketListenerClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
