...
public class MenuLinkIterClass extends io.github.jwharm.javagi.ResourceBase {
    ...
    public static MenuLinkIterClass allocate() {
        ...
        MenuLinkIterClass newInstance = new MenuLinkIterClass(Refcounted.get(segment.address()));
    ...
    @ApiStatus.Internal
    public MenuLinkIterClass(io.github.jwharm.javagi.Refcounted ref) {
        super(ref);
    }
}
