...
public class SocketClientClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public SocketClientClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private SocketClientClass struct;
        
         /**
         * A {@link SocketClientClass.Build} object constructs a {@link SocketClientClass} 
         ...
         */
        public SocketClientClass construct() {
            return struct;
        }
