...
public class OutsetShadowNode extends RenderNode {
     ...
     */
    public OutsetShadowNode(@NotNull RoundedRect outline, @NotNull org.gtk.gdk.RGBA color, @NotNull float dx, @NotNull float dy, @NotNull float spread, @NotNull float blurRadius) {
    ...
    public float getBlurRadius() {
        float RESULT;
        try {
            RESULT = (float) gsk_outset_shadow_node_get_blur_radius.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public @NotNull org.gtk.gdk.RGBA getColor() {
        ...
        try {
            RESULT = (MemoryAddress) gsk_outset_shadow_node_get_color.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    public float getDx() {
        float RESULT;
        try {
            RESULT = (float) gsk_outset_shadow_node_get_dx.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public float getDy() {
        float RESULT;
        try {
            RESULT = (float) gsk_outset_shadow_node_get_dy.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public @NotNull RoundedRect getOutline() {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) gsk_outset_shadow_node_get_outline.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    public float getSpread() {
        float RESULT;
        try {
            RESULT = (float) gsk_outset_shadow_node_get_spread.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
