...
public class InsetShadowNode extends org.gtk.gsk.RenderNode {
     ...
     */
    protected InsetShadowNode(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, InsetShadowNode> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new InsetShadowNode(input, ownership);
