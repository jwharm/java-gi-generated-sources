...
public class ContainerNode extends org.gtk.gsk.RenderNode {
     ...
     */
    protected ContainerNode(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ContainerNode> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ContainerNode(input, ownership);
