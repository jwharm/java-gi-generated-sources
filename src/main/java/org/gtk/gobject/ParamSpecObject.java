...
public class ParamSpecObject extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecObject(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecObject> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecObject(input);
