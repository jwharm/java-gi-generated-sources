...
public class ParamSpecObject extends org.gtk.gobject.ParamSpec {
     ...
     */
    @ApiStatus.Internal
    public ParamSpecObject(Addressable address, Ownership ownership) {
     ...
     * @return                    A new proxy instance of type {@code ParamSpecObject} that points to the memory address of the provided GObject.
    ...
    public static ParamSpecObject castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(new org.gtk.gobject.TypeInstance(gobject.handle(), Ownership.NONE), ParamSpecObject.getType())) {
            return new ParamSpecObject(gobject.handle(), gobject.yieldOwnership());
        } else {
    ...
    public static class Build extends org.gtk.gobject.ParamSpec.Build {
         ...
         /**
         * A {@link ParamSpecObject.Build} object constructs a {@link ParamSpecObject} 
        ...
        public Build() {
         ...
         /**
         * Finish building the {@link ParamSpecObject} object.
         * Internally, a call to {@link org.gtk.gobject.GObject#typeFromName} 
         * is executed to create a new GObject instance, which is then cast to 
         * {@link ParamSpecObject} using {@link ParamSpecObject#castFrom}.
         * @return A new instance of {@code ParamSpecObject} with the properties 
         *         that were set in the Build object.
         */
        public ParamSpecObject construct() {
            return ParamSpecObject.castFrom(
                org.gtk.gobject.Object.newWithProperties(
                    ParamSpecObject.getType(),
                    names.size(),
