...
public class ParamSpecObject extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecObject(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecObject> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecObject(input, ownership);
