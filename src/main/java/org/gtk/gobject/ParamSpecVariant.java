...
public class ParamSpecVariant extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecVariant(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecVariant> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecVariant(input, ownership);
