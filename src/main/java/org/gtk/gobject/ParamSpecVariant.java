...
public class ParamSpecVariant extends org.gtk.gobject.ParamSpec {
    ...
    public static ParamSpecVariant castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(new org.gtk.gobject.TypeInstance(gobject.handle(), Ownership.NONE), ParamSpecVariant.getType())) {
    ...
    public static class Build extends org.gtk.gobject.ParamSpec.Build {
         ...
         /**
         * A {@link ParamSpecVariant.Build} object constructs a {@link ParamSpecVariant} 
        ...
        public Build() {
         ...
         /**
         * Finish building the {@link ParamSpecVariant} object.
         * Internally, a call to {@link org.gtk.gobject.GObject#typeFromName} 
         * is executed to create a new GObject instance, which is then cast to 
         * {@link ParamSpecVariant} using {@link ParamSpecVariant#castFrom}.
         * @return A new instance of {@code ParamSpecVariant} with the properties 
         *         that were set in the Build object.
         */
        public ParamSpecVariant construct() {
            return ParamSpecVariant.castFrom(
                org.gtk.gobject.Object.newWithProperties(
                    ParamSpecVariant.getType(),
                    names.size(),
