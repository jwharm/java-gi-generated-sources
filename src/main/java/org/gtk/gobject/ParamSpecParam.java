...
public class ParamSpecParam extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecParam(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecParam> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecParam(input);
