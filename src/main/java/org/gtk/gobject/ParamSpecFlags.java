...
public class ParamSpecFlags extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecFlags(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecFlags> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecFlags(input);
