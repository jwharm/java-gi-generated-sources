...
public class ParamSpecChar extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecChar(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecChar> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecChar(input);
