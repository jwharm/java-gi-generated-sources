...
public class ParamSpecChar extends org.gtk.gobject.ParamSpec {
     ...
     * @return                    An instance of "ParamSpecChar" that points to the memory address of the provided GObject.
    ...
    public static ParamSpecChar castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(gobject.g_type_instance$get(), org.gtk.gobject.GObject.typeFromName("GParamSpecChar"))) {
            return new ParamSpecChar(gobject.handle(), gobject.refcounted().getOwnership());
        } else {
