...
public class ParamSpecPointer extends org.gtk.gobject.ParamSpec {
     ...
     */
    @ApiStatus.Internal
    public ParamSpecPointer(Addressable address, Ownership ownership) {
     ...
     * @return                    A new proxy instance of type {@code ParamSpecPointer} that points to the memory address of the provided GObject.
    ...
    public static ParamSpecPointer castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(new org.gtk.gobject.TypeInstance(gobject.handle(), Ownership.NONE), ParamSpecPointer.getType())) {
            return new ParamSpecPointer(gobject.handle(), gobject.yieldOwnership());
        } else {
    ...
    public static class Build extends org.gtk.gobject.ParamSpec.Build {
         ...
         /**
         * A {@link ParamSpecPointer.Build} object constructs a {@link ParamSpecPointer} 
        ...
        public Build() {
         ...
         /**
         * Finish building the {@link ParamSpecPointer} object.
         * Internally, a call to {@link org.gtk.gobject.GObject#typeFromName} 
         * is executed to create a new GObject instance, which is then cast to 
         * {@link ParamSpecPointer} using {@link ParamSpecPointer#castFrom}.
         * @return A new instance of {@code ParamSpecPointer} with the properties 
         *         that were set in the Build object.
         */
        public ParamSpecPointer construct() {
            return ParamSpecPointer.castFrom(
                org.gtk.gobject.Object.newWithProperties(
                    ParamSpecPointer.getType(),
                    names.size(),
