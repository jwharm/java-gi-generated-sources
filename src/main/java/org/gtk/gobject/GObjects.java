    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_param_spec_boolean.invokeExact(
                    Marshal.stringToAddress.marshal(name, SCOPE),
                    (Addressable) (nick == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(nick, SCOPE)),
                    (Addressable) (blurb == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(blurb, SCOPE)),
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (MemoryAddress) DowncallHandles.g_param_spec_string.invokeExact(
                    ...
                    (Addressable) (nick == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(nick, SCOPE)),
                    (Addressable) (blurb == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(blurb, SCOPE)),
                    (Addressable) (defaultValue == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(defaultValue, SCOPE)),
                    flags.getValue());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static org.gtk.glib.Type pointerTypeRegisterStatic(java.lang.String name) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        long RESULT;
        try {
            RESULT = (long) DowncallHandles.g_pointer_type_register_static.invokeExact(Marshal.stringToAddress.marshal(name, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return new org.gtk.glib.Type(RESULT);
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        try {
            DowncallHandles.g_signal_chain_from_overridden.invokeExact(
                    Interop.allocateNativeArray(instanceAndParams, org.gtk.gobject.Value.getMemoryLayout(), false, SCOPE),
                    returnValue.handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static @Nullable org.gtk.gobject.SignalInvocationHint signalGetInvocationHint(org.gtk.gobject.GObject instance) {
    ...
    return org.gtk.gobject.SignalInvocationHint.fromAddress.marshal(RESULT, null);
}
...
public static boolean signalIsValidName(java.lang.String name) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.g_signal_is_valid_name.invokeExact(Marshal.stringToAddress.marshal(name, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static int[] signalListIds(org.gtk.glib.Type itype, Out<Integer> nIds) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment nIdsPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemoryAddress RESULT;
        try {
        ...
        return MemorySegment.ofAddress(RESULT.get(Interop.valueLayout.ADDRESS, 0), nIds.get().intValue() * Interop.valueLayout.C_INT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_INT);
    }
}
...
public static boolean signalParseName(java.lang.String detailedSignal, org.gtk.glib.Type itype, Out<Integer> signalIdP, org.gtk.glib.Quark detailP, boolean forceDetailQuark) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment signalIdPPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment detailPPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static org.gtk.gobject.TypeInstance typeCheckInstanceCast(org.gtk.gobject.TypeInstance instance, org.gtk.glib.Type ifaceType) {
    ...
    return org.gtk.gobject.TypeInstance.fromAddress.marshal(RESULT, null);
}
...
public static boolean typeCheckIsValueType(org.gtk.glib.Type type) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.g_type_check_is_value_type.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static org.gtk.glib.Type[] typeChildren(org.gtk.glib.Type type, Out<Integer> nChildren) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment nChildrenPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemoryAddress RESULT;
        try {
...
public static org.gtk.gobject.TypeInstance typeCreateInstance(org.gtk.glib.Type type) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.g_type_create_instance.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.gtk.gobject.TypeInstance.fromAddress.marshal(RESULT, null);
...
public static org.gtk.gobject.TypeInterface typeDefaultInterfacePeek(org.gtk.glib.Type gType) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.g_type_default_interface_peek.invokeExact(gType.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
...
public static org.gtk.gobject.TypeInterface typeDefaultInterfaceRef(org.gtk.glib.Type gType) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.g_type_default_interface_ref.invokeExact(gType.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.gtk.gobject.TypeInterface.fromAddress.marshal(RESULT, null);
...
public static int typeDepth(org.gtk.glib.Type type) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.g_type_depth.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static void typeEnsure(org.gtk.glib.Type type) {
    try {
        DowncallHandles.g_type_ensure.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
}
...
public static org.gtk.glib.Type typeFromName(java.lang.String name) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        long RESULT;
        try {
            RESULT = (long) DowncallHandles.g_type_from_name.invokeExact(Marshal.stringToAddress.marshal(name, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return new org.gtk.glib.Type(RESULT);
...
public static org.gtk.glib.Type typeFundamental(org.gtk.glib.Type typeId) {
    long RESULT;
    try {
        RESULT = (long) DowncallHandles.g_type_fundamental.invokeExact(typeId.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return new org.gtk.glib.Type(RESULT);
...
public static int typeGetInstanceCount(org.gtk.glib.Type type) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.g_type_get_instance_count.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static org.gtk.gobject.TypePlugin typeGetPlugin(org.gtk.glib.Type type) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.g_type_get_plugin.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
...
public static org.gtk.glib.Type[] typeInterfaces(org.gtk.glib.Type type, Out<Integer> nInterfaces) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment nInterfacesPOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemoryAddress RESULT;
        try {
...
public static java.lang.String typeName(org.gtk.glib.Type type) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.g_type_name.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static org.gtk.glib.Type typeParent(org.gtk.glib.Type type) {
    long RESULT;
    try {
        RESULT = (long) DowncallHandles.g_type_parent.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return new org.gtk.glib.Type(RESULT);
...
public static org.gtk.glib.Quark typeQname(org.gtk.glib.Type type) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.g_type_qname.invokeExact(type.getValue().longValue());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
...
private static final MethodHandle g_value_type_transformable = Interop.downcallHandle(
    ...
    private static void registerTypes() {
        if (Binding.isAvailable()) Interop.register(Binding.getType(), Binding.fromAddress);
        if (BindingGroup.isAvailable()) Interop.register(BindingGroup.getType(), BindingGroup.fromAddress);
        if (InitiallyUnowned.isAvailable()) Interop.register(InitiallyUnowned.getType(), InitiallyUnowned.fromAddress);
        if (GObject.isAvailable()) Interop.register(GObject.getType(), GObject.fromAddress);
        if (ParamSpec.isAvailable()) Interop.register(ParamSpec.getType(), ParamSpec.fromAddress);
        if (ParamSpecBoolean.isAvailable()) Interop.register(ParamSpecBoolean.getType(), ParamSpecBoolean.fromAddress);
        if (ParamSpecBoxed.isAvailable()) Interop.register(ParamSpecBoxed.getType(), ParamSpecBoxed.fromAddress);
        if (ParamSpecChar.isAvailable()) Interop.register(ParamSpecChar.getType(), ParamSpecChar.fromAddress);
        if (ParamSpecDouble.isAvailable()) Interop.register(ParamSpecDouble.getType(), ParamSpecDouble.fromAddress);
        if (ParamSpecEnum.isAvailable()) Interop.register(ParamSpecEnum.getType(), ParamSpecEnum.fromAddress);
        if (ParamSpecFlags.isAvailable()) Interop.register(ParamSpecFlags.getType(), ParamSpecFlags.fromAddress);
        if (ParamSpecFloat.isAvailable()) Interop.register(ParamSpecFloat.getType(), ParamSpecFloat.fromAddress);
        if (ParamSpecGType.isAvailable()) Interop.register(ParamSpecGType.getType(), ParamSpecGType.fromAddress);
        if (ParamSpecInt.isAvailable()) Interop.register(ParamSpecInt.getType(), ParamSpecInt.fromAddress);
        if (ParamSpecInt64.isAvailable()) Interop.register(ParamSpecInt64.getType(), ParamSpecInt64.fromAddress);
        if (ParamSpecLong.isAvailable()) Interop.register(ParamSpecLong.getType(), ParamSpecLong.fromAddress);
        if (ParamSpecObject.isAvailable()) Interop.register(ParamSpecObject.getType(), ParamSpecObject.fromAddress);
        if (ParamSpecOverride.isAvailable()) Interop.register(ParamSpecOverride.getType(), ParamSpecOverride.fromAddress);
        if (ParamSpecParam.isAvailable()) Interop.register(ParamSpecParam.getType(), ParamSpecParam.fromAddress);
        if (ParamSpecPointer.isAvailable()) Interop.register(ParamSpecPointer.getType(), ParamSpecPointer.fromAddress);
        if (ParamSpecString.isAvailable()) Interop.register(ParamSpecString.getType(), ParamSpecString.fromAddress);
        if (ParamSpecUChar.isAvailable()) Interop.register(ParamSpecUChar.getType(), ParamSpecUChar.fromAddress);
        if (ParamSpecUInt.isAvailable()) Interop.register(ParamSpecUInt.getType(), ParamSpecUInt.fromAddress);
        if (ParamSpecUInt64.isAvailable()) Interop.register(ParamSpecUInt64.getType(), ParamSpecUInt64.fromAddress);
        if (ParamSpecULong.isAvailable()) Interop.register(ParamSpecULong.getType(), ParamSpecULong.fromAddress);
        if (ParamSpecUnichar.isAvailable()) Interop.register(ParamSpecUnichar.getType(), ParamSpecUnichar.fromAddress);
        if (ParamSpecValueArray.isAvailable()) Interop.register(ParamSpecValueArray.getType(), ParamSpecValueArray.fromAddress);
        if (ParamSpecVariant.isAvailable()) Interop.register(ParamSpecVariant.getType(), ParamSpecVariant.fromAddress);
        if (SignalGroup.isAvailable()) Interop.register(SignalGroup.getType(), SignalGroup.fromAddress);
        if (TypeModule.isAvailable()) Interop.register(TypeModule.getType(), TypeModule.fromAddress);
        if (TypePlugin.isAvailable()) Interop.register(TypePlugin.getType(), TypePlugin.fromAddress);
    }
}
