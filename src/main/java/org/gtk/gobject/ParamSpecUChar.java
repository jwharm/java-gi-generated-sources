...
public class ParamSpecUChar extends org.gtk.gobject.ParamSpec {
     ...
     */
    public void minimum$set(byte minimum) {
        getMemoryLayout()
            .varHandle(MemoryLayout.PathElement.groupElement("minimum"))
     ...
     */
    public void maximum$set(byte maximum) {
        getMemoryLayout()
            .varHandle(MemoryLayout.PathElement.groupElement("maximum"))
     ...
     */
    public void default_value$set(byte default_value) {
        getMemoryLayout()
            .varHandle(MemoryLayout.PathElement.groupElement("default_value"))
     ...
     */
    @ApiStatus.Internal
    public ParamSpecUChar(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    /**
     * Cast object to ParamSpecUChar if its GType is a (or inherits from) "GParamSpecUChar".
     * <p>
     ...
     * @return                    A new proxy instance of type {@code ParamSpecUChar} that points to the memory address of the provided GObject.
     *                            The type of the object is checked with {@code g_type_check_instance_is_a}.
     * @throws ClassCastException If the GType is not derived from "GParamSpecUChar", a ClassCastException will be thrown.
     */
    public static ParamSpecUChar castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(gobject.g_type_instance$get(), ParamSpecUChar.getType())) {
            return new ParamSpecUChar(gobject.handle(), gobject.yieldOwnership());
        } else {
            throw new ClassCastException("Object type is not an instance of GParamSpecUChar");
        }
    }
    ...
    public static class Build extends org.gtk.gobject.ParamSpec.Build {
         ...
         /**
         * A {@link ParamSpecUChar.Build} object constructs a {@link ParamSpecUChar} 
        ...
        public Build() {
         ...
         /**
         * Finish building the {@link ParamSpecUChar} object.
         * Internally, a call to {@link org.gtk.gobject.GObject#typeFromName} 
         * is executed to create a new GObject instance, which is then cast to 
         * {@link ParamSpecUChar} using {@link ParamSpecUChar#castFrom}.
         * @return A new instance of {@code ParamSpecUChar} with the properties 
         *         that were set in the Build object.
         */
        public ParamSpecUChar construct() {
            return ParamSpecUChar.castFrom(
                org.gtk.gobject.Object.newWithProperties(
                    ParamSpecUChar.getType(),
                    names.size(),
