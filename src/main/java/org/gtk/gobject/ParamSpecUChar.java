...
public class ParamSpecUChar extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecUChar(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecUChar> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecUChar(input, ownership);
