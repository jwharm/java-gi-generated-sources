...
public class ParamSpecBoxed extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecBoxed(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecBoxed> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecBoxed(input, ownership);
