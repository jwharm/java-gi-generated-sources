...
public class ParamSpecBoxed extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecBoxed(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecBoxed> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecBoxed(input);
