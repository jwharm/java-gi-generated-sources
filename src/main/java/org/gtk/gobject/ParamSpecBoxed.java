...
public class ParamSpecBoxed extends org.gtk.gobject.ParamSpec {
    ...
    public static ParamSpecBoxed castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(new org.gtk.gobject.TypeInstance(gobject.handle(), Ownership.NONE), ParamSpecBoxed.getType())) {
    ...
    public static class Build extends org.gtk.gobject.ParamSpec.Build {
         ...
         /**
         * A {@link ParamSpecBoxed.Build} object constructs a {@link ParamSpecBoxed} 
        ...
        public Build() {
         ...
         /**
         * Finish building the {@link ParamSpecBoxed} object.
         * Internally, a call to {@link org.gtk.gobject.GObject#typeFromName} 
         * is executed to create a new GObject instance, which is then cast to 
         * {@link ParamSpecBoxed} using {@link ParamSpecBoxed#castFrom}.
         * @return A new instance of {@code ParamSpecBoxed} with the properties 
         *         that were set in the Build object.
         */
        public ParamSpecBoxed construct() {
            return ParamSpecBoxed.castFrom(
                org.gtk.gobject.Object.newWithProperties(
                    ParamSpecBoxed.getType(),
                    names.size(),
