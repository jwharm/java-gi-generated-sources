...
public class ParamSpecUnichar extends org.gtk.gobject.ParamSpec {
     ...
     * @return                    A new proxy instance of type {@code ParamSpecUnichar} that points to the memory address of the provided GObject.
    ...
    public static ParamSpecUnichar castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(new org.gtk.gobject.TypeInstance(gobject.handle(), Ownership.NONE), ParamSpecUnichar.getType())) {
            return new ParamSpecUnichar(gobject.handle(), gobject.yieldOwnership());
        } else {
    ...
    public static class Build extends org.gtk.gobject.ParamSpec.Build {
         ...
         /**
         * A {@link ParamSpecUnichar.Build} object constructs a {@link ParamSpecUnichar} 
        ...
        public Build() {
         ...
         /**
         * Finish building the {@link ParamSpecUnichar} object.
         * Internally, a call to {@link org.gtk.gobject.GObject#typeFromName} 
         * is executed to create a new GObject instance, which is then cast to 
         * {@link ParamSpecUnichar} using {@link ParamSpecUnichar#castFrom}.
         * @return A new instance of {@code ParamSpecUnichar} with the properties 
         *         that were set in the Build object.
         */
        public ParamSpecUnichar construct() {
            return ParamSpecUnichar.castFrom(
                org.gtk.gobject.Object.newWithProperties(
                    ParamSpecUnichar.getType(),
                    names.size(),
