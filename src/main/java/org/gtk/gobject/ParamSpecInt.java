...
public class ParamSpecInt extends org.gtk.gobject.ParamSpec {
     ...
     * @return                    An instance of "ParamSpecInt" that points to the memory address of the provided GObject.
    ...
    public static ParamSpecInt castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(gobject.g_type_instance$get(), org.gtk.gobject.GObject.typeFromName("GParamSpecInt"))) {
            return new ParamSpecInt(gobject.handle(), gobject.refcounted().getOwnership());
        } else {
