...
public class ParamSpecInt extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecInt(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecInt> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecInt(input);
