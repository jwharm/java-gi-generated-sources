...
public class ParamSpecInt64 extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecInt64(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecInt64> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecInt64(input);
