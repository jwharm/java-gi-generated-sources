...
public class ParamSpecInt64 extends org.gtk.gobject.ParamSpec {
     ...
     */
    protected ParamSpecInt64(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ParamSpecInt64> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ParamSpecInt64(input, ownership);
