...
public class ToplevelInterface extends Struct {
     ...
     */
    protected ToplevelInterface(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ToplevelInterface> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ToplevelInterface(input, ownership);
}
