...
public class SurfaceClass extends Struct {
     ...
     */
    protected SurfaceClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SurfaceClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SurfaceClass(input, ownership);
}
