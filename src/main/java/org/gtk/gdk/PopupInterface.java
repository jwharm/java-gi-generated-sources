...
public class PopupInterface extends Struct {
    ...
    public static class Build {
        ...
        private PopupInterface struct;
        
         /**
         * A {@link PopupInterface.Build} object constructs a {@link PopupInterface} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = PopupInterface.allocate();
        }
        
         /**
         * Finish building the {@link PopupInterface} struct.
         * @return A new instance of {@code PopupInterface} with the fields 
         *         that were set in the Build object.
         */
        public PopupInterface construct() {
            return struct;
        }
    }
}
