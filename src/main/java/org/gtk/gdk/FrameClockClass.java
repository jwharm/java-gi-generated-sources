...
public class FrameClockClass extends Struct {
     ...
     */
    protected FrameClockClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, FrameClockClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new FrameClockClass(input, ownership);
}
