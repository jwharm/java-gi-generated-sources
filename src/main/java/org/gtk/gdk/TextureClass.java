...
public class TextureClass extends Struct {
     ...
     */
    protected TextureClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TextureClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TextureClass(input, ownership);
}
