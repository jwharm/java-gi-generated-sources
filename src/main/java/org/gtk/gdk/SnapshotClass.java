...
public class SnapshotClass extends Struct {
     ...
     */
    protected SnapshotClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SnapshotClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SnapshotClass(input, ownership);
}
