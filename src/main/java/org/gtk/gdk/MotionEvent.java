...
public class MotionEvent extends org.gtk.gdk.Event {
     ...
     */
    protected MotionEvent(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, MotionEvent> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new MotionEvent(input);
    ...
    public static boolean isAvailable() {
        return DowncallHandles.gdk_motion_event_get_type != null;
    }
}
