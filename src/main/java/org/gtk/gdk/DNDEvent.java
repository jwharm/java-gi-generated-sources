...
public class DNDEvent extends org.gtk.gdk.Event {
    ...
    public static DNDEvent castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(new org.gtk.gobject.TypeInstance(gobject.handle(), Ownership.NONE), DNDEvent.getType())) {
    ...
    public static class Build extends org.gtk.gdk.Event.Build {
         ...
         /**
         * A {@link DNDEvent.Build} object constructs a {@link DNDEvent} 
        ...
        public Build() {
         ...
         /**
         * Finish building the {@link DNDEvent} object.
         * Internally, a call to {@link org.gtk.gobject.GObject#typeFromName} 
         * is executed to create a new GObject instance, which is then cast to 
         * {@link DNDEvent} using {@link DNDEvent#castFrom}.
         * @return A new instance of {@code DNDEvent} with the properties 
         *         that were set in the Build object.
         */
        public DNDEvent construct() {
            return DNDEvent.castFrom(
