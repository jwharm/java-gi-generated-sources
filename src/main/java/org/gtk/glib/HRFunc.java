 ...
 */
/**
 * Functional interface declaration of the {@code HRFunc} callback.
 */
@FunctionalInterface
public interface HRFunc {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), HRFunc.class, DESCRIPTOR);
