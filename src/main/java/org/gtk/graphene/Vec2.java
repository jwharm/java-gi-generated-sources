...
public class Vec2 extends Struct {
    ...
    public static Vec2 allocate() {
        ...
        Vec2 newInstance = new Vec2(segment.address());
     ...
     */
    protected Vec2(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, Vec2> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new Vec2(input);
    ...
    public static Vec2 alloc() {
        ...
        var OBJECT = org.gtk.graphene.Vec2.fromAddress.marshal(RESULT, null);
    ...
    public org.gtk.graphene.Vec2 init(float x, float y) {
        ...
        return org.gtk.graphene.Vec2.fromAddress.marshal(RESULT, null);
    }
    ...
    public void toFloat(Out<float[]> dest) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            ...
            dest.set(MemorySegment.ofAddress(destPOINTER.get(Interop.valueLayout.ADDRESS, 0), 2 * Interop.valueLayout.C_FLOAT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_FLOAT));
        }
    }
