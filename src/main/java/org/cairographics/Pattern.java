...
public class Pattern extends Struct {
    ...
    public static Pattern allocate() {
        ...
        Pattern newInstance = new Pattern(segment.address());
     ...
     */
    protected Pattern(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, Pattern> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new Pattern(input);
}
