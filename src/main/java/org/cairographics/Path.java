...
public class Path extends Struct {
     ...
     */
    protected Path(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, Path> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new Path(input, ownership);
}
