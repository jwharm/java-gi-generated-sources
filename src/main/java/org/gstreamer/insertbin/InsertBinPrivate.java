...
public class InsertBinPrivate extends Struct {
     ...
     */
    protected InsertBinPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, InsertBinPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new InsertBinPrivate(input, ownership);
}
