...
public class AudioVisualizerPrivate extends Struct {
     ...
     */
    protected AudioVisualizerPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AudioVisualizerPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AudioVisualizerPrivate(input, ownership);
}
