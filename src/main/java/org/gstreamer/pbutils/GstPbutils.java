...
public final class GstPbutils {
    ...
    static {
        LibLoad.loadLibrary("gstpbutils-1.0");
        registerTypes();
    }
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.gst_codec_utils_aac_caps_set_level_and_profile.invokeExact(
                    caps.handle(),
                    Interop.allocateNativeArray(audioConfig, false, SCOPE),
                    len);
        } catch (Throwable ERR) {
...
public static int codecUtilsAacGetIndexFromSampleRate(int rate) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_codec_utils_aac_get_index_from_sample_rate.invokeExact(rate);
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static int codecUtilsAacGetSampleRateFromIndex(int srIdx) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_codec_utils_aac_get_sample_rate_from_index.invokeExact(srIdx);
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return RESULT;
...
public static @Nullable java.lang.String codecUtilsCapsGetMimeCodec(org.gstreamer.gst.Caps caps) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_codec_utils_caps_get_mime_codec.invokeExact(caps.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.gst_codec_utils_h264_caps_set_level_and_profile.invokeExact(
                    caps.handle(),
                    Interop.allocateNativeArray(sps, false, SCOPE),
                    len);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static byte codecUtilsH264GetLevelIdc(java.lang.String level) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        byte RESULT;
        try {
            RESULT = (byte) DowncallHandles.gst_codec_utils_h264_get_level_idc.invokeExact(Marshal.stringToAddress.marshal(level, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
...
public static boolean codecUtilsH264GetProfileFlagsLevel(byte[] codecData, int len, Out<Byte> profile, Out<Byte> flags, Out<Byte> level) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment profilePOINTER = SCOPE.allocate(Interop.valueLayout.C_BYTE);
        MemorySegment flagsPOINTER = SCOPE.allocate(Interop.valueLayout.C_BYTE);
        MemorySegment levelPOINTER = SCOPE.allocate(Interop.valueLayout.C_BYTE);
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_codec_utils_h264_get_profile_flags_level.invokeExact(
                    Interop.allocateNativeArray(codecData, false, SCOPE),
                    len,
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.gst_codec_utils_h265_caps_set_level_tier_and_profile.invokeExact(
                    caps.handle(),
                    Interop.allocateNativeArray(profileTierLevel, false, SCOPE),
                    len);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static byte codecUtilsH265GetLevelIdc(java.lang.String level) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        byte RESULT;
        try {
            RESULT = (byte) DowncallHandles.gst_codec_utils_h265_get_level_idc.invokeExact(Marshal.stringToAddress.marshal(level, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.gst_codec_utils_mpeg4video_caps_set_level_and_profile.invokeExact(
                    caps.handle(),
                    Interop.allocateNativeArray(visObjSeq, false, SCOPE),
                    len);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_codec_utils_opus_create_caps.invokeExact(
                    ...
                    streamCount,
                    coupledCount,
                    (Addressable) (channelMapping == null ? MemoryAddress.NULL : Interop.allocateNativeArray(channelMapping, false, SCOPE)));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static boolean codecUtilsOpusParseCaps(org.gstreamer.gst.Caps caps, Out<Integer> rate, Out<Byte> channels, Out<Byte> channelMappingFamily, Out<Byte> streamCount, Out<Byte> coupledCount, Out<byte[]> channelMapping) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment ratePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        MemorySegment channelsPOINTER = SCOPE.allocate(Interop.valueLayout.C_BYTE);
        MemorySegment channelMappingFamilyPOINTER = SCOPE.allocate(Interop.valueLayout.C_BYTE);
        MemorySegment streamCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_BYTE);
        MemorySegment coupledCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_BYTE);
        MemorySegment channelMappingPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
        ...
        channelMapping.set(MemorySegment.ofAddress(channelMappingPOINTER.get(Interop.valueLayout.ADDRESS, 0), 256 * Interop.valueLayout.C_BYTE.byteSize(), SCOPE).toArray(Interop.valueLayout.C_BYTE));
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
    }
}
...
public static boolean codecUtilsOpusParseHeader(org.gstreamer.gst.Buffer header, Out<Integer> rate, Out<Byte> channels, Out<Byte> channelMappingFamily, Out<Byte> streamCount, Out<Byte> coupledCount, Out<byte[]> channelMapping, Out<Short> preSkip, Out<Short> outputGain) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        MemorySegment coupledCountPOINTER = SCOPE.allocate(Interop.valueLayout.C_BYTE);
        MemorySegment channelMappingPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        MemorySegment preSkipPOINTER = SCOPE.allocate(Interop.valueLayout.C_SHORT);
        MemorySegment outputGainPOINTER = SCOPE.allocate(Interop.valueLayout.C_SHORT);
        int RESULT;
        try {
...
public static org.gtk.glib.List encodingListAllTargets(@Nullable java.lang.String categoryname) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_encoding_list_all_targets.invokeExact((Addressable) (categoryname == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(categoryname, SCOPE)));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.gst_install_plugins_async.invokeExact(
                    Interop.allocateNativeArray(details, false, SCOPE),
...
public static boolean isMissingPluginMessage(org.gstreamer.gst.Message msg) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_is_missing_plugin_message.invokeExact(msg.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static java.lang.String missingDecoderInstallerDetailNew(org.gstreamer.gst.Caps decodeCaps) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_missing_decoder_installer_detail_new.invokeExact(decodeCaps.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String missingElementInstallerDetailNew(java.lang.String factoryName) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_missing_element_installer_detail_new.invokeExact(Marshal.stringToAddress.marshal(factoryName, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String missingEncoderInstallerDetailNew(org.gstreamer.gst.Caps encodeCaps) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_missing_encoder_installer_detail_new.invokeExact(encodeCaps.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String missingPluginMessageGetDescription(org.gstreamer.gst.Message msg) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_missing_plugin_message_get_description.invokeExact(msg.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String missingPluginMessageGetInstallerDetail(org.gstreamer.gst.Message msg) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_missing_plugin_message_get_installer_detail.invokeExact(msg.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String missingUriSinkInstallerDetailNew(java.lang.String protocol) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_missing_uri_sink_installer_detail_new.invokeExact(Marshal.stringToAddress.marshal(protocol, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String missingUriSourceInstallerDetailNew(java.lang.String protocol) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_missing_uri_source_installer_detail_new.invokeExact(Marshal.stringToAddress.marshal(protocol, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.gst_pb_utils_add_codec_description_to_tag_list.invokeExact(
                    taglist.handle(),
                    (Addressable) (codecTag == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(codecTag, SCOPE)),
                    caps.handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
...
public static org.gstreamer.pbutils.PbUtilsCapsDescriptionFlags pbUtilsGetCapsDescriptionFlags(org.gstreamer.gst.Caps caps) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_pb_utils_get_caps_description_flags.invokeExact(caps.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
...
public static java.lang.String pbUtilsGetCodecDescription(org.gstreamer.gst.Caps caps) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_pb_utils_get_codec_description.invokeExact(caps.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String pbUtilsGetDecoderDescription(org.gstreamer.gst.Caps caps) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_pb_utils_get_decoder_description.invokeExact(caps.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String pbUtilsGetElementDescription(java.lang.String factoryName) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_pb_utils_get_element_description.invokeExact(Marshal.stringToAddress.marshal(factoryName, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String pbUtilsGetEncoderDescription(org.gstreamer.gst.Caps caps) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_pb_utils_get_encoder_description.invokeExact(caps.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static @Nullable java.lang.String pbUtilsGetFileExtensionFromCaps(org.gstreamer.gst.Caps caps) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_pb_utils_get_file_extension_from_caps.invokeExact(caps.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String pbUtilsGetSinkDescription(java.lang.String protocol) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_pb_utils_get_sink_description.invokeExact(Marshal.stringToAddress.marshal(protocol, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
public static java.lang.String pbUtilsGetSourceDescription(java.lang.String protocol) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_pb_utils_get_source_description.invokeExact(Marshal.stringToAddress.marshal(protocol, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.addressToString.marshal(RESULT, null);
...
private static final MethodHandle gst_plugins_base_version_string = Interop.downcallHandle(
    ...
    private static void registerTypes() {
        if (AudioVisualizer.isAvailable()) Interop.register(AudioVisualizer.getType(), AudioVisualizer.fromAddress);
        if (Discoverer.isAvailable()) Interop.register(Discoverer.getType(), Discoverer.fromAddress);
        if (DiscovererAudioInfo.isAvailable()) Interop.register(DiscovererAudioInfo.getType(), DiscovererAudioInfo.fromAddress);
        if (DiscovererContainerInfo.isAvailable()) Interop.register(DiscovererContainerInfo.getType(), DiscovererContainerInfo.fromAddress);
        if (DiscovererInfo.isAvailable()) Interop.register(DiscovererInfo.getType(), DiscovererInfo.fromAddress);
        if (DiscovererStreamInfo.isAvailable()) Interop.register(DiscovererStreamInfo.getType(), DiscovererStreamInfo.fromAddress);
        if (DiscovererSubtitleInfo.isAvailable()) Interop.register(DiscovererSubtitleInfo.getType(), DiscovererSubtitleInfo.fromAddress);
        if (DiscovererVideoInfo.isAvailable()) Interop.register(DiscovererVideoInfo.getType(), DiscovererVideoInfo.fromAddress);
        if (EncodingAudioProfile.isAvailable()) Interop.register(EncodingAudioProfile.getType(), EncodingAudioProfile.fromAddress);
        if (EncodingContainerProfile.isAvailable()) Interop.register(EncodingContainerProfile.getType(), EncodingContainerProfile.fromAddress);
        if (EncodingProfile.isAvailable()) Interop.register(EncodingProfile.getType(), EncodingProfile.fromAddress);
        if (EncodingTarget.isAvailable()) Interop.register(EncodingTarget.getType(), EncodingTarget.fromAddress);
        if (EncodingVideoProfile.isAvailable()) Interop.register(EncodingVideoProfile.getType(), EncodingVideoProfile.fromAddress);
    }
}
