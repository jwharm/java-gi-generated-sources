...
public class EncodingContainerProfileClass extends Struct {
     ...
     */
    protected EncodingContainerProfileClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, EncodingContainerProfileClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new EncodingContainerProfileClass(input, ownership);
}
