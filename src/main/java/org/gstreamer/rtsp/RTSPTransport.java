...
public class RTSPTransport extends Struct {
    ...
    public static RTSPTransport allocate() {
        ...
        RTSPTransport newInstance = new RTSPTransport(segment.address());
    ...
    public void setTrans(org.gstreamer.rtsp.RTSPTransMode trans) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("trans"))
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (trans == null ? MemoryAddress.NULL : trans.getValue()));
        }
    }
    ...
    public void setProfile(org.gstreamer.rtsp.RTSPProfile profile) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("profile"))
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (profile == null ? MemoryAddress.NULL : profile.getValue()));
        }
    }
    ...
    public void setLowerTransport(org.gstreamer.rtsp.RTSPLowerTrans lowerTransport) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("lower_transport"))
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (lowerTransport == null ? MemoryAddress.NULL : lowerTransport.getValue()));
        }
    }
    ...
    public void setDestination(java.lang.String destination) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("destination"))
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (destination == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(destination, SCOPE)));
        }
    }
    ...
    public void setLayers(int layers) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("layers"))
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), layers);
        }
    }
    ...
    public void setModePlay(boolean modePlay) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("mode_play"))
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), Marshal.booleanToInteger.marshal(modePlay, null).intValue());
        }
    }
    ...
    public void setModeRecord(boolean modeRecord) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("mode_record"))
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), Marshal.booleanToInteger.marshal(modeRecord, null).intValue());
        }
    }
    ...
    public void setAppend(boolean append) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("append"))
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), Marshal.booleanToInteger.marshal(append, null).intValue());
        }
    }
    ...
    public org.gstreamer.rtsp.RTSPRange getInterleaved() {
        ...
        return org.gstreamer.rtsp.RTSPRange.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
    ...
    public void setInterleaved(org.gstreamer.rtsp.RTSPRange interleaved) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (interleaved == null ? MemoryAddress.NULL : interleaved.handle()));
        }
    }
    ...
    public void setPort(org.gstreamer.rtsp.RTSPRange port) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (port == null ? MemoryAddress.NULL : port.handle()));
        }
    }
    ...
    public void setClientPort(org.gstreamer.rtsp.RTSPRange clientPort) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (clientPort == null ? MemoryAddress.NULL : clientPort.handle()));
        }
    }
    ...
    public void setServerPort(org.gstreamer.rtsp.RTSPRange serverPort) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (serverPort == null ? MemoryAddress.NULL : serverPort.handle()));
        }
    }
     ...
     */
    protected RTSPTransport(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, RTSPTransport> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new RTSPTransport(input);
    ...
    public java.lang.String asText() {
        ...
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_rtsp_transport_as_text.invokeExact(handle());
        } catch (Throwable ERR) {
    ...
    public org.gstreamer.rtsp.RTSPResult free() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_rtsp_transport_free.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    public org.gstreamer.rtsp.RTSPResult getMediaType(Out<java.lang.String> mediaType) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            MemorySegment mediaTypePOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
            int RESULT;
            try {
    ...
    public org.gstreamer.rtsp.RTSPResult init() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_rtsp_transport_init.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return org.gstreamer.rtsp.RTSPResult.of(RESULT);
    ...
    public static class Builder {
        ...
        public Builder setTrans(org.gstreamer.rtsp.RTSPTransMode trans) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("trans"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (trans == null ? MemoryAddress.NULL : trans.getValue()));
                return this;
            }
        }
        ...
        public Builder setProfile(org.gstreamer.rtsp.RTSPProfile profile) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("profile"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (profile == null ? MemoryAddress.NULL : profile.getValue()));
                return this;
            }
        }
        ...
        public Builder setLowerTransport(org.gstreamer.rtsp.RTSPLowerTrans lowerTransport) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("lower_transport"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (lowerTransport == null ? MemoryAddress.NULL : lowerTransport.getValue()));
                return this;
            }
        }
        ...
        public Builder setDestination(java.lang.String destination) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("destination"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (destination == null ? MemoryAddress.NULL : Marshal.stringToAddress.marshal(destination, SCOPE)));
                return this;
            }
        }
        ...
        public Builder setLayers(int layers) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("layers"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), layers);
                return this;
            }
        }
        ...
        public Builder setModePlay(boolean modePlay) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("mode_play"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), Marshal.booleanToInteger.marshal(modePlay, null).intValue());
                return this;
            }
        }
        ...
        public Builder setModeRecord(boolean modeRecord) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("mode_record"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), Marshal.booleanToInteger.marshal(modeRecord, null).intValue());
                return this;
            }
        }
        ...
        public Builder setAppend(boolean append) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("append"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), Marshal.booleanToInteger.marshal(append, null).intValue());
                return this;
            }
        }
        ...
        public Builder setInterleaved(org.gstreamer.rtsp.RTSPRange interleaved) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("interleaved"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (interleaved == null ? MemoryAddress.NULL : interleaved.handle()));
                return this;
            }
        }
        ...
        public Builder setPort(org.gstreamer.rtsp.RTSPRange port) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("port"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (port == null ? MemoryAddress.NULL : port.handle()));
                return this;
            }
        }
        ...
        public Builder setClientPort(org.gstreamer.rtsp.RTSPRange clientPort) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("client_port"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (clientPort == null ? MemoryAddress.NULL : clientPort.handle()));
                return this;
            }
        }
        ...
        public Builder setServerPort(org.gstreamer.rtsp.RTSPRange serverPort) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("server_port"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (serverPort == null ? MemoryAddress.NULL : serverPort.handle()));
                return this;
            }
        }
