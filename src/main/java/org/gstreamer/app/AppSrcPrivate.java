...
public class AppSrcPrivate extends Struct {
    ...
    public static AppSrcPrivate allocate() {
        ...
        AppSrcPrivate newInstance = new AppSrcPrivate(segment.address(), Ownership.NONE);
     ...
     */
    protected AppSrcPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AppSrcPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AppSrcPrivate(input, ownership);
}
