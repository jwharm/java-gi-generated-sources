...
public class PlayVideoInfo extends org.gstreamer.play.PlayStreamInfo {
     ...
     */
    protected PlayVideoInfo(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PlayVideoInfo> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PlayVideoInfo(input);
    
    public int getBitrate() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_play_video_info_get_bitrate.invokeExact(handle());
        } catch (Throwable ERR) {
    ...
    public int getHeight() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_play_video_info_get_height.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public int getMaxBitrate() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_play_video_info_get_max_bitrate.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public int getWidth() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_play_video_info_get_width.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public static boolean isAvailable() {
        return DowncallHandles.gst_play_video_info_get_type != null;
    }
}
