...
public class PlayVideoInfoClass extends Struct {
     ...
     */
    protected PlayVideoInfoClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PlayVideoInfoClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PlayVideoInfoClass(input, ownership);
}
