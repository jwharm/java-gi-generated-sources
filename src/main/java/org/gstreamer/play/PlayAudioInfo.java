...
public class PlayAudioInfo extends org.gstreamer.play.PlayStreamInfo {
     ...
     */
    @ApiStatus.Internal
    public PlayAudioInfo(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    /**
     * Cast object to PlayAudioInfo if its GType is a (or inherits from) "GstPlayAudioInfo".
     * <p>
     ...
     * @return                    A new proxy instance of type {@code PlayAudioInfo} that points to the memory address of the provided GObject.
     *                            The type of the object is checked with {@code g_type_check_instance_is_a}.
     * @throws ClassCastException If the GType is not derived from "GstPlayAudioInfo", a ClassCastException will be thrown.
     */
    public static PlayAudioInfo castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(new org.gtk.gobject.TypeInstance(gobject.handle(), Ownership.NONE), PlayAudioInfo.getType())) {
            return new PlayAudioInfo(gobject.handle(), gobject.yieldOwnership());
        } else {
            throw new ClassCastException("Object type is not an instance of GstPlayAudioInfo");
        }
    }
    ...
    public static class Build extends org.gstreamer.play.PlayStreamInfo.Build {
         ...
         /**
         * A {@link PlayAudioInfo.Build} object constructs a {@link PlayAudioInfo} 
         ...
         * {@link PlayAudioInfo} using {@link PlayAudioInfo#castFrom}.
         * @return A new instance of {@code PlayAudioInfo} with the properties 
         *         that were set in the Build object.
         */
        public PlayAudioInfo construct() {
            return PlayAudioInfo.castFrom(
