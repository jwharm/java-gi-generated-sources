...
public class PlaySignalAdapterClass extends Struct {
     ...
     */
    protected PlaySignalAdapterClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PlaySignalAdapterClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PlaySignalAdapterClass(input, ownership);
}
