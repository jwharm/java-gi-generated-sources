...
public class TranscoderSignalAdapterClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TranscoderSignalAdapterClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TranscoderSignalAdapterClass struct;
        
         /**
         * A {@link TranscoderSignalAdapterClass.Build} object constructs a {@link TranscoderSignalAdapterClass} 
         ...
         */
        public TranscoderSignalAdapterClass construct() {
            return struct;
        }
