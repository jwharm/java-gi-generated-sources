...
public class TranscoderClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TranscoderClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TranscoderClass struct;
        
         /**
         * A {@link TranscoderClass.Build} object constructs a {@link TranscoderClass} 
         ...
         */
        public TranscoderClass construct() {
            return struct;
        }
