...
public class TranscoderClass extends Struct {
    ...
    public static TranscoderClass allocate() {
        ...
        TranscoderClass newInstance = new TranscoderClass(segment.address());
     ...
     */
    protected TranscoderClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, TranscoderClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new TranscoderClass(input);
