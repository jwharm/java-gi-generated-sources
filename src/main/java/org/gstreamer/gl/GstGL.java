...
public static org.gstreamer.gl.GLSyncMeta bufferAddGlSyncMeta(org.gstreamer.gl.GLContext context, org.gstreamer.gst.Buffer buffer) {
    ...
    return org.gstreamer.gl.GLSyncMeta.fromAddress.marshal(RESULT, null);
}
...
public static org.gstreamer.gl.GLAllocationParams bufferPoolConfigGetGlAllocationParams(org.gstreamer.gst.Structure config) {
    MemoryAddress RESULT;
    try {
        RESULT = (MemoryAddress) DowncallHandles.gst_buffer_pool_config_get_gl_allocation_params.invokeExact(config.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            ...
            throw new AssertionError("Unexpected exception occured: ", ERR);
                ...
                display.set((org.gstreamer.gl.GLDisplay) Interop.register(displayPOINTER.get(Interop.valueLayout.ADDRESS, 0), org.gstreamer.gl.GLDisplay.fromAddress).marshal(displayPOINTER.get(Interop.valueLayout.ADDRESS, 0), null));
    ...
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        try {
            RESULT = (int) DowncallHandles.gst_gl_check_extension.invokeExact(
                    ...
                    Marshal.stringToAddress.marshal(ext, SCOPE));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean glEnsureElementData(org.gstreamer.gst.Element element, Out<org.gstreamer.gl.GLDisplay> displayPtr, Out<org.gstreamer.gl.GLContext> otherContextPtr) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        MemorySegment otherContextPtrPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
            ...
            throw new AssertionError("Unexpected exception occured: ", ERR);
                ...
                displayPtr.set((org.gstreamer.gl.GLDisplay) Interop.register(displayPtrPOINTER.get(Interop.valueLayout.ADDRESS, 0), org.gstreamer.gl.GLDisplay.fromAddress).marshal(displayPtrPOINTER.get(Interop.valueLayout.ADDRESS, 0), null));
                otherContextPtr.set((org.gstreamer.gl.GLContext) Interop.register(otherContextPtrPOINTER.get(Interop.valueLayout.ADDRESS, 0), org.gstreamer.gl.GLContext.fromAddress).marshal(otherContextPtrPOINTER.get(Interop.valueLayout.ADDRESS, 0), null));
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
    }
}
...
public static void glGetAffineTransformationMetaAsNdc(@Nullable org.gstreamer.video.VideoAffineTransformationMeta meta, Out<float[]> matrix) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment matrixPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        try {
        ...
        matrix.set(MemorySegment.ofAddress(matrixPOINTER.get(Interop.valueLayout.ADDRESS, 0), 16 * Interop.valueLayout.C_FLOAT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_FLOAT));
    }
}
...
public static boolean glHandleSetContext(org.gstreamer.gst.Element element, org.gstreamer.gst.Context context, Out<org.gstreamer.gl.GLDisplay> display, Out<org.gstreamer.gl.GLContext> otherContext) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        MemorySegment displayPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        MemorySegment otherContextPOINTER = SCOPE.allocate(Interop.valueLayout.ADDRESS);
        int RESULT;
        try {
            ...
            throw new AssertionError("Unexpected exception occured: ", ERR);
                ...
                display.set((org.gstreamer.gl.GLDisplay) Interop.register(displayPOINTER.get(Interop.valueLayout.ADDRESS, 0), org.gstreamer.gl.GLDisplay.fromAddress).marshal(displayPOINTER.get(Interop.valueLayout.ADDRESS, 0), null));
                otherContext.set((org.gstreamer.gl.GLContext) Interop.register(otherContextPOINTER.get(Interop.valueLayout.ADDRESS, 0), org.gstreamer.gl.GLContext.fromAddress).marshal(otherContextPOINTER.get(Interop.valueLayout.ADDRESS, 0), null));
        return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
    }
}
...
public static void glMultiplyMatrix4(float[] a, float[] b, Out<float[]> result) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        result.set(MemorySegment.ofAddress(resultPOINTER.get(Interop.valueLayout.ADDRESS, 0), 16 * Interop.valueLayout.C_FLOAT.byteSize(), SCOPE).toArray(Interop.valueLayout.C_FLOAT));
    }
}
...
public static org.gstreamer.gl.GLTextureTarget glValueGetTextureTargetMask(org.gtk.gobject.Value value) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_gl_value_get_texture_target_mask.invokeExact(value.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return org.gstreamer.gl.GLTextureTarget.of(RESULT);
...
public static boolean glslStringGetVersionProfile(java.lang.String s, Out<org.gstreamer.gl.GLSLVersion> version, Out<org.gstreamer.gl.GLSLProfile> profile) {
    try (MemorySession SCOPE = MemorySession.openConfined()) {
        ...
        MemorySegment profilePOINTER = SCOPE.allocate(Interop.valueLayout.C_INT);
        int RESULT;
        try {
...
public static boolean isGlBaseMemory(org.gstreamer.gst.Memory mem) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_is_gl_base_memory.invokeExact(mem.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean isGlBuffer(org.gstreamer.gst.Memory mem) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_is_gl_buffer.invokeExact(mem.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean isGlMemory(org.gstreamer.gst.Memory mem) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_is_gl_memory.invokeExact(mem.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean isGlMemoryPbo(org.gstreamer.gst.Memory mem) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_is_gl_memory_pbo.invokeExact(mem.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
public static boolean isGlRenderbuffer(org.gstreamer.gst.Memory mem) {
    int RESULT;
    try {
        RESULT = (int) DowncallHandles.gst_is_gl_renderbuffer.invokeExact(mem.handle());
    } catch (Throwable ERR) {
        throw new AssertionError("Unexpected exception occured: ", ERR);
    }
    return Marshal.integerToBoolean.marshal(RESULT, null).booleanValue();
...
private static final MethodHandle gst_is_gl_renderbuffer = Interop.downcallHandle(
    ...
    private static void registerTypes() {
        if (GLBaseFilter.isAvailable()) Interop.register(GLBaseFilter.getType(), GLBaseFilter.fromAddress);
        if (GLBaseMemoryAllocator.isAvailable()) Interop.register(GLBaseMemoryAllocator.getType(), GLBaseMemoryAllocator.fromAddress);
        if (GLBaseSrc.isAvailable()) Interop.register(GLBaseSrc.getType(), GLBaseSrc.fromAddress);
        if (GLBufferAllocator.isAvailable()) Interop.register(GLBufferAllocator.getType(), GLBufferAllocator.fromAddress);
        if (GLBufferPool.isAvailable()) Interop.register(GLBufferPool.getType(), GLBufferPool.fromAddress);
        if (GLColorConvert.isAvailable()) Interop.register(GLColorConvert.getType(), GLColorConvert.fromAddress);
        if (GLContext.isAvailable()) Interop.register(GLContext.getType(), GLContext.fromAddress);
        if (GLDisplay.isAvailable()) Interop.register(GLDisplay.getType(), GLDisplay.fromAddress);
        if (GLFilter.isAvailable()) Interop.register(GLFilter.getType(), GLFilter.fromAddress);
        if (GLFramebuffer.isAvailable()) Interop.register(GLFramebuffer.getType(), GLFramebuffer.fromAddress);
        if (GLMemoryAllocator.isAvailable()) Interop.register(GLMemoryAllocator.getType(), GLMemoryAllocator.fromAddress);
        if (GLMemoryPBOAllocator.isAvailable()) Interop.register(GLMemoryPBOAllocator.getType(), GLMemoryPBOAllocator.fromAddress);
        if (GLOverlayCompositor.isAvailable()) Interop.register(GLOverlayCompositor.getType(), GLOverlayCompositor.fromAddress);
        if (GLRenderbufferAllocator.isAvailable()) Interop.register(GLRenderbufferAllocator.getType(), GLRenderbufferAllocator.fromAddress);
        if (GLSLStage.isAvailable()) Interop.register(GLSLStage.getType(), GLSLStage.fromAddress);
        if (GLShader.isAvailable()) Interop.register(GLShader.getType(), GLShader.fromAddress);
        if (GLUpload.isAvailable()) Interop.register(GLUpload.getType(), GLUpload.fromAddress);
        if (GLViewConvert.isAvailable()) Interop.register(GLViewConvert.getType(), GLViewConvert.fromAddress);
        if (GLWindow.isAvailable()) Interop.register(GLWindow.getType(), GLWindow.fromAddress);
    }
}
