...
public class GLDisplayWaylandClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public GLDisplayWaylandClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private GLDisplayWaylandClass struct;
        
         /**
         * A {@link GLDisplayWaylandClass.Build} object constructs a {@link GLDisplayWaylandClass} 
         ...
         */
        public GLDisplayWaylandClass construct() {
            return struct;
        }
