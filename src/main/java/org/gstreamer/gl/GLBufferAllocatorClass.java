...
public class GLBufferAllocatorClass extends Struct {
     ...
     */
    protected GLBufferAllocatorClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, GLBufferAllocatorClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new GLBufferAllocatorClass(input, ownership);
