...
public class GLRenderbufferAllocatorClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public GLRenderbufferAllocatorClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private GLRenderbufferAllocatorClass struct;
        
         /**
         * A {@link GLRenderbufferAllocatorClass.Build} object constructs a {@link GLRenderbufferAllocatorClass} 
         ...
         */
        public GLRenderbufferAllocatorClass construct() {
            return struct;
        }
