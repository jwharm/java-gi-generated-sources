...
public class DmaBufAllocatorClass extends Struct {
    ...
    public static DmaBufAllocatorClass allocate() {
        ...
        DmaBufAllocatorClass newInstance = new DmaBufAllocatorClass(segment.address());
    ...
    public org.gstreamer.allocators.FdAllocatorClass getParentClass() {
        ...
        return org.gstreamer.allocators.FdAllocatorClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected DmaBufAllocatorClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DmaBufAllocatorClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DmaBufAllocatorClass(input);
