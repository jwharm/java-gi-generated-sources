...
public class TagMuxPrivate extends Struct {
     ...
     */
    protected TagMuxPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TagMuxPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TagMuxPrivate(input, ownership);
}
