...
public class TagMuxClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TagMuxClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TagMuxClass struct;
        
         /**
         * A {@link TagMuxClass.Build} object constructs a {@link TagMuxClass} 
        ...
        public Build setRenderStartTag(java.lang.foreign.MemoryAddress renderStartTag) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("render_start_tag"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (renderStartTag == null ? MemoryAddress.NULL : renderStartTag));
            return this;
        }
        
        public Build setRenderEndTag(java.lang.foreign.MemoryAddress renderEndTag) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("render_end_tag"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (renderEndTag == null ? MemoryAddress.NULL : renderEndTag));
            return this;
        }
