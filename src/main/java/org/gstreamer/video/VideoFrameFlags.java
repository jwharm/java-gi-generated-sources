...
public class VideoFrameFlags extends io.github.jwharm.javagi.Bitfield {
     ...
     */
    public VideoFrameFlags or(VideoFrameFlags mask) {
        return new VideoFrameFlags(this.getValue() | mask.getValue());
    }
    ...
    public static VideoFrameFlags combined(VideoFrameFlags mask, VideoFrameFlags... masks) {
        int value = mask.getValue();        for (VideoFrameFlags arg : masks) {
            value |= arg.getValue();
        }
