...
public class VideoDecoderPrivate extends Struct {
     ...
     */
    protected VideoDecoderPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VideoDecoderPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VideoDecoderPrivate(input, ownership);
}
