...
public class VideoFilter extends org.gstreamer.base.BaseTransform {
     ...
     */
    protected VideoFilter(Addressable address, Ownership ownership) {
    ...
    @ApiStatus.Internal
    public static final Marshal<Addressable, VideoFilter> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VideoFilter(input, ownership);
