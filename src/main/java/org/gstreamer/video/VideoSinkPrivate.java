...
public class VideoSinkPrivate extends Struct {
     ...
     */
    protected VideoSinkPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VideoSinkPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VideoSinkPrivate(input, ownership);
}
