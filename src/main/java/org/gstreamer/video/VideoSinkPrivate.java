...
public class VideoSinkPrivate extends Struct {
    ...
    public static VideoSinkPrivate allocate() {
        ...
        VideoSinkPrivate newInstance = new VideoSinkPrivate(segment.address());
     ...
     */
    protected VideoSinkPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VideoSinkPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VideoSinkPrivate(input);
}
