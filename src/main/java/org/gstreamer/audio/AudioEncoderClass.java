...
public class AudioEncoderClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public AudioEncoderClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private AudioEncoderClass struct;
        
         /**
         * A {@link AudioEncoderClass.Build} object constructs a {@link AudioEncoderClass} 
         ...
         */
        public AudioEncoderClass construct() {
            return struct;
        }
