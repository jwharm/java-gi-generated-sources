...
public class AudioBaseSrcPrivate extends Struct {
    ...
    public static AudioBaseSrcPrivate allocate() {
        ...
        AudioBaseSrcPrivate newInstance = new AudioBaseSrcPrivate(segment.address());
     ...
     */
    protected AudioBaseSrcPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, AudioBaseSrcPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new AudioBaseSrcPrivate(input);
}
