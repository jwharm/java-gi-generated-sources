...
public class AudioBaseSrcPrivate extends Struct {
     ...
     */
    protected AudioBaseSrcPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AudioBaseSrcPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AudioBaseSrcPrivate(input, ownership);
}
