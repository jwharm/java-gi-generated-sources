...
public class AudioDecoderClass extends Struct {
    ...
    public interface StartCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress dec) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE));
    ...
    public interface SetFormatCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress dec, MemoryAddress caps) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE), org.gstreamer.gst.Caps.fromAddress.marshal(caps, Ownership.NONE));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
    ...
    public interface ParseCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress dec, MemoryAddress adapter, MemoryAddress offset, MemoryAddress length) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE), (org.gstreamer.base.Adapter) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(adapter)), org.gstreamer.base.Adapter.fromAddress).marshal(adapter, Ownership.NONE), new PointerInteger(offset), new PointerInteger(length));
    ...
    public interface HandleFrameCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress dec, MemoryAddress buffer) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE), org.gstreamer.gst.Buffer.fromAddress.marshal(buffer, Ownership.NONE));
            return RESULT.getValue();
        }
    ...
    public interface FlushCallback {
        ...
        @ApiStatus.Internal default void upcall(MemoryAddress dec, int hard) {
            run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE), Marshal.integerToBoolean.marshal(hard, null).booleanValue());
        }
    ...
    public interface PrePushCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress dec, MemoryAddress buffer) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE), new PointerProxy<org.gstreamer.gst.Buffer>(buffer, org.gstreamer.gst.Buffer.fromAddress));
            return RESULT.getValue();
        }
    ...
    public interface SinkEventCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress dec, MemoryAddress event) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE), org.gstreamer.gst.Event.fromAddress.marshal(event, Ownership.NONE));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
    ...
    public interface DecideAllocationCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress dec, MemoryAddress query) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE), org.gstreamer.gst.Query.fromAddress.marshal(query, Ownership.NONE));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
    ...
    public interface GetcapsCallback {
        ...
        @ApiStatus.Internal default Addressable upcall(MemoryAddress dec, MemoryAddress filter) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(dec)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(dec, Ownership.NONE), org.gstreamer.gst.Caps.fromAddress.marshal(filter, Ownership.NONE));
    ...
    public interface TransformMetaCallback {
        ...
        @ApiStatus.Internal default int upcall(MemoryAddress enc, MemoryAddress outbuf, MemoryAddress meta, MemoryAddress inbuf) {
            var RESULT = run((org.gstreamer.audio.AudioDecoder) java.util.Objects.requireNonNullElse(Interop.typeRegister.get(Interop.getType(enc)), org.gstreamer.audio.AudioDecoder.fromAddress).marshal(enc, Ownership.NONE), org.gstreamer.gst.Buffer.fromAddress.marshal(outbuf, Ownership.NONE), org.gstreamer.gst.Meta.fromAddress.marshal(meta, Ownership.NONE), org.gstreamer.gst.Buffer.fromAddress.marshal(inbuf, Ownership.NONE));
            return Marshal.booleanToInteger.marshal(RESULT, null).intValue();
        }
     ...
     */
    protected AudioDecoderClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AudioDecoderClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AudioDecoderClass(input, ownership);
