...
public class VulkanImageBufferPoolClass extends Struct {
    ...
    public static VulkanImageBufferPoolClass allocate() {
        ...
        VulkanImageBufferPoolClass newInstance = new VulkanImageBufferPoolClass(segment.address());
     ...
     */
    protected VulkanImageBufferPoolClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanImageBufferPoolClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanImageBufferPoolClass(input);
