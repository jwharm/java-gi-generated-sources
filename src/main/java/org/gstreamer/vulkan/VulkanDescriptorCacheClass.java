...
public class VulkanDescriptorCacheClass extends Struct {
    ...
    public static VulkanDescriptorCacheClass allocate() {
        ...
        VulkanDescriptorCacheClass newInstance = new VulkanDescriptorCacheClass(segment.address());
     ...
     */
    protected VulkanDescriptorCacheClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanDescriptorCacheClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanDescriptorCacheClass(input);
