...
public class VulkanDescriptorCachePrivate extends Struct {
     ...
     */
    protected VulkanDescriptorCachePrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanDescriptorCachePrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VulkanDescriptorCachePrivate(input, ownership);
}
