...
public class VulkanPhysicalDeviceClass extends Struct {
    ...
    public static VulkanPhysicalDeviceClass allocate() {
        ...
        VulkanPhysicalDeviceClass newInstance = new VulkanPhysicalDeviceClass(segment.address(), Ownership.NONE);
     ...
     */
    protected VulkanPhysicalDeviceClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanPhysicalDeviceClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VulkanPhysicalDeviceClass(input, ownership);
