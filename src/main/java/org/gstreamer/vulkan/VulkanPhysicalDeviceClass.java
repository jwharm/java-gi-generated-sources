...
public class VulkanPhysicalDeviceClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public VulkanPhysicalDeviceClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private VulkanPhysicalDeviceClass struct;
        
         /**
         * A {@link VulkanPhysicalDeviceClass.Build} object constructs a {@link VulkanPhysicalDeviceClass} 
         ...
         */
        public VulkanPhysicalDeviceClass construct() {
            return struct;
        }
