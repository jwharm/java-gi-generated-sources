...
public class VulkanInstancePrivate extends Struct {
     ...
     */
    protected VulkanInstancePrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanInstancePrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VulkanInstancePrivate(input, ownership);
}
