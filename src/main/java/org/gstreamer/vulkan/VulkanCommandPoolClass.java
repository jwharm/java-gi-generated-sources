...
public class VulkanCommandPoolClass extends Struct {
    ...
    public static VulkanCommandPoolClass allocate() {
        ...
        VulkanCommandPoolClass newInstance = new VulkanCommandPoolClass(segment.address());
     ...
     */
    protected VulkanCommandPoolClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanCommandPoolClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanCommandPoolClass(input);
    
    /**
     * A {@link VulkanCommandPoolClass.Builder} object constructs a {@link VulkanCommandPoolClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link VulkanCommandPoolClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final VulkanCommandPoolClass struct;
         ...
         */
        public VulkanCommandPoolClass build() {
            return struct;
        }
