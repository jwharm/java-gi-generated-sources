...
public class VulkanCommandPoolClass extends Struct {
     ...
     */
    protected VulkanCommandPoolClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanCommandPoolClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VulkanCommandPoolClass(input, ownership);
