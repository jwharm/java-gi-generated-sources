...
public class VulkanFullScreenQuadClass extends Struct {
    ...
    public static VulkanFullScreenQuadClass allocate() {
        ...
        VulkanFullScreenQuadClass newInstance = new VulkanFullScreenQuadClass(segment.address(), Ownership.NONE);
     ...
     */
    protected VulkanFullScreenQuadClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanFullScreenQuadClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VulkanFullScreenQuadClass(input, ownership);
