...
public class VulkanFullScreenQuadClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public VulkanFullScreenQuadClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private VulkanFullScreenQuadClass struct;
        
         /**
         * A {@link VulkanFullScreenQuadClass.Build} object constructs a {@link VulkanFullScreenQuadClass} 
         ...
         */
        public VulkanFullScreenQuadClass construct() {
            return struct;
        }
