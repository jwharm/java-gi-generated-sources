...
public class VulkanCommandPoolPrivate extends Struct {
     ...
     */
    protected VulkanCommandPoolPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanCommandPoolPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VulkanCommandPoolPrivate(input, ownership);
}
