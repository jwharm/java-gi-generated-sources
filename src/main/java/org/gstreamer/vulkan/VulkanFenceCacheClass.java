...
public class VulkanFenceCacheClass extends Struct {
    ...
    public static VulkanFenceCacheClass allocate() {
        ...
        VulkanFenceCacheClass newInstance = new VulkanFenceCacheClass(segment.address());
     ...
     */
    protected VulkanFenceCacheClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanFenceCacheClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanFenceCacheClass(input);
