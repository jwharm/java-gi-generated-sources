...
public class VulkanBufferMemoryAllocator extends org.gstreamer.gst.Allocator {
     ...
     */
    protected VulkanBufferMemoryAllocator(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanBufferMemoryAllocator> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanBufferMemoryAllocator(input);
    ...
    public static boolean isAvailable() {
        return DowncallHandles.gst_vulkan_buffer_memory_allocator_get_type != null;
    }
}
