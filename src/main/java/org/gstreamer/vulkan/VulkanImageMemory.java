...
public class VulkanImageMemory extends Struct {
    ...
    public static VulkanImageMemory allocate() {
        ...
        VulkanImageMemory newInstance = new VulkanImageMemory(segment.address());
    ...
    public org.vulkan.Image getImage() {
        ...
        return org.vulkan.Image.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
    ...
    public void setImage(org.vulkan.Image image) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (image == null ? MemoryAddress.NULL : image.handle()));
        }
    }
    ...
    public org.vulkan.ImageCreateInfo getCreateInfo() {
        ...
        return org.vulkan.ImageCreateInfo.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
    ...
    public void setCreateInfo(org.vulkan.ImageCreateInfo createInfo) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (createInfo == null ? MemoryAddress.NULL : createInfo.handle()));
        }
    }
    ...
    public org.vulkan.ImageFormatProperties getFormatProperties() {
        ...
        return org.vulkan.ImageFormatProperties.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
    ...
    public void setFormatProperties(org.vulkan.ImageFormatProperties formatProperties) {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            getMemoryLayout()
                ...
                .set(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (formatProperties == null ? MemoryAddress.NULL : formatProperties.handle()));
        }
    }
    ...
    public org.vulkan.ImageUsageFlags getUsage() {
        ...
        return org.vulkan.ImageUsageFlags.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
    ...
    public org.gstreamer.vulkan.VulkanBarrierImageInfo getBarrier() {
        ...
        return org.gstreamer.vulkan.VulkanBarrierImageInfo.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected VulkanImageMemory(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanImageMemory> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanImageMemory(input);
    ...
    public int getHeight() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_vulkan_image_memory_get_height.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public int getWidth() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_vulkan_image_memory_get_width.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public static class Builder {
        ...
        public Builder setCreateInfo(org.vulkan.ImageCreateInfo createInfo) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("create_info"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (createInfo == null ? MemoryAddress.NULL : createInfo.handle()));
                return this;
            }
        }
        ...
        public Builder setFormatProperties(org.vulkan.ImageFormatProperties formatProperties) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    .varHandle(MemoryLayout.PathElement.groupElement("format_properties"))
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (formatProperties == null ? MemoryAddress.NULL : formatProperties.handle()));
                return this;
            }
        }
        ...
        public Builder setViews(java.lang.foreign.MemoryAddress[] views) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    ...
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (views == null ? MemoryAddress.NULL : Interop.allocateNativeArray(views, false, SCOPE)));
                return this;
            }
        }
        ...
        public Builder setOutstandingViews(java.lang.foreign.MemoryAddress[] outstandingViews) {
            try (MemorySession SCOPE = MemorySession.openConfined()) {
                getMemoryLayout()
                    ...
                    .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), SCOPE), (Addressable) (outstandingViews == null ? MemoryAddress.NULL : Interop.allocateNativeArray(outstandingViews, false, SCOPE)));
                return this;
            }
        }
