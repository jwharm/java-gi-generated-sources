...
public class VulkanDisplayPrivate extends Struct {
    ...
    public static VulkanDisplayPrivate allocate() {
        ...
        VulkanDisplayPrivate newInstance = new VulkanDisplayPrivate(segment.address());
     ...
     */
    protected VulkanDisplayPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanDisplayPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanDisplayPrivate(input);
}
