...
public class VulkanFence extends Struct {
    ...
    public static VulkanFence allocate() {
        ...
        VulkanFence newInstance = new VulkanFence(segment.address());
    ...
    public org.gstreamer.vulkan.VulkanFenceCache getCache() {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            var RESULT = (MemoryAddress) getMemoryLayout()
                ...
                .get(MemorySegment.ofAddress((MemoryAddress) handle(), getMemoryLayout().byteSize(), SCOPE));
            return (org.gstreamer.vulkan.VulkanFenceCache) Interop.register(RESULT, org.gstreamer.vulkan.VulkanFenceCache.fromAddress).marshal(RESULT, null);
        }
    }
    ...
    public org.vulkan.Fence getFence() {
        ...
        return org.vulkan.Fence.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected VulkanFence(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanFence> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanFence(input);
    ...
    private static MemoryAddress constructNew(org.gstreamer.vulkan.VulkanDevice device) throws GErrorException {
        try (MemorySession SCOPE = MemorySession.openConfined()) {
            ...
            try {
                RESULT = (MemoryAddress) DowncallHandles.gst_vulkan_fence_new.invokeExact(device.handle(),(Addressable) GERROR);
            } catch (Throwable ERR) {
    ...
    private static MemoryAddress constructNewAlwaysSignalled(org.gstreamer.vulkan.VulkanDevice device) {
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_vulkan_fence_new_always_signalled.invokeExact(device.handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT;
    ...
    public boolean isSignaled() {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_vulkan_fence_is_signaled.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    public void reset() {
        try {
            DowncallHandles.gst_vulkan_fence_reset.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    }
