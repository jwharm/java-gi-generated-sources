...
public class VulkanPhysicalDevicePrivate extends Struct {
     ...
     */
    protected VulkanPhysicalDevicePrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanPhysicalDevicePrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VulkanPhysicalDevicePrivate(input, ownership);
}
