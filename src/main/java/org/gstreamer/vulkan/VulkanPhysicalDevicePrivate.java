...
public class VulkanPhysicalDevicePrivate extends Struct {
    ...
    public static VulkanPhysicalDevicePrivate allocate() {
        ...
        VulkanPhysicalDevicePrivate newInstance = new VulkanPhysicalDevicePrivate(segment.address());
     ...
     */
    protected VulkanPhysicalDevicePrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanPhysicalDevicePrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanPhysicalDevicePrivate(input);
}
