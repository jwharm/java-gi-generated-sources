...
public class VulkanSwapperClass extends Struct {
    ...
    public static VulkanSwapperClass allocate() {
        ...
        VulkanSwapperClass newInstance = new VulkanSwapperClass(segment.address());
     ...
     */
    protected VulkanSwapperClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanSwapperClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new VulkanSwapperClass(input);
