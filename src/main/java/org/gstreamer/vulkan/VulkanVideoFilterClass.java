...
public class VulkanVideoFilterClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public VulkanVideoFilterClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private VulkanVideoFilterClass struct;
        
         /**
         * A {@link VulkanVideoFilterClass.Build} object constructs a {@link VulkanVideoFilterClass} 
         ...
         */
        public VulkanVideoFilterClass construct() {
            return struct;
        }
