...
public class VulkanDevicePrivate extends Struct {
     ...
     */
    protected VulkanDevicePrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, VulkanDevicePrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new VulkanDevicePrivate(input, ownership);
}
