...
public class PtpClockPrivate extends Struct {
    ...
    public static PtpClockPrivate allocate() {
        ...
        PtpClockPrivate newInstance = new PtpClockPrivate(segment.address());
     ...
     */
    protected PtpClockPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PtpClockPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PtpClockPrivate(input);
}
