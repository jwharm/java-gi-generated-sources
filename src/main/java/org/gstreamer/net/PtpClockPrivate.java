...
public class PtpClockPrivate extends Struct {
     ...
     */
    protected PtpClockPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PtpClockPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PtpClockPrivate(input, ownership);
}
