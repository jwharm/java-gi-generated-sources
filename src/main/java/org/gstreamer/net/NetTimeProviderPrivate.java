...
public class NetTimeProviderPrivate extends Struct {
     ...
     */
    protected NetTimeProviderPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, NetTimeProviderPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new NetTimeProviderPrivate(input, ownership);
}
