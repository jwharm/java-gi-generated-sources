...
public class TestClockClass extends Struct {
    ...
    public static TestClockClass allocate() {
        ...
        TestClockClass newInstance = new TestClockClass(segment.address());
    ...
    public org.gstreamer.gst.ClockClass getParentClass() {
        ...
        return org.gstreamer.gst.ClockClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected TestClockClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, TestClockClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new TestClockClass(input);
