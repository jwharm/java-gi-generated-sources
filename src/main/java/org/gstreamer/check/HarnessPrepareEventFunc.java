...
/**
 * Functional interface declaration of the {@code HarnessPrepareEventFunc} callback.
 */
@FunctionalInterface
public interface HarnessPrepareEventFunc {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), HarnessPrepareEventFunc.class, DESCRIPTOR);
