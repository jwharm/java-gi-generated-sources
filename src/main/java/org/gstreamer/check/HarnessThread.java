...
public class HarnessThread extends Struct {
    ...
    public static class Build {
        ...
        private HarnessThread struct;
        
         /**
         * A {@link HarnessThread.Build} object constructs a {@link HarnessThread} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = HarnessThread.allocate();
        }
        
         /**
         * Finish building the {@link HarnessThread} struct.
         * @return A new instance of {@code HarnessThread} with the fields 
         *         that were set in the Build object.
         */
        public HarnessThread construct() {
            return struct;
        }
    }
}
