...
/**
 * Functional interface declaration of the {@code DataQueueFullCallback} callback.
 */
@FunctionalInterface
public interface DataQueueFullCallback {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), DataQueueFullCallback.class, DESCRIPTOR);
