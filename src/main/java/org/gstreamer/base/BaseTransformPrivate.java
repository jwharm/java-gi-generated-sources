...
public class BaseTransformPrivate extends Struct {
    ...
    public static BaseTransformPrivate allocate() {
        ...
        BaseTransformPrivate newInstance = new BaseTransformPrivate(segment.address());
     ...
     */
    protected BaseTransformPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BaseTransformPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BaseTransformPrivate(input);
}
