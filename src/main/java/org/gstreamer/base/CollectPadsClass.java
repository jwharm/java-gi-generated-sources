...
public class CollectPadsClass extends Struct {
    ...
    public static CollectPadsClass allocate() {
        ...
        CollectPadsClass newInstance = new CollectPadsClass(segment.address());
     ...
     */
    protected CollectPadsClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, CollectPadsClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new CollectPadsClass(input);
