...
public class AggregatorPrivate extends Struct {
     ...
     */
    protected AggregatorPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AggregatorPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AggregatorPrivate(input, ownership);
}
