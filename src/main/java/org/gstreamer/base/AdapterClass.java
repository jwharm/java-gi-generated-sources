...
public class AdapterClass extends Struct {
    ...
    public static class Build {
        ...
        private AdapterClass struct;
        
         /**
         * A {@link AdapterClass.Build} object constructs a {@link AdapterClass} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = AdapterClass.allocate();
        }
        
         /**
         * Finish building the {@link AdapterClass} struct.
         * @return A new instance of {@code AdapterClass} with the fields 
         *         that were set in the Build object.
         */
        public AdapterClass construct() {
            return struct;
        }
    }
}
