...
public class AggregatorPadPrivate extends Struct {
     ...
     */
    protected AggregatorPadPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AggregatorPadPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AggregatorPadPrivate(input, ownership);
}
