...
public class CollectPadsPrivate extends Struct {
     ...
     */
    protected CollectPadsPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, CollectPadsPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new CollectPadsPrivate(input, ownership);
}
