...
public class BaseParse extends org.gstreamer.gst.Element {
     ...
     */
    protected BaseParse(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, BaseParse> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new BaseParse(input);
     ...
     */
    public boolean addIndexEntry(long offset, org.gstreamer.gst.ClockTime ts, boolean key, boolean force) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_base_parse_add_index_entry.invokeExact(
                    ...
                    Marshal.booleanToInteger.marshal(key, null).intValue(),
                    Marshal.booleanToInteger.marshal(force, null).intValue());
        } catch (Throwable ERR) {
     ...
     */
    public boolean convertDefault(org.gstreamer.gst.Format srcFormat, long srcValue, org.gstreamer.gst.Format destFormat, Out<Long> destValue) {
    ...
    public void drain() {
        try {
            DowncallHandles.gst_base_parse_drain.invokeExact(handle());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    }
     ...
     */
    public org.gstreamer.gst.FlowReturn finishFrame(org.gstreamer.base.BaseParseFrame frame, int size) {
        int RESULT;
        try {
     ...
     */
    public org.gstreamer.gst.FlowReturn pushFrame(org.gstreamer.base.BaseParseFrame frame) {
        int RESULT;
        try {
     ...
     */
    public void setDuration(org.gstreamer.gst.Format fmt, long duration, int interval) {
        try {
    ...
    public void setHasTimingInfo(boolean hasTiming) {
        try {
            DowncallHandles.gst_base_parse_set_has_timing_info.invokeExact(
                    handle(),
                    Marshal.booleanToInteger.marshal(hasTiming, null).intValue());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    }
    ...
    public void setInferTs(boolean inferTs) {
        try {
            DowncallHandles.gst_base_parse_set_infer_ts.invokeExact(
                    handle(),
                    Marshal.booleanToInteger.marshal(inferTs, null).intValue());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    }
    ...
    public void setPtsInterpolation(boolean ptsInterpolate) {
        try {
            DowncallHandles.gst_base_parse_set_pts_interpolation.invokeExact(
                    handle(),
                    Marshal.booleanToInteger.marshal(ptsInterpolate, null).intValue());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    }
    ...
    public void setSyncable(boolean syncable) {
        try {
            DowncallHandles.gst_base_parse_set_syncable.invokeExact(
                    handle(),
                    Marshal.booleanToInteger.marshal(syncable, null).intValue());
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    }
    ...
    /**
     * A {@link BaseParse.Builder} object constructs a {@link BaseParse} 
     * using the <em>builder pattern</em> to set property values. 
     * Use the various {@code set...()} methods to set properties, 
     * and finish construction with {@link BaseParse.Builder#build()}. 
     */
    ...
    public static class Builder extends org.gstreamer.gst.Element.Builder {
        ...
        public BaseParse build() {
            return (BaseParse) org.gtk.gobject.GObject.newWithProperties(
                BaseParse.getType(),
                names.size(),
         ...
         */
        public Builder setDisablePassthrough(boolean disablePassthrough) {
    ...
    public static boolean isAvailable() {
        return DowncallHandles.gst_base_parse_get_type != null;
    }
}
