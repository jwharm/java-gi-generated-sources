...
public class PlayerStreamInfoClass extends Struct {
    ...
    public static PlayerStreamInfoClass allocate() {
        ...
        PlayerStreamInfoClass newInstance = new PlayerStreamInfoClass(segment.address(), Ownership.NONE);
     ...
     */
    protected PlayerStreamInfoClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PlayerStreamInfoClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PlayerStreamInfoClass(input, ownership);
}
