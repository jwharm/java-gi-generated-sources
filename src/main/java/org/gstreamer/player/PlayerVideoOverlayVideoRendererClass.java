...
public class PlayerVideoOverlayVideoRendererClass extends Struct {
    ...
    public static PlayerVideoOverlayVideoRendererClass allocate() {
        ...
        PlayerVideoOverlayVideoRendererClass newInstance = new PlayerVideoOverlayVideoRendererClass(segment.address());
     ...
     */
    protected PlayerVideoOverlayVideoRendererClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PlayerVideoOverlayVideoRendererClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PlayerVideoOverlayVideoRendererClass(input);
}
