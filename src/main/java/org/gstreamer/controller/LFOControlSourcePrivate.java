...
public class LFOControlSourcePrivate extends Struct {
     ...
     */
    protected LFOControlSourcePrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, LFOControlSourcePrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new LFOControlSourcePrivate(input, ownership);
}
