...
public class TimedValueControlSourceClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TimedValueControlSourceClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TimedValueControlSourceClass struct;
        
         /**
         * A {@link TimedValueControlSourceClass.Build} object constructs a {@link TimedValueControlSourceClass} 
         ...
         */
        public TimedValueControlSourceClass construct() {
            return struct;
        }
