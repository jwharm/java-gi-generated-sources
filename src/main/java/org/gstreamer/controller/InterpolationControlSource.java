...
public class InterpolationControlSource extends org.gstreamer.controller.TimedValueControlSource {
     ...
     */
    protected InterpolationControlSource(Addressable address, Ownership ownership) {
    ...
    @ApiStatus.Internal
    public static final Marshal<Addressable, InterpolationControlSource> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new InterpolationControlSource(input, ownership);
