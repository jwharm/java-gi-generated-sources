...
public class TriggerControlSourcePrivate extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TriggerControlSourcePrivate(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TriggerControlSourcePrivate struct;
        
         /**
         * A {@link TriggerControlSourcePrivate.Build} object constructs a {@link TriggerControlSourcePrivate} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = TriggerControlSourcePrivate.allocate();
        }
        
         /**
         * Finish building the {@link TriggerControlSourcePrivate} struct.
         * @return A new instance of {@code TriggerControlSourcePrivate} with the fields 
         *         that were set in the Build object.
         */
        public TriggerControlSourcePrivate construct() {
            return struct;
        }
    }
}
