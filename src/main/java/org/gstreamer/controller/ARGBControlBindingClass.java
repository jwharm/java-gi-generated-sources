...
public class ARGBControlBindingClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public ARGBControlBindingClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private ARGBControlBindingClass struct;
        
         /**
         * A {@link ARGBControlBindingClass.Build} object constructs a {@link ARGBControlBindingClass} 
         ...
         */
        public ARGBControlBindingClass construct() {
            return struct;
        }
