...
public class InterpolationControlSourceClass extends Struct {
    ...
    public static InterpolationControlSourceClass allocate() {
        ...
        InterpolationControlSourceClass newInstance = new InterpolationControlSourceClass(segment.address());
    ...
    public org.gstreamer.controller.TimedValueControlSourceClass getParentClass() {
        ...
        return org.gstreamer.controller.TimedValueControlSourceClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected InterpolationControlSourceClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, InterpolationControlSourceClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new InterpolationControlSourceClass(input);
