...
public class InterpolationControlSourcePrivate extends Struct {
     ...
     */
    @ApiStatus.Internal
    public InterpolationControlSourcePrivate(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private InterpolationControlSourcePrivate struct;
        
         /**
         * A {@link InterpolationControlSourcePrivate.Build} object constructs a {@link InterpolationControlSourcePrivate} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = InterpolationControlSourcePrivate.allocate();
        }
        
         /**
         * Finish building the {@link InterpolationControlSourcePrivate} struct.
         * @return A new instance of {@code InterpolationControlSourcePrivate} with the fields 
         *         that were set in the Build object.
         */
        public InterpolationControlSourcePrivate construct() {
            return struct;
        }
    }
}
