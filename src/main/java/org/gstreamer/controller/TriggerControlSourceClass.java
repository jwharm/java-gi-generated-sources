...
public class TriggerControlSourceClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TriggerControlSourceClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TriggerControlSourceClass struct;
        
         /**
         * A {@link TriggerControlSourceClass.Build} object constructs a {@link TriggerControlSourceClass} 
         ...
         */
        public TriggerControlSourceClass construct() {
            return struct;
        }
