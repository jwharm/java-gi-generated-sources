...
public class DirectControlBindingClass extends Struct {
    ...
    public static DirectControlBindingClass allocate() {
        ...
        DirectControlBindingClass newInstance = new DirectControlBindingClass(segment.address());
    ...
    public org.gstreamer.gst.ControlBindingClass getParentClass() {
        ...
        return org.gstreamer.gst.ControlBindingClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected DirectControlBindingClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, DirectControlBindingClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new DirectControlBindingClass(input);
