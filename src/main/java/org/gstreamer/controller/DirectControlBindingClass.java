...
public class DirectControlBindingClass extends Struct {
     ...
     */
    public org.gstreamer.gst.ControlBindingClass parentClass$get() {
        long OFFSET = getMemoryLayout().byteOffset(MemoryLayout.PathElement.groupElement("parent_class"));
        return new org.gstreamer.gst.ControlBindingClass(((MemoryAddress) handle()).addOffset(OFFSET), Ownership.UNKNOWN);
    }
     ...
     */
    @ApiStatus.Internal
    public DirectControlBindingClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private DirectControlBindingClass struct;
        
         /**
         * A {@link DirectControlBindingClass.Build} object constructs a {@link DirectControlBindingClass} 
         ...
         */
        public DirectControlBindingClass construct() {
            return struct;
        }
