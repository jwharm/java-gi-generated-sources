...
public class RTPBaseAudioPayloadClass extends Struct {
    ...
    public static RTPBaseAudioPayloadClass allocate() {
        ...
        RTPBaseAudioPayloadClass newInstance = new RTPBaseAudioPayloadClass(segment.address(), Ownership.NONE);
     ...
     */
    public org.gstreamer.rtp.RTPBasePayloadClass parentClass$get() {
        long OFFSET = getMemoryLayout().byteOffset(MemoryLayout.PathElement.groupElement("parent_class"));
        return new org.gstreamer.rtp.RTPBasePayloadClass(((MemoryAddress) handle()).addOffset(OFFSET), Ownership.UNKNOWN);
    }
     ...
     */
    @ApiStatus.Internal
    public RTPBaseAudioPayloadClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private RTPBaseAudioPayloadClass struct;
        
         /**
         * A {@link RTPBaseAudioPayloadClass.Build} object constructs a {@link RTPBaseAudioPayloadClass} 
         ...
         */
        public RTPBaseAudioPayloadClass construct() {
            return struct;
        }
         ...
         */
        public Build setParentClass(org.gstreamer.rtp.RTPBasePayloadClass parentClass) {
            getMemoryLayout()
