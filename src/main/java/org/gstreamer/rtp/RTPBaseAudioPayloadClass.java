...
public class RTPBaseAudioPayloadClass extends Struct {
    ...
    public org.gstreamer.rtp.RTPBasePayloadClass getParentClass() {
        ...
        return org.gstreamer.rtp.RTPBasePayloadClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), Ownership.UNKNOWN);
    }
     ...
     */
    protected RTPBaseAudioPayloadClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RTPBaseAudioPayloadClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RTPBaseAudioPayloadClass(input, ownership);
