...
public class RTPBaseAudioPayloadPrivate extends Struct {
     ...
     */
    protected RTPBaseAudioPayloadPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RTPBaseAudioPayloadPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RTPBaseAudioPayloadPrivate(input, ownership);
}
