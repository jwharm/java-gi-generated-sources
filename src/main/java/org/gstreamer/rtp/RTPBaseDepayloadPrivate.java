...
public class RTPBaseDepayloadPrivate extends Struct {
     ...
     */
    protected RTPBaseDepayloadPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, RTPBaseDepayloadPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new RTPBaseDepayloadPrivate(input, ownership);
}
