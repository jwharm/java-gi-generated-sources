...
public class GhostPadClass extends Struct {
    ...
    public static GhostPadClass allocate() {
        ...
        GhostPadClass newInstance = new GhostPadClass(segment.address());
    ...
    public org.gstreamer.gst.ProxyPadClass getParentClass() {
        ...
        return org.gstreamer.gst.ProxyPadClass.fromAddress.marshal(((MemoryAddress) handle()).addOffset(OFFSET), null);
    }
     ...
     */
    protected GhostPadClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, GhostPadClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new GhostPadClass(input);
