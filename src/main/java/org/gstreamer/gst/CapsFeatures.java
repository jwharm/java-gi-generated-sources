...
public class CapsFeatures extends Struct {
    ...
    public static class Build {
        ...
        private CapsFeatures struct;
        
         /**
         * A {@link CapsFeatures.Build} object constructs a {@link CapsFeatures} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = CapsFeatures.allocate();
        }
        
         /**
         * Finish building the {@link CapsFeatures} struct.
         * @return A new instance of {@code CapsFeatures} with the fields 
         *         that were set in the Build object.
         */
        public CapsFeatures construct() {
            return struct;
        }
    }
}
