...
public class StreamCollectionClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public StreamCollectionClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private StreamCollectionClass struct;
        
         /**
         * A {@link StreamCollectionClass.Build} object constructs a {@link StreamCollectionClass} 
         ...
         */
        public StreamCollectionClass construct() {
            return struct;
        }
        ...
        public Build setStreamNotify(java.lang.foreign.MemoryAddress streamNotify) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("stream_notify"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (streamNotify == null ? MemoryAddress.NULL : streamNotify));
            return this;
        }
