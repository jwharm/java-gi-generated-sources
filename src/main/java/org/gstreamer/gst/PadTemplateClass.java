...
public class PadTemplateClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public PadTemplateClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private PadTemplateClass struct;
        
         /**
         * A {@link PadTemplateClass.Build} object constructs a {@link PadTemplateClass} 
         ...
         */
        public PadTemplateClass construct() {
            return struct;
        }
        ...
        public Build setPadCreated(java.lang.foreign.MemoryAddress padCreated) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("pad_created"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (padCreated == null ? MemoryAddress.NULL : padCreated));
            return this;
        }
