...
public class Sample extends Struct {
    ...
    public static class Build {
        ...
        private Sample struct;
        
         /**
         * A {@link Sample.Build} object constructs a {@link Sample} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = Sample.allocate();
        }
        
         /**
         * Finish building the {@link Sample} struct.
         * @return A new instance of {@code Sample} with the fields 
         *         that were set in the Build object.
         */
        public Sample construct() {
            return struct;
        }
    }
}
