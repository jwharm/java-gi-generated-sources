...
public class TocSetterInterface extends Struct {
    ...
    public static TocSetterInterface allocate() {
        ...
        TocSetterInterface newInstance = new TocSetterInterface(segment.address());
     ...
     */
    protected TocSetterInterface(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, TocSetterInterface> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new TocSetterInterface(input);
