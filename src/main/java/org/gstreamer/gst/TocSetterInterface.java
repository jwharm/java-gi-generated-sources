...
public class TocSetterInterface extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TocSetterInterface(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TocSetterInterface struct;
        
         /**
         * A {@link TocSetterInterface.Build} object constructs a {@link TocSetterInterface} 
         ...
         */
        public TocSetterInterface construct() {
            return struct;
        }
