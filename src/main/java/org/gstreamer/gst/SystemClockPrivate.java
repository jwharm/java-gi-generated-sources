...
public class SystemClockPrivate extends Struct {
     ...
     */
    protected SystemClockPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, SystemClockPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new SystemClockPrivate(input, ownership);
}
