...
public class PipelineClass extends Struct {
    ...
    public static PipelineClass allocate() {
        ...
        PipelineClass newInstance = new PipelineClass(segment.address());
     ...
     */
    protected PipelineClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new PipelineClass(input);
