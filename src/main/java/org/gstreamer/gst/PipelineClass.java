...
public class PipelineClass extends Struct {
     ...
     */
    protected PipelineClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, PipelineClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new PipelineClass(input, ownership);
    
    /**
     * A {@link PipelineClass.Builder} object constructs a {@link PipelineClass} 
     * struct using the <em>builder pattern</em> to set the field values. 
     * Use the various {@code set...()} methods to set field values, 
     * and finish construction with {@link PipelineClass.Builder#build()}. 
     */
    ...
    public static class Builder {
        ...
        private final PipelineClass struct;
