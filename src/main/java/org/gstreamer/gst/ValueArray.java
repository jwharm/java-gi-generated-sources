...
public class ValueArray extends io.github.jwharm.javagi.ObjectBase {
    ...
    public static ValueArray castFrom(org.gtk.gobject.Object gobject) {
        if (org.gtk.gobject.GObject.typeCheckInstanceIsA(new org.gtk.gobject.TypeInstance(gobject.handle(), Ownership.NONE), ValueArray.getType())) {
            return new ValueArray(gobject.handle(), gobject.yieldOwnership());
        } else {
            throw new ClassCastException("Object type is not an instance of GstValueArray");
        }
    }
