...
public class TagSetterInterface extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TagSetterInterface(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TagSetterInterface struct;
        
         /**
         * A {@link TagSetterInterface.Build} object constructs a {@link TagSetterInterface} 
         ...
         */
        public TagSetterInterface construct() {
            return struct;
        }
