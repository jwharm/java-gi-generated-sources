 ...
 */
/**
 * Functional interface declaration of the {@code PadGetRangeFunction} callback.
 */
@FunctionalInterface
public interface PadGetRangeFunction {
    ...
    @ApiStatus.Internal default int upcall(MemoryAddress pad, MemoryAddress parent, long offset, int length, MemoryAddress buffer) {
        var RESULT = run((org.gstreamer.gst.Pad) Interop.register(pad, org.gstreamer.gst.Pad.fromAddress).marshal(pad, null), (org.gstreamer.gst.GstObject) Interop.register(parent, org.gstreamer.gst.GstObject.fromAddress).marshal(parent, null), offset, length, new PointerProxy<org.gstreamer.gst.Buffer>(buffer, org.gstreamer.gst.Buffer.fromAddress));
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), PadGetRangeFunction.class, DESCRIPTOR);
