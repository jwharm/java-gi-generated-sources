...
public class BusPrivate extends Struct {
     ...
     */
    protected BusPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BusPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BusPrivate(input, ownership);
}
