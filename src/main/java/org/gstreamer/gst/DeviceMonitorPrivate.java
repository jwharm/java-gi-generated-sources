...
public class DeviceMonitorPrivate extends Struct {
     ...
     */
    protected DeviceMonitorPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, DeviceMonitorPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new DeviceMonitorPrivate(input, ownership);
}
