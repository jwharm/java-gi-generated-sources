...
public class DeviceMonitorPrivate extends Struct {
    ...
    public static class Build {
        ...
        private DeviceMonitorPrivate struct;
        
         /**
         * A {@link DeviceMonitorPrivate.Build} object constructs a {@link DeviceMonitorPrivate} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = DeviceMonitorPrivate.allocate();
        }
        
         /**
         * Finish building the {@link DeviceMonitorPrivate} struct.
         * @return A new instance of {@code DeviceMonitorPrivate} with the fields 
         *         that were set in the Build object.
         */
        public DeviceMonitorPrivate construct() {
            return struct;
        }
    }
}
