...
public class StreamCollectionPrivate extends Struct {
     ...
     */
    protected StreamCollectionPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, StreamCollectionPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new StreamCollectionPrivate(input, ownership);
}
