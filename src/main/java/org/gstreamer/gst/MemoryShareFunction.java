 ...
 */
/**
 * Functional interface declaration of the {@code MemoryShareFunction} callback.
 */
@FunctionalInterface
public interface MemoryShareFunction {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), MemoryShareFunction.class, DESCRIPTOR);
