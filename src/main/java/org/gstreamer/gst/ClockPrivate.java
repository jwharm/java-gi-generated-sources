...
public class ClockPrivate extends Struct {
     ...
     */
    protected ClockPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, ClockPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new ClockPrivate(input, ownership);
}
