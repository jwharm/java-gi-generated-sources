...
public class SystemClockClass extends Struct {
    ...
    public static SystemClockClass allocate() {
        ...
        SystemClockClass newInstance = new SystemClockClass(segment.address());
     ...
     */
    protected SystemClockClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, SystemClockClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new SystemClockClass(input);
