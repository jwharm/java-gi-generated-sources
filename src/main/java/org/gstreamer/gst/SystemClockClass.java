...
public class SystemClockClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public SystemClockClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private SystemClockClass struct;
        
         /**
         * A {@link SystemClockClass.Build} object constructs a {@link SystemClockClass} 
         ...
         */
        public SystemClockClass construct() {
            return struct;
        }
