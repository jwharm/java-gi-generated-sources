...
public class ProxyPadPrivate extends Struct {
     ...
     */
    @ApiStatus.Internal
    public ProxyPadPrivate(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private ProxyPadPrivate struct;
        
         /**
         * A {@link ProxyPadPrivate.Build} object constructs a {@link ProxyPadPrivate} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = ProxyPadPrivate.allocate();
        }
        
         /**
         * Finish building the {@link ProxyPadPrivate} struct.
         * @return A new instance of {@code ProxyPadPrivate} with the fields 
         *         that were set in the Build object.
         */
        public ProxyPadPrivate construct() {
            return struct;
        }
    }
}
