...
public class TypeFindFactoryClass extends Struct {
    ...
    public static TypeFindFactoryClass allocate() {
        ...
        TypeFindFactoryClass newInstance = new TypeFindFactoryClass(segment.address(), Ownership.NONE);
     ...
     */
    protected TypeFindFactoryClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, TypeFindFactoryClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new TypeFindFactoryClass(input, ownership);
}
