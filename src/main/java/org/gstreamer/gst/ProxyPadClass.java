...
public class ProxyPadClass extends Struct {
    ...
    public static ProxyPadClass allocate() {
        ...
        ProxyPadClass newInstance = new ProxyPadClass(segment.address());
     ...
     */
    protected ProxyPadClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, ProxyPadClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new ProxyPadClass(input);
