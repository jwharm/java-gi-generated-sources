...
public final class Gst {
    ...
    public static int debugConstructWinColor(int colorinfo) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_debug_construct_win_color.invokeExact(
                    colorinfo);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    public static boolean isCapsFeatures(@Nullable java.lang.foreign.MemoryAddress obj) {
        int RESULT;
        try {
            RESULT = (int) DowncallHandles.gst_is_caps_features.invokeExact(
                    (Addressable) (obj == null ? MemoryAddress.NULL : (Addressable) obj));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return RESULT != 0;
    ...
    public static @NotNull org.gstreamer.gst.Element parseLaunchv(@NotNull java.lang.String[] argv) throws io.github.jwharm.javagi.GErrorException {
        ...
        MemoryAddress RESULT;
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_parse_launchv.invokeExact(
    ...
    public static @Nullable PointerString protectionFilterSystemsByAvailableDecryptors(@NotNull java.lang.String[] systemIdentifiers) {
        ...
        try {
            RESULT = (MemoryAddress) DowncallHandles.gst_protection_filter_systems_by_available_decryptors.invokeExact(
                    Interop.allocateNativeArray(systemIdentifiers, false));
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
        return new PointerString(RESULT);
    ...
    public static long utilGdoubleToGuint64(double value) {
        long RESULT;
        try {
            RESULT = (long) DowncallHandles.gst_util_gdouble_to_guint64.invokeExact(
                    value);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
    ...
    public static double utilGuint64ToGdouble(long value) {
        double RESULT;
        try {
            RESULT = (double) DowncallHandles.gst_util_guint64_to_gdouble.invokeExact(
                    value);
        } catch (Throwable ERR) {
            throw new AssertionError("Unexpected exception occured: ", ERR);
        }
