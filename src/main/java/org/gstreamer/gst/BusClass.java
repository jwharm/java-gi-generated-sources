...
public class BusClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public BusClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private BusClass struct;
        
         /**
         * A {@link BusClass.Build} object constructs a {@link BusClass} 
        ...
        public Build setMessage(java.lang.foreign.MemoryAddress message) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("message"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (message == null ? MemoryAddress.NULL : message));
            return this;
        }
        
        public Build setSyncMessage(java.lang.foreign.MemoryAddress syncMessage) {
            getMemoryLayout()
                .varHandle(MemoryLayout.PathElement.groupElement("sync_message"))
                .set(MemorySegment.ofAddress((MemoryAddress) struct.handle(), getMemoryLayout().byteSize(), Interop.getScope()), (Addressable) (syncMessage == null ? MemoryAddress.NULL : syncMessage));
            return this;
        }
