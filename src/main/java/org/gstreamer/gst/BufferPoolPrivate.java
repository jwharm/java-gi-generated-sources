...
public class BufferPoolPrivate extends Struct {
     ...
     */
    protected BufferPoolPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, BufferPoolPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new BufferPoolPrivate(input, ownership);
}
