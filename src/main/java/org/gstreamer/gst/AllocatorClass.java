...
public class AllocatorClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public AllocatorClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private AllocatorClass struct;
        
         /**
         * A {@link AllocatorClass.Build} object constructs a {@link AllocatorClass} 
         ...
         */
        public AllocatorClass construct() {
            return struct;
        }
