 ...
 */
/**
 * Functional interface declaration of the {@code StructureMapFunc} callback.
 */
@FunctionalInterface
public interface StructureMapFunc {
     ...
     */
    @ApiStatus.Internal MethodHandle HANDLE = Interop.getHandle(MethodHandles.lookup(), StructureMapFunc.class, DESCRIPTOR);
