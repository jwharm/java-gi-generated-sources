...
public class TracerFactoryClass extends Struct {
     ...
     */
    @ApiStatus.Internal
    public TracerFactoryClass(Addressable address, Ownership ownership) {
    ...
    public static class Build {
        ...
        private TracerFactoryClass struct;
        
         /**
         * A {@link TracerFactoryClass.Build} object constructs a {@link TracerFactoryClass} 
         * struct using the <em>builder pattern</em> to set the field values. 
         * Use the various {@code set...()} methods to set field values, 
         * and finish construction with {@link #construct()}. 
         */
        public Build() {
            struct = TracerFactoryClass.allocate();
        }
        
         /**
         * Finish building the {@link TracerFactoryClass} struct.
         * @return A new instance of {@code TracerFactoryClass} with the fields 
         *         that were set in the Build object.
         */
        public TracerFactoryClass construct() {
            return struct;
        }
    }
}
