...
public class TaskPrivate extends Struct {
    ...
    public static TaskPrivate allocate() {
        ...
        TaskPrivate newInstance = new TaskPrivate(segment.address());
     ...
     */
    protected TaskPrivate(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, TaskPrivate> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new TaskPrivate(input);
}
