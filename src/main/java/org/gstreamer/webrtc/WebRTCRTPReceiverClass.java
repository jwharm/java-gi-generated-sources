...
public class WebRTCRTPReceiverClass extends Struct {
    ...
    public static WebRTCRTPReceiverClass allocate() {
        ...
        WebRTCRTPReceiverClass newInstance = new WebRTCRTPReceiverClass(segment.address());
     ...
     */
    protected WebRTCRTPReceiverClass(Addressable address) {
        super(address);
    }
     ...
     */
    @ApiStatus.Internal
    public static final Marshal<Addressable, WebRTCRTPReceiverClass> fromAddress = (input, scope) -> input.equals(MemoryAddress.NULL) ? null : new WebRTCRTPReceiverClass(input);
}
