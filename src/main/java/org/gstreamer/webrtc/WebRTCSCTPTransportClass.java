...
public class WebRTCSCTPTransportClass extends Struct {
     ...
     */
    protected WebRTCSCTPTransportClass(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, WebRTCSCTPTransportClass> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new WebRTCSCTPTransportClass(input, ownership);
}
