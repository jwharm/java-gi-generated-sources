...
public class WebRTCSCTPTransport extends org.gstreamer.gst.GstObject {
     ...
     */
    protected WebRTCSCTPTransport(Addressable address, Ownership ownership) {
    ...
    @ApiStatus.Internal
    public static final Marshal<Addressable, WebRTCSCTPTransport> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new WebRTCSCTPTransport(input, ownership);
