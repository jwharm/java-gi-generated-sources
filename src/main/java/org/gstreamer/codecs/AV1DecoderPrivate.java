...
public class AV1DecoderPrivate extends Struct {
     ...
     */
    protected AV1DecoderPrivate(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, AV1DecoderPrivate> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new AV1DecoderPrivate(input, ownership);
}
