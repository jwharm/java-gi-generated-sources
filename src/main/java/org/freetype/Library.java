...
public class Library extends Struct {
     ...
     */
    protected Library(Addressable address, Ownership ownership) {
        super(address, ownership);
    }
    
    @ApiStatus.Internal
    public static final Marshal<Addressable, Library> fromAddress = (input, ownership) -> input.equals(MemoryAddress.NULL) ? null : new Library(input, ownership);
}
