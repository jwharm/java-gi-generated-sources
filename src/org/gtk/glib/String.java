...
public class String extends io.github.jwharm.javagi.interop.ResourceBase {
    ...
    public String(java.lang.String init) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.g_string_new(Interop.getAllocator().allocateUtf8String(init)), true));
    }
    ...
    public String(java.lang.String init, long len) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.g_string_new_len(Interop.getAllocator().allocateUtf8String(init), len), true));
    }
    ...
    public String(long dflSize) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.g_string_sized_new(dflSize), true));
    }
    ...
    public String append(java.lang.String val) {
        ...
        return new String(ProxyFactory.getProxy(RESULT, false));
    }
