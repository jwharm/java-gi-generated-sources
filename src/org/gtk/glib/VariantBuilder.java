...
public class VariantBuilder extends io.github.jwharm.javagi.interop.ResourceBase {
    ...
    public VariantBuilder(VariantType type) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.g_variant_builder_new(type.HANDLE()), true));
    }
    ...
    public VariantBuilder ref() {
        ...
        return new VariantBuilder(ProxyFactory.getProxy(RESULT, true));
    }
