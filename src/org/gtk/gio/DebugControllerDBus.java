...
public class DebugControllerDBus extends org.gtk.gobject.Object implements DebugController, Initable {
     ...
     */
    public void stop() {
        io.github.jwharm.javagi.interop.jextract.gtk_h.g_debug_controller_dbus_stop(HANDLE());
    }
    ...
    public void onAuthorize(AuthorizeHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("authorize"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
