...
public interface MemoryMonitor extends io.github.jwharm.javagi.interop.NativeAddress {
    ...
    public default void onLowMemoryWarning(LowMemoryWarningHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("low-memory-warning"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
