...
public interface MemoryMonitor extends io.github.jwharm.javagi.interop.NativeAddress {
    ...
    public default void onLowMemoryWarning(LowMemoryWarningHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.allocateNativeString("low-memory-warning").HANDLE(), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
