...
public class SocketService extends SocketListener {
    ...
    public void onIncoming(IncomingHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("incoming"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
