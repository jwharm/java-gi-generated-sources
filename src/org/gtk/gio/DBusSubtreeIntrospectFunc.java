...
/**
 * The type of the @introspect function in {@link org.gtk.gio.DBusSubtreeVTable} 
 * 
 ...
 * be a <code>null</code> terminated array of pointers to {@link org.gtk.gio.DBusInterfaceInfo} structures describing the interfaces implemented by @node.  This
 * array will have g_dbus_interface_info_unref() called on each item
 * before being freed with g_free().
 * 
 * The difference between returning <code>null</code> and an array containing zero
 * items is that the standard DBus interfaces will returned to the
 * remote introspector in the empty array case, but not in the <code>null</code> case.
 */
@FunctionalInterface
