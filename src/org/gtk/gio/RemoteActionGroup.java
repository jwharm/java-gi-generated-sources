 ...
 * <p>
 * <h1>BusActionGroup implements #GRemoteActionGroup.  This provides a</h1>
 * mechanism to send platform data for action invocations over D-Bus.
 * <p>
 * Additionally, g_dbus_connection_export_action_group() will check if
 * the exported #GActionGroup implements #GRemoteActionGroup and use the<code>_full</code> variants of the calls if available.  This
