...
/**
 * {@link org.gtk.gio.TlsInteraction} provides a mechanism for the TLS connection and database
 * code to interact with the user. It can be used to ask the user for passwords.
 * 
 * To use a {@link org.gtk.gio.TlsInteraction} with a TLS connection use
 * g_tls_connection_set_interaction().
 * 
 * Callers should instantiate a derived class that implements the various
 * interaction methods to show the required dialogs.
 * 
 * Callers should use the &<code>#39</code> invoke&<code>#39</code>  functions like
 ...
 * {@link org.gtk.gio.TlsInteractionResult<code>#UNHANDLED</code>   If a derived class implements an async method,
...
public class TlsInteraction extends org.gtk.gobject.Object {
     ...
     * user then {@link org.gtk.gio.TlsInteractionResult<code>#FAILED</code>  will be returned with an error that
     * contains a {@link org.gtk.gio.IOErrorEnum<code>#CANCELLED</code>  error code. Certain implementations may
     ...
     * 
     * If {@link org.gtk.gio.TlsInteractionResult<code>#HANDLED</code>  is returned, then the {@link org.gtk.gio.TlsPassword} passed
     * to g_tls_interaction_ask_password() will have its password filled in.
     * 
     * If the interaction is cancelled by the cancellation object, or by the
     * user then {@link org.gtk.gio.TlsInteractionResult<code>#FAILED</code>  will be returned with an error that
     * contains a {@link org.gtk.gio.IOErrorEnum<code>#CANCELLED</code>  error code.
     */
     ...
     * is called by called by {@link org.gtk.gio.TlsConnection} or {@link org.gtk.gio.TlsDatabase} to ask the user
     * for a password.
     * 
     * Derived subclasses usually implement a password prompt, although they may
     * also choose to provide a password from elsewhere. The @password value will
     ...
     * created. This is called by called by {@link org.gtk.gio.TlsConnection} when the peer
     ...
     * 
     * If {@link org.gtk.gio.TlsInteractionResult<code>#HANDLED</code>  is returned, then the {@link org.gtk.gio.TlsConnection} passed to g_tls_interaction_request_certificate() will have had its
     * {@link org.gtk.gio.TlsConnection} certificate filled in.
     * 
     * If the interaction is cancelled by the cancellation object, or by the
     * user then {@link org.gtk.gio.TlsInteractionResult<code>#FAILED</code>  will be returned with an error that
     * contains a {@link org.gtk.gio.IOErrorEnum<code>#CANCELLED</code>  error code. Certain implementations may
     ...
     * 
     * If {@link org.gtk.gio.TlsInteractionResult<code>#HANDLED</code>  is returned, then the {@link org.gtk.gio.TlsConnection} passed to g_tls_interaction_request_certificate_async() will have had its
     * {@link org.gtk.gio.TlsConnection} certificate filled in.
     * 
     * If the interaction is cancelled by the cancellation object, or by the
     * user then {@link org.gtk.gio.TlsInteractionResult<code>#FAILED</code>  will be returned with an error that
