...
public class PropertyAction extends org.gtk.gobject.Object implements Action {
    ...
    public PropertyAction(java.lang.String name, org.gtk.gobject.Object object, java.lang.String propertyName) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.g_property_action_new(Interop.getAllocator().allocateUtf8String(name), object.HANDLE(), Interop.getAllocator().allocateUtf8String(propertyName)), true));
    }
