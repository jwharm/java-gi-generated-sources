...
public interface ActionGroup extends io.github.jwharm.javagi.interop.NativeAddress {
    ...
    public default void actionAdded(java.lang.String actionName) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.g_action_group_action_added(HANDLE(), Interop.getAllocator().allocateUtf8String(actionName));
    }
    ...
    public default void actionEnabledChanged(java.lang.String actionName, boolean enabled) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.g_action_group_action_enabled_changed(HANDLE(), Interop.getAllocator().allocateUtf8String(actionName), enabled ? 1 : 0);
    }
    ...
    public default void actionRemoved(java.lang.String actionName) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.g_action_group_action_removed(HANDLE(), Interop.getAllocator().allocateUtf8String(actionName));
    }
    ...
    public default void actionStateChanged(java.lang.String actionName, org.gtk.glib.Variant state) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.g_action_group_action_state_changed(HANDLE(), Interop.getAllocator().allocateUtf8String(actionName), state.HANDLE());
    }
    ...
    public default void activateAction(java.lang.String actionName, org.gtk.glib.Variant parameter) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.g_action_group_activate_action(HANDLE(), Interop.getAllocator().allocateUtf8String(actionName), parameter.HANDLE());
    }
    ...
    public default void changeActionState(java.lang.String actionName, org.gtk.glib.Variant value) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.g_action_group_change_action_state(HANDLE(), Interop.getAllocator().allocateUtf8String(actionName), value.HANDLE());
    }
    ...
    public default boolean getActionEnabled(java.lang.String actionName) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.g_action_group_get_action_enabled(HANDLE(), Interop.getAllocator().allocateUtf8String(actionName));
        return (RESULT != 0);
    }
    ...
    public default boolean hasAction(java.lang.String actionName) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.g_action_group_has_action(HANDLE(), Interop.getAllocator().allocateUtf8String(actionName));
        return (RESULT != 0);
    }
    ...
    public default void onActionAdded(ActionAddedHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("action-added"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
    ...
    public default void onActionEnabledChanged(ActionEnabledChangedHandler handler) {
        try {
            ...
            NativeSymbol nativeSymbol = CLinker.systemCLinker().upcallStub(methodHandle, descriptor, Interop.getScope());
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("action-enabled-changed"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public default void onActionRemoved(ActionRemovedHandler handler) {
        try {
            ...
            FunctionDescriptor descriptor = FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS);
            NativeSymbol nativeSymbol = CLinker.systemCLinker().upcallStub(methodHandle, descriptor, Interop.getScope());
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("action-removed"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public default void onActionStateChanged(ActionStateChangedHandler handler) {
        try {
            ...
            NativeSymbol nativeSymbol = CLinker.systemCLinker().upcallStub(methodHandle, descriptor, Interop.getScope());
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("action-state-changed"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    class ActionGroupImpl extends org.gtk.gobject.Object implements ActionGroup {
        public ActionGroupImpl(io.github.jwharm.javagi.interop.Proxy proxy) {
            super(proxy);
        }
    }
}
