...
public class FileOutputStream extends OutputStream implements Seekable {
    ...
    public FileOutputStream(io.github.jwharm.javagi.interop.Reference reference) {
        super(reference);
    }
     ...
     */
    public void queryInfoAsync(FileOutputStream stream, java.lang.String attributes, int ioPriority, Cancellable cancellable, AsyncReadyCallback callback) {
        try {
            ...
            gtk_h.g_file_output_stream_query_info_async(handle(), Interop.allocateNativeString(attributes).handle(), ioPriority, cancellable.handle(), nativeSymbol, intSegment);
        } catch (Exception e) {
