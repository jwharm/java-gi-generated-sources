 ...
 * 
 * The contents of the {@link org.gtk.graphene.Vec4} structure are private and should
...
public class Vec4 extends io.github.jwharm.javagi.ResourceBase {
    ...
    /**
     * Allocates a new {@link org.gtk.graphene.Vec4} structure.
     * 
    ...
    /**
     * Checks whether the two given {@link org.gtk.graphene.Vec4} are equal.
     */
    ...
    /**
     * Retrieves the value of the fourth component of the given {@link org.gtk.graphene.Vec4}
     */
    public float getW() {
    ...
    /**
     * Retrieves the value of the first component of the given {@link org.gtk.graphene.Vec4}
     */
    public float getX() {
    ...
    /**
     * Creates a {@link org.gtk.graphene.Vec2} that contains the first two components
     * of the given {@link org.gtk.graphene.Vec4}
     */
    ...
    /**
     * Creates a {@link org.gtk.graphene.Vec3} that contains the first three components
     * of the given {@link org.gtk.graphene.Vec4}
     */
    ...
    /**
     * Retrieves the value of the second component of the given {@link org.gtk.graphene.Vec4}
     */
    public float getY() {
    ...
    /**
     * Retrieves the value of the third component of the given {@link org.gtk.graphene.Vec4}
     */
    public float getZ() {
    ...
    /**
     * Initializes a {@link org.gtk.graphene.Vec4} using the given values.
     * 
    ...
    /**
     * Initializes a {@link org.gtk.graphene.Vec4} with the values inside the given array.
     */
    ...
    /**
     * Initializes a {@link org.gtk.graphene.Vec4} using the components of a
     * {@link org.gtk.graphene.Vec2} and the values of @z and @w.
     */
    ...
    /**
     * Initializes a {@link org.gtk.graphene.Vec4} using the components of a
     * {@link org.gtk.graphene.Vec3} and the value of @w.
     */
    ...
    /**
     * Initializes a {@link org.gtk.graphene.Vec4} using the components of
     * another {@link org.gtk.graphene.Vec4}
     */
    ...
    /**
     * Computes the length of the given {@link org.gtk.graphene.Vec4}
     */
    public float length() {
    ...
    /**
     * Compares the two given {@link org.gtk.graphene.Vec4} vectors and checks
    ...
    /**
     * Negates the given {@link org.gtk.graphene.Vec4}
     */
    ...
    /**
     * Normalizes the given {@link org.gtk.graphene.Vec4}
     */
    ...
    /**
     * Stores the components of the given {@link org.gtk.graphene.Vec4} into an array
