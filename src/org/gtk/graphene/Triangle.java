...
public class Triangle extends io.github.jwharm.javagi.interop.ResourceBase {
     ...
     */
    public Triangle() {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.graphene_triangle_alloc(), true));
    }
    ...
    public Triangle initFromFloat(float[] a, float[] b, float[] c) {
        ...
        return new Triangle(ProxyFactory.getProxy(RESULT, false));
    }
