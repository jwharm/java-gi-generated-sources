...
public class Euler extends io.github.jwharm.javagi.interop.ResourceBase {
    ...
    public Euler(io.github.jwharm.javagi.interop.Proxy proxy) {
        super(proxy);
    }
     ...
     */
    public Euler() {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.graphene_euler_alloc(), true));
    }
    ...
    public Euler init(float x, float y, float z) {
        ...
        return new Euler(ProxyFactory.getProxy(RESULT, false));
    }
