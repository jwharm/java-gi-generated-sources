...
public class Sphere extends io.github.jwharm.javagi.interop.ResourceBase {
     ...
     */
    public Sphere() {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.graphene_sphere_alloc(), true));
    }
    ...
    public Sphere init(Point3D center, float radius) {
        ...
        return new Sphere(ProxyFactory.getProxy(RESULT, false));
    }
