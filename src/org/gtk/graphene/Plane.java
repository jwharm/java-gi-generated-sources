...
public class Plane extends io.github.jwharm.javagi.interop.ResourceBase {
     ...
     */
    public Plane() {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.graphene_plane_alloc(), true));
    }
    ...
    public Plane init(Vec3 normal, float constant) {
        ...
        return new Plane(ProxyFactory.getProxy(RESULT, false));
    }
