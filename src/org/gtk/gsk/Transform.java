...
public class Transform extends io.github.jwharm.javagi.interop.ResourceBase {
    ...
    public Transform(io.github.jwharm.javagi.interop.Proxy proxy) {
        super(proxy);
    }
    
    public Transform() {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.gsk_transform_new(), true));
    }
    ...
    public Transform invert() {
        ...
        return new Transform(ProxyFactory.getProxy(RESULT, true));
    }
