...
public class GLShaderNode extends RenderNode {
     ...
     * {@link org.gtk.gsk.GLShader#formatArgs} or {@link [struct@Gsk.ShaderArgsBuilder] (ref=struct)}.
     * <p>
     * See {@link org.gtk.gsk.GLShader} for details about how the shader should be written.
     * <p>
     * All the children will be rendered into textures (if they aren&#39;t already<code>GskTextureNodes</code>, which will be used directly). These textures will be
     * sent as input to the shader.
     * 
     * If the renderer doesn&#39;t support GL shaders, or if there is any problem
     * when compiling the shader, then the node will draw pink. You should use
     * {@link org.gtk.gsk.GLShader#compile} to ensure the @shader will work for the
