 ...
 * <p>
 * It&<code>#8217</code> s simply a convenience widget; you could construct the equivalent of<code>GtkMessageDialog</code> from <code>GtkDialog</code> without too much effort, but<code>GtkMessageDialog</code> saves typing.
 * <p>
 * The easiest way to do a modal message dialog is to use the {@link org.gtk.gtk.DialogFlags<code>#MODAL</code>  flag, which will call {@link org.gtk.gtk.Window<code>#setModal</code>  internally. The dialog will
 * prevent interaction with the parent window until it&<code>#39</code> s hidden or destroyed.
 ...
 *                                  GTK_MESSAGE_ERROR,
 *                                  GTK_BUTTONS_CLOSE,
 *                                  &<code>#34</code> Error reading &<code>#8220</code> <code>s</code> <code>#8221</code> : <code>s</code> <code>#34</code> ,
 *                                  filename,
 *                                  g_strerror (errno));
 ...
 * {@link org.gtk.gtk.DialogFlags<code>#MODAL</code>  flag:
 * <p><pre>c
 ...
 * the message area as an internal child with the name &<code>#8220</code> message_area&<code>#8221</code> .
 */
public class MessageDialog extends Dialog implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
     ...
     * 
     * This is the box where the dialog&<code>#8217</code> s primary and secondary labels
     * are packed. You can add your own extra content to that box and it
     * will appear below those labels. See {@link org.gtk.gtk.Dialog<code>#getContentArea</code> 
