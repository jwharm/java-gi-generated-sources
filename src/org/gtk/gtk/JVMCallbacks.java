...
public final class JVMCallbacks {
    ...
    public static void signalWidgetDestroy(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Widget(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalWidgetDirectionChanged(MemoryAddress source, int previousDirection, MemoryAddress data) {
        ...
        handler.signalReceived(new Widget(ProxyFactory.getCachedProxy(source)), TextDirection.fromValue(previousDirection));
    }
    ...
    public static boolean signalWidgetKeynavFailed(MemoryAddress source, int direction, MemoryAddress data) {
        ...
        return handler.signalReceived(new Widget(ProxyFactory.getCachedProxy(source)), DirectionType.fromValue(direction));
    }
    ...
    public static boolean signalWidgetMnemonicActivate(MemoryAddress source, boolean groupCycling, MemoryAddress data) {
        ...
        return handler.signalReceived(new Widget(ProxyFactory.getCachedProxy(source)), groupCycling);
    }
    ...
    public static void signalWidgetMoveFocus(MemoryAddress source, int direction, MemoryAddress data) {
        ...
        handler.signalReceived(new Widget(ProxyFactory.getCachedProxy(source)), DirectionType.fromValue(direction));
    }
    ...
    public static boolean signalWidgetQueryTooltip(MemoryAddress source, int x, int y, boolean keyboardMode, MemoryAddress tooltip, MemoryAddress data) {
        ...
        return handler.signalReceived(new Widget(ProxyFactory.getCachedProxy(source)), x, y, keyboardMode, new Tooltip(ProxyFactory.getProxy(tooltip, false)));
    }
    ...
    public static void signalWidgetStateFlagsChanged(MemoryAddress source, int flags, MemoryAddress data) {
        ...
        handler.signalReceived(new Widget(ProxyFactory.getCachedProxy(source)), flags);
    }
    ...
    public static void signalCellAreaAddEditable(MemoryAddress source, MemoryAddress renderer, MemoryAddress editable, MemoryAddress cellArea, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new CellArea(ProxyFactory.getCachedProxy(source)), new CellRenderer(ProxyFactory.getProxy(renderer, false)), new CellEditable.CellEditableImpl(ProxyFactory.getProxy(editable, false)), new org.gtk.gdk.Rectangle(ProxyFactory.getProxy(cellArea, false)), path.getUtf8String(0));
    }
    ...
    public static void signalCellAreaApplyAttributes(MemoryAddress source, MemoryAddress model, MemoryAddress iter, boolean isExpander, boolean isExpanded, MemoryAddress data) {
        ...
        handler.signalReceived(new CellArea(ProxyFactory.getCachedProxy(source)), new TreeModel.TreeModelImpl(ProxyFactory.getProxy(model, false)), new TreeIter(ProxyFactory.getProxy(iter, false)), isExpander, isExpanded);
    }
    ...
    public static void signalCellAreaFocusChanged(MemoryAddress source, MemoryAddress renderer, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new CellArea(ProxyFactory.getCachedProxy(source)), new CellRenderer(ProxyFactory.getProxy(renderer, false)), path.getUtf8String(0));
    }
    ...
    public static void signalCellAreaRemoveEditable(MemoryAddress source, MemoryAddress renderer, MemoryAddress editable, MemoryAddress data) {
        ...
        handler.signalReceived(new CellArea(ProxyFactory.getCachedProxy(source)), new CellRenderer(ProxyFactory.getProxy(renderer, false)), new CellEditable.CellEditableImpl(ProxyFactory.getProxy(editable, false)));
    }
    ...
    public static void signalFlowBoxActivateCursorChild(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new FlowBox(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalFlowBoxChildActivated(MemoryAddress source, MemoryAddress child, MemoryAddress data) {
        ...
        handler.signalReceived(new FlowBox(ProxyFactory.getCachedProxy(source)), new FlowBoxChild(ProxyFactory.getProxy(child, false)));
    }
    ...
    public static boolean signalFlowBoxMoveCursor(MemoryAddress source, int step, int count, boolean extend, boolean modify, MemoryAddress data) {
        ...
        return handler.signalReceived(new FlowBox(ProxyFactory.getCachedProxy(source)), MovementStep.fromValue(step), count, extend, modify);
    }
    ...
    public static void signalButtonActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Button(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalFontChooserFontActivated(MemoryAddress source, MemoryAddress fontname, MemoryAddress data) {
        ...
        handler.signalReceived(new FontChooser.FontChooserImpl(ProxyFactory.getCachedProxy(source)), fontname.getUtf8String(0));
    }
    ...
    public static boolean signalShortcutsSectionChangeCurrentPage(MemoryAddress source, int object, MemoryAddress data) {
        ...
        return handler.signalReceived(new ShortcutsSection(ProxyFactory.getCachedProxy(source)), object);
    }
    ...
    public static void signalShortcutsWindowClose(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new ShortcutsWindow(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalEntryActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Entry(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalEntryIconPress(MemoryAddress source, int iconPos, MemoryAddress data) {
        ...
        handler.signalReceived(new Entry(ProxyFactory.getCachedProxy(source)), EntryIconPosition.fromValue(iconPos));
    }
    ...
    public static void signalRecentManagerChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new RecentManager(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalCssProviderParsingError(MemoryAddress source, MemoryAddress section, MemoryAddress error, MemoryAddress data) {
        ...
        handler.signalReceived(new CssProvider(ProxyFactory.getCachedProxy(source)), new CssSection(ProxyFactory.getProxy(section, false)), new org.gtk.glib.Error(ProxyFactory.getProxy(error, false)));
    }
    ...
    public static void signalToggleButtonToggled(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new ToggleButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalDragSourceDragBegin(MemoryAddress source, MemoryAddress drag, MemoryAddress data) {
        ...
        handler.signalReceived(new DragSource(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Drag(ProxyFactory.getProxy(drag, false)));
    }
    ...
    public static boolean signalDragSourceDragCancel(MemoryAddress source, MemoryAddress drag, int reason, MemoryAddress data) {
        ...
        return handler.signalReceived(new DragSource(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Drag(ProxyFactory.getProxy(drag, false)), org.gtk.gdk.DragCancelReason.fromValue(reason));
    }
    ...
    public static void signalDragSourceDragEnd(MemoryAddress source, MemoryAddress drag, boolean deleteData, MemoryAddress data) {
        ...
        handler.signalReceived(new DragSource(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Drag(ProxyFactory.getProxy(drag, false)), deleteData);
    }
    ...
    public static void signalDragSourcePrepare(MemoryAddress source, double x, double y, MemoryAddress data) {
        ...
        handler.signalReceived(new DragSource(ProxyFactory.getCachedProxy(source)), x, y);
    }
    ...
    public static void signalFileChooserWidgetDesktopFolder(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new FileChooserWidget(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalFileChooserWidgetLocationPopup(MemoryAddress source, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new FileChooserWidget(ProxyFactory.getCachedProxy(source)), path.getUtf8String(0));
    }
    ...
    public static void signalFileChooserWidgetQuickBookmark(MemoryAddress source, int bookmarkIndex, MemoryAddress data) {
        ...
        handler.signalReceived(new FileChooserWidget(ProxyFactory.getCachedProxy(source)), bookmarkIndex);
    }
    ...
    public static void signalListViewActivate(MemoryAddress source, int position, MemoryAddress data) {
        ...
        handler.signalReceived(new ListView(ProxyFactory.getCachedProxy(source)), position);
    }
    ...
    public static void signalDialogClose(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Dialog(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalDialogResponse(MemoryAddress source, int responseId, MemoryAddress data) {
        ...
        handler.signalReceived(new Dialog(ProxyFactory.getCachedProxy(source)), responseId);
    }
    ...
    public static void signalFontButtonActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new FontButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalExpanderActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Expander(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalScrolledWindowEdgeOvershot(MemoryAddress source, int pos, MemoryAddress data) {
        ...
        handler.signalReceived(new ScrolledWindow(ProxyFactory.getCachedProxy(source)), PositionType.fromValue(pos));
    }
    ...
    public static void signalScrolledWindowMoveFocusOut(MemoryAddress source, int directionType, MemoryAddress data) {
        ...
        handler.signalReceived(new ScrolledWindow(ProxyFactory.getCachedProxy(source)), DirectionType.fromValue(directionType));
    }
    ...
    public static boolean signalScrolledWindowScrollChild(MemoryAddress source, int scroll, boolean horizontal, MemoryAddress data) {
        ...
        return handler.signalReceived(new ScrolledWindow(ProxyFactory.getCachedProxy(source)), ScrollType.fromValue(scroll), horizontal);
    }
    ...
    public static void signalPrintOperationBeginPrint(MemoryAddress source, MemoryAddress context, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)), new PrintContext(ProxyFactory.getProxy(context, false)));
    }
    ...
    public static void signalPrintOperationCreateCustomWidget(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalPrintOperationCustomWidgetApply(MemoryAddress source, MemoryAddress widget, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)), new Widget(ProxyFactory.getProxy(widget, false)));
    }
    ...
    public static void signalPrintOperationDone(MemoryAddress source, int result, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)), PrintOperationResult.fromValue(result));
    }
    ...
    public static void signalPrintOperationDrawPage(MemoryAddress source, MemoryAddress context, int pageNr, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)), new PrintContext(ProxyFactory.getProxy(context, false)), pageNr);
    }
    ...
    public static boolean signalPrintOperationPaginate(MemoryAddress source, MemoryAddress context, MemoryAddress data) {
        ...
        return handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)), new PrintContext(ProxyFactory.getProxy(context, false)));
    }
    ...
    public static boolean signalPrintOperationPreview(MemoryAddress source, MemoryAddress preview, MemoryAddress context, MemoryAddress parent, MemoryAddress data) {
        ...
        return handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)), new PrintOperationPreview.PrintOperationPreviewImpl(ProxyFactory.getProxy(preview, false)), new PrintContext(ProxyFactory.getProxy(context, false)), new Window(ProxyFactory.getProxy(parent, false)));
    }
    ...
    public static void signalPrintOperationRequestPageSetup(MemoryAddress source, MemoryAddress context, int pageNr, MemoryAddress setup, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)), new PrintContext(ProxyFactory.getProxy(context, false)), pageNr, new PageSetup(ProxyFactory.getProxy(setup, false)));
    }
    ...
    public static void signalPrintOperationUpdateCustomWidget(MemoryAddress source, MemoryAddress widget, MemoryAddress setup, MemoryAddress settings, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperation(ProxyFactory.getCachedProxy(source)), new Widget(ProxyFactory.getProxy(widget, false)), new PageSetup(ProxyFactory.getProxy(setup, false)), new PrintSettings(ProxyFactory.getProxy(settings, false)));
    }
    ...
    public static void signalAppChooserWidgetApplicationActivated(MemoryAddress source, MemoryAddress application, MemoryAddress data) {
        ...
        handler.signalReceived(new AppChooserWidget(ProxyFactory.getCachedProxy(source)), new org.gtk.gio.AppInfo.AppInfoImpl(ProxyFactory.getProxy(application, false)));
    }
    ...
    public static void signalEventControllerMotionEnter(MemoryAddress source, double x, double y, MemoryAddress data) {
        ...
        handler.signalReceived(new EventControllerMotion(ProxyFactory.getCachedProxy(source)), x, y);
    }
    ...
    public static void signalEventControllerMotionLeave(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new EventControllerMotion(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalPasswordEntryActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new PasswordEntry(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalGestureClickPressed(MemoryAddress source, int nPress, double x, double y, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureClick(ProxyFactory.getCachedProxy(source)), nPress, x, y);
    }
    ...
    public static void signalGestureClickStopped(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureClick(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalGestureClickUnpairedRelease(MemoryAddress source, double x, double y, int button, MemoryAddress sequence, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureClick(ProxyFactory.getCachedProxy(source)), x, y, button, new org.gtk.gdk.EventSequence(ProxyFactory.getProxy(sequence, false)));
    }
    ...
    public static boolean signalIconViewActivateCursorItem(MemoryAddress source, MemoryAddress data) {
        ...
        return handler.signalReceived(new IconView(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalIconViewItemActivated(MemoryAddress source, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new IconView(ProxyFactory.getCachedProxy(source)), new TreePath(ProxyFactory.getProxy(path, false)));
    }
    ...
    public static boolean signalIconViewMoveCursor(MemoryAddress source, int step, int count, boolean extend, boolean modify, MemoryAddress data) {
        ...
        return handler.signalReceived(new IconView(ProxyFactory.getCachedProxy(source)), MovementStep.fromValue(step), count, extend, modify);
    }
    ...
    public static void signalIconViewSelectAll(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new IconView(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalPrintOperationPreviewGotPageSize(MemoryAddress source, MemoryAddress context, MemoryAddress pageSetup, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperationPreview.PrintOperationPreviewImpl(ProxyFactory.getCachedProxy(source)), new PrintContext(ProxyFactory.getProxy(context, false)), new PageSetup(ProxyFactory.getProxy(pageSetup, false)));
    }
    ...
    public static void signalPrintOperationPreviewReady(MemoryAddress source, MemoryAddress context, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintOperationPreview.PrintOperationPreviewImpl(ProxyFactory.getCachedProxy(source)), new PrintContext(ProxyFactory.getProxy(context, false)));
    }
    ...
    public static void signalCellRendererTextEdited(MemoryAddress source, MemoryAddress path, MemoryAddress newText, MemoryAddress data) {
        ...
        handler.signalReceived(new CellRendererText(ProxyFactory.getCachedProxy(source)), path.getUtf8String(0), newText.getUtf8String(0));
    }
    ...
    public static void signalSorterChanged(MemoryAddress source, int change, MemoryAddress data) {
        ...
        handler.signalReceived(new Sorter(ProxyFactory.getCachedProxy(source)), SorterChange.fromValue(change));
    }
    ...
    public static void signalListBoxRowActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new ListBoxRow(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalAdjustmentChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Adjustment(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalAppChooserButtonActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new AppChooserButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalAppChooserButtonCustomItemActivated(MemoryAddress source, MemoryAddress itemName, MemoryAddress data) {
        ...
        handler.signalReceived(new AppChooserButton(ProxyFactory.getCachedProxy(source)), itemName.getUtf8String(0));
    }
    ...
    public static void signalCellRendererToggleToggled(MemoryAddress source, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new CellRendererToggle(ProxyFactory.getCachedProxy(source)), path.getUtf8String(0));
    }
    ...
    public static void signalApplicationWindowAdded(MemoryAddress source, MemoryAddress window, MemoryAddress data) {
        ...
        handler.signalReceived(new Application(ProxyFactory.getCachedProxy(source)), new Window(ProxyFactory.getProxy(window, false)));
    }
    ...
    public static void signalDropControllerMotionEnter(MemoryAddress source, double x, double y, MemoryAddress data) {
        ...
        handler.signalReceived(new DropControllerMotion(ProxyFactory.getCachedProxy(source)), x, y);
    }
    ...
    public static void signalDropControllerMotionLeave(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new DropControllerMotion(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalPopoverActivateDefault(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Popover(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalGesturePanPan(MemoryAddress source, int direction, double offset, MemoryAddress data) {
        ...
        handler.signalReceived(new GesturePan(ProxyFactory.getCachedProxy(source)), PanDirection.fromValue(direction), offset);
    }
    ...
    public static boolean signalPanedAcceptPosition(MemoryAddress source, MemoryAddress data) {
        ...
        return handler.signalReceived(new Paned(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalPanedCycleChildFocus(MemoryAddress source, boolean reversed, MemoryAddress data) {
        ...
        return handler.signalReceived(new Paned(ProxyFactory.getCachedProxy(source)), reversed);
    }
    ...
    public static boolean signalPanedMoveHandle(MemoryAddress source, int scrollType, MemoryAddress data) {
        ...
        return handler.signalReceived(new Paned(ProxyFactory.getCachedProxy(source)), ScrollType.fromValue(scrollType));
    }
    ...
    public static void signalGestureStylusDown(MemoryAddress source, double x, double y, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureStylus(ProxyFactory.getCachedProxy(source)), x, y);
    }
    ...
    public static void signalDrawingAreaResize(MemoryAddress source, int width, int height, MemoryAddress data) {
        ...
        handler.signalReceived(new DrawingArea(ProxyFactory.getCachedProxy(source)), width, height);
    }
    ...
    public static void signalColorButtonActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new ColorButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalEntryCompletionCursorOnMatch(MemoryAddress source, MemoryAddress model, MemoryAddress iter, MemoryAddress data) {
        ...
        return handler.signalReceived(new EntryCompletion(ProxyFactory.getCachedProxy(source)), new TreeModel.TreeModelImpl(ProxyFactory.getProxy(model, false)), new TreeIter(ProxyFactory.getProxy(iter, false)));
    }
    ...
    public static boolean signalEntryCompletionInsertPrefix(MemoryAddress source, MemoryAddress prefix, MemoryAddress data) {
        ...
        return handler.signalReceived(new EntryCompletion(ProxyFactory.getCachedProxy(source)), prefix.getUtf8String(0));
    }
    ...
    public static void signalEntryCompletionNoMatches(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new EntryCompletion(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalSpinButtonChangeValue(MemoryAddress source, int scroll, MemoryAddress data) {
        ...
        handler.signalReceived(new SpinButton(ProxyFactory.getCachedProxy(source)), ScrollType.fromValue(scroll));
    }
    ...
    public static void signalSpinButtonInput(MemoryAddress source, double newValue, MemoryAddress data) {
        ...
        handler.signalReceived(new SpinButton(ProxyFactory.getCachedProxy(source)), newValue);
    }
    ...
    public static boolean signalSpinButtonOutput(MemoryAddress source, MemoryAddress data) {
        ...
        return handler.signalReceived(new SpinButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalSpinButtonValueChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new SpinButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalScaleButtonPopdown(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new ScaleButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalScaleButtonValueChanged(MemoryAddress source, double value, MemoryAddress data) {
        ...
        handler.signalReceived(new ScaleButton(ProxyFactory.getCachedProxy(source)), value);
    }
    ...
    public static void signalTextActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Text(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalTextDeleteFromCursor(MemoryAddress source, int type, int count, MemoryAddress data) {
        ...
        handler.signalReceived(new Text(ProxyFactory.getCachedProxy(source)), DeleteType.fromValue(type), count);
    }
    ...
    public static void signalTextInsertAtCursor(MemoryAddress source, MemoryAddress string, MemoryAddress data) {
        ...
        handler.signalReceived(new Text(ProxyFactory.getCachedProxy(source)), string.getUtf8String(0));
    }
    ...
    public static void signalTextMoveCursor(MemoryAddress source, int step, int count, boolean extend, MemoryAddress data) {
        ...
        handler.signalReceived(new Text(ProxyFactory.getCachedProxy(source)), MovementStep.fromValue(step), count, extend);
    }
    ...
    public static void signalTextPreeditChanged(MemoryAddress source, MemoryAddress preedit, MemoryAddress data) {
        ...
        handler.signalReceived(new Text(ProxyFactory.getCachedProxy(source)), preedit.getUtf8String(0));
    }
    ...
    public static void signalGestureSwipeSwipe(MemoryAddress source, double velocityX, double velocityY, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureSwipe(ProxyFactory.getCachedProxy(source)), velocityX, velocityY);
    }
    ...
    public static void signalCellRendererComboChanged(MemoryAddress source, MemoryAddress pathString, MemoryAddress newIter, MemoryAddress data) {
        ...
        handler.signalReceived(new CellRendererCombo(ProxyFactory.getCachedProxy(source)), pathString.getUtf8String(0), new TreeIter(ProxyFactory.getProxy(newIter, false)));
    }
    ...
    public static void signalSelectionModelSelectionChanged(MemoryAddress source, int position, int nItems, MemoryAddress data) {
        ...
        handler.signalReceived(new SelectionModel.SelectionModelImpl(ProxyFactory.getCachedProxy(source)), position, nItems);
    }
    ...
    public static void signalTextViewBackspace(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new TextView(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalTextViewDeleteFromCursor(MemoryAddress source, int type, int count, MemoryAddress data) {
        ...
        handler.signalReceived(new TextView(ProxyFactory.getCachedProxy(source)), DeleteType.fromValue(type), count);
    }
    ...
    public static boolean signalTextViewExtendSelection(MemoryAddress source, int granularity, MemoryAddress location, MemoryAddress start, MemoryAddress end, MemoryAddress data) {
        ...
        return handler.signalReceived(new TextView(ProxyFactory.getCachedProxy(source)), TextExtendSelection.fromValue(granularity), new TextIter(ProxyFactory.getProxy(location, false)), new TextIter(ProxyFactory.getProxy(start, false)), new TextIter(ProxyFactory.getProxy(end, false)));
    }
    ...
    public static void signalTextViewInsertAtCursor(MemoryAddress source, MemoryAddress string, MemoryAddress data) {
        ...
        handler.signalReceived(new TextView(ProxyFactory.getCachedProxy(source)), string.getUtf8String(0));
    }
    ...
    public static void signalTextViewMoveCursor(MemoryAddress source, int step, int count, boolean extendSelection, MemoryAddress data) {
        ...
        handler.signalReceived(new TextView(ProxyFactory.getCachedProxy(source)), MovementStep.fromValue(step), count, extendSelection);
    }
    ...
    public static void signalTextViewMoveViewport(MemoryAddress source, int step, int count, MemoryAddress data) {
        ...
        handler.signalReceived(new TextView(ProxyFactory.getCachedProxy(source)), ScrollStep.fromValue(step), count);
    }
    ...
    public static void signalTextViewPreeditChanged(MemoryAddress source, MemoryAddress preedit, MemoryAddress data) {
        ...
        handler.signalReceived(new TextView(ProxyFactory.getCachedProxy(source)), preedit.getUtf8String(0));
    }
    ...
    public static void signalTextViewSelectAll(MemoryAddress source, boolean select, MemoryAddress data) {
        ...
        handler.signalReceived(new TextView(ProxyFactory.getCachedProxy(source)), select);
    }
    ...
    public static void signalRangeAdjustBounds(MemoryAddress source, double value, MemoryAddress data) {
        ...
        handler.signalReceived(new Range(ProxyFactory.getCachedProxy(source)), value);
    }
    ...
    public static boolean signalRangeChangeValue(MemoryAddress source, int scroll, double value, MemoryAddress data) {
        ...
        return handler.signalReceived(new Range(ProxyFactory.getCachedProxy(source)), ScrollType.fromValue(scroll), value);
    }
    ...
    public static void signalRangeMoveSlider(MemoryAddress source, int step, MemoryAddress data) {
        ...
        handler.signalReceived(new Range(ProxyFactory.getCachedProxy(source)), ScrollType.fromValue(step));
    }
    ...
    public static void signalRangeValueChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Range(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalGestureLongPressCancelled(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureLongPress(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalGestureLongPressPressed(MemoryAddress source, double x, double y, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureLongPress(ProxyFactory.getCachedProxy(source)), x, y);
    }
    ...
    public static void signalEntryBufferDeletedText(MemoryAddress source, int position, int nChars, MemoryAddress data) {
        ...
        handler.signalReceived(new EntryBuffer(ProxyFactory.getCachedProxy(source)), position, nChars);
    }
    ...
    public static void signalEntryBufferInsertedText(MemoryAddress source, int position, MemoryAddress chars, int nChars, MemoryAddress data) {
        ...
        handler.signalReceived(new EntryBuffer(ProxyFactory.getCachedProxy(source)), position, chars.getUtf8String(0), nChars);
    }
    ...
    public static void signalIMContextCommit(MemoryAddress source, MemoryAddress str, MemoryAddress data) {
        ...
        handler.signalReceived(new IMContext(ProxyFactory.getCachedProxy(source)), str.getUtf8String(0));
    }
    ...
    public static boolean signalIMContextDeleteSurrounding(MemoryAddress source, int offset, int nChars, MemoryAddress data) {
        ...
        return handler.signalReceived(new IMContext(ProxyFactory.getCachedProxy(source)), offset, nChars);
    }
    ...
    public static void signalIMContextPreeditChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new IMContext(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalIMContextRetrieveSurrounding(MemoryAddress source, MemoryAddress data) {
        ...
        return handler.signalReceived(new IMContext(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalMenuButtonActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new MenuButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalDropTargetAsyncAccept(MemoryAddress source, MemoryAddress drop, MemoryAddress data) {
        ...
        return handler.signalReceived(new DropTargetAsync(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Drop(ProxyFactory.getProxy(drop, false)));
    }
    ...
    public static void signalDropTargetAsyncDragEnter(MemoryAddress source, MemoryAddress drop, double x, double y, MemoryAddress data) {
        ...
        handler.signalReceived(new DropTargetAsync(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Drop(ProxyFactory.getProxy(drop, false)), x, y);
    }
    ...
    public static void signalDropTargetAsyncDragLeave(MemoryAddress source, MemoryAddress drop, MemoryAddress data) {
        ...
        handler.signalReceived(new DropTargetAsync(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Drop(ProxyFactory.getProxy(drop, false)));
    }
    ...
    public static boolean signalDropTargetAsyncDrop(MemoryAddress source, MemoryAddress drop, double x, double y, MemoryAddress data) {
        ...
        return handler.signalReceived(new DropTargetAsync(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Drop(ProxyFactory.getProxy(drop, false)), x, y);
    }
    ...
    public static void signalEditableChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Editable.EditableImpl(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalEditableDeleteText(MemoryAddress source, int startPos, int endPos, MemoryAddress data) {
        ...
        handler.signalReceived(new Editable.EditableImpl(ProxyFactory.getCachedProxy(source)), startPos, endPos);
    }
    ...
    public static void signalEditableInsertText(MemoryAddress source, MemoryAddress text, int length, int position, MemoryAddress data) {
        ...
        handler.signalReceived(new Editable.EditableImpl(ProxyFactory.getCachedProxy(source)), text.getUtf8String(0), length, position);
    }
    ...
    public static void signalEmojiChooserEmojiPicked(MemoryAddress source, MemoryAddress text, MemoryAddress data) {
        ...
        handler.signalReceived(new EmojiChooser(ProxyFactory.getCachedProxy(source)), text.getUtf8String(0));
    }
    ...
    public static void signalColorChooserColorActivated(MemoryAddress source, MemoryAddress color, MemoryAddress data) {
        ...
        handler.signalReceived(new ColorChooser.ColorChooserImpl(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.RGBA(ProxyFactory.getProxy(color, false)));
    }
    ...
    public static void signalGestureRotateAngleChanged(MemoryAddress source, double angle, double angleDelta, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureRotate(ProxyFactory.getCachedProxy(source)), angle, angleDelta);
    }
    ...
    public static void signalTreeViewColumnsChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeView(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalTreeViewExpandCollapseCursorRow(MemoryAddress source, boolean object, boolean p0, boolean p1, MemoryAddress data) {
        ...
        return handler.signalReceived(new TreeView(ProxyFactory.getCachedProxy(source)), object, p0, p1);
    }
    ...
    public static boolean signalTreeViewMoveCursor(MemoryAddress source, int step, int direction, boolean extend, boolean modify, MemoryAddress data) {
        ...
        return handler.signalReceived(new TreeView(ProxyFactory.getCachedProxy(source)), MovementStep.fromValue(step), direction, extend, modify);
    }
    ...
    public static void signalTreeViewRowActivated(MemoryAddress source, MemoryAddress path, MemoryAddress column, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeView(ProxyFactory.getCachedProxy(source)), new TreePath(ProxyFactory.getProxy(path, false)), new TreeViewColumn(ProxyFactory.getProxy(column, false)));
    }
    ...
    public static void signalTreeViewRowCollapsed(MemoryAddress source, MemoryAddress iter, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeView(ProxyFactory.getCachedProxy(source)), new TreeIter(ProxyFactory.getProxy(iter, false)), new TreePath(ProxyFactory.getProxy(path, false)));
    }
    ...
    public static boolean signalTreeViewSelectAll(MemoryAddress source, MemoryAddress data) {
        ...
        return handler.signalReceived(new TreeView(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalTreeViewSelectCursorRow(MemoryAddress source, boolean object, MemoryAddress data) {
        ...
        return handler.signalReceived(new TreeView(ProxyFactory.getCachedProxy(source)), object);
    }
    ...
    public static boolean signalTreeViewTestCollapseRow(MemoryAddress source, MemoryAddress iter, MemoryAddress path, MemoryAddress data) {
        ...
        return handler.signalReceived(new TreeView(ProxyFactory.getCachedProxy(source)), new TreeIter(ProxyFactory.getProxy(iter, false)), new TreePath(ProxyFactory.getProxy(path, false)));
    }
    ...
    public static void signalGridViewActivate(MemoryAddress source, int position, MemoryAddress data) {
        ...
        handler.signalReceived(new GridView(ProxyFactory.getCachedProxy(source)), position);
    }
    ...
    public static void signalCellRendererAccelAccelCleared(MemoryAddress source, MemoryAddress pathString, MemoryAddress data) {
        ...
        handler.signalReceived(new CellRendererAccel(ProxyFactory.getCachedProxy(source)), pathString.getUtf8String(0));
    }
    ...
    public static void signalCellRendererAccelAccelEdited(MemoryAddress source, MemoryAddress pathString, int accelKey, int accelMods, int hardwareKeycode, MemoryAddress data) {
        ...
        handler.signalReceived(new CellRendererAccel(ProxyFactory.getCachedProxy(source)), pathString.getUtf8String(0), accelKey, accelMods, hardwareKeycode);
    }
    ...
    public static void signalTreeViewColumnClicked(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeViewColumn(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalAssistantApply(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Assistant(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalAssistantPrepare(MemoryAddress source, MemoryAddress page, MemoryAddress data) {
        ...
        handler.signalReceived(new Assistant(ProxyFactory.getCachedProxy(source)), new Widget(ProxyFactory.getProxy(page, false)));
    }
    ...
    public static boolean signalOverlayGetChildPosition(MemoryAddress source, MemoryAddress widget, MemoryAddress allocation, MemoryAddress data) {
        ...
        return handler.signalReceived(new Overlay(ProxyFactory.getCachedProxy(source)), new Widget(ProxyFactory.getProxy(widget, false)), new org.gtk.gdk.Rectangle(ProxyFactory.getProxy(allocation, false)));
    }
    ...
    public static void signalComboBoxActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new ComboBox(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalComboBoxFormatEntryText(MemoryAddress source, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new ComboBox(ProxyFactory.getCachedProxy(source)), path.getUtf8String(0));
    }
    ...
    public static void signalComboBoxMoveActive(MemoryAddress source, int scrollType, MemoryAddress data) {
        ...
        handler.signalReceived(new ComboBox(ProxyFactory.getCachedProxy(source)), ScrollType.fromValue(scrollType));
    }
    ...
    public static boolean signalComboBoxPopdown(MemoryAddress source, MemoryAddress data) {
        ...
        return handler.signalReceived(new ComboBox(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalGestureZoomScaleChanged(MemoryAddress source, double scale, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureZoom(ProxyFactory.getCachedProxy(source)), scale);
    }
    ...
    public static void signalListBoxActivateCursorRow(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new ListBox(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalListBoxMoveCursor(MemoryAddress source, int object, int p0, boolean p1, boolean p2, MemoryAddress data) {
        ...
        handler.signalReceived(new ListBox(ProxyFactory.getCachedProxy(source)), MovementStep.fromValue(object), p0, p1, p2);
    }
    ...
    public static void signalListBoxRowActivated(MemoryAddress source, MemoryAddress row, MemoryAddress data) {
        ...
        handler.signalReceived(new ListBox(ProxyFactory.getCachedProxy(source)), new ListBoxRow(ProxyFactory.getProxy(row, false)));
    }
    ...
    public static void signalFlowBoxChildActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new FlowBoxChild(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalTreeModelRowChanged(MemoryAddress source, MemoryAddress path, MemoryAddress iter, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeModel.TreeModelImpl(ProxyFactory.getCachedProxy(source)), new TreePath(ProxyFactory.getProxy(path, false)), new TreeIter(ProxyFactory.getProxy(iter, false)));
    }
    ...
    public static void signalTreeModelRowDeleted(MemoryAddress source, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeModel.TreeModelImpl(ProxyFactory.getCachedProxy(source)), new TreePath(ProxyFactory.getProxy(path, false)));
    }
    ...
    public static void signalTreeModelRowsReordered(MemoryAddress source, MemoryAddress path, MemoryAddress iter, MemoryAddress newOrder, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeModel.TreeModelImpl(ProxyFactory.getCachedProxy(source)), new TreePath(ProxyFactory.getProxy(path, false)), new TreeIter(ProxyFactory.getProxy(iter, false)), newOrder);
    }
    ...
    public static void signalDropDownActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new DropDown(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalSearchEntryActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new SearchEntry(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalWindowActivateDefault(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Window(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalWindowCloseRequest(MemoryAddress source, MemoryAddress data) {
        ...
        return handler.signalReceived(new Window(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalWindowEnableDebugging(MemoryAddress source, boolean toggle, MemoryAddress data) {
        ...
        return handler.signalReceived(new Window(ProxyFactory.getCachedProxy(source)), toggle);
    }
    ...
    public static void signalGLAreaCreateContext(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new GLArea(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalGLAreaRender(MemoryAddress source, MemoryAddress context, MemoryAddress data) {
        ...
        return handler.signalReceived(new GLArea(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.GLContext(ProxyFactory.getProxy(context, false)));
    }
    ...
    public static void signalGLAreaResize(MemoryAddress source, int width, int height, MemoryAddress data) {
        ...
        handler.signalReceived(new GLArea(ProxyFactory.getCachedProxy(source)), width, height);
    }
    ...
    public static void signalCalendarDaySelected(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Calendar(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalColumnViewActivate(MemoryAddress source, int position, MemoryAddress data) {
        ...
        handler.signalReceived(new ColumnView(ProxyFactory.getCachedProxy(source)), position);
    }
    ...
    public static void signalCheckButtonActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new CheckButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalEventControllerLegacyEvent(MemoryAddress source, MemoryAddress event, MemoryAddress data) {
        ...
        return handler.signalReceived(new EventControllerLegacy(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Event(ProxyFactory.getProxy(event, false)));
    }
    ...
    public static void signalLabelActivateCurrentLink(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Label(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalLabelActivateLink(MemoryAddress source, MemoryAddress uri, MemoryAddress data) {
        ...
        return handler.signalReceived(new Label(ProxyFactory.getCachedProxy(source)), uri.getUtf8String(0));
    }
    ...
    public static void signalLabelMoveCursor(MemoryAddress source, int step, int count, boolean extendSelection, MemoryAddress data) {
        ...
        handler.signalReceived(new Label(ProxyFactory.getCachedProxy(source)), MovementStep.fromValue(step), count, extendSelection);
    }
    ...
    public static void signalStyleProviderGtkPrivateChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new StyleProvider.StyleProviderImpl(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalLevelBarOffsetChanged(MemoryAddress source, MemoryAddress name, MemoryAddress data) {
        ...
        handler.signalReceived(new LevelBar(ProxyFactory.getCachedProxy(source)), name.getUtf8String(0));
    }
    ...
    public static void signalStatusbarTextPopped(MemoryAddress source, int contextId, MemoryAddress text, MemoryAddress data) {
        ...
        handler.signalReceived(new Statusbar(ProxyFactory.getCachedProxy(source)), contextId, text.getUtf8String(0));
    }
    ...
    public static void signalATContextStateChange(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new ATContext(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalTreeSortableSortColumnChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeSortable.TreeSortableImpl(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalNativeDialogResponse(MemoryAddress source, int responseId, MemoryAddress data) {
        ...
        handler.signalReceived(new NativeDialog(ProxyFactory.getCachedProxy(source)), responseId);
    }
    ...
    public static void signalFilterChanged(MemoryAddress source, int change, MemoryAddress data) {
        ...
        handler.signalReceived(new Filter(ProxyFactory.getCachedProxy(source)), FilterChange.fromValue(change));
    }
    ...
    public static void signalCellEditableEditingDone(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new CellEditable.CellEditableImpl(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalSignalListItemFactoryBind(MemoryAddress source, MemoryAddress listitem, MemoryAddress data) {
        ...
        handler.signalReceived(new SignalListItemFactory(ProxyFactory.getCachedProxy(source)), new ListItem(ProxyFactory.getProxy(listitem, false)));
    }
    ...
    public static boolean signalAboutDialogActivateLink(MemoryAddress source, MemoryAddress uri, MemoryAddress data) {
        ...
        return handler.signalReceived(new AboutDialog(ProxyFactory.getCachedProxy(source)), uri.getUtf8String(0));
    }
    ...
    public static void signalTreeSelectionChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new TreeSelection(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalSwitchActivate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new Switch(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalSwitchStateSet(MemoryAddress source, boolean state, MemoryAddress data) {
        ...
        return handler.signalReceived(new Switch(ProxyFactory.getCachedProxy(source)), state);
    }
    ...
    public static void signalIconThemeChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new IconTheme(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalInfoBarClose(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new InfoBar(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalInfoBarResponse(MemoryAddress source, int responseId, MemoryAddress data) {
        ...
        handler.signalReceived(new InfoBar(ProxyFactory.getCachedProxy(source)), responseId);
    }
    ...
    public static void signalEventControllerScrollDecelerate(MemoryAddress source, double velX, double velY, MemoryAddress data) {
        ...
        handler.signalReceived(new EventControllerScroll(ProxyFactory.getCachedProxy(source)), velX, velY);
    }
    ...
    public static boolean signalEventControllerScrollScroll(MemoryAddress source, double dx, double dy, MemoryAddress data) {
        ...
        return handler.signalReceived(new EventControllerScroll(ProxyFactory.getCachedProxy(source)), dx, dy);
    }
    ...
    public static void signalEventControllerScrollScrollBegin(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new EventControllerScroll(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalTextTagTableTagAdded(MemoryAddress source, MemoryAddress tag, MemoryAddress data) {
        ...
        handler.signalReceived(new TextTagTable(ProxyFactory.getCachedProxy(source)), new TextTag(ProxyFactory.getProxy(tag, false)));
    }
    ...
    public static void signalTextTagTableTagChanged(MemoryAddress source, MemoryAddress tag, boolean sizeChanged, MemoryAddress data) {
        ...
        handler.signalReceived(new TextTagTable(ProxyFactory.getCachedProxy(source)), new TextTag(ProxyFactory.getProxy(tag, false)), sizeChanged);
    }
    ...
    public static void signalGestureDragDragBegin(MemoryAddress source, double startX, double startY, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureDrag(ProxyFactory.getCachedProxy(source)), startX, startY);
    }
    ...
    public static void signalGestureDragDragEnd(MemoryAddress source, double offsetX, double offsetY, MemoryAddress data) {
        ...
        handler.signalReceived(new GestureDrag(ProxyFactory.getCachedProxy(source)), offsetX, offsetY);
    }
    ...
    public static void signalCellRendererEditingCanceled(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new CellRenderer(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalCellRendererEditingStarted(MemoryAddress source, MemoryAddress editable, MemoryAddress path, MemoryAddress data) {
        ...
        handler.signalReceived(new CellRenderer(ProxyFactory.getCachedProxy(source)), new CellEditable.CellEditableImpl(ProxyFactory.getProxy(editable, false)), path.getUtf8String(0));
    }
    ...
    public static void signalPrinterDetailsAcquired(MemoryAddress source, boolean success, MemoryAddress data) {
        ...
        handler.signalReceived(new Printer(ProxyFactory.getCachedProxy(source)), success);
    }
    ...
    public static void signalGestureBegin(MemoryAddress source, MemoryAddress sequence, MemoryAddress data) {
        ...
        handler.signalReceived(new Gesture(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.EventSequence(ProxyFactory.getProxy(sequence, false)));
    }
    ...
    public static void signalGestureSequenceStateChanged(MemoryAddress source, MemoryAddress sequence, int state, MemoryAddress data) {
        ...
        handler.signalReceived(new Gesture(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.EventSequence(ProxyFactory.getProxy(sequence, false)), EventSequenceState.fromValue(state));
    }
    ...
    public static void signalPrintJobStatusChanged(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new PrintJob(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalDropTargetAccept(MemoryAddress source, MemoryAddress drop, MemoryAddress data) {
        ...
        return handler.signalReceived(new DropTarget(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Drop(ProxyFactory.getProxy(drop, false)));
    }
    ...
    public static boolean signalDropTargetDrop(MemoryAddress source, MemoryAddress value, double x, double y, MemoryAddress data) {
        ...
        return handler.signalReceived(new DropTarget(ProxyFactory.getCachedProxy(source)), new org.gtk.gobject.Value(ProxyFactory.getProxy(value, false)), x, y);
    }
    ...
    public static void signalDropTargetEnter(MemoryAddress source, double x, double y, MemoryAddress data) {
        ...
        handler.signalReceived(new DropTarget(ProxyFactory.getCachedProxy(source)), x, y);
    }
    ...
    public static void signalDropTargetLeave(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new DropTarget(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalLinkButtonActivateLink(MemoryAddress source, MemoryAddress data) {
        ...
        return handler.signalReceived(new LinkButton(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalEventControllerKeyImUpdate(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new EventControllerKey(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static boolean signalEventControllerKeyKeyPressed(MemoryAddress source, int keyval, int keycode, int state, MemoryAddress data) {
        ...
        return handler.signalReceived(new EventControllerKey(ProxyFactory.getCachedProxy(source)), keyval, keycode, state);
    }
    ...
    public static void signalEventControllerKeyKeyReleased(MemoryAddress source, int keyval, int keycode, int state, MemoryAddress data) {
        ...
        handler.signalReceived(new EventControllerKey(ProxyFactory.getCachedProxy(source)), keyval, keycode, state);
    }
    ...
    public static boolean signalEventControllerKeyModifiers(MemoryAddress source, int keyval, MemoryAddress data) {
        ...
        return handler.signalReceived(new EventControllerKey(ProxyFactory.getCachedProxy(source)), keyval);
    }
    ...
    public static void signalTextBufferApplyTag(MemoryAddress source, MemoryAddress tag, MemoryAddress start, MemoryAddress end, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)), new TextTag(ProxyFactory.getProxy(tag, false)), new TextIter(ProxyFactory.getProxy(start, false)), new TextIter(ProxyFactory.getProxy(end, false)));
    }
    ...
    public static void signalTextBufferBeginUserAction(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)));
    }
    ...
    public static void signalTextBufferDeleteRange(MemoryAddress source, MemoryAddress start, MemoryAddress end, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)), new TextIter(ProxyFactory.getProxy(start, false)), new TextIter(ProxyFactory.getProxy(end, false)));
    }
    ...
    public static void signalTextBufferInsertChildAnchor(MemoryAddress source, MemoryAddress location, MemoryAddress anchor, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)), new TextIter(ProxyFactory.getProxy(location, false)), new TextChildAnchor(ProxyFactory.getProxy(anchor, false)));
    }
    ...
    public static void signalTextBufferInsertPaintable(MemoryAddress source, MemoryAddress location, MemoryAddress paintable, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)), new TextIter(ProxyFactory.getProxy(location, false)), new org.gtk.gdk.Paintable.PaintableImpl(ProxyFactory.getProxy(paintable, false)));
    }
    ...
    public static void signalTextBufferInsertText(MemoryAddress source, MemoryAddress location, MemoryAddress text, int len, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)), new TextIter(ProxyFactory.getProxy(location, false)), text.getUtf8String(0), len);
    }
    ...
    public static void signalTextBufferMarkDeleted(MemoryAddress source, MemoryAddress mark, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)), new TextMark(ProxyFactory.getProxy(mark, false)));
    }
    ...
    public static void signalTextBufferMarkSet(MemoryAddress source, MemoryAddress location, MemoryAddress mark, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)), new TextIter(ProxyFactory.getProxy(location, false)), new TextMark(ProxyFactory.getProxy(mark, false)));
    }
    ...
    public static void signalTextBufferPasteDone(MemoryAddress source, MemoryAddress clipboard, MemoryAddress data) {
        ...
        handler.signalReceived(new TextBuffer(ProxyFactory.getCachedProxy(source)), new org.gtk.gdk.Clipboard(ProxyFactory.getProxy(clipboard, false)));
    }
    ...
    public static boolean signalNotebookChangeCurrentPage(MemoryAddress source, int object, MemoryAddress data) {
        ...
        return handler.signalReceived(new Notebook(ProxyFactory.getCachedProxy(source)), object);
    }
    ...
    public static void signalNotebookCreateWindow(MemoryAddress source, MemoryAddress page, MemoryAddress data) {
        ...
        handler.signalReceived(new Notebook(ProxyFactory.getCachedProxy(source)), new Widget(ProxyFactory.getProxy(page, false)));
    }
    ...
    public static boolean signalNotebookFocusTab(MemoryAddress source, int object, MemoryAddress data) {
        ...
        return handler.signalReceived(new Notebook(ProxyFactory.getCachedProxy(source)), NotebookTab.fromValue(object));
    }
    ...
    public static void signalNotebookMoveFocusOut(MemoryAddress source, int object, MemoryAddress data) {
        ...
        handler.signalReceived(new Notebook(ProxyFactory.getCachedProxy(source)), DirectionType.fromValue(object));
    }
    ...
    public static void signalNotebookPageAdded(MemoryAddress source, MemoryAddress child, int pageNum, MemoryAddress data) {
        ...
        handler.signalReceived(new Notebook(ProxyFactory.getCachedProxy(source)), new Widget(ProxyFactory.getProxy(child, false)), pageNum);
    }
    ...
    public static boolean signalNotebookReorderTab(MemoryAddress source, int object, boolean p0, MemoryAddress data) {
        ...
        return handler.signalReceived(new Notebook(ProxyFactory.getCachedProxy(source)), DirectionType.fromValue(object), p0);
    }
    ...
    public static void signalNotebookSwitchPage(MemoryAddress source, MemoryAddress page, int pageNum, MemoryAddress data) {
        ...
        handler.signalReceived(new Notebook(ProxyFactory.getCachedProxy(source)), new Widget(ProxyFactory.getProxy(page, false)), pageNum);
    }
    ...
    public static void signalEventControllerFocusEnter(MemoryAddress source, MemoryAddress data) {
        ...
        handler.signalReceived(new EventControllerFocus(ProxyFactory.getCachedProxy(source)));
    }
