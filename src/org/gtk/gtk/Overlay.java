...
public class Overlay extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    public void onGetChildPosition(GetChildPositionHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("get-child-position"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
