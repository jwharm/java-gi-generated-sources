...
public class TreeRowReference extends io.github.jwharm.javagi.interop.ResourceBase {
    ...
    public TreeRowReference(TreeModel model, TreePath path) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_tree_row_reference_new(model.HANDLE(), path.HANDLE()), true));
    }
    ...
    public TreeRowReference(org.gtk.gobject.Object proxy, TreeModel model, TreePath path) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_tree_row_reference_new_proxy(proxy.HANDLE(), model.HANDLE(), path.HANDLE()), true));
    }
    ...
    public TreeRowReference copy() {
        ...
        return new TreeRowReference(ProxyFactory.getProxy(RESULT, true));
    }
