...
/**
 * A <code>GtkStatusbar</code> widget is usually placed along the bottom of an application&#39;s
 * main {@link org.gtk.gtk.Window}.
 * <p>
 * !{@link [An example GtkStatusbar]}(statusbar.png)
 * <p>
 * A <code>GtkStatusBar</code> may provide a regular commentary of the application&#39;s
 ...
 * be generated by {@link org.gtk.gtk.Statusbar#getContextId}, given a message and
 ...
 * <p>
 * Messages are added to the bar&#8217;s stack with {@link org.gtk.gtk.Statusbar#push}.
 * <p>
 * The message at the top of the stack can be removed using
 * {@link org.gtk.gtk.Statusbar#pop}. A message can be removed from anywhere in the
 * stack if its message id was recorded at the time it was added. This is done
 * using {@link org.gtk.gtk.Statusbar#remove}.
 * <p>
 * <h2>CSS node</h2>
...
public class Statusbar extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    /**
     * Removes the first message in the <code>GtkStatusbar</code>&#8217;s stack
