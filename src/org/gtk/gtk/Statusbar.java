...
/**
 * A <code>GtkStatusbar</code> widget is usually placed along the bottom of an application&<code>#39</code> s
 * main {@link org.gtk.gtk.Window}.
 * <p>
 * !{@link [An example GtkStatusbar]}(statusbar.png)
 * <p>
 * A <code>GtkStatusBar</code> may provide a regular commentary of the application&<code>#39</code> s
 * status (as is usually the case in a web browser, for example), or may be
 * used to simply output a message when the status changes, (when an upload
 * is complete in an FTP client, for example).
 * <p>
 * Status bars in GTK maintain a stack of messages. The message at
 * the top of the each bar&<code>#8217</code> s stack is the one that will currently be displayed.
 * <p>
 * Any messages added to a statusbar&<code>#8217</code> s stack must specify a context id that
 * is used to uniquely identify the source of a message. This context id can
 * be generated by {@link org.gtk.gtk.Statusbar<code>#getContextId</code> , given a message and
 ...
 * <p>
 * Status bars are created using {@link [ctor@Gtk.Statusbar.new] (ref=ctor)}.
 * <p>
 * Messages are added to the bar&<code>#8217</code> s stack with {@link org.gtk.gtk.Statusbar<code>#push</code> .
 * <p>
 * The message at the top of the stack can be removed using
 * {@link org.gtk.gtk.Statusbar<code>#pop</code> . A message can be removed from anywhere in the
 * stack if its message id was recorded at the time it was added. This is done
 * using {@link org.gtk.gtk.Statusbar<code>#remove</code> .
 * <p>
 * <h2>CSS node</h2>
 * <p><code>GtkStatusbar</code> has a single CSS node with name <code>statusbar</code>.
 */
public class Statusbar extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    /**
     * Creates a new <code>GtkStatusbar</code> ready for messages.
     */
    public Statusbar() {
        super(constructNew());
    }
    ...
    /**
     * Removes the first message in the <code>GtkStatusbar</code>&<code>#8217</code> s stack
    ...
    /**
     * Pushes a new message onto a statusbar&<code>#8217</code> s stack.
     */
    ...
    /**
     * Forces the removal of a message from a statusbar&<code>#8217</code> s stack.
    ...
    /**
     * Forces the removal of all messages from a statusbar&<code>#39</code> s
    ...
    /**
     * Emitted whenever a new message is popped off a statusbar&<code>#39</code> s stack.
     */
    ...
    /**
     * Emitted whenever a new message gets pushed onto a statusbar&<code>#39</code> s stack.
     */
