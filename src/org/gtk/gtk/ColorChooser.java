...
public interface ColorChooser extends io.github.jwharm.javagi.interop.NativeAddress {
    ...
    public default void onColorActivated(ColorActivatedHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("color-activated"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
