 ...
 */
public class BuilderScopeInterface extends io.github.jwharm.javagi.interop.ResourceBase {

    public BuilderScopeInterface(io.github.jwharm.javagi.interop.Reference reference) {
        super(reference);
    }
