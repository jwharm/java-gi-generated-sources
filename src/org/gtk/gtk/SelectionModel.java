...
public interface SelectionModel extends io.github.jwharm.javagi.interop.NativeAddress {
    ...
    public default boolean isSelected(int position) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_is_selected(HANDLE(), position);
        return (RESULT != 0);
    }
    ...
    public default boolean selectAll() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_select_all(HANDLE());
        return (RESULT != 0);
    }
    ...
    public default boolean selectItem(int position, boolean unselectRest) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_select_item(HANDLE(), position, unselectRest ? 1 : 0);
        return (RESULT != 0);
    }
    ...
    public default boolean selectRange(int position, int nItems, boolean unselectRest) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_select_range(HANDLE(), position, nItems, unselectRest ? 1 : 0);
        return (RESULT != 0);
    }
    ...
    public default void selectionChanged(int position, int nItems) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_selection_changed(HANDLE(), position, nItems);
    }
    ...
    public default boolean setSelection(Bitset selected, Bitset mask) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_set_selection(HANDLE(), selected.HANDLE(), mask.HANDLE());
        return (RESULT != 0);
    }
    ...
    public default boolean unselectAll() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_unselect_all(HANDLE());
        return (RESULT != 0);
    }
    ...
    public default boolean unselectItem(int position) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_unselect_item(HANDLE(), position);
        return (RESULT != 0);
    }
    ...
    public default boolean unselectRange(int position, int nItems) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_selection_model_unselect_range(HANDLE(), position, nItems);
        return (RESULT != 0);
    }
    ...
    class SelectionModelImpl extends org.gtk.gobject.Object implements SelectionModel {
        public SelectionModelImpl(io.github.jwharm.javagi.interop.Proxy proxy) {
            super(proxy);
        }
    }
}
