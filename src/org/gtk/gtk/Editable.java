...
public interface Editable extends io.github.jwharm.javagi.interop.NativeAddress {
    ...
    public default void deleteSelection() {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_delete_selection(HANDLE());
    }
    ...
    public default void deleteText(int startPos, int endPos) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_delete_text(HANDLE(), startPos, endPos);
    }
    ...
    public default void finishDelegate() {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_finish_delegate(HANDLE());
    }
    ...
    public default float getAlignment() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_get_alignment(HANDLE());
        return RESULT;
    }
    ...
    public default java.lang.String getChars(int startPos, int endPos) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_get_chars(HANDLE(), startPos, endPos);
    ...
    public default boolean getEditable() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_get_editable(HANDLE());
        return (RESULT != 0);
    }
    ...
    public default boolean getEnableUndo() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_get_enable_undo(HANDLE());
        return (RESULT != 0);
    }
    ...
    public default int getMaxWidthChars() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_get_max_width_chars(HANDLE());
        return RESULT;
    }
    ...
    public default int getPosition() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_get_position(HANDLE());
        return RESULT;
    }
    ...
    public default java.lang.String getText() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_get_text(HANDLE());
        return RESULT.getUtf8String(0);
    }
    ...
    public default int getWidthChars() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_get_width_chars(HANDLE());
        return RESULT;
    }
    ...
    public default void initDelegate() {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_init_delegate(HANDLE());
    }
    ...
    public default void selectRegion(int startPos, int endPos) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_select_region(HANDLE(), startPos, endPos);
    }
    ...
    public default void setAlignment(float xalign) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_set_alignment(HANDLE(), xalign);
    }
    ...
    public default void setEditable(boolean isEditable) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_set_editable(HANDLE(), isEditable ? 1 : 0);
    }
    ...
    public default void setEnableUndo(boolean enableUndo) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_set_enable_undo(HANDLE(), enableUndo ? 1 : 0);
    }
    ...
    public default void setMaxWidthChars(int nChars) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_set_max_width_chars(HANDLE(), nChars);
    }
    ...
    public default void setPosition(int position) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_set_position(HANDLE(), position);
    }
    ...
    public default void setText(java.lang.String text) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_set_text(HANDLE(), Interop.getAllocator().allocateUtf8String(text));
    }
    ...
    public default void setWidthChars(int nChars) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_editable_set_width_chars(HANDLE(), nChars);
    }
    ...
    public default void onDeleteText(DeleteTextHandler handler) {
        try {
            ...
            NativeSymbol nativeSymbol = CLinker.systemCLinker().upcallStub(methodHandle, descriptor, Interop.getScope());
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("delete-text"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    class EditableImpl extends org.gtk.gobject.Object implements Editable {
        public EditableImpl(io.github.jwharm.javagi.interop.Proxy proxy) {
            super(proxy);
        }
    }
}
