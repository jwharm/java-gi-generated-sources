...
public class GesturePan extends GestureDrag {
    ...
    public Orientation getOrientation() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_gesture_pan_get_orientation(HANDLE());
    ...
    public void setOrientation(Orientation orientation) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_gesture_pan_set_orientation(HANDLE(), orientation.getValue());
    }
    ...
    public void onPan(PanHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("pan"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
