...
public class DropTargetAsync extends EventController {
    ...
    public DropTargetAsync(org.gtk.gdk.ContentFormats formats, int actions) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_drop_target_async_new(formats.HANDLE(), actions), true));
    }
    ...
    public int getActions() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_drop_target_async_get_actions(HANDLE());
        return RESULT;
    }
    ...
    public org.gtk.gdk.ContentFormats getFormats() {
        ...
        return new org.gtk.gdk.ContentFormats(ProxyFactory.getProxy(RESULT, true));
    }
    ...
    public void rejectDrop(org.gtk.gdk.Drop drop) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_drop_target_async_reject_drop(HANDLE(), drop.HANDLE());
    }
    ...
    public void setActions(int actions) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_drop_target_async_set_actions(HANDLE(), actions);
    }
    ...
    public void setFormats(org.gtk.gdk.ContentFormats formats) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_drop_target_async_set_formats(HANDLE(), formats.HANDLE());
    }
    ...
    public void onAccept(AcceptHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("accept"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
    ...
    public void onDragEnter(DragEnterHandler handler) {
        try {
            ...
            NativeSymbol nativeSymbol = CLinker.systemCLinker().upcallStub(methodHandle, descriptor, Interop.getScope());
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("drag-enter"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public void onDragLeave(DragLeaveHandler handler) {
        try {
            ...
            NativeSymbol nativeSymbol = CLinker.systemCLinker().upcallStub(methodHandle, descriptor, Interop.getScope());
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("drag-leave"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public void onDragMotion(DragMotionHandler handler) {
        try {
            ...
            FunctionDescriptor descriptor = FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.JAVA_DOUBLE, ValueLayout.JAVA_DOUBLE, ValueLayout.ADDRESS);
            NativeSymbol nativeSymbol = CLinker.systemCLinker().upcallStub(methodHandle, descriptor, Interop.getScope());
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("drag-motion"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public void onDrop(DropHandler handler) {
        try {
            ...
            NativeSymbol nativeSymbol = CLinker.systemCLinker().upcallStub(methodHandle, descriptor, Interop.getScope());
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("drop"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
