...
public class Text extends Widget implements Accessible, Buildable, ConstraintTarget, Editable {
     ...
     */
    public Text() {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_text_new(), false));
    }
    ...
    public Text(EntryBuffer buffer) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_text_new_with_buffer(buffer.HANDLE()), false));
    }
    ...
    public void setPlaceholderText(java.lang.String text) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_text_set_placeholder_text(HANDLE(), Interop.getAllocator().allocateUtf8String(text));
    }
