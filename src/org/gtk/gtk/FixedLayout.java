...
/**
 * <code>GtkFixedLayout</code> is a layout manager which can place child widgets
 * at fixed positions.
 * <p>
 ...
 *   cases.
 * <p>
 * In addition, <code>GtkFixedLayout</code> does not pay attention to text direction and
...
public class FixedLayout extends LayoutManager {
    ...
    /**
     * Creates a new <code>GtkFixedLayout</code>.
     */
    public FixedLayout() {
        super(constructNew());
    }
