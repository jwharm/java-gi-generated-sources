...
public interface TreeSortable extends io.github.jwharm.javagi.interop.NativeAddress {
    ...
    public default void onSortColumnChanged(SortColumnChangedHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("sort-column-changed"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
