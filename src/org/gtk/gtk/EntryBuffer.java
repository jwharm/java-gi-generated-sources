...
public class EntryBuffer extends org.gtk.gobject.Object {
    ...
    public int deleteText(int position, int nChars) {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_entry_buffer_delete_text(HANDLE(), position, nChars);
        return RESULT;
    }
    ...
    public void emitDeletedText(int position, int nChars) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_entry_buffer_emit_deleted_text(HANDLE(), position, nChars);
    }
    ...
    public long getBytes() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_entry_buffer_get_bytes(HANDLE());
        return RESULT;
    }
    ...
    public int getLength() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_entry_buffer_get_length(HANDLE());
        return RESULT;
    }
    ...
    public int getMaxLength() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_entry_buffer_get_max_length(HANDLE());
        return RESULT;
    }
    ...
    public java.lang.String getText() {
        var RESULT = io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_entry_buffer_get_text(HANDLE());
    ...
    public void setMaxLength(int maxLength) {
        io.github.jwharm.javagi.interop.jextract.gtk_h.gtk_entry_buffer_set_max_length(HANDLE(), maxLength);
    }
