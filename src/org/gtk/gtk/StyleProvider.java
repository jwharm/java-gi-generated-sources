...
public interface StyleProvider extends io.github.jwharm.javagi.interop.NativeAddress {
    ...
    public default void onGtkPrivateChanged(GtkPrivateChangedHandler handler) {
        try {
            ...
            io.github.jwharm.javagi.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String("gtk-private-changed"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);
        } catch (Exception e) {
