...
public class Layout extends org.gtk.gobject.Object {
    ...
    public Layout(Context context) {
        super(ProxyFactory.getProxy(io.github.jwharm.javagi.interop.jextract.gtk_h.pango_layout_new(context.HANDLE()), true));
    }
    ...
    public Layout copy() {
        ...
        return new Layout(ProxyFactory.getProxy(RESULT, true));
    }
    ...
    public AttrList getAttributes() {
        ...
        return new AttrList(ProxyFactory.getProxy(RESULT, false));
    }
    ...
    public Context getContext() {
        ...
        return new Context(ProxyFactory.getProxy(RESULT, false));
    }
    ...
    public FontDescription getFontDescription() {
        ...
        return new FontDescription(ProxyFactory.getProxy(RESULT, false));
    }
    ...
    public TabArray getTabs() {
        ...
        return new TabArray(ProxyFactory.getProxy(RESULT, true));
    }
